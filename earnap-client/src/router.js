...
const ROUTES = [
    ...
    { path: '/admin/pending-jobs', requireAuth: true, requireAdmin: true, render: () => import('./views/AdminJobsPage.js') },
    { path: '/admin/active-jobs',  requireAuth: true, requireAdmin: true, render: () => import('./views/AdminJobsPage.js') },
