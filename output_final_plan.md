...
8. Run data-backed browser verification of worker watch/claim, proof upload/review, admin video CRUD, user ban/unban, and assignment/payment flows after migrations are applied; basic authenticated route rendering is already covered locally.
