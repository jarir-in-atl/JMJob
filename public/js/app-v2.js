var Mt=Object.defineProperty;var p=(e,t)=>()=>(e&&(t=e(e=0)),t);var w=(e,t)=>{for(var a in t)Mt(e,a,{get:t[a],enumerable:!0})};function Ht(e,t){Ne?Ne(e,t):console.error("[Ghost] Unhandled effect error:",e)}function H(e){let t=e,a=new Set;return{get(){return x&&(a.add(x),x.dependencies.add(a)),t},set(r){t!==r&&(t=r,Pe(a))}}}function Pe(e){ne(()=>{e.forEach(t=>{t.notify?t.notify():j.add(t)})})}function ne(e){re++;try{e()}finally{if(re--,re===0){let t=Array.from(j);j.clear(),t.forEach(a=>a.run())}}}function y(e){let t={dependencies:new Set,run(){se(t),I.push(x),x=t;try{e()}catch(a){Ht(a,e)}finally{x=I.pop()}},notify(){j.add(t)}};return t.run(),()=>se(t)}function ie(e){let t,a=!0,r=new Set,s={dependencies:new Set,notify(){a||(a=!0,Pe(r))}};return{get(){if(x&&(r.add(x),x.dependencies.add(r)),a){se(s),I.push(x),x=s;try{t=e()}finally{x=I.pop()}a=!1}return t}}}function se(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var x,I,j,re,Ne,F=p(()=>{x=null,I=[],j=new Set,re=0,Ne=null});function R(){oe.totalUpdates++,oe.recentUpdates++}var D,oe,de=p(()=>{D=new Set,oe={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function C(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){Ft(e,t);return}if(e.__ghostWhen){Nt(e,t);return}if(e.__ghostLazy){Pt(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;D.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([r,s])=>{if(r==="ghostStyle"&&s?.mount){s.mount(a);return}let i=r.startsWith("on");typeof s=="function"&&!i?e.effects.push(y(()=>{a.setAttribute(r,s()),R(),e.events.update?.forEach(n=>n())})):i?a[r.toLowerCase()]=s:a.setAttribute(r,s)}),e.children.forEach(r=>{if(r!=null)if(r.__ghostList||r.__ghostWhen||r.__ghostLazy)C(r,a);else if(typeof r=="string"||typeof r=="number")a.appendChild(document.createTextNode(String(r)));else if(typeof r=="function"){let s=null;e.effects.push(y(()=>{let i=r(),n=document.createTextNode(String(i??""));s?a.replaceChild(n,s):a.appendChild(n),s=n,R(),e.events.update?.forEach(o=>o())}))}else C(r,a)}),t.appendChild(a),e.events.mount?.forEach(r=>r())}function W(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),D.delete(e)}}function Ft(e,t){let{getItems:a,keyFn:r,renderFn:s}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function d(m){return m.el||null}let v=y(()=>{let m=a(),L=m.map((b,M)=>String(r(b,M))),qt=Array.from(o.keys());for(let b of qt)if(!L.includes(b)){let M=o.get(b);W(M.ghostNode),o.delete(b)}for(let b=0;b<m.length;b++){let M=L[b];if(!o.has(M)){let U=s(m[b],b),N=document.createElement("ghost-list-slot");for(C(U,N);N.firstChild;)t.insertBefore(N.firstChild,n);o.set(M,{ghostNode:U})}}for(let b=L.length-1;b>=0;b--){let M=L[b],U=o.get(M);if(!U)continue;let N=d(U.ghostNode);if(!N)continue;let He=L[b+1],Fe=(He?d(o.get(He)?.ghostNode):null)||n;N.nextSibling!==Fe&&t.insertBefore(N,Fe)}R()});e._listCleanup=()=>{v();for(let m of o.values())W(m.ghostNode);o.clear(),i.remove(),n.remove()}}function P(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function Nt(e,t){let{conditionGetter:a,trueFn:r,falseFn:s}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=y(()=>{let v=a()?r:s;if(n&&(W(n),n=null),v&&(n=v(),n)){let m=document.createElement("ghost-when-slot");for(C(n,m);m.firstChild;)t.insertBefore(m.firstChild,i)}R()});e._whenCleanup=()=>{o(),n&&W(n),i.remove()}}function Pt(e,t){let{importFn:a,fallback:r}=e,s=document.createComment("[ghost-lazy]");t.appendChild(s);let i=null;if(r){let n=document.createElement("ghost-lazy-slot");for(C(r,n);n.firstChild;)t.insertBefore(n.firstChild,s);i=r}a().then(n=>{let o=n.default||n;i&&(W(i),i=null);let d=typeof o=="function"?o():o,v=document.createElement("ghost-lazy-slot");for(C(d,v);v.firstChild;)t.insertBefore(v.firstChild,s);i=d}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var le=p(()=>{F();de()});var Ue=p(()=>{F()});var B=p(()=>{});var Re=p(()=>{de()});var We=p(()=>{F()});var Oe=p(()=>{le();F();B();B()});function Rt(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function r(s){let i={};if(s.nodeType===3)return s.nodeValue.trim();if(s.attributes?.length){i["@attributes"]={};for(let n of s.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of s.childNodes){let o=n.nodeName,d=r(n);d!==""&&(i[o]===void 0?i[o]=d:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(d)))}return i}return r(a.documentElement)}function Wt(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function pe(e,t={}){let{cache:a=!1,...r}=t,s=(r.method||"GET").toUpperCase(),i={url:e,...r};for(let L of pe.interceptors.request)i=L(i)??i;let n=i.url;delete i.url;let o=Wt(n,s);if(a==="memory"&&s==="GET"&&ce.has(o))return ce.get(o);let d=await fetch(n,i),v=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let m;v.includes("application/xml")||v.includes("text/xml")?m=Rt(await d.text()):v.includes("application/json")?m=await d.json():m=await d.text();for(let L of pe.interceptors.response)m=L(d,m)??m;return a==="memory"&&s==="GET"&&ce.set(o,m),m}var ce,Ie=p(()=>{ce=new Map;pe.interceptors={request:[],response:[]}});function ue(e,t){let a;try{let s=localStorage.getItem(e);a=s?JSON.parse(s):t}catch{a=t}let r=H(a);return y(()=>{try{localStorage.setItem(e,JSON.stringify(r.get()))}catch(s){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,s)}}),r}var je=p(()=>{F()});function Ot(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(r=>r(a))},clear(t){t?e.delete(t):e.clear()}}}var ja,De=p(()=>{ja=Ot()});var Ga,It,Be=p(()=>{F();Ga=H("en"),It=new Map;It.set("en",{})});var E=p(()=>{F();le();Ue();B();Re();We();Oe();Ie();je();De();Be()});function Ge(e){me=e}function ze(e){he=e}async function u(e,{method:t="GET",body:a,headers:r={},signal:s}={}){let i=e.startsWith("http")?e:jt.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...r}};me&&(n.headers.Authorization=`Bearer ${me}`),a!==void 0&&(n.body=JSON.stringify(a)),s&&(n.signal=s);let o=await fetch(i,n);if(o.status===401)throw he&&he(),new G("Unauthorized",401,null);let d=null,v=o.headers.get("content-type")||"";try{if(v.includes("application/json"))d=await o.json();else{let m=await o.text();d=m?{message:m}:null}}catch{}if(!o.ok){let m=d&&d.message||`HTTP ${o.status}`;throw new G(m,o.status,d)}return d}var jt,me,he,G,c,T=p(()=>{jt=window.JMJOB_CONFIG||{apiBase:"/api"},me=null,he=null;G=class extends Error{constructor(t,a,r){super(t),this.status=a,this.payload=r}},c={health:()=>u("/health"),register:e=>u("/auth/register",{method:"POST",body:e}),login:e=>u("/auth/login",{method:"POST",body:e}),logout:()=>u("/auth/logout",{method:"POST"}),me:()=>u("/auth/me"),meUser:()=>u("/user"),reward:e=>u("/user/reward",{method:"POST",body:e}),withdraw:e=>u("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>u("/user/withdrawals"),referrals:()=>u("/user/referrals"),adHistory:()=>u("/user/ads"),adsConfig:()=>u("/ads/config"),adsNext:()=>u("/ads/next"),webTasks:()=>u("/tasks/web"),webTaskStart:e=>u("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>u("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>u("/tasks/telegram"),tgTaskVerify:e=>u("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>u("/admin/stats"),adminWithdrawals:(e="pending")=>u(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>u(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>u(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>u(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>u("/admin/users"),adminProviders:()=>u("/admin/ad-providers"),adminUpdateProvider:(e,t)=>u(`/admin/ad-providers/${e}`,{method:"POST",body:t})}});function l(e,t="info",a=3500){O.set({message:e,type:t,id:Date.now()}),fe&&clearTimeout(fe),fe=setTimeout(()=>O.set(null),a)}async function S(){if(!A.get())return null;try{let e=await c.me();return h.set(e.data),e.data}catch{return null}}async function Je(e,t){let a=await c.login({email:e,password:t});return A.set(a.data.token),h.set(a.data.user),a.data.user}async function Ve(e){let t=await c.register(e);return A.set(t.data.token),h.set(t.data.user),t.data.user}async function z(){try{await c.logout()}catch{}A.set(null),h.set(null),q.set("/login")}function g(e){window.location.hash=e}var Dt,Bt,A,h,O,fe,q,$,f=p(()=>{E();E();T();Dt="earnap_token",Bt="earnap_user",A=ue(Dt,null),h=ue(Bt,null),O=H(null),fe=null;q=H(window.location.hash.replace(/^#/,"")||"/"),$=ie(()=>!!A.get()&&!!h.get());y(()=>{let e=A.get();Ge(e)});ze(()=>{A.set(null),h.set(null),q.set("/login"),l("Session expired. Please log in.","error")})});var Ke={};w(Ke,{HomePage:()=>J});function J(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=h.get(),a=_("div","welcome-popup","");a.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),r=e.querySelector("#admin-content");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),s.classList.add("admin-tab--active"),ft(s.dataset.tab,r)})}),ft("stats",r)}}async function ft(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let r=(await c.adminStats()).data;t.innerHTML=`
            ...
            `;let s=t.querySelector("#wd-list");r.forEach(i=>s.appendChild(vt(i,s))),t.querySelector("#wd-filter").addEventListener("change",async i=>{let n=await c.adminWithdrawals(i.target.value);s.innerHTML="",(n.data||[]).forEach(o=>s.appendChild(vt(o,s)))})}else if(e==="users"){let r=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let s=t.querySelector(".admin-list");r.forEach(i=>{let n=document.createElement("div");n.className="admin-row",n.innerHTML=`
                    <div>
                        ...
                        <span class="muted">${k(i.email)}</span>
    ...
    `,e.status==="pending"){let r=document.createElement("div");r.className="admin-row__actions";let s=document.createElement("button");s.className="btn btn--success btn--sm",s.textContent="Approve",s.addEventListener("click",async()=>{try{await c.adminApprove(e.id,{admin_note:"Approved by admin"}),l("Withdrawal approved","success"),a.remove()}catch(n){l(n.message,"error")}});let i=document.createElement("button");i.className="btn btn--danger btn--sm",i.textContent="Reject",i.addEventListener("click",async()=>{let n=prompt("Reason for rejection (optional):","Invalid wallet address");try{await c.adminReject(e.id,{admin_note:n||""}),l("Withdrawal rejected (refunded)","info"),a.remove()}catch(o){l(o.message,"error")}}),r.appendChild(s),r.appendChild(i),a.appendChild(r)}else if(e.status==="approved"){let r=document.createElement("div");r.className="admin-row__actions";let s=document.createElement("button");s.className="btn btn--primary btn--sm",s.textContent="Mark as Paid",s.addEventListener("click",async()=>{try{await c.adminPay(e.id,{admin_note:"Paid by admin"}),l("Marked as paid","success"),a.remove()}catch(i){l(i.message,"error")}}),r.appendChild(s),a.appendChild(r)}return a}function na(e,t){let a=document.createElement("div");a.className="admin-row admin-row--provider";let r=!!e.enabled,s=e.block_id||"";return a.innerHTML=`
        ...
        <div class="admin-row__form">
            <label>Block ID: <input class="provider-block-id" type="text" value="${k(s)}" placeholder="e.g. 7387"></label>
    ...
    `;let a=e.querySelector("#login-form");a&&a.addEventListener("submit",async r=>{r.preventDefault();let s=new FormData(a),i=a.querySelector("button");i.disabled=!0,i.textContent="Logging in\u2026";try{await Je(s.get("email"),s.get("password")),l("Welcome back!","success"),g("/")}catch(n){l(n.message||"Login failed","error"),i.disabled=!1,i.textContent="Log in"}})}function ia(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Ae=p(()=>{f()});var wt={};w(wt,{RegisterPage:()=>qe});function qe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        ...
        `;let a=e.querySelector("#register-form");a.addEventListener("submit",async r=>{r.preventDefault();let s=new FormData(a),i=a.querySelector("button");i.disabled=!0,i.textContent="Creating\u2026";try{let n={name:s.get("name"),email:s.get("email"),password:s.get("password")};t&&(n.referral_code=t),await Ve(n),l("Account created \u2014 welcome!","success"),g("/")}catch(n){let o=n.payload&&n.payload.errors;if(o){let d=Object.values(o)[0];l(Array.isArray(d)?d[0]:d,"error")}else l(n.message||"Registration failed","error");i.disabled=!1,i.textContent="Create account"}})}}var Me=p(()=>{f();f()});E();f();E();f();var te=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ve(),Ke))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Y(),ge))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Y(),ge))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(be(),Ze))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ye(),et))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(xe(),tt))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Z(),$e))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(st(),rt))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ot(),it))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ct(),lt))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(mt(),ut))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Z(),$e))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ke(),ht))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ce(),gt))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(Ae(),bt))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(Me(),wt))}],Kr=y(()=>{let e=q.get();return te.find(t=>t.path===e)||te[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";q.set(e)});E();f();var oa=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}];function yt(){return{tag:"aside",props:{class:"sidebar",id:"sidebar"},children:[da(),la()]}}function da(){return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"span",props:{},children:["JM"]},{tag:"span",props:{},children:["JOB"]}]}}function la(){return{tag:"nav",props:{class:"sidebar__nav"},children:oa.map(e=>ca(e))}}function ca({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${q.get()===e?" sidebar__item--active":""}`,href:`#${e}`,onclick:s=>{s.preventDefault(),g(e),St()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function _t(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>St()},children:[]}}function xt(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.add("sidebar--open"),t&&t.classList.add("sidebar-overlay--active")}function St(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}f();E();function Tt(){return P(()=>$.get(),()=>ua(),()=>pa())}function pa(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function ua(){let e=h.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>xt(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]}]},{tag:"div",props:{class:"topbar__right"},children:[{tag:"button",props:{class:"topbar__notifications","aria-label":"Notifications"},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge"},children:["3"]}]},{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[e?e.name:"Loading\u2026"]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await z(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}f();E();function $t(){return P(()=>!!O.get(),()=>{let e=O.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}function Lt(){return{tag:"div",props:{class:"app-shell"},children:[P(()=>$.get(),()=>yt(),()=>null),P(()=>$.get(),()=>_t(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[Tt(),{tag:"main",props:{class:"app-main"},children:[ma()]}]},$t()]}}function ma(){let e=q.get(),t=te.find(a=>a.path===e);return t?t.requireAuth&&!$.get()?(g("/login"),kt()):t.requireAdmin&&(!h.get()||!h.get().is_admin)?va():!t.requireAuth&&$.get()&&["/login","/register"].includes(e)?(g("/"),kt()):ha(t):fa()}function ha(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function fa(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>g("/")},children:["Go home"]}]}}function va(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>g("/")},children:["Go home"]}]}}function kt(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}E();f();ve();Ae();Me();ye();Y();be();ke();xe();Z();Ce();var Ct={"/":J,"/refer":we,"/webtask":V,"/earn":K,"/tg-tasks":ee,"/withdraw":X,"/profile":Te,"/admin":Le,"/login":Ee,"/register":qe};function Et(){ae(),setTimeout(ae,50),window.addEventListener("hashchange",ae),y(()=>{$.get(),setTimeout(ae,0)})}async function ae(){let e=window.location.hash.replace(/^#/,"")||"/";Ct[e]||(e="/");let t=$.get(),a=["/login","/register"];if(a.includes(e)&&t){g("/");return}if(!a.includes(e)&&!t){g("/login");return}let r=document.getElementById("app"),s=r.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let n=r.querySelector(".bottomnav");n?r.insertBefore(s,n):r.appendChild(s)}s.innerHTML=`<div data-view="${e}" class="view-skeleton"><div class="spinner"></div></div>`;let i=Ct[e];try{let n=i();typeof n=="function"?await n():n&&typeof n.then=="function"&&await n}catch(n){console.error("View render threw synchronously for",e,n),s.innerHTML=`<div class="card"><h2>Error</h2><p>${n.message}</p></div>`}}f();var At=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();At.innerHTML="";C(Lt(),At);A.get()&&S();Et();
