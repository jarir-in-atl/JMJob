var Ot=Object.defineProperty;var p=(e,t)=>()=>(e&&(t=e(e=0)),t);var y=(e,t)=>{for(var a in t)Ot(e,a,{get:t[a],enumerable:!0})};function Wt(e,t){Re?Re(e,t):console.error("[Ghost] Unhandled effect error:",e)}function S(e){let t=e,a=new Set;return{get(){return x&&(a.add(x),x.dependencies.add(a)),t},set(r){t!==r&&(t=r,Oe(a))}}}function Oe(e){oe(()=>{e.forEach(t=>{t.notify?t.notify():B.add(t)})})}function oe(e){ne++;try{e()}finally{if(ne--,ne===0){let t=Array.from(B);B.clear(),t.forEach(a=>a.run())}}}function w(e){let t={dependencies:new Set,run(){ie(t),D.push(x),x=t;try{e()}catch(a){Wt(a,e)}finally{x=D.pop()}},notify(){B.add(t)}};return t.run(),()=>ie(t)}function de(e){let t,a=!0,r=new Set,s={dependencies:new Set,notify(){a||(a=!0,Oe(r))}};return{get(){if(x&&(r.add(x),x.dependencies.add(r)),a){ie(s),D.push(x),x=s;try{t=e()}finally{x=D.pop()}a=!1}return t}}}function ie(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var x,D,B,ne,Re,F=p(()=>{x=null,D=[],B=new Set,ne=0,Re=null});function W(){le.totalUpdates++,le.recentUpdates++}var G,le,ce=p(()=>{G=new Set,le={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function A(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){It(e,t);return}if(e.__ghostWhen){jt(e,t);return}if(e.__ghostLazy){Dt(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;G.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([r,s])=>{if(r==="ghostStyle"&&s?.mount){s.mount(a);return}let i=r.startsWith("on");typeof s=="function"&&!i?e.effects.push(w(()=>{a.setAttribute(r,s()),W(),e.events.update?.forEach(n=>n())})):i?a[r.toLowerCase()]=s:a.setAttribute(r,s)}),e.children.forEach(r=>{if(r!=null)if(r.__ghostList||r.__ghostWhen||r.__ghostLazy)A(r,a);else if(typeof r=="string"||typeof r=="number")a.appendChild(document.createTextNode(String(r)));else if(typeof r=="function"){let s=null;e.effects.push(w(()=>{let i=r(),n=document.createTextNode(String(i??""));s?a.replaceChild(n,s):a.appendChild(n),s=n,W(),e.events.update?.forEach(o=>o())}))}else A(r,a)}),t.appendChild(a),e.events.mount?.forEach(r=>r())}function I(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),G.delete(e)}}function It(e,t){let{getItems:a,keyFn:r,renderFn:s}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function d(m){return m.el||null}let v=w(()=>{let m=a(),C=m.map((b,H)=>String(r(b,H))),Rt=Array.from(o.keys());for(let b of Rt)if(!C.includes(b)){let H=o.get(b);I(H.ghostNode),o.delete(b)}for(let b=0;b<m.length;b++){let H=C[b];if(!o.has(H)){let O=s(m[b],b),P=document.createElement("ghost-list-slot");for(A(O,P);P.firstChild;)t.insertBefore(P.firstChild,n);o.set(H,{ghostNode:O})}}for(let b=C.length-1;b>=0;b--){let H=C[b],O=o.get(H);if(!O)continue;let P=d(O.ghostNode);if(!P)continue;let Pe=C[b+1],Ue=(Pe?d(o.get(Pe)?.ghostNode):null)||n;P.nextSibling!==Ue&&t.insertBefore(P,Ue)}W()});e._listCleanup=()=>{v();for(let m of o.values())I(m.ghostNode);o.clear(),i.remove(),n.remove()}}function U(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function jt(e,t){let{conditionGetter:a,trueFn:r,falseFn:s}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=w(()=>{let v=a()?r:s;if(n&&(I(n),n=null),v&&(n=v(),n)){let m=document.createElement("ghost-when-slot");for(A(n,m);m.firstChild;)t.insertBefore(m.firstChild,i)}W()});e._whenCleanup=()=>{o(),n&&I(n),i.remove()}}function Dt(e,t){let{importFn:a,fallback:r}=e,s=document.createComment("[ghost-lazy]");t.appendChild(s);let i=null;if(r){let n=document.createElement("ghost-lazy-slot");for(A(r,n);n.firstChild;)t.insertBefore(n.firstChild,s);i=r}a().then(n=>{let o=n.default||n;i&&(I(i),i=null);let d=typeof o=="function"?o():o,v=document.createElement("ghost-lazy-slot");for(A(d,v);v.firstChild;)t.insertBefore(v.firstChild,s);i=d}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var pe=p(()=>{F();ce()});var We=p(()=>{F()});var z=p(()=>{});var Ie=p(()=>{ce()});var je=p(()=>{F()});var De=p(()=>{pe();F();z();z()});function Gt(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function r(s){let i={};if(s.nodeType===3)return s.nodeValue.trim();if(s.attributes?.length){i["@attributes"]={};for(let n of s.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of s.childNodes){let o=n.nodeName,d=r(n);d!==""&&(i[o]===void 0?i[o]=d:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(d)))}return i}return r(a.documentElement)}function zt(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function me(e,t={}){let{cache:a=!1,...r}=t,s=(r.method||"GET").toUpperCase(),i={url:e,...r};for(let C of me.interceptors.request)i=C(i)??i;let n=i.url;delete i.url;let o=zt(n,s);if(a==="memory"&&s==="GET"&&ue.has(o))return ue.get(o);let d=await fetch(n,i),v=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let m;v.includes("application/xml")||v.includes("text/xml")?m=Gt(await d.text()):v.includes("application/json")?m=await d.json():m=await d.text();for(let C of me.interceptors.response)m=C(d,m)??m;return a==="memory"&&s==="GET"&&ue.set(o,m),m}var ue,Be=p(()=>{ue=new Map;me.interceptors={request:[],response:[]}});function he(e,t){let a;try{let s=localStorage.getItem(e);a=s?JSON.parse(s):t}catch{a=t}let r=S(a);return w(()=>{try{localStorage.setItem(e,JSON.stringify(r.get()))}catch(s){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,s)}}),r}var Ge=p(()=>{F()});function Jt(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(r=>r(a))},clear(t){t?e.delete(t):e.clear()}}}var Qa,ze=p(()=>{Qa=Jt()});var ar,Vt,Je=p(()=>{F();ar=S("en"),Vt=new Map;Vt.set("en",{})});var k=p(()=>{F();pe();We();z();Ie();je();De();Be();Ge();ze();Je()});function Ve(e){fe=e}function Ye(e){ve=e}async function u(e,{method:t="GET",body:a,headers:r={},signal:s}={}){let i=e.startsWith("http")?e:Yt.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...r}};fe&&(n.headers.Authorization=`Bearer ${fe}`),a!==void 0&&(n.body=JSON.stringify(a)),s&&(n.signal=s);let o=await fetch(i,n);if(o.status===401)throw ve&&ve(),new J("Unauthorized",401,null);let d=null,v=o.headers.get("content-type")||"";try{if(v.includes("application/json"))d=await o.json();else{let m=await o.text();d=m?{message:m}:null}}catch{}if(!o.ok){let m=d&&d.message||`HTTP ${o.status}`;throw new J(m,o.status,d)}return d}var Yt,fe,ve,J,c,$=p(()=>{Yt=window.EARNAPP_CONFIG||{apiBase:"/api"},fe=null,ve=null;J=class extends Error{constructor(t,a,r){super(t),this.status=a,this.payload=r}},c={health:()=>u("/health"),register:e=>u("/auth/register",{method:"POST",body:e}),login:e=>u("/auth/login",{method:"POST",body:e}),logout:()=>u("/auth/logout",{method:"POST"}),me:()=>u("/auth/me"),meUser:()=>u("/user"),reward:e=>u("/user/reward",{method:"POST",body:e}),withdraw:e=>u("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>u("/user/withdrawals"),referrals:()=>u("/user/referrals"),adHistory:()=>u("/user/ads"),adsConfig:()=>u("/ads/config"),adsNext:()=>u("/ads/next"),webTasks:()=>u("/tasks/web"),webTaskStart:e=>u("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>u("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>u("/tasks/telegram"),tgTaskVerify:e=>u("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>u("/admin/stats"),adminWithdrawals:(e="pending")=>u(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>u(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>u(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>u(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>u("/admin/users"),adminProviders:()=>u("/admin/ad-providers"),adminUpdateProvider:(e,t)=>u(`/admin/ad-providers/${e}`,{method:"POST",body:t})}});function l(e,t="info",a=3500){j.set({message:e,type:t,id:Date.now()}),ge&&clearTimeout(ge),ge=setTimeout(()=>j.set(null),a)}async function T(){if(!q.get())return null;try{let e=await c.me();return h.set(e.data),e.data}catch{return null}}async function Ke(e,t){let a=await c.login({email:e,password:t});return q.set(a.data.token),h.set(a.data.user),a.data.user}async function Xe(e){let t=await c.register(e);return q.set(t.data.token),h.set(t.data.user),t.data.user}async function V(){try{await c.logout()}catch{}q.set(null),h.set(null),M.set("/login")}function g(e){window.location.hash=e}var Kt,Xt,q,h,j,ge,M,L,f=p(()=>{k();k();$();Kt="earnap_token",Xt="earnap_user",q=he(Kt,null),h=he(Xt,null),j=S(null),ge=null;M=S(window.location.hash.replace(/^#/,"")||"/"),L=de(()=>!!q.get()&&!!h.get());w(()=>{let e=q.get();Ve(e)});Ye(()=>{q.set(null),h.set(null),M.set("/login"),l("Session expired. Please log in.","error")})});var Qe={};y(Qe,{HomePage:()=>Y});function Y(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=h.get(),a=_("div","welcome-popup","");a.innerHTML=`
        ...
        `,a.querySelector("button").addEventListener("click",()=>a.remove()),e.appendChild(a),e.appendChild(Zt(t)),e.appendChild(Qt(t)),e.appendChild(await ea(t)),e.appendChild(await ta())}}function _(e,t,a){let r=document.createElement(e);return t&&(r.className=t),a!==void 0&&(r.textContent=a),r}function Zt(e){let t=_("div","card card--user-header"),a=_("div","user-header__left"),r=_("img","avatar avatar--lg");r.src=e?e.avatar_url:"https://placehold.co/60x60/e8e8e8/a9a9a9?text=U",r.alt="avatar",a.appendChild(r);let s=_("div","user-header__info");s.innerHTML=`
    ...
    `,t.appendChild(i),t}function Qt(e){let t=_("div","card card--daily-mission");t.innerHTML=`
        <h3 class="card__title">Daily Mission</h3>
        <p class="card__sub">Target: 50 | Completed: ${e?e.today_ads:0} | High Reward</p>
    `;let a=_("button","btn btn--secondary","Claim Daily Bonus");return a.disabled=!0,a.addEventListener("click",()=>l("Daily bonus already claimed today.","info")),t.appendChild(a),t}async function ea(e){let t=_("div","card card--ad-reward"),a=e?e.ads_remaining:0;t.innerHTML=`
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,r=e.querySelector("#ad-slot"),s=e.querySelector("#ad-countdown");setTimeout(()=>{r.innerHTML=`
        ...
        `;let i=r.querySelector("#cd-num"),n=setInterval(async()=>{a--,i.textContent=a,s.textContent=`Reward in ${a}s\u2026`,a<=0&&(clearInterval(n),await da(e,"simulated",t))},1e3)},300)}async function da(e,t,a){try{let r=await c.reward({provider:t,started_at:a});l(`+$${parseFloat(r.data.reward).toFixed(4)} credited!`,"success"),await T(),e.remove(),Z()()}catch(r){l(r.message||"Reward failed","error"),e.remove()}}var ye=p(()=>{$();f()});var rt={};y(rt,{ReferPage:()=>_e});function _e(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--refer";let t=h.get(),a=null;try{a=(await c.referrals()).data}catch{l("Failed to load referrals","error")}let r=a?a.referral_link:t?`${window.location.origin}/?ref=${t.referral_code}`:"";e.innerHTML=`
        ...
        `;let s=e.querySelector("#copy-btn"),i=e.querySelector("#refer-link-input");s.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(i.value),l("Link copied to clipboard!","success")}catch{i.select(),document.execCommand("copy"),l("Link copied!","success")}});let n=e.querySelector("#share-tg");n.href="https://t.me/share/url?url="+encodeURIComponent(r);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let v=document.createElement("div");v.className="refer-item",v.innerHTML=`
                ...
                `,o.appendChild(v)})}}function at(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var xe=p(()=>{$();f()});var st={};y(st,{WithdrawPage:()=>Q});function Q(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=h.get();e.innerHTML=`
        ...
        ${r}
    `,t}function Se(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Te=p(()=>{$();f()});var Le={};y(Le,{ProfilePage:()=>$e});function $e(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=h.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let s=(await c.adHistory()).data||[];if(s.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let i=a.querySelector(".ad-history__list");s.forEach(n=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                    ...
                    `,i.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function ke(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ee=p(()=>{$();f()});var it={};y(it,{default:()=>nt});async function nt(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var ot=p(()=>{f()});var lt={};y(lt,{default:()=>dt});async function dt(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var ct=p(()=>{f()});var ut={};y(ut,{default:()=>pt});async function pt(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
    ...
    `,document.getElementById("logout-btn")?.addEventListener("click",async()=>{await V(),l("Logged out.","info")})}var vt=p(()=>{f()});var gt={};y(gt,{TgTasksPage:()=>ae});function ae(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--tgtasks",e.innerHTML=`
    ...
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async r=>{r.preventDefault();let s=a.href;window.open(s,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&pa(e,t)},3e3)})}return t}async function pa(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await T(),ae()()}catch(r){l(r.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function te(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Ee=p(()=>{$();f()});var yt={};y(yt,{AdminPage:()=>Ce});function Ce(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=h.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),r=e.querySelector("#admin-content");a.forEach(s=>{s.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),s.classList.add("admin-tab--active"),bt(s.dataset.tab,r)})}),bt("stats",r)}}async function bt(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let r=(await c.adminStats()).data;t.innerHTML=`
            ...
            `;let s=t.querySelector("#wd-list");r.forEach(i=>s.appendChild(wt(i,s))),t.querySelector("#wd-filter").addEventListener("change",async i=>{let n=await c.adminWithdrawals(i.target.value);s.innerHTML="",(n.data||[]).forEach(o=>s.appendChild(wt(o,s)))})}else if(e==="users"){let r=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let s=t.querySelector(".admin-list");r.forEach(i=>{let n=document.createElement("div");n.className="admin-row",n.innerHTML=`
                ...
                `,s.appendChild(n)})}else if(e==="providers"){let r=(await c.adminProviders()).data||[];t.innerHTML='<div class="admin-list"></div>';let s=t.querySelector(".admin-list");r.forEach(i=>s.appendChild(ua(i,s)))}}catch{t.innerHTML='<p class="muted">Failed to load.</p>'}}function wt(e,t){let a=document.createElement("div");if(a.className="admin-row admin-row--withdrawal",a.innerHTML=`
    ...
    `;let a=e.querySelector("#login-form");a&&a.addEventListener("submit",async r=>{r.preventDefault();let s=new FormData(a),i=a.querySelector("button");i.disabled=!0,i.textContent="Logging in\u2026";try{await Ke(s.get("email"),s.get("password")),l("Welcome back!","success"),g("/")}catch(n){l(n.message||"Login failed","error"),i.disabled=!1,i.textContent="Log in"}})}function ma(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Me=p(()=>{f()});var xt={};y(xt,{RegisterPage:()=>He});function He(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.EARNAPP_CONFIG&&window.EARNAPP_CONFIG.referralCode||"";e.innerHTML=`
            <div class="auth-card">
        ...
        `;let a=e.querySelector("#register-form");a.addEventListener("submit",async r=>{r.preventDefault();let s=new FormData(a),i=a.querySelector("button");i.disabled=!0,i.textContent="Creating\u2026";try{let n={name:s.get("name"),email:s.get("email"),password:s.get("password")};t&&(n.referral_code=t),await Xe(n),l("Account created \u2014 welcome!","success"),g("/")}catch(n){let o=n.payload&&n.payload.errors;if(o){let d=Object.values(o)[0];l(Array.isArray(d)?d[0]:d,"error")}else l(n.message||"Registration failed","error");i.disabled=!1,i.textContent="Create account"}})}}var Fe=p(()=>{f();f()});k();f();k();f();var re=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(be(),Qe))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(X(),we))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(X(),we))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ye(),tt))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(xe(),rt))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Te(),st))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ee(),Le))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ot(),it))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ct(),lt))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(mt(),ut))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(vt(),ft))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ee(),Le))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ee(),gt))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ae(),yt))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(Me(),_t))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(Fe(),xt))}],os=w(()=>{let e=M.get();return re.find(t=>t.path===e)||re[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";M.set(e)});k();f();k();var ha=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],St="sidebar_collapsed",R=S(localStorage.getItem(St)==="true");function fa(){let e=!R.get();R.set(e),localStorage.setItem(St,String(e))}function Tt(){return{tag:"aside",props:{class:()=>`sidebar ${R.get()?"sidebar--collapsed":""}`,id:"sidebar"},children:[va(),ga(),ba()]}}function va(){return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"span",props:{},children:["JM"]},{tag:"span",props:{class:()=>(R.get(),"")},children:["JOB"]}]}}function ga(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>fa(),title:()=>R.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${R.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function ba(){return{tag:"nav",props:{class:"sidebar__nav"},children:ha.map(e=>wa(e))}}function wa({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${M.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>R.get()?t:"",onclick:s=>{s.preventDefault(),g(e),Lt()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function kt(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>Lt()},children:[]}}function $t(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.add("sidebar--open"),t&&t.classList.add("sidebar-overlay--active")}function Lt(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}f();k();k();var Et="jmjob_theme";function ya(){let e=localStorage.getItem(Et);return e==="dark"||e==="light"?e:"system"}function _a(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}var N=S(ya());function Ne(e){let t=_a(e);document.documentElement.setAttribute("data-theme",t)}Ne(N.get());w(()=>{let e=N.get();Ne(e),localStorage.setItem(Et,e)});window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{N.get()==="system"&&Ne("system")});function Ct(){let e=N.get();N.set(e==="dark"?"light":"dark")}function At(){return U(()=>L.get(),()=>Sa(),()=>xa())}function qt(){let e=()=>N.get()==="dark";return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:e()?"Switch to light mode":"Switch to dark mode",onclick:()=>Ct(),"data-theme":()=>N.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function xa(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[qt(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function Sa(){let e=h.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>$t(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]}]},{tag:"div",props:{class:"topbar__right"},children:[qt(),{tag:"button",props:{class:"topbar__notifications","aria-label":"Notifications"},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge"},children:["3"]}]},{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[e?e.name:"Loading\u2026"]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await V(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}f();k();function Mt(){return U(()=>!!j.get(),()=>{let e=j.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}function Ft(){return{tag:"div",props:{class:"app-shell"},children:[U(()=>L.get(),()=>Tt(),()=>null),U(()=>L.get(),()=>kt(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[At(),{tag:"main",props:{class:"app-main"},children:[Ta()]}]},Mt()]}}function Ta(){let e=M.get(),t=re.find(a=>a.path===e);return t?t.requireAuth&&!L.get()?(g("/login"),Ht()):t.requireAdmin&&(!h.get()||!h.get().is_admin)?La():!t.requireAuth&&L.get()&&["/login","/register"].includes(e)?(g("/"),Ht()):ka(t):$a()}function ka(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function $a(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>g("/")},children:["Go home"]}]}}function La(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>g("/")},children:["Go home"]}]}}function Ht(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}k();f();be();Me();Fe();xe();X();ye();Ee();Te();ee();Ae();var Nt={"/":Y,"/refer":_e,"/webtask":K,"/earn":Z,"/tg-tasks":ae,"/withdraw":Q,"/profile":$e,"/admin":Ce,"/login":qe,"/register":He};function Pt(){se(),setTimeout(se,50),window.addEventListener("hashchange",se),w(()=>{L.get(),setTimeout(se,0)})}async function se(){let e=window.location.hash.replace(/^#/,"")||"/";Nt[e]||(e="/");let t=L.get(),a=["/login","/register"];if(a.includes(e)&&t){g("/");return}if(!a.includes(e)&&!t){g("/login");return}let r=document.getElementById("app"),s=r.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let n=r.querySelector(".bottomnav");n?r.insertBefore(s,n):r.appendChild(s)}s.innerHTML=`<div data-view="${e}" class="view-skeleton"><div class="spinner"></div></div>`;let i=Nt[e];try{let n=i();typeof n=="function"?await n():n&&typeof n.then=="function"&&await n}catch(n){console.error("View render threw synchronously for",e,n),s.innerHTML=`<div class="card"><h2>Error</h2><p>${n.message}</p></div>`}}f();var Ut=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();Ut.innerHTML="";A(Ft(),Ut);q.get()&&T();Pt();
