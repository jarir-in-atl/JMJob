var mr=Object.defineProperty;var v=(e,t)=>()=>(e&&(t=e(e=0)),t);var _=(e,t)=>{for(var a in t)mr(e,a,{get:t[a],enumerable:!0})};function br(e,t){xa?xa(e,t):console.error("[Ghost] Unhandled effect error:",e)}function P(e){let t=e,a=new Set;return{get(){return j&&(a.add(j),j.dependencies.add(a)),t},set(s){t!==s&&(t=s,Ta(a))}}}function Ta(e){at(()=>{e.forEach(t=>{t.notify?t.notify():_e.add(t)})})}function at(e){et++;try{e()}finally{if(et--,et===0){let t=Array.from(_e);_e.clear(),t.forEach(a=>a.run())}}}function k(e){let t={dependencies:new Set,run(){tt(t),we.push(j),j=t;try{e()}catch(a){br(a,e)}finally{j=we.pop()}},notify(){_e.add(t)}};return t.run(),()=>tt(t)}function st(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,Ta(s))}};return{get(){if(j&&(s.add(j),j.dependencies.add(s)),a){tt(r),we.push(j),j=r;try{t=e()}finally{j=we.pop()}a=!1}return t}}}function tt(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var j,we,_e,et,xa,V=v(()=>{j=null,we=[],_e=new Set,et=0,xa=null});function ne(){rt.totalUpdates++,rt.recentUpdates++}var $e,rt,it=v(()=>{$e=new Set,rt={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function D(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){gr(e,t);return}if(e.__ghostWhen){fr(e,t);return}if(e.__ghostLazy){vr(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;$e.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let i=s.startsWith("on");typeof r=="function"&&!i?e.effects.push(k(()=>{a.setAttribute(s,r()),ne(),e.events.update?.forEach(n=>n())})):i?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)D(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push(k(()=>{let i=s(),n=document.createTextNode(String(i??""));r?a.replaceChild(n,r):a.appendChild(n),r=n,ne(),e.events.update?.forEach(o=>o())}))}else D(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function oe(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),$e.delete(e)}}function gr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function c(m){return m.el||null}let u=k(()=>{let m=a(),y=m.map(($,N)=>String(s($,N))),L=Array.from(o.keys());for(let $ of L)if(!y.includes($)){let N=o.get($);oe(N.ghostNode),o.delete($)}for(let $=0;$<m.length;$++){let N=y[$];if(!o.has(N)){let ie=r(m[$],$),Z=document.createElement("ghost-list-slot");for(D(ie,Z);Z.firstChild;)t.insertBefore(Z.firstChild,n);o.set(N,{ghostNode:ie})}}for(let $=y.length-1;$>=0;$--){let N=y[$],ie=o.get(N);if(!ie)continue;let Z=c(ie.ghostNode);if(!Z)continue;let Sa=y[$+1],ka=(Sa?c(o.get(Sa)?.ghostNode):null)||n;Z.nextSibling!==ka&&t.insertBefore(Z,ka)}ne()});e._listCleanup=()=>{u();for(let m of o.values())oe(m.ghostNode);o.clear(),i.remove(),n.remove()}}function I(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function fr(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=k(()=>{let u=a()?s:r;if(n&&(oe(n),n=null),u&&(n=u(),n)){let m=document.createElement("ghost-when-slot");for(D(n,m);m.firstChild;)t.insertBefore(m.firstChild,i)}ne()});e._whenCleanup=()=>{o(),n&&oe(n),i.remove()}}function vr(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let i=null;if(s){let n=document.createElement("ghost-lazy-slot");for(D(s,n);n.firstChild;)t.insertBefore(n.firstChild,r);i=s}a().then(n=>{let o=n.default||n;i&&(oe(i),i=null);let c=typeof o=="function"?o():o,u=document.createElement("ghost-lazy-slot");for(D(c,u);u.firstChild;)t.insertBefore(u.firstChild,r);i=c}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var nt=v(()=>{V();it()});var La=v(()=>{V()});var Se=v(()=>{});var Ea=v(()=>{it()});var Ca=v(()=>{V()});var qa=v(()=>{nt();V();Se();Se()});function yr(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let i={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){i["@attributes"]={};for(let n of r.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of r.childNodes){let o=n.nodeName,c=s(n);c!==""&&(i[o]===void 0?i[o]=c:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(c)))}return i}return s(a.documentElement)}function wr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function lt(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),i={url:e,...s};for(let y of lt.interceptors.request)i=y(i)??i;let n=i.url;delete i.url;let o=wr(n,r);if(a==="memory"&&r==="GET"&&ot.has(o))return ot.get(o);let c=await fetch(n,i),u=c.headers.get("content-type")||"";if(!c.ok)throw new Error(`Ghost-HTTP Error: ${c.status} ${c.statusText}`);let m;u.includes("application/xml")||u.includes("text/xml")?m=yr(await c.text()):u.includes("application/json")?m=await c.json():m=await c.text();for(let y of lt.interceptors.response)m=y(c,m)??m;return a==="memory"&&r==="GET"&&ot.set(o,m),m}var ot,Aa=v(()=>{ot=new Map;lt.interceptors={request:[],response:[]}});function ct(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=P(a);return k(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var Ma=v(()=>{V()});function _r(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var bo,Na=v(()=>{bo=_r()});var vo,$r,Pa=v(()=>{V();vo=P("en"),$r=new Map;$r.set("en",{})});var H=v(()=>{V();nt();La();Se();Ea();Ca();qa();Aa();Ma();Na();Pa()});function Ha(e){ke=e}function Sr(){return ke}function Ba(e){dt=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let i=e.startsWith("http")?e:ja.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};ke&&(n.headers.Authorization=`Bearer ${ke}`),a!==void 0&&(n.body=JSON.stringify(a)),r&&(n.signal=r);let o=await fetch(i,n);if(o.status===401)throw dt&&dt(),new le("Unauthorized",401,null);let c=null,u=o.headers.get("content-type")||"";try{if(u.includes("application/json"))c=await o.json();else{let m=await o.text();c=m?{message:m}:null}}catch{}if(!o.ok){let m=c&&c.message||`HTTP ${o.status}`;throw new le(m,o.status,c)}return c}var ja,ke,dt,le,d,w=v(()=>{ja=window.JMJOB_CONFIG||{apiBase:"/api"},ke=null,dt=null;le=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},d={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>p("/admin/subcategories"),adminCreateSubcategory:e=>p("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>p(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>p(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),notices:()=>p("/notices"),adminUpdateNotices:e=>p("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=ja.apiBase+"/admin/notices/upload",a={},s=Sr();s&&(a.Authorization=`Bearer ${s}`);let r=await fetch(t,{method:"POST",headers:a,body:e}),i=await r.json();if(!r.ok)throw new le(i.message||"Upload failed",r.status,i);return i},adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function l(e,t="info",a=3500){ce.set({message:e,type:t,id:Date.now()}),pt&&clearTimeout(pt),pt=setTimeout(()=>ce.set(null),a)}async function q(){if(!U.get())return null;try{let e=await d.me();return g.set(e.data),e.data}catch{return null}}async function Ia(e,t){let a=await d.login({email:e,password:t});return U.set(a.data.token),g.set(a.data.user),a.data.user}async function Fa(e){return d.requestRegistrationOtp(e)}async function Ra(e){let t=await d.verifyRegistrationOtp(e);return U.set(t.data.token),g.set(t.data.user),t.data.user}async function xe(){try{await d.logout()}catch{}U.set(null),g.set(null),x.set("/login")}function f(e){window.location.hash=e}var kr,xr,U,g,ce,pt,x,E,h=v(()=>{H();H();w();kr="earnap_token",xr="earnap_user",U=ct(kr,null),g=ct(xr,null),ce=P(null),pt=null;x=P(window.location.hash.replace(/^#/,"")||"/"),E=st(()=>!!U.get()&&!!g.get());k(()=>{let e=U.get();Ha(e)});Ba(()=>{U.set(null),g.set(null),x.set("/login"),l("Session expired. Please log in.","error")})});var Ua={};_(Ua,{HomePage:()=>Le});function Le(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Tr(e),e.appendChild(Lr(t)),e.appendChild(Er()),e.appendChild(Cr(t))}}function Q(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Tr(e){Te&&(clearInterval(Te),Te=null);try{let t=await d.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(y=>{if(typeof y=="string"){let L=y.trim();return L.startsWith("/")||L.startsWith("http")?{image:L,text:""}:{image:"",text:L}}return{image:y.image||"",text:y.text||""}}).filter(y=>y.image&&y.image.trim()||y.text&&y.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let r=Q("div","welcome-popup welcome-popup--banner","");r.innerHTML=`
            <div id="notice-banner-content" class="welcome-popup__content"></div>
        `,e.firstChild?e.insertBefore(r,e.firstChild):e.appendChild(r);let i=r.querySelector("#notice-banner-content"),n=typeof t.interval=="number"&&t.interval>0?t.interval:4,o=t.direction||"right_to_left",c={right_to_left:{exit:"banner-vanish-left",enter:"banner-enter-right"},left_to_right:{exit:"banner-vanish-right",enter:"banner-enter-left"},top_to_bottom:{exit:"banner-vanish-bottom",enter:"banner-enter-top"},bottom_to_top:{exit:"banner-vanish-top",enter:"banner-enter-bottom"},fade:{exit:"banner-vanish-fade",enter:"banner-enter-fade"}},u=c[o]||c.right_to_left,m=0;Da(i,s[0]),s.length>1&&(Te=setInterval(()=>{let y;do y=Math.floor(Math.random()*s.length);while(y===m&&s.length>1);m=y,i.className=`welcome-popup__content ${u.exit}`,setTimeout(()=>{Da(i,s[m]),i.className=`welcome-popup__content ${u.enter}`,setTimeout(()=>{i.className="welcome-popup__content"},350)},350)},n*1e3))}catch{}}function Da(e,t){e.innerHTML="";let a=!!(t&&t.text&&t.text.trim());if(!!(t&&t.image&&t.image.trim())){let r=document.createElement("img");r.className="welcome-popup__image",r.src=t.image,r.alt=t.text||"Banner Notice",r.onerror=()=>{r.style.display="none"},e.appendChild(r)}if(a){let r=document.createElement("div");r.className="welcome-popup__text-wrap",r.innerHTML=`<strong>JM Job:</strong> <span>${qr(t.text)}</span>`,e.appendChild(r)}}function Lr(e){let t=Q("div","card card--user-header"),a=Q("div","user-header__stats");return a.innerHTML=`
    ...
    `,t.appendChild(a),t}function Er(){let e=Q("div","icon-grid");return[{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill",tone:"purple"},{path:"/earn",label:"Earn Ad",icon:"bi-play-circle-fill",tone:"green"},{path:"/tasks",label:"Web Task",icon:"bi-link-45deg",tone:"blue"},{path:"/webtask",label:"Tasks",icon:"bi-telegram",tone:"blue"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2",tone:"amber"},{path:"/refer",label:"Referral",icon:"bi-gift-fill",tone:"pink"},{path:"/profile",label:"Profile",icon:"bi-person-bounding-box",tone:"gray"},{path:"/support",label:"Support",icon:"bi-headset",tone:"red"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin",tone:"green"}].forEach(a=>{let s=Q("a",`icon-grid__item icon-grid__item--${a.tone}`);s.href=`#${a.path}`,s.innerHTML=`
            <span class="icon-grid__chip">
                <i class="bi ${a.icon}"></i>
            </span>
            <span class="icon-grid__label">${a.label}</span>
        `,s.addEventListener("click",r=>{r.preventDefault(),f(a.path)}),e.appendChild(s)}),e}function Cr(e){let t=Q("div","card card--daily-mission"),a=e&&e.today_ads||0,s=e&&e.ads_limit||50,r=Math.min(100,a/Math.max(1,s)*100);t.innerHTML=`
        <div class="card__row">
    ...
    `;let i=Q("button","btn btn--primary btn--xl","\u{1F381} Claim Daily Bonus");return i.addEventListener("click",async()=>{try{let n=await fetch("/api/user/claim-daily-bonus",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:"Bearer "+(window.JMJOB_TOKEN||"")}}).then(o=>o.json());n.success?(l(n.message||"Daily bonus claimed!","success"),await q(),Le()()):l(n.message||"Bonus not available.","info")}catch{l("Could not claim. Try again later.","error")}}),t.appendChild(i),t}function qr(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}var Te,ut=v(()=>{h();w();Te=null});var mt={};_(mt,{WebTaskPage:()=>de});function de(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--webtask",e.innerHTML='<h2 class="page-title">Web Task Center</h2><div class="task-list" id="task-list">Loading\u2026</div>';let t=e.querySelector("#task-list");try{let s=(await d.webTasks()).data||[];if(s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}t.innerHTML="",s.forEach(r=>t.appendChild(Ar(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function Ar(e){let t=document.createElement("div");t.className="card card--task",t.innerHTML=`
        <h3 class="card__title">${Oa(e.title)}</h3>
        <p class="card__sub">${Oa(e.description||"")}</p>
        <div class="task-meta">
    ...
    `;let a=t.querySelector("button");return a&&!a.disabled&&a.addEventListener("click",()=>Mr(e,a,t)),t}async function Mr(e,t,a){t.disabled=!0,t.textContent="Opening\u2026",window.open(e.target_url,"_blank","noopener,noreferrer");let s=0,r=e.duration_seconds;t.textContent=`Wait ${r}s\u2026`;let n=(await d.webTaskStart({task_id:e.id})).data.completion_id,o=setInterval(()=>{s+=1;let c=r-s;t.textContent=c>0?`Wait ${c}s\u2026`:"Claim Reward",s>=r&&(clearInterval(o),Nr(t,n,a))},1e3)}function Nr(e,t,a){e.textContent="Claim Reward",e.classList.remove("btn--primary"),e.classList.add("btn--success"),e.disabled=!1,e.onclick=async()=>{e.disabled=!0,e.textContent="Claiming\u2026";try{let s=await d.webTaskClaim({completion_id:t});l("+"+parseFloat(s.data.reward).toFixed(2)+" credited!","success"),await q(),de()()}catch(s){l(s.message||"Claim failed","error"),e.disabled=!1,e.textContent="Claim Reward"}}}function Oa(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Ee=v(()=>{w();h()});var Wa={};_(Wa,{EarnPage:()=>Ce});function Ce(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--earn";let t=g.get(),a=t?t.ads_remaining:0;e.innerHTML=`
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),r=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let r=e.querySelector("#copy-btn"),i=e.querySelector("#refer-link-input");r.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(i.value),l("Link copied to clipboard!","success")}catch{i.select(),document.execCommand("copy"),l("Link copied!","success")}});let n=e.querySelector("#share-tg");n.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(c=>{let u=document.createElement("div");u.className="refer-item",u.innerHTML=`
                    ...
                    <div class="refer-item__info">
                        <div class="refer-item__name">${Ja(c.name)}</div>
                        <div class="refer-item__username">@${Ja(c.username)}</div>
                    </div>
                    <div class="refer-item__earned">$${parseFloat(c.lifetime_earned).toFixed(2)}</div>
                `,o.appendChild(u)})}}function Ja(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ft=v(()=>{w();h()});var za={};_(za,{WithdrawPage:()=>qe});function qe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#withdraw-form");a.addEventListener("submit",async r=>{r.preventDefault();let i=new FormData(a),n=a.querySelector("button");n.disabled=!0,n.textContent="Submitting\u2026";try{let o=await d.withdraw({amount:parseFloat(i.get("amount")),wallet_address:String(i.get("wallet_address")),gateway:String(i.get("gateway"))});l("Withdrawal requested!","success"),await q(),qe()()}catch(o){let c=o.payload&&o.payload.errors;if(c){let u=Object.values(c)[0];l(Array.isArray(u)?u[0]:u,"error")}else l(o.message||"Withdrawal failed","error");n.disabled=!1,n.textContent="Confirm Withdrawal"}});let s=e.querySelector("#withdraw-history");try{let i=(await d.withdrawals()).data||[];i.length===0?s.innerHTML='<p class="muted">No withdrawals yet.</p>':(s.innerHTML="",i.forEach(n=>s.appendChild(Hr(n))))}catch{s.innerHTML='<p class="muted">Failed to load history.</p>'}}}function Hr(e){let t=document.createElement("div");t.className="withdraw-row withdraw-row--"+e.status;let a=(e.status||"pending").toUpperCase(),s=e.admin_note?`<div class="withdraw-row__note">"${vt(e.admin_note)}"</div>`:"";return t.innerHTML=`
        <div class="withdraw-row__main">
            <div class="withdraw-row__amount">$${parseFloat(e.amount).toFixed(2)}</div>
            <div class="withdraw-row__gateway">${vt(e.gateway)} \xB7 ${vt(e.wallet_address)}</div>
        </div>
        <div class="withdraw-row__status">${a}</div>
        ${s}
    `,t}function vt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ht=v(()=>{w();h()});var Ya={};_(Ya,{DepositPage:()=>yt});function yt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=g.get();e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{S.selectedGateway=t.getAttribute("data-gateway"),Xa(),Ir()})})}}function Ir(){let e=S.gateways.find(i=>i.key===S.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `,document.getElementById("copy-wallet-btn")?.addEventListener("click",()=>{navigator.clipboard.writeText(e.wallet_number).then(()=>{l("Wallet number copied.","info")}).catch(()=>{l("Could not copy. Please copy manually.","error")})}));let r=document.getElementById("deposit-amount");r&&(r.min=S.minAmount,r.max=S.maxAmount,r.placeholder=`${S.minAmount} \u2013 ${S.maxAmount}`)}function Va(){let e=document.getElementById("payment-history");if(e){if(S.submissions.length===0){e.innerHTML='<p class="muted">No submissions yet.</p>';return}e.innerHTML=S.submissions.map(t=>{let a=Br[t.status]||{label:t.status,class:""};return`
            <div class="payment-row ${a.class}">
                <div class="payment-row__main">
                    <div class="payment-row__amount">\u09F3 ${parseFloat(t.amount).toFixed(2)}</div>
                    <div class="payment-row__gateway">${te((t.gateway||"").toUpperCase())} \u2022 TRX: ${te(t.trxid)}</div>
                </div>
                <div class="payment-row__status">${a.label}</div>
                <div class="payment-row__date">${Fr(t.created_at)}</div>
            </div>
        `}).join("")}}function Fr(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function te(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Br,S,wt=v(()=>{w();h();Br={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},S={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var $t={};_($t,{ProfilePage:()=>Ae});function Ae(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=g.get();e.innerHTML=`
            <div class="card card--profile">
                <img class="avatar avatar--xl" src="${t?t.avatar_url:""}" alt="">
                <h2 class="card__title">${t?_t(t.name):""}</h2>
                <p class="card__sub">@${t?_t(t.username):""}</p>
        ...
        `;let a=e.querySelector("#ad-history");try{let r=(await d.adHistory()).data||[];if(r.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let i=a.querySelector(".ad-history__list");r.forEach(n=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                        <span class="ad-history__provider">${_t(n.provider)}</span>
                    ...
                    `,i.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function _t(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Me=v(()=>{w();h()});var Ka={};_(Ka,{default:()=>Ne});async function Ne(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var St=v(()=>{h()});var Za={};_(Za,{default:()=>Pe});async function Pe(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var kt=v(()=>{h()});var Qa={};_(Qa,{default:()=>je});async function je(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var xt=v(()=>{h()});function Rr(){let e=localStorage.getItem(es);return e==="dark"||e==="light"?e:"system"}function Dr(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function Tt(e){let t=Dr(e);document.documentElement.setAttribute("data-theme",t)}function ts(){let e=B.get();B.set(e==="dark"?"light":"dark")}function as(e){B.set(e)}function Ur(){let e=localStorage.getItem(ss);return e&&Lt.includes(e)?e:"default"}function rs(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function is(e){Lt.includes(e)&&pe.set(e)}function ns(){return Lt}var es,B,ss,Lt,pe,Et=v(()=>{H();es="jmjob_theme";B=P(Rr());Tt(B.get());k(()=>{let e=B.get();Tt(e),localStorage.setItem(es,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{B.get()==="system"&&Tt("system")});ss="jmjob_color_theme",Lt=["default","emerald","amber","rose"];pe=P(Ur());rs(pe.get());k(()=>{let e=pe.get();rs(e),localStorage.setItem(ss,e)})});var os={};_(os,{default:()=>Be});async function Be(){let e=document.querySelector("[data-view]");if(!e)return;let t=g.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=B.get(),s=pe.get(),r=ns();e.innerHTML=`
            ...
            <div class="settings-section">
                ...
                <div class="settings-item settings-item--stack">
                    <div class="settings-info">
                        ...
                        <div class="settings-value">${He[s]||"Default (Purple)"}</div>
                    </div>
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${He[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${Or[o]};"></span>
                                <span class="theme-swatch__label">${(He[o]||o).split(" ")[0]}</span>
                            </button>
                        `).join("")}
                    </div>
                </div>
    ...
    `;let i=document.getElementById("theme-mode-group");i&&i.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let c=o.getAttribute("data-mode");as(c),l(`Theme mode set to ${c}.`,"info")})});let n=document.getElementById("color-theme-group");n&&n.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let c=o.getAttribute("data-color");is(c),l(`Accent color set to ${He[c]||c}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await xe(),l("Logged out.","info")})}var He,Or,Ct=v(()=>{h();Et();He={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},Or={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var cs={};_(cs,{NotificationsPage:()=>qt});function qt(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `;let t=e.querySelector("#tg-list");try{let s=(await d.tgTasks()).data||[];if(t.innerHTML="",s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}s.forEach(r=>t.appendChild(Gr(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function Gr(e){let t=document.createElement("div");if(t.className="card card--task",t.innerHTML=`
        <div class="task-header">
            <div class="task-channel">
                <i class="bi bi-telegram"></i>
                <strong>${Ie(e.channel_name)}</strong>
                <span class="muted">${Ie(e.channel_username)}</span>
            </div>
        </div>
        <p class="card__sub">${Ie(e.description||"")}</p>
        <div class="task-meta">
            <span><i class="bi bi-cash"></i> $${parseFloat(e.reward).toFixed(3)}</span>
        </div>
        <div class="task-actions">
            ${e.completed?'<button class="btn btn--ghost" disabled>\u2713 Completed</button>':`<a class="btn btn--primary" href="https://t.me/${Ie(e.channel_username.replace("@",""))}" target="_blank" rel="noopener" data-task-id="${e.id}">Join channel</a>`}
        </div>
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&zr(e,t)},3e3)})}return t}async function zr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await d.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await q(),Fe()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ie(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Mt=v(()=>{w();h()});var ms={};_(ms,{PosterDashboardPage:()=>Pt});function Pt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-dashboard";let t=g.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML=`
        ...
        `;let a=e.querySelector("#poster-new-job");a&&a.addEventListener("click",s=>{s.preventDefault(),f("/poster/post-job")}),await ps()}}async function ps(){let e=document.getElementById("poster-dashboard-content");if(e)try{let t=await d.posterStats();Xr(e,t.data||{})}catch(t){e.innerHTML=`
            <div class="card">
                <p class="muted">Failed to load poster statistics: ${us(t.message||"Unknown error")}</p>
                <button class="btn btn--secondary" id="poster-retry">Try again</button>
            </div>
        `,e.querySelector("#poster-retry")?.addEventListener("click",ps),l(t.message||"Failed to load poster statistics.","error")}}function Xr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=Nt(t.wallet_balance),i=Nt(t.frozen_balance),n=Nt(t.total_spent);e.innerHTML=`
        <div class="stat-grid poster-stat-grid">
            ${Re("bi-briefcase","Total jobs",a.total||0)}
            ${Re("bi-lightning-charge","Active jobs",s)}
            ${Re("bi-wallet2","Available wallet",r,"\u09F3")}
            ${Re("bi-lock","In escrow",i,"\u09F3")}
        </div>
        ...
        <div class="poster-dashboard-grid">
            <div class="card">
                ...
                <div class="poster-status-list">
                    ${ae("open",a.open)}
                    ${ae("in_review",a.in_review)}
                    ${ae("assigned",a.assigned)}
                    ${ae("submitted",a.submitted)}
                    ${ae("revision",a.revision)}
                    ${ae("completed",a.completed)}
                </div>
            </div>
    ...
    `,e.querySelectorAll("[data-poster-link]").forEach(o=>{o.addEventListener("click",c=>{c.preventDefault(),f(o.getAttribute("href").replace(/^#/,""))})})}function Re(e,t,a,s=""){return`
        <div class="stat-tile poster-stat-tile">
            <i class="bi ${e} poster-stat-icon"></i>
            <span class="muted">${t}</span>
            <strong>${s}${us(String(a))}</strong>
        </div>
    `}function ae(e,t){let a=Number(t||0);return`
        <div class="poster-status-row">
            <span><i class="bi ${Yr(e)}"></i> ${Vr[e]||e}</span>
            <strong>${a}</strong>
        </div>
    `}function Yr(e){return{open:"bi-megaphone",in_review:"bi-search",assigned:"bi-person-check",submitted:"bi-inbox",revision:"bi-arrow-repeat",completed:"bi-check-circle"}[e]||"bi-circle"}function Nt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function us(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Vr,jt=v(()=>{w();h();Vr={open:"Open",in_review:"In review",assigned:"Assigned",submitted:"Awaiting review",revision:"Revision requested",completed:"Completed",cancelled:"Cancelled",expired:"Expired",disputed:"Disputed"}});var fs={};_(fs,{PostJobPage:()=>Ht});function Ht(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--post-job",!ei()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}let t={currentStep:1,categories:[],mainCategoryId:"",subCategoryId:"",title:"",description:"",thumbnailBase64:"",proofRequirements:[{title:"",type:"text"}],workerCount:1,costPerWorker:10,biddingValue:3,biddingUnit:"days",deadlineAt:"",feePercentage:30};try{let a=await d.categories();t.categories=a.data||[]}catch(a){l(a.message||"Could not load categories.","error")}fe(e,t)}}function fe(e,t){e.innerHTML=`
    ...
    `,Kr(e,t)}function Kr(e,t){let a=e.querySelector("#wizard-card-body");a&&(t.currentStep===1?gs(a,e,t):t.currentStep===2?be(a,e,t):t.currentStep===3&&Zr(a,e,t))}function gs(e,t,a){let s=a.categories.find(o=>Number(o.id)===Number(a.mainCategoryId)),r=s?s.subcategories||[]:[];e.innerHTML=`
    ...
    `;let n=e.querySelector("#worker-count-input"),o=e.querySelector("#cost-per-worker-input"),c=()=>{a.workerCount=Math.max(1,parseInt(n.value,10)||1),a.costPerWorker=Math.max(0,parseFloat(o.value)||0);let u=a.workerCount*a.costPerWorker,m=u*(a.feePercentage/100),y=u+m;e.querySelector("#summary-subtotal").textContent=`\u09F3${u.toFixed(2)}`,e.querySelector("#summary-fee").textContent=`\u09F3${m.toFixed(2)}`,e.querySelector("#summary-total").textContent=`\u09F3${y.toFixed(2)}`};n.addEventListener("input",c),o.addEventListener("input",c),e.querySelector("#step-cancel").addEventListener("click",Bt),e.querySelector("#step-3-back").addEventListener("click",()=>{bs(e,a),a.currentStep=2,fe(t,a)}),e.querySelector("#step-3-form").addEventListener("submit",async u=>{u.preventDefault(),bs(e,a);let m=e.querySelector("#post-job-publish");m.disabled=!0,m.textContent="Publishing\u2026";let y=0,L=Number(a.biddingValue||0);L>0&&(a.biddingUnit==="minutes"?y=L/60:a.biddingUnit==="hours"?y=L:a.biddingUnit==="days"?y=L*24:a.biddingUnit==="months"&&(y=L*24*30));try{await d.posterCreateJob({category_id:Number(a.mainCategoryId),subcategory_id:a.subCategoryId?Number(a.subCategoryId):null,title:a.title.trim(),description:a.description.trim(),thumbnail:a.thumbnailBase64||null,proof_requirements:a.proofRequirements,worker_count:Number(a.workerCount),cost_per_worker:Number(a.costPerWorker),budget:Number(a.workerCount)*Number(a.costPerWorker),deadline_at:Qr(a.deadlineAt),bidding_window_hours:y}),l("Job published successfully.","success"),f("/poster/jobs")}catch($){l($.message||"Could not publish job.","error"),m.disabled=!1,m.textContent="Publish Job"}})}function bs(e,t){t.workerCount=Number(e.querySelector("#worker-count-input")?.value||1),t.costPerWorker=Number(e.querySelector("#cost-per-worker-input")?.value||0),t.biddingValue=Number(e.querySelector("#bidding-val-input")?.value||0),t.biddingUnit=e.querySelector("#bidding-unit-input")?.value||"days",t.deadlineAt=e.querySelector("#deadline-input")?.value||""}function Bt(){confirm("Are you sure you want to cancel posting this job?")&&f("/poster")}function Qr(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function ei(){return!!g.get()}function ge(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var It=v(()=>{w();h()});var hs={};_(hs,{PosterJobsPage:()=>Ft});function Ft(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--poster-jobs",!ri()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
            ...
            <div class="poster-filter-bar">
                <label>Status
                    <select class="admin-select" id="poster-job-filter">
                        ${ti.map(t=>`<option value="${t}" ${t===Ue?"selected":""}>${t?vs(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#poster-jobs-new").addEventListener("click",t=>{t.preventDefault(),f("/poster/post-job")}),e.querySelector("#poster-job-filter").addEventListener("change",async t=>{Ue=t.target.value,await De()}),e.querySelector("#poster-jobs-refresh").addEventListener("click",De),await De()}}}async function De(){let e=document.getElementById("poster-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=((await d.posterMyJobs()).data||[]).filter(s=>!Ue||s.status===Ue);e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(ai(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${se(t.message||"unknown error")}</p>`}}}function ai(e){let t=document.createElement("article");return t.className=`admin-row poster-job-row poster-job-row--${se(e.status)}`,t.innerHTML=`
        <div class="poster-job-row__header">
            <div><strong>${se(e.title)}</strong><span class="badge">${se(vs(e.status).toUpperCase())}</span></div>
            <strong class="admin-row__amount">${se(e.currency||"BDT")} ${Number(e.budget||0).toFixed(2)}</strong>
        </div>
        <p class="muted poster-job-row__description">${se(e.description||"").slice(0,220)}${String(e.description||"").length>220?"\u2026":""}</p>
        <div class="admin-job-row__meta"><span><strong>Bids:</strong> ${Number(e.bid_count||0)}</span><span><strong>Views:</strong> ${Number(e.view_count||0)}</span><span><strong>Created:</strong> ${ii(e.created_at)}</span></div>
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>f(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>si(e.id)),t}async function si(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await d.posterCancelJob(e,{reason:t}),l("Job cancelled.","success"),await De()}catch(a){l(a.message||"Could not cancel job.","error")}}function ri(){return!!g.get()}function vs(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function ii(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function se(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ti,Ue,Rt=v(()=>{w();h();ti=["","open","assigned","submitted","revision","completed","cancelled","disputed"],Ue=""});var ys={};_(ys,{PosterWalletPage:()=>Ut});function Ut(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-wallet";let t=g.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([d.posterStats(),d.paymentSubmissions()]);ni(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${Oe(a.message||"unknown error")}</p>`}}}function ni(e,t,a){let s=Dt(t.wallet_balance),r=Dt(t.frozen_balance),i=Dt(t.total_spent);e.innerHTML=`
        ...
        <div class="card"><h2 class="card__title">Deposit history</h2><div class="poster-deposit-list">${oi(a)}</div></div>
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>f("/deposit"))}function oi(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${Oe((t.gateway||"").toUpperCase())}</strong><small>${Oe(t.trxid)} \xB7 ${li(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${Oe(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function Dt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function li(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ot=v(()=>{w();h()});var $s={};_($s,{AdminPage:()=>Jt});function Jt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),r.classList.add("admin-tab--active"),ws(r.dataset.tab,s)})}),ws("stats",s)}}async function ws(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([d.adminStats(),d.adminRevenue()]),r=a.data||{},i=s.data||{},n=i.currency_symbol||"\u09F3";t.innerHTML=`
                <div class="stat-grid admin-revenue-grid">
                    ${X("bi-graph-up-arrow","Platform revenue",Wt(i.platform_revenue,n))}
                    ${X("bi-percent","Commission rate",`${(Number(i.commission_rate||0)*100).toFixed(2)}%`)}
                    ${X("bi-briefcase","Total jobs",Y(i.total_jobs))}
                    ${X("bi-check2-circle","Completed jobs",Y(i.completed_jobs))}
                    ${X("bi-lightning-charge","Active jobs",Y(i.active_jobs))}
                    ${X("bi-people","Total users",Y(i.total_users))}
                    ${X("bi-hourglass-split","Pending deposits",Y(i.pending_payments))}
                    ${X("bi-lock","Held in escrow",Wt(i.escrow_total,n))}
                </div>
                <div class="card admin-operations-card">
                    ...
                    <div class="admin-operations-grid">
                        <div><span class="muted">Withdrawals</span><strong>${Y(r.total_withdrawals)}</strong></div>
                        <div><span class="muted">Pending withdrawals</span><strong>${Y(r.pending_withdrawals)}</strong></div>
                        <div><span class="muted">Total ad views</span><strong>${Y(r.total_ad_views)}</strong></div>
                        <div><span class="muted">Lifetime paid</span><strong>${Wt(r.total_lifetime_paid,n)}</strong></div>
                    </div>
                </div>
            ...
            `;let r=t.querySelector("#wd-list");s.forEach(i=>r.appendChild(_s(i,r))),t.querySelector("#wd-filter").addEventListener("change",async i=>{let n=await d.adminWithdrawals(i.target.value);r.innerHTML="",(n.data||[]).forEach(o=>r.appendChild(_s(o,r)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await d.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list"),i=Number(g.get()?.id||0);s.forEach(n=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                    <div>
    ...
    `,a.querySelector(".provider-save").addEventListener("click",async()=>{let i={block_id:a.querySelector(".provider-block-id").value.trim()||null,weight:parseInt(a.querySelector(".provider-weight").value,10)||0,reward_per_view:parseFloat(a.querySelector(".provider-reward").value)||0,min_duration_seconds:parseInt(a.querySelector(".provider-duration").value,10)||12,enabled:a.querySelector(".provider-enabled").checked};try{await d.adminUpdateProvider(e.id,i),l("Provider saved","success")}catch(n){l(n.message,"error")}}),a}function C(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Gt=v(()=>{w();h();h()});var xs={};_(xs,{AdminPaymentsPage:()=>Vt});function Vt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-tabs">
                <button class="admin-tab ${O.status==="pending"?"admin-tab--active":""}" data-status="pending">Pending</button>
                <button class="admin-tab ${O.status==="approved"?"admin-tab--active":""}" data-status="approved">Approved</button>
                <button class="admin-tab ${O.status==="rejected"?"admin-tab--active":""}" data-status="rejected">Rejected</button>
                <button class="admin-tab ${O.status===""?"admin-tab--active":""}" data-status="">All</button>
            </div>

            <div class="admin-list" id="admin-payments-list">
                <div class="spinner"></div>
            </div>
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{O.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),zt()})}),await zt()}}async function zt(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await d.adminPayments(O.status);O.items=t.data||[],pi(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${ee(t.message||"Failed to load.")}</p>`}}}function pi(e){if(O.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",O.items.forEach(t=>e.appendChild(ui(t)))}function ui(e){let t=di[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
            <div class="admin-row__amount">\u09F3 ${parseFloat(e.amount).toFixed(2)} <span class="badge badge--gateway">${ee((e.gateway||"").toUpperCase())}</span></div>
            <div class="admin-row__sub">
                <strong>TRX:</strong> <code>${ee(e.trxid)}</code>
                &nbsp;\u2022&nbsp;
                <strong>From:</strong> ${ee(e.sender_number)}
                ${e.user?`&nbsp;\u2022&nbsp;<strong>User:</strong> ${ee(e.user.name)} <span class="muted">(${ee(e.user.email)})</span>`:""}
            </div>
            <div class="admin-row__meta">
                <span class="admin-row__status payment-row__status">${t.label}</span>
                &nbsp;\u2022&nbsp;
                <span class="muted">Submitted: ${ks(e.created_at)}</span>
                ${e.verified_at?`&nbsp;\u2022&nbsp;<span class="muted">Verified: ${ks(e.verified_at)}</span>`:""}
            </div>
            ${e.admin_note?`<div class="admin-row__note"><em>Note:</em> ${ee(e.admin_note)}</div>`:""}
        </div>
        ${e.status==="pending"?`
    ...
    `,e.status==="pending"&&(a.querySelector('[data-action="approve"]')?.addEventListener("click",()=>Ss(e.id,"approve",a)),a.querySelector('[data-action="reject"]')?.addEventListener("click",()=>Ss(e.id,"reject",a))),a}async function Ss(e,t,a){let s=prompt(t==="approve"?"Optional note for approval:":"Reason for rejection:");if(s!==null)try{let i=await(t==="approve"?d.adminApprovePayment:d.adminRejectPayment)(e,{note:s||null});l(i.message||"Done.","success"),await zt()}catch(r){l(r.message||"Action failed.","error")}}function ks(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ee(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var di,O,Xt=v(()=>{w();h();di={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},O={status:"pending",items:[],loading:!1}});var Ls={};_(Ls,{AdminJobsPage:()=>Zt});function Zt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-jobs",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Status
                    <select class="admin-select" id="admin-job-status">
                        ${mi.map(t=>`<option value="${t}" ${t===Kt?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-job-status").addEventListener("change",async t=>{Kt=t.target.value,await ve()}),e.querySelector("#admin-job-refresh").addEventListener("click",ve),await ve()}}}async function ve(){let e=document.getElementById("admin-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await d.adminJobs(Kt)).data||[];e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(bi(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${F(t.message||"unknown error")}</p>`}}}function bi(e){let t=document.createElement("article");t.className=`admin-row admin-job-row admin-job-row--${F(e.status)}`;let a=e.worker?`${F(e.worker.name)} <span class="muted">(${F(e.worker.email||"")})</span>`:'<span class="muted">Unassigned</span>';t.innerHTML=`
        ...
        <div class="admin-job-row__footer">
            <span class="muted">Updated ${fi(e.updated_at||e.created_at)}</span>
            <div class="admin-row__actions"></div>
        </div>
    `;let s=t.querySelector(".admin-row__actions");return["completed","cancelled","disputed"].includes(e.status)||s.appendChild(Yt("Mark disputed","btn--danger",()=>gi(e.id))),e.status==="disputed"&&(s.appendChild(Yt("Release payment","btn--success",()=>Ts(e.id,"release"))),s.appendChild(Yt("Cancel and refund","btn--danger",()=>Ts(e.id,"cancel")))),t}function Yt(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function gi(e){if(confirm("Flag this job for admin dispute review?"))try{await d.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await ve()}catch(t){l(t.message||"Could not flag job.","error")}}async function Ts(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await d.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ve()}catch(r){l(r.message||"Could not resolve dispute.","error")}}function fi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function F(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var mi,Kt,Qt=v(()=>{w();h();mi=["","open","in_review","assigned","submitted","revision","disputed","completed","cancelled","expired"],Kt=""});var Es={};_(Es,{AdminTransactionsPage:()=>aa});function aa(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Type
                    <select class="admin-select" id="admin-transaction-type">
                        ${vi.map(t=>`<option value="${t}" ${t===ta?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All transactions"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{ta=t.target.value,await ea()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",ea),await ea()}}}async function ea(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await d.adminTransactions({type:ta})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(hi(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${W(t.message||"unknown error")}</p>`}}}function hi(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${W(e.type)}`,t.innerHTML=`
        <div class="admin-transaction-row__header">
            <div>
                <strong>${W(String(e.type||"").replace("_"," ").toUpperCase())}</strong>
                <span class="badge">#${Number(e.id||0)}</span>
            </div>
            <strong class="admin-row__amount">${W(e.currency||"BDT")} ${Number(e.amount||0).toFixed(2)}</strong>
        </div>
        <div class="admin-transaction-row__meta">
            <span><strong>User:</strong> ${W(e.user_name||"Platform")} ${e.user_email?`<span class="muted">(${W(e.user_email)})</span>`:""}</span>
            <span><strong>Job:</strong> ${W(e.job_title||(e.job_id?`#${e.job_id}`:"\u2014"))}</span>
            <span><strong>Date:</strong> ${yi(e.created_at)}</span>
        </div>
        ${e.note?`<p class="muted admin-transaction-row__note">${W(e.note)}</p>`:""}
        ${e.reference?`<code class="admin-transaction-row__reference">${W(e.reference)}</code>`:""}
    `,t}function yi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function W(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var vi,ta,sa=v(()=>{w();h();vi=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],ta=""});var Cs={};_(Cs,{AdminReportsPage:()=>ra});function ra(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await wi()}}}async function wi(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await d.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            <div class="stat-grid admin-report-summary">
                ${We("Transactions",Je(s.transaction_count))}
                ${We("Transaction volume",Ge(s.transaction_volume))}
                ${We("Jobs",Je(s.job_count))}
                ${We("Job value",Ge(s.job_value))}
            </div>
            <div class="admin-report-grid">
                <div class="card">
                    <h3 class="card__title">Transactions by type</h3>
                    <div class="admin-report-list">${_i(a.transactions||[])}</div>
                </div>
                <div class="card">
                    <h3 class="card__title">Jobs by status</h3>
                    <div class="admin-report-list">${$i(a.jobs||[])}</div>
                </div>
            </div>
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${he(t.message||"unknown error")}</p>`}}function We(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${he(e)}</span><strong>${he(t)}</strong></div>`}function _i(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${he(String(t.type||"").replace("_"," "))}</strong><small>${Je(t.transaction_count)} entries</small></span>
            <strong>${Ge(t.amount)}</strong>
        </div>
    `).join(""):'<p class="muted">No transactions yet.</p>'}function $i(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${he(String(t.status||"").replace("_"," "))}</strong><small>${Je(t.job_count)} jobs</small></span>
            <strong>${Ge(t.budget)}</strong>
        </div>
    `).join(""):'<p class="muted">No jobs yet.</p>'}function Je(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Ge(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function he(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ia=v(()=>{w();h()});var qs={};_(qs,{LoginPage:()=>na});function na(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
            <h1 class="auth-card__title">\u{1F4B0} JMJob</h1>
            <p class="auth-card__sub">Log in to your account</p>
            ${t?`<p class="auth-card__referral">Referred by <strong>${Si(t)}</strong></p>`:""}
    ...
    `;let t=document.getElementById("forgot-form"),a=document.getElementById("submit-btn");t.addEventListener("submit",async s=>{s.preventDefault();let r=t.email.value.trim();if(!r){l("Please enter your email address.","error");return}a.disabled=!0,a.textContent="Sending...";try{await d.forgotPassword({email:r}),l("If an account exists with this email, you will receive a reset code.","success"),f(`/reset-password?email=${encodeURIComponent(r)}`)}catch(i){l(i.message||"Failed to send reset code.","error"),a.disabled=!1,a.textContent="Send Reset Code"}})}var pa=v(()=>{w();h()});var Ps={};_(Ps,{default:()=>Ve});async function Ve(){let e=document.querySelector("[data-view]");if(!e)return;let a=(new URLSearchParams(window.location.hash.split("?")[1]).get("email")||"").trim().toLowerCase();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--auth",e.innerHTML=`
        <div class="auth-card">
            ...
            <form class="auth-form" id="reset-form">
                <label class="auth-form__label">
                    Email Address
                    <input type="email" name="email" value="${ki(a)}" placeholder="you@example.com" required autocomplete="email">
                </label>
    ...
    `;let s=document.getElementById("reset-form"),r=document.getElementById("submit-btn");s.addEventListener("submit",async i=>{i.preventDefault();let n=s.email.value.trim(),o=s.otp.value.trim(),c=s.password.value,u=s.password_confirmation.value;if(!n||!o||!c){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(c!==u){l("Passwords do not match.","error");return}if(c.length<6){l("Password must be at least 6 characters.","error");return}r.disabled=!0,r.textContent="Resetting...";try{await d.resetPassword({email:n,otp:o,password:c,password_confirmation:u}),l("Password reset successfully! You can now log in.","success"),f("/login")}catch(m){l(m.message||"Failed to reset password.","error"),r.disabled=!1,r.textContent="Reset Password"}})}function ki(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ua=v(()=>{w();h()});var rr={};_(rr,{JobDetailPage:()=>Tn});function Tn(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=g.get();t.innerHTML=`
        ...
        `;try{let s=await d.job(e),{job:r,bids:i,bid_count:n,my_bid:o}=s.data;Ln(r,i,n,o,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${K(s.message||"unknown")}</p>`}}}function Ln(e,t,a,s,r){let i=document.getElementById("job-detail-content");if(!i)return;let n=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,o=n?Math.max(0,Math.floor((n-Date.now())/1e3)):null,c=o!=null?qn(o):"\u2014",u=["open","in_review"].includes(e.status),m=!!s;i.innerHTML=`
        <div class="card job-detail__card">
            <div class="job-detail__head">
                <div>
                    ${e.category?`<span class="job-detail__cat"><i class="bi ${e.category.icon_class||""}"></i> ${K(e.category.name)}</span>`:""}
                    <h1 class="job-detail__title">${K(e.title)}</h1>
            ...
            <div class="job-detail__body">
                <h3>Description</h3>
                <p>${K(e.description).replace(/\n/g,"<br>")}</p>
                ${e.requirements?`<h3>Requirements</h3><p>${K(e.requirements).replace(/\n/g,"<br>")}</p>`:""}
                <h3>Posted by</h3>
                <p>${e.poster?K(e.poster.name):"Unknown"} <span class="muted">@${e.poster?.username||"?"}</span></p>
            </div>
        </div>

        ${En(e,t,s,r,u)}
    `,Cn(e,s,r)}function En(e,t,a,s,r){return a?`
            <div class="card">
                ...
                <div class="bid-row bid-row--${a.status}">
                    <div>
                        ...
                        <div class="muted">${K(a.proposal)}</div>
                    </div>
                    ...
                    ${t.map(i=>`
                        <div class="bid-row">
                            <div>
                                ...
                                <div class="muted">${K(i.proposal).slice(0,100)}${i.proposal.length>100?"\u2026":""}</div>
                            </div>
    ...
    `:'<div class="card"><p class="muted">Please log in to place a bid.</p></div>':'<div class="card"><p class="muted">Bidding is closed for this job.</p></div>'}function Cn(e,t,a){if(t){let r=document.getElementById("withdraw-bid-btn");r&&r.addEventListener("click",async()=>{if(confirm("Withdraw your bid?"))try{await d.withdrawBid(t.id),l("Bid withdrawn.","success"),f(`/jobs/${e.id}`)}catch(i){l(i.message||"Failed to withdraw.","error")}});return}let s=document.getElementById("bid-form");s&&s.addEventListener("submit",async r=>{r.preventDefault();let i=new FormData(s),n=document.getElementById("bid-submit-btn");n.disabled=!0,n.textContent="Submitting\u2026";try{await d.placeBid(e.id,{amount:parseFloat(i.get("amount")),delivery_days:parseInt(i.get("delivery_days"),10),proposal:String(i.get("proposal")||"").trim()}),l("Bid placed!","success"),f(`/jobs/${e.id}`)}catch(o){l(o.message||"Failed to place bid.","error")}finally{n.disabled=!1,n.textContent="Submit Bid"}})}function qn(e){if(e<=0)return"expired";let t=Math.floor(e/86400),a=Math.floor(e%86400/3600);if(t>0)return`${t}d ${a}h`;let s=Math.floor(e%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function K(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ir=v(()=>{w();h()});var lr={};_(lr,{PosterJobDetailPage:()=>An});function An(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.innerHTML="",t.className="view view--poster-job-detail",!Fn()){t.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}t.innerHTML='<a href="#/poster/jobs" class="back-link"><i class="bi bi-arrow-left"></i> My jobs</a><div id="poster-job-detail-content"><div class="spinner"></div></div>',await nr(e)}}}async function nr(e){let t=document.getElementById("poster-job-detail-content");if(t)try{let s=(await d.posterJobBids(e)).data||{};Mn(t,s.job||{},s.bids||[],s.submissions||[])}catch(a){t.innerHTML=`<p class="muted">Failed to load job: ${T(a.message||"unknown error")}</p>`}}function Mn(e,t,a,s){e.innerHTML=`
        <div class="card poster-detail-card">
            <div class="poster-detail-card__header"><div><h1 class="page-title">${T(t.title)}</h1><p class="muted">${T(t.description||"")}</p></div><span class="badge badge--status badge--${T(t.status)}">${T(Rn(t.status).toUpperCase())}</span></div>
            <div class="poster-detail-meta"><span>Budget <strong>\u09F3${Number(t.budget||0).toFixed(2)}</strong></span><span>Bids <strong>${Number(t.bid_count||a.length)}</strong></span><span>Views <strong>${Number(t.view_count||0)}</strong></span><span>Created <strong>${or(t.created_at)}</strong></span></div>
        </div>
        <div class="poster-detail-grid">
            <div class="card"><div class="card__header"><div><h2 class="card__title">Bid comparison</h2><p class="muted">Choose one pending proposal to assign the job.</p></div></div><div class="poster-bid-list">${Nn(t,a)}</div></div>
            <div class="card"><div class="card__header"><div><h2 class="card__title">Submission review</h2><p class="muted">Approve delivery to release payment or request changes.</p></div></div><div class="poster-submission-list">${Pn(t,s)}</div></div>
        </div>
    ...
    `,e.querySelectorAll("[data-accept-bid]").forEach(r=>r.addEventListener("click",()=>jn(t.id,r.dataset.acceptBid))),e.querySelectorAll("[data-release-submission]").forEach(r=>r.addEventListener("click",()=>Hn(t.id,r.dataset.releaseSubmission))),e.querySelectorAll("[data-revision-submission]").forEach(r=>r.addEventListener("click",()=>Bn(t.id,r.dataset.revisionSubmission))),e.querySelector("#poster-detail-cancel")?.addEventListener("click",()=>In(t.id))}function Nn(e,t){return t.length?t.map(a=>`
    ...
    `).join(""):'<p class="muted">No bids yet.</p>'}function Pn(e,t){return t.length?t.map(a=>`
        <div class="poster-submission-row poster-submission-row--${T(a.status)}"><div><strong>${T(a.worker?.name||"Worker")}</strong><span class="muted">Submitted ${or(a.created_at)} \xB7 ${T(String(a.status||"").replace("_"," "))}</span><p>${T(a.description||"")}</p>${a.external_link?`<a href="${T(a.external_link)}" target="_blank" rel="noopener noreferrer">Open delivery link</a>`:""}${a.reviewer_note?`<p class="muted"><strong>Revision note:</strong> ${T(a.reviewer_note)}</p>`:""}</div>${a.status==="pending_review"&&e.status==="submitted"?`<div class="poster-submission-row__actions"><button class="btn btn--success btn--sm" data-release-submission="${Number(a.id)}">Release payment</button><button class="btn btn--ghost btn--sm" data-revision-submission="${Number(a.id)}">Request revision</button></div>`:""}</div>
    `).join(""):'<p class="muted">No work submitted yet.</p>'}async function jn(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await d.posterAcceptBid(e,t),l("Worker selected and escrow held.","success"),await _a(e)}catch(a){l(a.message||"Could not select worker.","error")}}async function Hn(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await d.posterReleasePayment(e,{submission_id:Number(t)}),l("Payment released.","success"),await _a(e)}catch(a){l(a.message||"Could not release payment.","error")}}async function Bn(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await d.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),l("Revision requested.","success"),await _a(e)}catch(s){l(s.message||"Could not request revision.","error")}}async function In(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await d.posterCancelJob(e,{reason:"Cancelled by poster"}),l("Job cancelled.","success"),f("/poster/jobs")}catch(t){l(t.message||"Could not cancel job.","error")}}async function _a(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await nr(e))}function Fn(){return!!g.get()}function Rn(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function or(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var cr=v(()=>{w();h()});H();h();H();h();var Xe=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ut(),Ua))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ee(),mt))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ee(),mt))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(bt(),Wa))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ft(),Ga))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ht(),za))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(wt(),Ya))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Me(),$t))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(St(),Ka))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(kt(),Za))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(xt(),Qa))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ct(),os))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(At(),cs))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Me(),$t))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Mt(),ds))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(jt(),ms))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(It(),fs))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Rt(),hs))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ot(),ys))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Gt(),$s))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Xt(),xs))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Qt(),Ls))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(sa(),Es))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ia(),Cs))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(oa(),qs))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(da(),Ms))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(pa(),Ns))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ua(),Ps))}],Jl=k(()=>{let e=x.get().split("?")[0]||"/";return Xe.find(t=>t.path===e)||Xe[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";x.set(e)});H();h();H();var xi=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],Ti=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],Li=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Ei(){let e=g.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...Ti];let t=[...xi];return e&&e.role==="poster"&&t.push({separator:!0},...Li),t}var js="sidebar_collapsed",re=P(localStorage.getItem(js)==="true");function Ci(){let e=!re.get();re.set(e),localStorage.setItem(js,String(e))}function Hs(){let e=()=>x.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${re.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[qi(),Ai(),Mi()]}}function qi(){let e=()=>x.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function Ai(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>Ci(),title:()=>re.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${re.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function Mi(){return{tag:"nav",props:{class:"sidebar__nav"},children:Ei().map(e=>e.header?Ni(e.header):e.separator?Pi():ji(e))}}function Ni(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function Pi(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function ji({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${x.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>re.get()?t:"",onclick:r=>{r.preventDefault(),f(e),Is()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function Bs(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>Is()},children:[]}}function Is(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}h();H();h();var Hi=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],Bi=[{path:"/admin",label:"Admin Panel",icon:"bi-shield-lock"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Oversight",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Transactions",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Settings",icon:"bi-sliders"}],Ii=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Fi(){let e=g.get();if(e&&e.is_admin)return Bi;let t=[...Hi];return e&&e.role==="poster"&&t.push({separator:!0},...Ii),t}function Ri({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${x.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:r=>{r.preventDefault(),f(e),ma()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function Di(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>ma()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function Ui(){return{tag:"nav",props:{class:"mobile-nav__list"},children:Fi().map(e=>e.separator?Oi():Ri(e))}}function Oi(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function Fs(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[Di(),Ui()]}}function Rs(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>ma()},children:[]}}function Ds(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function ma(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}Et();w();function Us(){return I(()=>E.get(),()=>Yi(),()=>Xi())}function Os(){let e=()=>{let t=B.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>ts(),"data-theme":()=>B.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function Wi(){let e=document.getElementById("topbar-notifications-panel");if(!e)return;let t=e.classList.contains("topbar-notifications--open");document.querySelectorAll(".topbar-notifications--open").forEach(a=>a.classList.remove("topbar-notifications--open")),t||e.classList.add("topbar-notifications--open")}function Ji(){return setTimeout(Gi,0),{tag:"div",props:{class:"topbar__notifications-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__notifications","aria-label":"Notifications",onclick:e=>{e.stopPropagation(),Wi()}},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge",id:"topbar-notification-badge","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-notifications",id:"topbar-notifications-panel"},children:[{tag:"div",props:{class:"topbar-notifications__header"},children:[{tag:"strong",props:{},children:["Notifications"]},{tag:"button",props:{class:"topbar-notifications__close","aria-label":"Close",onclick:()=>{let e=document.getElementById("topbar-notifications-panel");e&&e.classList.remove("topbar-notifications--open")}},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]},{tag:"ul",props:{class:"topbar-notifications__list",id:"topbar-notifications-list"},children:[Vi("Loading notifications\u2026","Your latest updates will appear here.","bi-hourglass-split","info")]},{tag:"div",props:{class:"topbar-notifications__footer"},children:[{tag:"a",props:{href:"#/notifications",class:"topbar-notifications__link"},children:["View all notifications"]}]}]}]}}async function Gi(){let e=document.getElementById("topbar-notifications-list"),t=document.getElementById("topbar-notification-badge");if(!(!e||!t))try{let a=await d.notifications({limit:5}),s=Array.isArray(a.data)?a.data:[],r=Number(a.meta?.unread_count||s.filter(i=>!i.read).length||0);t.textContent=r>99?"99+":String(r),e.innerHTML=s.length?s.map(zi).join(""):'<li class="topbar-notifications__empty">No notifications yet.</li>',e.querySelectorAll("[data-notification-id]").forEach(i=>{i.addEventListener("click",async()=>{let n=i.getAttribute("data-notification-id");if(!(!n||i.getAttribute("data-read")==="1"))try{await d.notificationRead(n),i.setAttribute("data-read","1"),i.classList.remove("topbar-notification--unread");let o=Math.max(0,Number(t.textContent.replace("+",""))-1);t.textContent=String(o)}catch{}})})}catch{e.innerHTML='<li class="topbar-notifications__empty">Notifications are unavailable right now.</li>',t.textContent="0"}}function zi(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?` href="#${Ye(t.action_url)}"`:"";return`<li class="topbar-notification topbar-notification--${a} ${e.read?"":"topbar-notification--unread"}" data-notification-id="${Ye(e.id)}" data-read="${e.read?"1":"0"}"><i class="bi ${s} topbar-notification__icon"></i><div class="topbar-notification__body"><div class="topbar-notification__title">${Ye(t.title||"Notification")}</div><div class="topbar-notification__text">${Ye(t.message||"")}</div>${r?`<a class="topbar-notification__action"${r}>Open</a>`:""}</div></li>`}function Ye(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Vi(e,t,a,s){return{tag:"li",props:{class:`topbar-notification topbar-notification--${s}`},children:[{tag:"i",props:{class:`bi ${a} topbar-notification__icon`},children:[]},{tag:"div",props:{class:"topbar-notification__body"},children:[{tag:"div",props:{class:"topbar-notification__title"},children:[e]},{tag:"div",props:{class:"topbar-notification__text"},children:[t]}]}]}}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-notifications-panel");t&&t.classList.contains("topbar-notifications--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__notifications")&&t.classList.remove("topbar-notifications--open")});function Xi(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[Os(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function Yi(){let e=g.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>Ds(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[Os(),Ji(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await xe(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}h();H();function Ws(){return I(()=>!!ce.get(),()=>{let e=ce.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}w();function Js(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{d.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let r=[];a.facebook&&r.push(`<a href="${Ke(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&r.push(`<a href="${Ke(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&r.push(`<a href="${Ke(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&r.push(`<a href="${Ke(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=r.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function Ke(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}h();var Ki=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],Zi=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"}];function Qi(){let e=g.get();return e&&e.is_admin?Zi:Ki}function en({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${x.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:r=>{r.preventDefault(),f(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function tn(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function an(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:Qi().map(e=>e.separator?tn():en(e))}}function ba(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&ba()},!0),window.addEventListener("resize",()=>setTimeout(ba,50)),document.addEventListener("hnav:rendered",()=>setTimeout(ba,0)));function Gs(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[an()]}}function zs(){let e=()=>!!g.get()?.is_admin,t=()=>x.get().startsWith("/admin"),a=()=>E.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[I(()=>E.get(),()=>Hs(),()=>null),I(()=>E.get(),()=>Bs(),()=>null),I(()=>E.get(),()=>Fs(),()=>null),I(()=>E.get(),()=>Rs(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[Us(),I(()=>E.get()&&!e(),()=>Gs(),()=>null),{tag:"main",props:{class:"app-main"},children:[sn()]},Js()]},Ws()]}}function sn(){let t=x.get().split("?")[0]||"/",a=Xe.find(r=>r.path===t),s=g.get();return s&&s.is_admin&&!t.startsWith("/admin")?(f("/admin"),ga()):a?a.requireAuth&&!E.get()?(f("/login"),ga()):a.requireAdmin&&(!g.get()||!g.get().is_admin)?on():!a.requireAuth&&E.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(f("/"),ga()):rn(a):nn()}function rn(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function nn(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function on(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function ga(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}H();h();ut();oa();da();pa();ua();ft();Ee();bt();Mt();ht();Me();Gt();Xt();wt();St();kt();xt();Ct();w();h();var b={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function Xs(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
        ...
        `,b.categories.length===0)try{let t=await d.categories();b.categories=Array.isArray(t.data)?t.data:[];let a=document.getElementById("jobs-category");a&&(a.innerHTML=Vs())}catch{}document.getElementById("jobs-apply")?.addEventListener("click",()=>{ln(),b.page=1,Ze()}),document.getElementById("jobs-reset")?.addEventListener("click",()=>{b.search="",b.categoryId="",b.minBudget="",b.maxBudget="",b.sort="latest",b.page=1,cn(),Ze()}),document.getElementById("jobs-search")?.addEventListener("keydown",t=>{t.key==="Enter"&&document.getElementById("jobs-apply")?.click()}),await Ze()}}}function Vs(){return'<option value="">All categories</option>'+b.categories.map(e=>`<option value="${R(e.id)}" ${String(e.id)===String(b.categoryId)?"selected":""}>${R(e.name)}</option>`).join("")}function ln(){b.search=document.getElementById("jobs-search")?.value.trim()||"",b.categoryId=document.getElementById("jobs-category")?.value||"",b.minBudget=document.getElementById("jobs-min-budget")?.value.trim()||"",b.maxBudget=document.getElementById("jobs-max-budget")?.value.trim()||"",b.sort=document.getElementById("jobs-sort")?.value||"latest"}function cn(){let e={"jobs-search":b.search,"jobs-category":b.categoryId,"jobs-min-budget":b.minBudget,"jobs-max-budget":b.maxBudget,"jobs-sort":b.sort};Object.entries(e).forEach(([t,a])=>{let s=document.getElementById(t);s&&(s.value=a)})}async function Ze(){let e=document.getElementById("jobs-grid");if(!e)return;let t=++b.requestSerial;b.loading=!0,e.innerHTML='<div class="spinner"></div>';try{let a={page:b.page,per_page:b.perPage,sort:b.sort};b.search&&(a.search=b.search),b.categoryId&&(a.category_id=b.categoryId),b.minBudget!==""&&(a.min_budget=b.minBudget),b.maxBudget!==""&&(a.max_budget=b.maxBudget);let s=await d.jobs(a);if(t!==b.requestSerial)return;b.jobs=Array.isArray(s.data)?s.data:[],b.total=Number(s.meta?.total||0),b.lastPage=Math.max(1,Number(s.meta?.last_page||1)),dn()}catch(a){if(t!==b.requestSerial)return;e.innerHTML=`<p class="muted">Failed to load jobs: ${R(a.message||"unknown error")}</p>`,Ys(),Ks()}finally{t===b.requestSerial&&(b.loading=!1)}}function dn(){let e=document.getElementById("jobs-grid");if(e){if(Ys(),Ks(),b.jobs.length===0){e.innerHTML='<p class="muted">No jobs match your filters. Try clearing them.</p>';return}e.innerHTML=b.jobs.map(t=>`
        <a class="job-card" href="#/jobs/${encodeURIComponent(t.id)}" data-id="${R(t.id)}">
            <div class="job-card__head">
                ${t.category&&t.category.icon_class?`<i class="bi ${pn(t.category.icon_class)} job-card__cat-icon"></i>`:""}
            ...
            <p class="job-card__desc">${R(un(t.description,140))}</p>
    ...
    `).join(""),e.querySelectorAll("a.job-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function Ys(){let e=document.getElementById("jobs-results-meta");if(!e)return;if(b.total===0){e.textContent="No open jobs found";return}let t=(b.page-1)*b.perPage+1,a=Math.min(b.page*b.perPage,b.total);e.textContent=`Showing ${t}-${a} of ${b.total} open jobs`}function Ks(){let e=document.getElementById("jobs-pagination");if(e){if(b.lastPage<=1){e.innerHTML="";return}e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>b.lastPage||a===b.page||(b.page=a,Ze())})})}}function pn(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function un(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function R(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var fa={bids:[],loading:!1};function Zs(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await d.workerBids();fa.bids=t.data||[],mn()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${Qs(t.message||"unknown")}</p>`}}}}function mn(){let e=document.getElementById("bids-list");if(e){if(fa.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=fa.bids.map(t=>`
        <a class="bid-row-card" href="#/jobs/${t.job_id}" data-id="${t.job_id}">
            <div class="bid-row-card__main">
                <div class="bid-row-card__title">${Qs(t.job?.title||"Job")}</div>
                <div class="bid-row-card__meta">
                    ...
                    <span class="muted">${bn(t.created_at)}</span>
                </div>
            </div>
            <span class="badge badge--status badge--${t.status}">${t.status.toUpperCase()}</span>
        </a>
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function bn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function Qs(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var ye={jobs:[],submissions:[],loading:!1};function va(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([d.workerActiveJobs(),d.workerSubmissions()]);ye.jobs=t.data||[],ye.submissions=a.data||[],gn()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${ha(t.message||"unknown")}</p>`}}}}function gn(){let e=document.getElementById("active-jobs-list");if(e){if(ye.jobs.length===0){e.innerHTML=`<p class="muted">No active jobs. Once a poster accepts your bid, it'll appear here.</p>`;return}e.innerHTML=ye.jobs.map(t=>{let a=ye.submissions.find(r=>r.job_id===t.id),s=t.status;return`
        ...
        `}).join(""),hn()}}function fn(e,t){return`
        <div class="active-job-card__sub">
            <strong>Submitted:</strong> ${yn(t.created_at)}
    ...
    `}function hn(){document.querySelectorAll("form.submit-form").forEach(e=>{e.addEventListener("submit",async t=>{t.preventDefault();let a=parseInt(e.getAttribute("data-job-id"),10),s=new FormData(e),r=e.querySelector("[data-submit-btn]");r.disabled=!0,r.innerHTML='<i class="bi bi-hourglass"></i> Submitting\u2026';try{await d.submitWork(a,{description:String(s.get("description")||"").trim(),external_link:String(s.get("external_link")||"").trim()||null}),l("Work submitted!","success"),va()()}catch(i){l(i.message||"Failed to submit.","error")}finally{r.disabled=!1,r.innerHTML='<i class="bi bi-send"></i> Submit Work'}})})}function yn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ha(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var A={activeTab:"categories",categories:[],subcategories:[],loading:!1};function er(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#tab-cats-btn").addEventListener("click",()=>{A.activeTab="categories",ya(e)}),e.querySelector("#tab-subcats-btn").addEventListener("click",()=>{A.activeTab="subcategories",ya(e)}),await G(e)}}async function G(e){try{let[t,a]=await Promise.all([d.adminCategories(),d.adminSubcategories()]);A.categories=t.data||[],A.subcategories=a.data||[],ya(e)}catch(t){l(t.message||"Failed to load category data.","error")}}function ya(e){let t=e.querySelector("#tab-cats-btn"),a=e.querySelector("#tab-subcats-btn"),s=e.querySelector("#tab-content");s&&(A.activeTab==="categories"?(t&&(t.className="btn btn--primary"),a&&(a.className="btn btn--ghost"),wn(s,e)):(t&&(t.className="btn btn--ghost"),a&&(a.className="btn btn--primary"),_n(s,e)))}function wn(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
            <h3>Main Categories List</h3>
            ${A.categories.length===0?'<p class="muted">No categories yet.</p>':`
                        ...
                        <tbody>
                            ${A.categories.map(s=>`
                                <tr style="border-bottom: 1px solid #f3f4f6;">
                                    <td style="padding:0.75rem 0.5rem;"><strong>${J(s.name)}</strong></td>
                                    <td style="padding:0.75rem 0.5rem;" class="muted">/${J(s.slug)}</td>
                                    ...
                                    <td style="padding:0.75rem 0.5rem; font-size:0.85rem;" class="muted">${J(s.created_at||"-")}</td>
                                    <td style="padding:0.75rem 0.5rem; font-size:0.85rem;" class="muted">${J(s.updated_at||"-")}</td>
                                    <td style="padding:0.75rem 0.5rem;">
    ...
    `,e.querySelectorAll(".edit-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.categories.find(c=>String(c.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Main Category "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await d.adminUpdateCategory(r,{min_cost:o}),l(`Min cost updated for ${i.name}.`,"success"),await G(t)}catch(c){l(c.message,"error")}})}),e.querySelectorAll(".toggle-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.categories.find(n=>String(n.id)===String(r));if(i)try{await d.adminUpdateCategory(r,{is_active:!i.is_active}),l("Category updated.","success"),await G(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete category?"))try{let i=await d.adminDeleteCategory(r);l(i.message||"Deleted.","success"),await G(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-cat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),description:String(r.get("description")||"").trim()||null,is_active:r.get("is_active")==="on"};try{await d.adminCreateCategory(i),l("Main Category created.","success"),await G(t)}catch(n){l(n.message,"error")}})}function _n(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
            <h3>Subcategories List</h3>
            ${A.subcategories.length===0?'<p class="muted">No subcategories yet.</p>':`
                <div class="table-responsive">
                    <table class="table" style="width:100%; text-align:left; border-collapse:collapse;">
                        <thead>
                        ...
                        <tbody>
                            ${A.subcategories.map(s=>`
                                <tr style="border-bottom: 1px solid #f3f4f6;">
                                    <td style="padding:0.75rem 0.5rem;"><strong>${J(s.name)}</strong></td>
                                    <td style="padding:0.75rem 0.5rem;"><span class="badge" style="background:#e0e7ff; color:#3730a3;">${J(s.category_name||"-")}</span></td>
                                    <td style="padding:0.75rem 0.5rem;">\u09F3${Number(s.min_cost||1).toFixed(2)}</td>
                                    <td style="padding:0.75rem 0.5rem;">
                                        <span class="badge ${s.is_active?"badge--success":"badge--warning"}">
                                            ${s.is_active?"Active":"Inactive"}
            ...
            <form id="add-subcat-form" class="poster-form">
                <label>Parent Main Category
                    <select name="category_id" required>
                        ...
                        ${A.categories.map(s=>`
                            <option value="${s.id}">${J(s.name)}</option>
                        `).join("")}
                    </select>
                </label>
    ...
    `,e.querySelectorAll(".edit-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.subcategories.find(c=>String(c.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Subcategory "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await d.adminUpdateSubcategory(r,{min_cost:o}),l(`Min cost updated for ${i.name}.`,"success"),await G(t)}catch(c){l(c.message,"error")}})}),e.querySelectorAll(".toggle-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.subcategories.find(n=>String(n.id)===String(r));if(i)try{await d.adminUpdateSubcategory(r,{is_active:!i.is_active}),l("Subcategory updated.","success"),await G(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete subcategory?"))try{let i=await d.adminDeleteSubcategory(r);l(i.message||"Deleted.","success"),await G(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-subcat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={category_id:parseInt(r.get("category_id")||"0",10),name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),is_active:r.get("is_active")==="on"};try{await d.adminCreateSubcategory(i),l("Subcategory created.","success"),await G(t)}catch(n){l(n.message,"error")}})}function J(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var z={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1};function tr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await ar()}}async function ar(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a,s]=await Promise.all([d.adminSettings(),d.socialLinks(),d.notices()]);z.grouped=t.data||{},z.social=a||{},z.noticesData=s||{interval:4,notices:[]},$n()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${M(t.message||"unknown")}</p>`}}}function $n(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(z.grouped).map(n=>`
        <div class="card settings-group">
            <h3 class="card__title">${M(n.charAt(0).toUpperCase()+n.slice(1))}</h3>
            <div class="settings-group__rows">
                ${z.grouped[n].map(o=>kn(n,o)).join("")}
            </div>
        </div>
    `).join(""),s=z.noticesData,r=[];Array.isArray(s.notices)&&s.notices.length&&(r=s.notices.map(n=>typeof n=="string"?n.startsWith("/")||n.startsWith("http")?{image:n,text:""}:{image:"",text:n}:{image:n.image||"",text:n.text||""})),r.length||(r=[{image:"",text:""}]),a+=`
        ...
        <div class="card settings-group" style="margin-top:20px;">
            ...
            <div class="settings-group__rows">
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-facebook" value="${M(i.facebook||"")}" placeholder="https://facebook.com/yourpage" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-instagram" value="${M(i.instagram||"")}" placeholder="https://instagram.com/yourprofile" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-whatsapp" value="${M(i.whatsapp||"")}" placeholder="https://wa.me/1234567890" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-telegram" value="${M(i.telegram||"")}" placeholder="https://t.me/yourchannel" class="settings-row__input">
                    </div>
                </div>
            </div>
        </div>
    ...
    `,e.innerHTML=a,document.getElementById("settings-save-btn").addEventListener("click",xn),document.getElementById("add-notice-btn").addEventListener("click",Sn),wa()}function sr(e,t={image:"",text:""}){let a=typeof t=="string"?t.startsWith("/")||t.startsWith("http")?t:"":t?.image||"",s=typeof t=="string"?!t.startsWith("/")&&!t.startsWith("http")?t:"":t?.text||"",r="";return a?r=`<div class="banner-preview"><img src="${M(a)}" alt="Banner preview"></div>`:s?r=`<div class="banner-preview banner-preview--text"><strong>Text Notice:</strong> <span>${M(s)}</span></div>`:r='<div class="banner-preview banner-preview--empty"><i class="bi bi-image muted"></i> No image uploaded</div>',`
        <div class="banner-message-row card">
            ...
            <div class="banner-message-row__fields">
                <div class="banner-field banner-field--full">
                    ${r}
                    <input type="hidden" class="notice-msg-image" value="${M(a)}">
    ...
    `}function Sn(){let e=document.getElementById("notice-messages-container");if(!e)return;let t=e.querySelectorAll(".banner-message-row").length+1,a=document.createElement("div");a.innerHTML=sr(t,{image:""});let s=a.firstElementChild;e.appendChild(s),wa()}function wa(){let e=document.getElementById("notice-messages-container");if(!e)return;e.querySelectorAll(".banner-message-row").forEach((a,s)=>{let r=a.querySelector(".banner-message-num");r&&(r.textContent=`Banner ${s+1}`);let i=a.querySelector(".banner-file-input"),n=a.querySelector(".notice-msg-image"),o=a.querySelector(".banner-preview"),c=a.querySelector(".banner-upload-status"),u=a.querySelector(".banner-upload-btn");i&&!i.dataset.wired&&(i.dataset.wired="true",i.addEventListener("change",async y=>{let L=y.target.files[0];if(L){c&&(c.textContent="Uploading\u2026");try{let $=new FormData;$.append("image",L);let N=await d.adminUploadBannerImage($);N&&N.url&&(n.value=N.url,o.className="banner-preview",o.innerHTML=`<img src="${M(N.url)}" alt="Banner preview">`,c&&(c.textContent="Uploaded!"))}catch($){c&&(c.textContent=$.message||"Upload failed."),l($.message||"Failed to upload image.","error")}}}));let m=a.querySelector(".remove-notice-btn");m&&(m.onclick=()=>{a.remove(),wa()})})}function kn(e,t){let a=`set-${t.key.replace(/[^a-z0-9]/gi,"_")}`,s;switch(t.value_type){case"boolean":s=`<label class="settings-row__check"><input type="checkbox" id="${a}" ${t.value?"checked":""}></label>`;break;case"integer":case"percent":s=`<input type="number" step="1" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"decimal":s=`<input type="number" step="0.0001" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"json":s=`<textarea id="${a}" rows="3" class="settings-row__input">${M(JSON.stringify(t.value,null,2)||"")}</textarea>`;break;default:s=`<input type="text" id="${a}" value="${M(String(t.value))}" class="settings-row__input">`}return`
        <div class="settings-row">
            <label for="${a}" class="settings-row__label">
                <strong>${M(t.key)}</strong>
                <span class="muted">${M(t.description||"")}</span>
            </label>
            <div class="settings-row__control">${s}</div>
        </div>
    `}async function xn(){let e={};for(let n of Object.keys(z.grouped))for(let o of z.grouped[n]){let c=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,u=document.getElementById(c);if(!u)continue;let m;o.value_type==="boolean"?m=u.checked:o.value_type==="integer"||o.value_type==="percent"?m=parseInt(u.value,10):o.value_type==="decimal"?m=parseFloat(u.value):o.value_type==="json"?m=u.value?JSON.parse(u.value):null:m=u.value,e[o.key]=m}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".banner-message-row")).map(n=>({image:n.querySelector(".notice-msg-image")?.value.trim()||""})).filter(n=>n.image!==""),r={interval:document.getElementById("notice-interval")?.value||4,direction:document.getElementById("notice-direction")?.value||"right_to_left",notices:s},i=document.getElementById("settings-save-btn");i.disabled=!0,i.textContent="Saving\u2026";try{await Promise.all([d.adminUpdateSettings(e),d.adminUpdateSocialLinks(t),d.adminUpdateNotices(r)]),l("Settings, notices, and social links saved successfully.","success"),await ar()}catch(n){l(n.message||"Failed to save.","error")}finally{i.disabled=!1,i.textContent="Save All Changes"}}function M(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}Qt();sa();ia();jt();It();Rt();Ot();At();var dr={"/":Le,"/refer":gt,"/webtask":de,"/tasks":de,"/earn":Ce,"/tg-tasks":Fe,"/withdraw":qe,"/profile":Ae,"/wallet":Ae,"/admin":Jt,"/admin/payments":Vt,"/admin/categories":er,"/admin/settings":tr,"/admin/jobs":Zt,"/admin/transactions":aa,"/admin/reports":ra,"/deposit":yt,"/leaderboard":Ne,"/achievements":Pe,"/support":je,"/settings":Be,"/jobs/available":Xs,"/worker/bids":Zs,"/worker/active-jobs":va,"/poster":Pt,"/poster/post-job":Ht,"/poster/jobs":Ft,"/poster/wallet":Ut,"/notifications":qt,"/login":na,"/register":ca,"/forgot-password":ze,"/reset-password":Ve};function pr(){Qe(),setTimeout(Qe,50),window.addEventListener("hashchange",Qe),k(()=>{E.get(),setTimeout(Qe,0)})}async function Qe(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!dr[t]){let n=t.match(/^\/jobs\/(\d+)$/);if(n){let c=await Promise.resolve().then(()=>(ir(),rr));await $a(()=>c.JobDetailPage(n[1]),t);return}let o=t.match(/^\/poster\/jobs\/(\d+)$/);if(o){if(!E.get()){f("/login");return}let c=await Promise.resolve().then(()=>(cr(),lr));await $a(()=>c.PosterJobDetailPage(o[1]),t);return}t="/"}let a=E.get(),s=g.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?f("/admin"):f("/");return}if(!r.includes(t)&&!a){f("/login");return}if(t==="/"&&s&&s.is_admin){f("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){Dn();return}let i=dr[t];await $a(i,t)}async function $a(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function Dn(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}h();var ur=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();ur.innerHTML="";D(zs(),ur);U.get()&&q();pr();
