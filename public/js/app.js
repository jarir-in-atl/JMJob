var fr=Object.defineProperty;var v=(e,t)=>()=>(e&&(t=e(e=0)),t);var _=(e,t)=>{for(var a in t)fr(e,a,{get:t[a],enumerable:!0})};function vr(e,t){Ea?Ea(e,t):console.error("[Ghost] Unhandled effect error:",e)}function j(e){let t=e,a=new Set;return{get(){return H&&(a.add(H),H.dependencies.add(a)),t},set(s){t!==s&&(t=s,Ca(a))}}}function Ca(e){lt(()=>{e.forEach(t=>{t.notify?t.notify():Te.add(t)})})}function lt(e){nt++;try{e()}finally{if(nt--,nt===0){let t=Array.from(Te);Te.clear(),t.forEach(a=>a.run())}}}function T(e){let t={dependencies:new Set,run(){ot(t),ke.push(H),H=t;try{e()}catch(a){vr(a,e)}finally{H=ke.pop()}},notify(){Te.add(t)}};return t.run(),()=>ot(t)}function dt(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,Ca(s))}};return{get(){if(H&&(s.add(H),H.dependencies.add(s)),a){ot(r),ke.push(H),H=r;try{t=e()}finally{H=ke.pop()}a=!1}return t}}}function ot(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var H,ke,Te,nt,Ea,K=v(()=>{H=null,ke=[],Te=new Set,nt=0,Ea=null});function de(){ct.totalUpdates++,ct.recentUpdates++}var Le,ct,pt=v(()=>{Le=new Set,ct={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function O(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){hr(e,t);return}if(e.__ghostWhen){yr(e,t);return}if(e.__ghostLazy){wr(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;Le.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let i=s.startsWith("on");typeof r=="function"&&!i?e.effects.push(T(()=>{a.setAttribute(s,r()),de(),e.events.update?.forEach(n=>n())})):i?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)O(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push(T(()=>{let i=s(),n=document.createTextNode(String(i??""));r?a.replaceChild(n,r):a.appendChild(n),r=n,de(),e.events.update?.forEach(o=>o())}))}else O(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function ce(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),Le.delete(e)}}function hr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function d(u){return u.el||null}let m=T(()=>{let u=a(),y=u.map(($,k)=>String(s($,k))),C=Array.from(o.keys());for(let $ of C)if(!y.includes($)){let k=o.get($);ce(k.ghostNode),o.delete($)}for(let $=0;$<u.length;$++){let k=y[$];if(!o.has(k)){let ae=r(u[$],$),U=document.createElement("ghost-list-slot");for(O(ae,U);U.firstChild;)t.insertBefore(U.firstChild,n);o.set(k,{ghostNode:ae})}}for(let $=y.length-1;$>=0;$--){let k=y[$],ae=o.get(k);if(!ae)continue;let U=d(ae.ghostNode);if(!U)continue;let Se=y[$+1],xe=(Se?d(o.get(Se)?.ghostNode):null)||n;U.nextSibling!==xe&&t.insertBefore(U,xe)}de()});e._listCleanup=()=>{m();for(let u of o.values())ce(u.ghostNode);o.clear(),i.remove(),n.remove()}}function R(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function yr(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=T(()=>{let m=a()?s:r;if(n&&(ce(n),n=null),m&&(n=m(),n)){let u=document.createElement("ghost-when-slot");for(O(n,u);u.firstChild;)t.insertBefore(u.firstChild,i)}de()});e._whenCleanup=()=>{o(),n&&ce(n),i.remove()}}function wr(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let i=null;if(s){let n=document.createElement("ghost-lazy-slot");for(O(s,n);n.firstChild;)t.insertBefore(n.firstChild,r);i=s}a().then(n=>{let o=n.default||n;i&&(ce(i),i=null);let d=typeof o=="function"?o():o,m=document.createElement("ghost-lazy-slot");for(O(d,m);m.firstChild;)t.insertBefore(m.firstChild,r);i=d}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var ut=v(()=>{K();pt()});var Aa=v(()=>{K()});var Ee=v(()=>{});var qa=v(()=>{pt()});var Ma=v(()=>{K()});var Na=v(()=>{ut();K();Ee();Ee()});function $r(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let i={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){i["@attributes"]={};for(let n of r.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of r.childNodes){let o=n.nodeName,d=s(n);d!==""&&(i[o]===void 0?i[o]=d:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(d)))}return i}return s(a.documentElement)}function Sr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function bt(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),i={url:e,...s};for(let y of bt.interceptors.request)i=y(i)??i;let n=i.url;delete i.url;let o=Sr(n,r);if(a==="memory"&&r==="GET"&&mt.has(o))return mt.get(o);let d=await fetch(n,i),m=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let u;m.includes("application/xml")||m.includes("text/xml")?u=$r(await d.text()):m.includes("application/json")?u=await d.json():u=await d.text();for(let y of bt.interceptors.response)u=y(d,u)??u;return a==="memory"&&r==="GET"&&mt.set(o,u),u}var mt,Pa=v(()=>{mt=new Map;bt.interceptors={request:[],response:[]}});function gt(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=j(a);return T(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var ja=v(()=>{K()});function xr(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var ho,Ha=v(()=>{ho=xr()});var _o,kr,Ba=v(()=>{K();_o=j("en"),kr=new Map;kr.set("en",{})});var I=v(()=>{K();ut();Aa();Ee();qa();Ma();Na();Pa();ja();Ha();Ba()});function Fa(e){Ce=e}function Tr(){return Ce}function Ra(e){ft=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let i=e.startsWith("http")?e:Ia.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};Ce&&(n.headers.Authorization=`Bearer ${Ce}`),a!==void 0&&(n.body=JSON.stringify(a)),r&&(n.signal=r);let o=await fetch(i,n);if(o.status===401)throw ft&&ft(),new pe("Unauthorized",401,null);let d=null,m=o.headers.get("content-type")||"";try{if(m.includes("application/json"))d=await o.json();else{let u=await o.text();d=u?{message:u}:null}}catch{}if(!o.ok){let u=d&&d.message||`HTTP ${o.status}`;throw new pe(u,o.status,d)}return d}var Ia,Ce,ft,pe,c,w=v(()=>{Ia=window.JMJOB_CONFIG||{apiBase:"/api"},Ce=null,ft=null;pe=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>p("/admin/subcategories"),adminCreateSubcategory:e=>p("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>p(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>p(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),notices:()=>p("/notices"),adminUpdateNotices:e=>p("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=Ia.apiBase+"/admin/notices/upload",a={},s=Tr();s&&(a.Authorization=`Bearer ${s}`);let r=await fetch(t,{method:"POST",headers:a,body:e}),i=await r.json();if(!r.ok)throw new pe(i.message||"Upload failed",r.status,i);return i},adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminJobSubmissions:e=>p(`/admin/jobs/${e}/submissions`),adminApproveJob:(e,t={})=>p(`/admin/jobs/${e}/approve`,{method:"POST",body:t}),adminDeclineJob:(e,t={})=>p(`/admin/jobs/${e}/decline`,{method:"POST",body:t}),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function l(e,t="info",a=3500){ue.set({message:e,type:t,id:Date.now()}),vt&&clearTimeout(vt),vt=setTimeout(()=>ue.set(null),a)}async function M(){if(!J.get())return null;try{let e=await c.me();return g.set(e.data),e.data}catch{return null}}async function Da(e,t){let a=await c.login({email:e,password:t});return J.set(a.data.token),g.set(a.data.user),a.data.user}async function Ua(e){return c.requestRegistrationOtp(e)}async function Oa(e){let t=await c.verifyRegistrationOtp(e);return J.set(t.data.token),g.set(t.data.user),t.data.user}async function Ae(){try{await c.logout()}catch{}J.set(null),g.set(null),L.set("/login")}function f(e){window.location.hash=e}var Lr,Er,J,g,ue,vt,L,A,h=v(()=>{I();I();w();Lr="earnap_token",Er="earnap_user",J=gt(Lr,null),g=gt(Er,null),ue=j(null),vt=null;L=j(window.location.hash.replace(/^#/,"")||"/"),A=dt(()=>!!J.get()&&!!g.get());T(()=>{let e=J.get();Fa(e)});Ra(()=>{J.set(null),g.set(null),L.set("/login"),l("Session expired. Please log in.","error")})});var Wa={};_(Wa,{HomePage:()=>Me});function Me(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Cr(e),e.appendChild(Ar(t)),e.appendChild(qr()),e.appendChild(Mr(t))}}function se(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Cr(e){qe&&(clearInterval(qe),qe=null);try{let t=await c.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(y=>{if(typeof y=="string"){let C=y.trim();return C.startsWith("/")||C.startsWith("http")?{image:C,text:""}:{image:"",text:C}}return{image:y.image||"",text:y.text||""}}).filter(y=>y.image&&y.image.trim()||y.text&&y.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let r=se("div","welcome-popup welcome-popup--banner","");r.innerHTML=`
            <div id="notice-banner-content" class="welcome-popup__content"></div>
        `,e.firstChild?e.insertBefore(r,e.firstChild):e.appendChild(r);let i=r.querySelector("#notice-banner-content"),n=typeof t.interval=="number"&&t.interval>0?t.interval:4,o=t.direction||"right_to_left",d={right_to_left:{exit:"banner-vanish-left",enter:"banner-enter-right"},left_to_right:{exit:"banner-vanish-right",enter:"banner-enter-left"},top_to_bottom:{exit:"banner-vanish-bottom",enter:"banner-enter-top"},bottom_to_top:{exit:"banner-vanish-top",enter:"banner-enter-bottom"},fade:{exit:"banner-vanish-fade",enter:"banner-enter-fade"}},m=d[o]||d.right_to_left,u=0;Ja(i,s[0]),s.length>1&&(qe=setInterval(()=>{let y;do y=Math.floor(Math.random()*s.length);while(y===u&&s.length>1);u=y,i.className=`welcome-popup__content ${m.exit}`,setTimeout(()=>{Ja(i,s[u]),i.className=`welcome-popup__content ${m.enter}`,setTimeout(()=>{i.className="welcome-popup__content"},350)},350)},n*1e3))}catch{}}function Ja(e,t){e.innerHTML="";let a=!!(t&&t.text&&t.text.trim());if(!!(t&&t.image&&t.image.trim())){let r=document.createElement("img");r.className="welcome-popup__image",r.src=t.image,r.alt=t.text||"Banner Notice",r.onerror=()=>{r.style.display="none"},e.appendChild(r)}if(a){let r=document.createElement("div");r.className="welcome-popup__text-wrap",r.innerHTML=`<strong>JM Job:</strong> <span>${Nr(t.text)}</span>`,e.appendChild(r)}}function Ar(e){let t=se("div","card card--user-header"),a=se("div","user-header__stats");return a.innerHTML=`
    ...
    `;let i=se("button","btn btn--primary btn--xl","\u{1F381} Claim Daily Bonus");return i.addEventListener("click",async()=>{try{let n=await fetch("/api/user/claim-daily-bonus",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json",Authorization:"Bearer "+(window.JMJOB_TOKEN||"")}}).then(o=>o.json());n.success?(l(n.message||"Daily bonus claimed!","success"),await M(),Me()()):l(n.message||"Bonus not available.","info")}catch{l("Could not claim. Try again later.","error")}}),t.appendChild(i),t}function Nr(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}var qe,ht=v(()=>{h();w();qe=null});var yt={};_(yt,{WebTaskPage:()=>me});function me(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--webtask",e.innerHTML='<h2 class="page-title">Web Task Center</h2><div class="task-list" id="task-list">Loading\u2026</div>';let t=e.querySelector("#task-list");try{let s=(await c.webTasks()).data||[];if(s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}t.innerHTML="",s.forEach(r=>t.appendChild(Pr(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function Pr(e){let t=document.createElement("div");t.className="card card--task",t.innerHTML=`
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),r=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let i=s.querySelector("#cd-num"),n=setInterval(async()=>{a--,i.textContent=a,r.textContent=`Reward in ${a}s\u2026`,a<=0&&(clearInterval(n),await Ir(e,"simulated",t))},1e3)},300)}async function Ir(e,t,a){try{let s=await c.reward({provider:t,started_at:a});l(`+$${parseFloat(s.data.reward).toFixed(4)} credited!`,"success"),await M(),e.remove(),Pe()()}catch(s){l(s.message||"Reward failed","error"),e.remove()}}var wt=v(()=>{w();h()});var Xa={};_(Xa,{ReferPage:()=>_t});function _t(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--refer";let t=g.get(),a=null;try{a=(await c.referrals()).data}catch{l("Failed to load referrals","error")}let s=a?a.referral_link:t?`${window.location.origin}/?ref=${t.referral_code}`:"";e.innerHTML=`
        ...
        `;let r=e.querySelector("#copy-btn"),i=e.querySelector("#refer-link-input");r.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(i.value),l("Link copied to clipboard!","success")}catch{i.select(),document.execCommand("copy"),l("Link copied!","success")}});let n=e.querySelector("#share-tg");n.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let m=document.createElement("div");m.className="refer-item",m.innerHTML=`
                ...
                `,o.appendChild(m)})}}function Va(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var $t=v(()=>{w();h()});var Ya={};_(Ya,{WithdrawPage:()=>je});function je(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#withdraw-form");a.addEventListener("submit",async r=>{r.preventDefault();let i=new FormData(a),n=a.querySelector("button");n.disabled=!0,n.textContent="Submitting\u2026";try{let o=await c.withdraw({amount:parseFloat(i.get("amount")),wallet_address:String(i.get("wallet_address")),gateway:String(i.get("gateway"))});l("Withdrawal requested!","success"),await M(),je()()}catch(o){let d=o.payload&&o.payload.errors;if(d){let m=Object.values(d)[0];l(Array.isArray(m)?m[0]:m,"error")}else l(o.message||"Withdrawal failed","error");n.disabled=!1,n.textContent="Confirm Withdrawal"}});let s=e.querySelector("#withdraw-history");try{let i=(await c.withdrawals()).data||[];i.length===0?s.innerHTML='<p class="muted">No withdrawals yet.</p>':(s.innerHTML="",i.forEach(n=>s.appendChild(Fr(n))))}catch{s.innerHTML='<p class="muted">Failed to load history.</p>'}}}function Fr(e){let t=document.createElement("div");t.className="withdraw-row withdraw-row--"+e.status;let a=(e.status||"pending").toUpperCase(),s=e.admin_note?`<div class="withdraw-row__note">"${St(e.admin_note)}"</div>`:"";return t.innerHTML=`
    ...
    `,t}function St(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var xt=v(()=>{w();h()});var Qa={};_(Qa,{DepositPage:()=>kt});function kt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=g.get();e.innerHTML=`
        ...
        `;try{x.loading=!0;let[s,r]=await Promise.all([c.paymentGateways(),c.paymentSubmissions()]);x.gateways=s.data.gateways,x.minAmount=s.data.min_amount,x.maxAmount=s.data.max_amount,x.submissions=r.data,Za(),Ka()}catch(s){l("Failed to load deposit info: "+s.message,"error")}finally{x.loading=!1}let a=document.getElementById("deposit-form");a&&a.addEventListener("submit",async s=>{if(s.preventDefault(),!x.selectedGateway){l("Please select a payment method.","error");return}let r=new FormData(a),i=document.getElementById("deposit-submit-btn");i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i> Submitting\u2026';try{let n=await c.paymentSubmit({gateway:x.selectedGateway,sender_number:String(r.get("sender_number")||"").trim(),amount:parseFloat(r.get("amount")),trxid:String(r.get("trxid")||"").trim().toUpperCase()});l(n.message||"Payment submitted.","success"),a.reset();let o=await c.paymentSubmissions();x.submissions=o.data,Ka(),await M();let d=g.get(),m=document.getElementById("deposit-balance");m&&d&&(m.textContent="\u09F3"+parseFloat(d.role==="poster"?d.wallet_balance||0:d.balance||0).toFixed(2))}catch(n){l(n.message||"Failed to submit payment.","error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-send"></i> Submit Payment'}})}}function Za(){let e=document.getElementById("payment-gateways");if(e){if(x.gateways.length===0){e.innerHTML='<p class="muted">No payment methods available right now.</p>';return}e.innerHTML=x.gateways.map(t=>`
        <button class="payment-gateway ${x.selectedGateway===t.key?"is-selected":""}" data-gateway="${t.key}">
            ...
            ${x.selectedGateway===t.key?'<i class="bi bi-check-circle-fill payment-gateway__check"></i>':""}
        </button>
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{x.selectedGateway=t.getAttribute("data-gateway"),Za(),Dr()})})}}function Dr(){let e=x.gateways.find(i=>i.key===x.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `,document.getElementById("copy-wallet-btn")?.addEventListener("click",()=>{navigator.clipboard.writeText(e.wallet_number).then(()=>{l("Wallet number copied.","info")}).catch(()=>{l("Could not copy. Please copy manually.","error")})}));let r=document.getElementById("deposit-amount");r&&(r.min=x.minAmount,r.max=x.maxAmount,r.placeholder=`${x.minAmount} \u2013 ${x.maxAmount}`)}function Ka(){let e=document.getElementById("payment-history");if(e){if(x.submissions.length===0){e.innerHTML='<p class="muted">No submissions yet.</p>';return}e.innerHTML=x.submissions.map(t=>{let a=Rr[t.status]||{label:t.status,class:""};return`
            <div class="payment-row ${a.class}">
                ...
                <div class="payment-row__date">${Ur(t.created_at)}</div>
            </div>
        `}).join("")}}function Ur(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ie(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Rr,x,Tt=v(()=>{w();h();Rr={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},x={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var Et={};_(Et,{ProfilePage:()=>He});function He(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=g.get();e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var qt=v(()=>{h()});function Or(){let e=localStorage.getItem(ss);return e==="dark"||e==="light"?e:"system"}function Jr(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function Mt(e){let t=Jr(e);document.documentElement.setAttribute("data-theme",t)}function rs(){let e=F.get();F.set(e==="dark"?"light":"dark")}function is(e){F.set(e)}function Wr(){let e=localStorage.getItem(ns);return e&&Nt.includes(e)?e:"default"}function os(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function ls(e){Nt.includes(e)&&be.set(e)}function ds(){return Nt}var ss,F,ns,Nt,be,Pt=v(()=>{I();ss="jmjob_theme";F=j(Or());Mt(F.get());T(()=>{let e=F.get();Mt(e),localStorage.setItem(ss,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{F.get()==="system"&&Mt("system")});ns="jmjob_color_theme",Nt=["default","emerald","amber","rose"];be=j(Wr());os(be.get());T(()=>{let e=be.get();os(e),localStorage.setItem(ns,e)})});var cs={};_(cs,{default:()=>Ue});async function Ue(){let e=document.querySelector("[data-view]");if(!e)return;let t=g.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=F.get(),s=be.get(),r=ds();e.innerHTML=`
                    ...
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${De[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${zr[o]};"></span>
    ...
    `;let i=document.getElementById("theme-mode-group");i&&i.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-mode");is(d),l(`Theme mode set to ${d}.`,"info")})});let n=document.getElementById("color-theme-group");n&&n.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-color");ls(d),l(`Accent color set to ${De[d]||d}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await Ae(),l("Logged out.","info")})}var De,zr,jt=v(()=>{h();Pt();De={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},zr={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var us={};_(us,{NotificationsPage:()=>Ht});function Ht(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `,document.getElementById("notifications-read-all")?.addEventListener("click",async()=>{try{await c.notificationsReadAll(),l("All notifications marked as read.","success"),await ps()}catch(t){l(t.message||"Could not update notifications.","error")}}),await ps())}}async function ps(){let e=document.getElementById("notifications-page-list");if(e)try{let t=await c.notifications({limit:100}),a=Array.isArray(t.data)?t.data:[];e.innerHTML=a.length?a.map(Gr).join(""):'<p class="muted notifications-page__empty">No notifications yet.</p>',e.querySelectorAll("[data-notification-id]").forEach(s=>{s.querySelector("[data-mark-read]")?.addEventListener("click",async()=>{try{await c.notificationRead(s.getAttribute("data-notification-id")),s.classList.remove("notifications-page__item--unread"),s.querySelector("[data-mark-read]").remove()}catch(r){l(r.message||"Could not mark notification as read.","error")}})})}catch(t){e.innerHTML=`<p class="muted">Failed to load notifications: ${ge(t.message||"unknown error")}</p>`}}function Gr(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?`<a class="btn btn--ghost btn--sm" href="#${ge(t.action_url)}">Open</a>`:"",i=e.read?"":'<button class="btn btn--ghost btn--sm" data-mark-read>Mark read</button>';return`<article class="notifications-page__item ${e.read?"":"notifications-page__item--unread"}" data-notification-id="${ge(e.id)}"><i class="bi ${s} notifications-page__icon notifications-page__icon--${a}"></i><div class="notifications-page__body"><h3>${ge(t.title||"Notification")}</h3><p>${ge(t.message||"")}</p><small>${Vr(e.created_at)}</small></div><div class="notifications-page__actions">${r}${i}</div></article>`}function Vr(e){if(!e)return"";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function ge(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Bt=v(()=>{w();h()});var ms={};_(ms,{TgTasksPage:()=>Je});function Je(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--tgtasks",e.innerHTML=`
        ...
        `;let t=e.querySelector("#tg-list");try{let s=(await c.tgTasks()).data||[];if(t.innerHTML="",s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}s.forEach(r=>t.appendChild(Xr(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function Xr(e){let t=document.createElement("div");if(t.className="card card--task",t.innerHTML=`
    ...
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&Yr(e,t)},3e3)})}return t}async function Yr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await M(),Je()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Oe(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var It=v(()=>{w();h()});var fs={};_(fs,{PosterDashboardPage:()=>Rt});function Rt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--poster-dashboard",!g.get()){e.innerHTML='<div class="card"><h2>Access required</h2><a class="btn btn--primary" href="#/login">Log in</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
                <div>
        ...
        `;let a=e.querySelector("#poster-new-job");a&&a.addEventListener("click",s=>{s.preventDefault(),f("/poster/post-job")}),await bs()}}async function bs(){let e=document.getElementById("poster-dashboard-content");if(e)try{let t=await c.posterStats();Zr(e,t.data||{})}catch(t){e.innerHTML=`
            <div class="card">
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",bs),l(t.message||"Failed to load poster statistics.","error")}}function Zr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=Ft(t.wallet_balance),i=Ft(t.frozen_balance),n=Ft(t.total_spent);e.innerHTML=`
    ...
    `}function ne(e,t){let a=Number(t||0);return`
        <div class="poster-status-row">
            <span><i class="bi ${Qr(e)}"></i> ${Kr[e]||e}</span>
            <strong>${a}</strong>
        </div>
    `}function Qr(e){return{open:"bi-megaphone",in_review:"bi-search",assigned:"bi-person-check",submitted:"bi-inbox",revision:"bi-arrow-repeat",completed:"bi-check-circle"}[e]||"bi-circle"}function Ft(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function gs(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Kr,Dt=v(()=>{w();h();Kr={open:"Open",in_review:"In review",assigned:"Assigned",submitted:"Awaiting review",revision:"Revision requested",completed:"Completed",cancelled:"Cancelled",expired:"Expired",disputed:"Disputed"}});var ys={};_(ys,{PostJobPage:()=>Ut});function Ut(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--post-job",!si()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}let t={currentStep:1,categories:[],mainCategoryId:"",subCategoryId:"",title:"",description:"",thumbnailBase64:"",proofRequirements:[{title:"",type:"text"}],workerCount:1,costPerWorker:10,biddingValue:3,biddingUnit:"days",deadlineAt:"",feePercentage:30};try{let a=await c.categories();t.categories=a.data||[]}catch(a){l(a.message||"Could not load categories.","error")}ye(e,t)}}function ye(e,t){e.innerHTML=`
    ...
    `,ei(e,t)}function ei(e,t){let a=e.querySelector("#wizard-card-body");a&&(t.currentStep===1?hs(a,e,t):t.currentStep===2?ve(a,e,t):t.currentStep===3&&ti(a,e,t))}function hs(e,t,a){let s=a.categories.find(o=>Number(o.id)===Number(a.mainCategoryId)),r=s?s.subcategories||[]:[];e.innerHTML=`
    ...
    `;let i=e.querySelector("#main-category-select"),n=e.querySelector("#sub-category-select");i.addEventListener("change",o=>{a.mainCategoryId=o.target.value,a.subCategoryId="",hs(e,t,a)}),n.addEventListener("change",o=>{a.subCategoryId=o.target.value}),e.querySelector("#step-cancel").addEventListener("click",Ot),e.querySelector("#step-1-form").addEventListener("submit",o=>{if(o.preventDefault(),!a.mainCategoryId){l("Please select a main category.","error");return}let d=a.categories.find(u=>Number(u.id)===Number(a.mainCategoryId)),m=d?Number(d.min_cost||1):1;if(a.subCategoryId&&d&&d.subcategories){let u=d.subcategories.find(y=>Number(y.id)===Number(a.subCategoryId));u&&u.min_cost&&(m=Number(u.min_cost))}a.minCost=m,a.costPerWorker<a.minCost&&(a.costPerWorker=a.minCost),a.currentStep=2,ye(t,a)})}function ve(e,t,a){e.innerHTML=`
                ...
                <div id="proof-pairs-container">
                    ${a.proofRequirements.map((i,n)=>`
                        <div class="proof-pair-row" style="display:flex; gap:0.5rem; align-items:center; margin-bottom:0.5rem;" data-index="${n}">
                            ...
                            `:`
                                <input type="text" class="proof-title-input" placeholder="Proof Requirement Title (e.g. Provide Username)" value="${he(i.title||"")}" style="flex:2;" required>
                            `}
    ...
    `;let s=e.querySelector("#proof-pairs-container");s.addEventListener("change",i=>{if(i.target.classList.contains("proof-type-select"))fe(e,a),ve(e,t,a);else if(i.target.classList.contains("proof-file-input")){let n=i.target.closest(".proof-pair-row"),o=Number(n.getAttribute("data-index")),d=i.target.files[0];if(d){let m=new FileReader;m.onload=u=>{a.proofRequirements[o].fileBase64=u.target.result,a.proofRequirements[o].title=d.name,ve(e,t,a)},m.readAsDataURL(d)}}}),e.querySelector("#add-proof-btn").addEventListener("click",()=>{fe(e,a),a.proofRequirements.push({title:"",type:"text"}),ve(e,t,a)}),s.addEventListener("click",i=>{let n=i.target.closest(".remove-proof-btn");if(n){let o=Number(n.getAttribute("data-index"));fe(e,a),a.proofRequirements.splice(o,1),ve(e,t,a)}}),e.querySelector("#job-thumbnail-input").addEventListener("change",i=>{let n=i.target.files[0];if(n){let o=new FileReader;o.onload=d=>{a.thumbnailBase64=d.target.result},o.readAsDataURL(n)}}),e.querySelector("#step-cancel").addEventListener("click",Ot),e.querySelector("#step-2-back").addEventListener("click",()=>{fe(e,a),a.currentStep=1,ye(t,a)}),e.querySelector("#step-2-form").addEventListener("submit",i=>{if(i.preventDefault(),fe(e,a),!a.title.trim()){l("Job title is required.","error");return}if(!a.description.trim()){l("Task instructions are required.","error");return}a.currentStep=3,ye(t,a)})}function fe(e,t){t.title=e.querySelector("#job-title-input")?.value||"",t.description=e.querySelector("#job-desc-input")?.value||"";let a=e.querySelectorAll(".proof-pair-row");t.proofRequirements=Array.from(a).map((s,r)=>{let i=s.querySelector(".proof-type-select")?.value||"text",n=s.querySelector(".proof-title-input"),o=n?n.value:t.proofRequirements[r]?.title||"Screenshot Proof",d=t.proofRequirements[r]?.fileBase64||null;return{title:o,type:i,fileBase64:d}})}function ti(e,t,a){let s=Number(a.workerCount||0)*Number(a.costPerWorker||0),r=s*(a.feePercentage/100),i=s+r;e.innerHTML=`
    ...
    `;let n=e.querySelector("#worker-count-input"),o=e.querySelector("#cost-per-worker-input"),d=()=>{a.workerCount=Math.max(1,parseInt(n.value,10)||1),a.costPerWorker=Math.max(0,parseFloat(o.value)||0);let m=a.workerCount*a.costPerWorker,u=m*(a.feePercentage/100),y=m+u;e.querySelector("#summary-subtotal").textContent=`\u09F3${m.toFixed(2)}`,e.querySelector("#summary-fee").textContent=`\u09F3${u.toFixed(2)}`,e.querySelector("#summary-total").textContent=`\u09F3${y.toFixed(2)}`};n.addEventListener("input",d),o.addEventListener("input",d),e.querySelector("#step-cancel").addEventListener("click",Ot),e.querySelector("#step-3-back").addEventListener("click",()=>{vs(e,a),a.currentStep=2,ye(t,a)}),e.querySelector("#step-3-form").addEventListener("submit",async m=>{m.preventDefault(),vs(e,a);let u=e.querySelector("#post-job-publish");u.disabled=!0,u.textContent="Publishing\u2026";let y=0,C=Number(a.biddingValue||0);C>0&&(a.biddingUnit==="minutes"?y=C/60:a.biddingUnit==="hours"?y=C:a.biddingUnit==="days"?y=C*24:a.biddingUnit==="months"&&(y=C*24*30));try{let $=await c.posterCreateJob({category_id:Number(a.mainCategoryId),subcategory_id:a.subCategoryId?Number(a.subCategoryId):null,title:a.title.trim(),description:a.description.trim(),thumbnail:a.thumbnailBase64||null,proof_requirements:a.proofRequirements,worker_count:Number(a.workerCount),cost_per_worker:Number(a.costPerWorker),budget:Number(a.workerCount)*Number(a.costPerWorker),deadline_at:ai(a.deadlineAt),bidding_window_hours:y});l("Job submitted for admin review.","success");let k=g.get(),ae=k&&(k.username||k.name)||"User",U=$?.data?.id||"",Se=`${window.location.origin}/#/poster/jobs/${U}`,Ta=`I, the user ${ae}, has submitted this job ${Se} for publishing. Let's talk about payment and approval`,xe=`https://wa.me/8801775722083?text=${encodeURIComponent(Ta)}`,La=t.querySelector("#wizard-card-body");La&&(La.innerHTML=`
                ...
                `)}catch($){l($.message||"Could not publish job.","error"),u.disabled=!1,u.textContent="Publish Job"}})}function vs(e,t){t.workerCount=Number(e.querySelector("#worker-count-input")?.value||1),t.costPerWorker=Number(e.querySelector("#cost-per-worker-input")?.value||0),t.biddingValue=Number(e.querySelector("#bidding-val-input")?.value||0),t.biddingUnit=e.querySelector("#bidding-unit-input")?.value||"days",t.deadlineAt=e.querySelector("#deadline-input")?.value||""}function Ot(){confirm("Are you sure you want to cancel posting this job?")&&f("/poster")}function ai(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function si(){return!!g.get()}function he(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Jt=v(()=>{w();h()});var _s={};_(_s,{PosterJobsPage:()=>Wt});function Wt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--poster-jobs",!oi()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
            ...
            <div class="poster-filter-bar" style="margin-bottom: 16px;">
                <label>Filter Status
                    <select class="admin-select" id="poster-job-filter">
                        ${ri.map(t=>`<option value="${t}" ${t===Ge?"selected":""}>${t?ws(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        <div class="admin-job-row__meta">
            ...
            <span><strong>Created:</strong> ${li(e.created_at)}</span>
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>f(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>ni(e.id)),t}async function ni(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await c.posterCancelJob(e,{reason:t}),l("Job cancelled.","success"),await ze()}catch(a){l(a.message||"Could not cancel job.","error")}}function oi(){return!!g.get()}function ws(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function li(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function W(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ri,Ge,zt=v(()=>{w();h();ri=["","pending_approval","open","assigned","submitted","revision","completed","declined","cancelled","disputed"],Ge=""});var $s={};_($s,{PosterWalletPage:()=>Vt});function Vt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-wallet";let t=g.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([c.posterStats(),c.paymentSubmissions()]);di(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${Ve(a.message||"unknown error")}</p>`}}}function di(e,t,a){let s=Gt(t.wallet_balance),r=Gt(t.frozen_balance),i=Gt(t.total_spent);e.innerHTML=`
    ...
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>f("/deposit"))}function ci(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${Ve((t.gateway||"").toUpperCase())}</strong><small>${Ve(t.trxid)} \xB7 ${pi(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${Ve(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function Gt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function pi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Ve(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Xt=v(()=>{w();h()});var ks={};_(ks,{AdminPage:()=>Kt});function Kt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),r.classList.add("admin-tab--active"),Ss(r.dataset.tab,s)})}),Ss("stats",s)}}async function Ss(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),r=a.data||{},i=s.data||{},n=i.currency_symbol||"\u09F3";t.innerHTML=`
            ...
            `;let r=t.querySelector("#wd-list");s.forEach(i=>r.appendChild(xs(i,r))),t.querySelector("#wd-filter").addEventListener("change",async i=>{let n=await c.adminWithdrawals(i.target.value);r.innerHTML="",(n.data||[]).forEach(o=>r.appendChild(xs(o,r)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list"),i=Number(g.get()?.id||0);s.forEach(n=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                ...
                `;let d=o.querySelector(".admin-user-role");d?.addEventListener("change",async()=>{let m=n.role||(n.is_admin?"admin":"worker");try{let u=await c.adminUpdateUserRole(n.id,d.value);n.role=u.data?.role||d.value,n.is_admin=!!u.data?.is_admin,o.querySelector(".user-role-badge").textContent=n.role.toUpperCase(),l("User role updated","success")}catch(u){d.value=m,l(u.message||"Role update failed","error")}}),r.appendChild(o)})}else if(e==="providers"){let s=(await c.adminProviders()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list");s.forEach(i=>r.appendChild(ui(i,r)))}}catch{t.innerHTML='<p class="muted">Failed to load.</p>'}}function Z(e,t,a){return`
    ...
    `,a.querySelector(".provider-save").addEventListener("click",async()=>{let i={block_id:a.querySelector(".provider-block-id").value.trim()||null,weight:parseInt(a.querySelector(".provider-weight").value,10)||0,reward_per_view:parseFloat(a.querySelector(".provider-reward").value)||0,min_duration_seconds:parseInt(a.querySelector(".provider-duration").value,10)||12,enabled:a.querySelector(".provider-enabled").checked};try{await c.adminUpdateProvider(e.id,i),l("Provider saved","success")}catch(n){l(n.message,"error")}}),a}function q(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Zt=v(()=>{w();h();h()});var Es={};_(Es,{AdminPaymentsPage:()=>ea});function ea(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{z.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),Qt()})}),await Qt()}}async function Qt(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(z.status);z.items=t.data||[],bi(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${re(t.message||"Failed to load.")}</p>`}}}function bi(e){if(z.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",z.items.forEach(t=>e.appendChild(gi(t)))}function gi(e){let t=mi[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,e.status==="pending"&&(a.querySelector('[data-action="approve"]')?.addEventListener("click",()=>Ts(e.id,"approve",a)),a.querySelector('[data-action="reject"]')?.addEventListener("click",()=>Ts(e.id,"reject",a))),a}async function Ts(e,t,a){let s=prompt(t==="approve"?"Optional note for approval:":"Reason for rejection:");if(s!==null)try{let i=await(t==="approve"?c.adminApprovePayment:c.adminRejectPayment)(e,{note:s||null});l(i.message||"Done.","success"),await Qt()}catch(r){l(r.message||"Action failed.","error")}}function Ls(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function re(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var mi,z,ta=v(()=>{w();h();mi={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},z={status:"pending",items:[],loading:!1}});var Xe={};_(Xe,{AdminJobsPage:()=>aa});function aa(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--admin-jobs",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}let t=window.location.hash.replace(/^#/,"").split("?")[0];t==="/admin/pending-jobs"?B="pending_approval":t==="/admin/active-jobs"&&(B="open"),e.innerHTML=`
            ...
            <div class="admin-toolbar" style="margin-bottom: 16px;">
                <label>Filter Status
                    <select class="admin-select" id="admin-job-status">
                        ${fi.map(s=>`<option value="${s.value}" ${s.value===B?"selected":""}>${s.label}</option>`).join("")}
                    </select>
                </label>
        ...
        `;let a=e.querySelectorAll(".admin-tab");a.forEach(s=>{s.addEventListener("click",async()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),s.classList.add("admin-tab--active"),B=s.dataset.status;let r=e.querySelector("#admin-job-status");r&&(r.value=B),await ee()})}),e.querySelector("#admin-job-status").addEventListener("change",async s=>{B=s.target.value,a.forEach(r=>r.classList.toggle("admin-tab--active",r.dataset.status===B)),await ee()}),e.querySelector("#admin-job-refresh").addEventListener("click",ee),await ee()}}async function ee(){let e=document.getElementById("admin-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=B==="all"?"":B,s=(await c.adminJobs(t)).data||[];e.innerHTML=s.length?"":'<p class="muted card" style="padding:20px; text-align:center;">No jobs found for this section.</p>',s.forEach(r=>e.appendChild(vi(r)))}catch(t){e.innerHTML=`<p class="muted card" style="padding:20px;">Failed to load jobs: ${S(t.message||"unknown error")}</p>`}}}function vi(e){let t=document.createElement("article");t.className=`admin-row admin-job-row admin-job-row--${S(e.status)}`;let a=e.status==="pending_approval",s=e.status==="declined",r="";!a&&!s&&(r=`
            <div class="admin-job-row__metrics" style="display: flex; gap: 16px; margin: 10px 0; background: rgba(0,0,0,0.03); padding: 10px 14px; border-radius: 6px; font-size: 13px;">
                <div><i class="bi bi-clock-history"></i> <strong>Days Remaining:</strong> <span style="color:#d97706;">${S(e.days_remaining||"N/A")}</span></div>
                <div><i class="bi bi-people"></i> <strong>Active Workers:</strong> ${Number(e.active_workers_count||0)} / ${Number(e.worker_count||1)} working</div>
                <div><i class="bi bi-check2-square"></i> <strong>Tasks Remaining:</strong> ${Number(e.remaining_tasks_count||0)} slots left</div>
            </div>
        `),t.innerHTML=`
        <div class="admin-job-row__header">
            <div>
                ...
                <span class="badge badge--${a?"warning":s?"danger":"success"}">${S(String(e.status||"").replace("_"," ").toUpperCase())}</span>
            </div>
            <strong class="admin-row__amount">${S(e.currency||"BDT")} ${Number(e.total_payable_amount||e.budget||0).toFixed(2)}</strong>
        </div>

        <p class="admin-job-row__description muted">${S(e.description||"")}</p>

        ${r}

        <div class="admin-job-row__meta">
            <span><strong>Poster:</strong> ${S(e.poster?.name||"(deleted)")} (${S(e.poster?.email||"")})</span>
            <span><strong>Category:</strong> ${S(e.category_name||"Uncategorized")}</span>
            <span><strong>Workers Needed:</strong> ${Number(e.worker_count||1)}</span>
            <span><strong>Cost/Worker:</strong> ${S(e.currency||"BDT")} ${Number(e.cost_per_worker||0).toFixed(2)}</span>
            ${e.decline_reason?`<span style="color:#dc2626;"><strong>Decline Reason:</strong> ${S(e.decline_reason)}</span>`:""}
        </div>

        <div class="admin-job-row__footer">
            <span class="muted">Submitted: ${As(e.created_at)}</span>
            <div class="admin-row__actions"></div>
        </div>
    `;let i=t.querySelector(".admin-row__actions");return!a&&!s&&i.appendChild(oe("View Proofs & Screenshots","btn--ghost",()=>hi(e.id,e.title))),a?(i.appendChild(oe("Activate Job","btn--success",()=>yi(e.id))),i.appendChild(oe("Decline","btn--danger",()=>wi(e.id)))):e.status==="disputed"?(i.appendChild(oe("Release Payment","btn--success",()=>Cs(e.id,"release"))),i.appendChild(oe("Cancel & Refund","btn--danger",()=>Cs(e.id,"cancel")))):["completed","cancelled","declined"].includes(e.status)||i.appendChild(oe("Mark Disputed","btn--danger",()=>_i(e.id))),t}function oe(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function hi(e,t){let a=document.getElementById("admin-proof-modal-container");if(!a)return;a.innerHTML=`
        <div class="modal-backdrop" style="position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,0.6); display:flex; align-items:center; justify-content:center; z-index:99999;">
            <div class="modal-card" style="background:#fff; width:90%; max-width:800px; max-height:85vh; border-radius:12px; padding:24px; overflow-y:auto; box-shadow:0 10px 30px rgba(0,0,0,0.2);">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
                    <h2 style="margin:0; font-size:18px;"><i class="bi bi-file-earmark-check"></i> Proof Submissions for "${S(t)}"</h2>
    ...
    `,a.querySelector("#close-proof-modal").addEventListener("click",()=>{a.innerHTML=""});let r=a.querySelector("#proof-modal-content");try{let o=((await c.adminJobSubmissions(e)).data||{}).submissions||[];if(!o.length){r.innerHTML='<p class="muted" style="text-align:center; padding:30px;">No worker submissions or proof screenshots submitted yet for this job.</p>';return}r.innerHTML=o.map(d=>{let m=d.work_proof_data||{},u=d.attachment_path?d.attachment_path.startsWith("http")?d.attachment_path:`/storage/${d.attachment_path}`:null,y=u&&/\.(jpg|jpeg|png|gif|webp)$/i.test(u);return`
                <div class="card" style="margin-bottom:16px; padding:16px; border:1px solid #e2e8f0; border-radius:8px; background:#f9fafb;">
                    <div style="display:flex; justify-content:space-between; margin-bottom:8px;">
                        <div>
                            <strong><i class="bi bi-person"></i> ${S(d.worker_name)}</strong>
                            <span class="muted">(${S(d.worker_email||d.worker_username||"")})</span>
                        </div>
                        <span class="badge badge--${d.status==="approved"?"success":"warning"}">${S(d.status.toUpperCase())}</span>
                    </div>

                    ${d.description?`<p style="margin:8px 0; font-size:14px; background:#fff; padding:10px; border-radius:6px; border:1px solid #edf2f7;"><strong>Proof Description:</strong><br>${S(d.description)}</p>`:""}

                    ${d.external_link?`<div style="margin:8px 0;"><a href="${S(d.external_link)}" target="_blank" class="btn btn--ghost btn--sm"><i class="bi bi-box-arrow-up-right"></i> Open External Proof Link</a></div>`:""}

                    ${u?`
                        <div style="margin:10px 0;">
                            <strong>Proof Screenshot / Attachment:</strong><br>
                            ${y?`<a href="${S(u)}" target="_blank"><img src="${S(u)}" alt="Proof screenshot" style="max-width:100%; max-height:300px; border-radius:6px; border:1px solid #cbd5e1; margin-top:6px; object-fit:contain;"></a>`:`<a href="${S(u)}" target="_blank" class="btn btn--ghost btn--sm"><i class="bi bi-download"></i> Download Attachment</a>`}
                        </div>
                    `:""}

                    ${d.trx_id?`<div style="font-size:12px; color:#475569; margin-top:6px;"><strong>TrxID:</strong> ${S(d.trx_id)} | <strong>bKash:</strong> ${S(d.bkash_number||"N/A")}</div>`:""}

                    <div style="font-size:12px; color:#64748b; margin-top:8px;">Submitted on: ${As(d.created_at)}</div>
                </div>
            `}).join("")}catch(i){r.innerHTML=`<p class="muted">Failed to load submissions: ${S(i.message||"unknown error")}</p>`}}async function yi(e){if(confirm("Approve and activate this job post?"))try{await c.adminApproveJob(e),l("Job approved and activated!","success"),await ee()}catch(t){l(t.message||"Could not approve job.","error")}}async function wi(e){let t=prompt("Reason for declining this job post:");if(t!==null)try{await c.adminDeclineJob(e,{reason:t}),l("Job declined.","info"),await ee()}catch(a){l(a.message||"Could not decline job.","error")}}async function _i(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await ee()}catch(t){l(t.message||"Could not flag job.","error")}}async function Cs(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ee()}catch(r){l(r.message||"Could not resolve dispute.","error")}}function As(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function S(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var fi,B,we=v(()=>{w();h();fi=[{value:"pending_approval",label:"Job Post (Pending Approval)"},{value:"open",label:"Active Job"},{value:"all",label:"All Jobs"},{value:"in_review",label:"In Review"},{value:"assigned",label:"Assigned"},{value:"submitted",label:"Submitted"},{value:"revision",label:"Revision"},{value:"disputed",label:"Disputed"},{value:"completed",label:"Completed"},{value:"declined",label:"Declined"},{value:"cancelled",label:"Cancelled"},{value:"expired",label:"Expired"}],B="pending_approval"});var qs={};_(qs,{AdminTransactionsPage:()=>ia});function ia(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Type
                    <select class="admin-select" id="admin-transaction-type">
                        ${$i.map(t=>`<option value="${t}" ${t===ra?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All transactions"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{ra=t.target.value,await sa()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",sa),await sa()}}}async function sa(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminTransactions({type:ra})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(Si(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${G(t.message||"unknown error")}</p>`}}}function Si(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${G(e.type)}`,t.innerHTML=`
        ...
        <div class="admin-transaction-row__meta">
            ...
            <span><strong>Date:</strong> ${xi(e.created_at)}</span>
        </div>
    ...
    `,t}function xi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function G(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var $i,ra,na=v(()=>{w();h();$i=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],ra=""});var Ms={};_(Ms,{AdminReportsPage:()=>oa});function oa(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await ki()}}}async function ki(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            ...
            <div class="admin-report-grid">
                ...
                <div class="card">
                    ...
                    <div class="admin-report-list">${Li(a.jobs||[])}</div>
                </div>
            </div>
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${_e(t.message||"unknown error")}</p>`}}function Ye(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${_e(e)}</span><strong>${_e(t)}</strong></div>`}function Ti(e){return e.length?e.map(t=>`
    ...
    `).join(""):'<p class="muted">No transactions yet.</p>'}function Li(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${_e(String(t.status||"").replace("_"," "))}</strong><small>${Ke(t.job_count)} jobs</small></span>
            <strong>${Ze(t.budget)}</strong>
        </div>
    `).join(""):'<p class="muted">No jobs yet.</p>'}function Ke(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Ze(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function _e(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var la=v(()=>{w();h()});var Ns={};_(Ns,{LoginPage:()=>da});function da(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
            <h1 class="auth-card__title">\u{1F4B0} JMJob</h1>
            <p class="auth-card__sub">Log in to your account</p>
            ${t?`<p class="auth-card__referral">Referred by <strong>${Ei(t)}</strong></p>`:""}
    ...
    `;let t=document.getElementById("forgot-form"),a=document.getElementById("submit-btn");t.addEventListener("submit",async s=>{s.preventDefault();let r=t.email.value.trim();if(!r){l("Please enter your email address.","error");return}a.disabled=!0,a.textContent="Sending...";try{await c.forgotPassword({email:r}),l("If an account exists with this email, you will receive a reset code.","success"),f(`/reset-password?email=${encodeURIComponent(r)}`)}catch(i){l(i.message||"Failed to send reset code.","error"),a.disabled=!1,a.textContent="Send Reset Code"}})}var ba=v(()=>{w();h()});var Bs={};_(Bs,{default:()=>et});async function et(){let e=document.querySelector("[data-view]");if(!e)return;let a=(new URLSearchParams(window.location.hash.split("?")[1]).get("email")||"").trim().toLowerCase();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--auth",e.innerHTML=`
        <div class="auth-card">
            ...
            <form class="auth-form" id="reset-form">
                <label class="auth-form__label">
                    Email Address
                    <input type="email" name="email" value="${Ci(a)}" placeholder="you@example.com" required autocomplete="email">
                </label>
    ...
    `;let s=document.getElementById("reset-form"),r=document.getElementById("submit-btn");s.addEventListener("submit",async i=>{i.preventDefault();let n=s.email.value.trim(),o=s.otp.value.trim(),d=s.password.value,m=s.password_confirmation.value;if(!n||!o||!d){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(d!==m){l("Passwords do not match.","error");return}if(d.length<6){l("Password must be at least 6 characters.","error");return}r.disabled=!0,r.textContent="Resetting...";try{await c.resetPassword({email:n,otp:o,password:d,password_confirmation:m}),l("Password reset successfully! You can now log in.","success"),f("/login")}catch(u){l(u.message||"Failed to reset password.","error"),r.disabled=!1,r.textContent="Reset Password"}})}function Ci(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ga=v(()=>{w();h()});var or={};_(or,{JobDetailPage:()=>qn});function qn(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=g.get();t.innerHTML=`
        ...
        `;try{let s=await c.job(e),{job:r,bids:i,bid_count:n,my_bid:o}=s.data;Mn(r,i,n,o,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${te(s.message||"unknown")}</p>`}}}function Mn(e,t,a,s,r){let i=document.getElementById("job-detail-content");if(!i)return;let n=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,o=n?Math.max(0,Math.floor((n-Date.now())/1e3)):null,d=o!=null?jn(o):"\u2014",m=["open","in_review"].includes(e.status),u=!!s;i.innerHTML=`
        ...
        ${Nn(e,t,s,r,m)}
    `,Pn(e,s,r)}function Nn(e,t,a,s,r){return a?`
            <div class="card">
    ...
    `:'<div class="card"><p class="muted">Please log in to place a bid.</p></div>':'<div class="card"><p class="muted">Bidding is closed for this job.</p></div>'}function Pn(e,t,a){if(t){let r=document.getElementById("withdraw-bid-btn");r&&r.addEventListener("click",async()=>{if(confirm("Withdraw your bid?"))try{await c.withdrawBid(t.id),l("Bid withdrawn.","success"),f(`/jobs/${e.id}`)}catch(i){l(i.message||"Failed to withdraw.","error")}});return}let s=document.getElementById("bid-form");s&&s.addEventListener("submit",async r=>{r.preventDefault();let i=new FormData(s),n=document.getElementById("bid-submit-btn");n.disabled=!0,n.textContent="Submitting\u2026";try{await c.placeBid(e.id,{amount:parseFloat(i.get("amount")),delivery_days:parseInt(i.get("delivery_days"),10),proposal:String(i.get("proposal")||"").trim()}),l("Bid placed!","success"),f(`/jobs/${e.id}`)}catch(o){l(o.message||"Failed to place bid.","error")}finally{n.disabled=!1,n.textContent="Submit Bid"}})}function jn(e){if(e<=0)return"expired";let t=Math.floor(e/86400),a=Math.floor(e%86400/3600);if(t>0)return`${t}d ${a}h`;let s=Math.floor(e%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function te(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var lr=v(()=>{w();h()});var pr={};_(pr,{PosterJobDetailPage:()=>Hn});function Hn(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.innerHTML="",t.className="view view--poster-job-detail",!Jn()){t.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}t.innerHTML='<a href="#/poster/jobs" class="back-link"><i class="bi bi-arrow-left"></i> My jobs</a><div id="poster-job-detail-content"><div class="spinner"></div></div>',await dr(e)}}}async function dr(e){let t=document.getElementById("poster-job-detail-content");if(t)try{let s=(await c.posterJobBids(e)).data||{};Bn(t,s.job||{},s.bids||[],s.submissions||[])}catch(a){t.innerHTML=`<p class="muted">Failed to load job: ${E(a.message||"unknown error")}</p>`}}function Bn(e,t,a,s){e.innerHTML=`
        <div class="card poster-detail-card">
            <div class="poster-detail-card__header"><div><h1 class="page-title">${E(t.title)}</h1><p class="muted">${E(t.description||"")}</p></div><span class="badge badge--status badge--${E(t.status)}">${E(Wn(t.status).toUpperCase())}</span></div>
        ...
        <div class="poster-detail-grid">
            <div class="card"><div class="card__header"><div><h2 class="card__title">Bid comparison</h2><p class="muted">Choose one pending proposal to assign the job.</p></div></div><div class="poster-bid-list">${In(t,a)}</div></div>
            <div class="card"><div class="card__header"><div><h2 class="card__title">Submission review</h2><p class="muted">Approve delivery to release payment or request changes.</p></div></div><div class="poster-submission-list">${Fn(t,s)}</div></div>
        </div>
    ...
    `,e.querySelectorAll("[data-accept-bid]").forEach(r=>r.addEventListener("click",()=>Rn(t.id,r.dataset.acceptBid))),e.querySelectorAll("[data-release-submission]").forEach(r=>r.addEventListener("click",()=>Dn(t.id,r.dataset.releaseSubmission))),e.querySelectorAll("[data-revision-submission]").forEach(r=>r.addEventListener("click",()=>Un(t.id,r.dataset.revisionSubmission))),e.querySelector("#poster-detail-cancel")?.addEventListener("click",()=>On(t.id))}function In(e,t){return t.length?t.map(a=>`
        <div class="poster-bid-row poster-bid-row--${E(a.status)}"><div class="poster-bid-row__main"><strong>${E(a.worker?.name||"Worker")}</strong><span class="muted">${E(a.worker?.email||"")} \xB7 Rating ${Number(a.worker?.rating||0).toFixed(2)}</span><p>${E(a.proposal||"")}</p></div><div class="poster-bid-row__offer"><strong>\u09F3${Number(a.amount||0).toFixed(2)}</strong><span>${Number(a.delivery_days||0)} days</span><span class="badge">${E(String(a.status||"").toUpperCase())}</span>${a.status==="pending"&&["open","in_review"].includes(e.status)?`<button class="btn btn--primary btn--sm" data-accept-bid="${Number(a.id)}">Select worker</button>`:""}</div></div>
    `).join(""):'<p class="muted">No bids yet.</p>'}function Fn(e,t){return t.length?t.map(a=>`
        <div class="poster-submission-row poster-submission-row--${E(a.status)}"><div><strong>${E(a.worker?.name||"Worker")}</strong><span class="muted">Submitted ${cr(a.created_at)} \xB7 ${E(String(a.status||"").replace("_"," "))}</span><p>${E(a.description||"")}</p>${a.external_link?`<a href="${E(a.external_link)}" target="_blank" rel="noopener noreferrer">Open delivery link</a>`:""}${a.reviewer_note?`<p class="muted"><strong>Revision note:</strong> ${E(a.reviewer_note)}</p>`:""}</div>${a.status==="pending_review"&&e.status==="submitted"?`<div class="poster-submission-row__actions"><button class="btn btn--success btn--sm" data-release-submission="${Number(a.id)}">Release payment</button><button class="btn btn--ghost btn--sm" data-revision-submission="${Number(a.id)}">Request revision</button></div>`:""}</div>
    `).join(""):'<p class="muted">No work submitted yet.</p>'}async function Rn(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await c.posterAcceptBid(e,t),l("Worker selected and escrow held.","success"),await xa(e)}catch(a){l(a.message||"Could not select worker.","error")}}async function Dn(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await c.posterReleasePayment(e,{submission_id:Number(t)}),l("Payment released.","success"),await xa(e)}catch(a){l(a.message||"Could not release payment.","error")}}async function Un(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await c.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),l("Revision requested.","success"),await xa(e)}catch(s){l(s.message||"Could not request revision.","error")}}async function On(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await c.posterCancelJob(e,{reason:"Cancelled by poster"}),l("Job cancelled.","success"),f("/poster/jobs")}catch(t){l(t.message||"Could not cancel job.","error")}}async function xa(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await dr(e))}function Jn(){return!!g.get()}function Wn(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function cr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function E(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ur=v(()=>{w();h()});I();h();I();h();var tt=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ht(),Wa))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ne(),yt))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ne(),yt))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(wt(),Ga))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>($t(),Xa))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(xt(),Ya))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Tt(),Qa))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Be(),Et))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ct(),es))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(At(),ts))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(qt(),as))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(jt(),cs))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Bt(),us))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Be(),Et))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(It(),ms))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Dt(),fs))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Jt(),ys))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(zt(),_s))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Xt(),$s))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Zt(),ks))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ta(),Es))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(we(),Xe))},{path:"/admin/pending-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(we(),Xe))},{path:"/admin/active-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(we(),Xe))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(na(),qs))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(la(),Ms))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ca(),Ns))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ma(),js))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ba(),Hs))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ga(),Bs))}],Xl=T(()=>{let e=L.get().split("?")[0]||"/";return tt.find(t=>t.path===e)||tt[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";L.set(e)});I();h();I();var Ai=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],qi=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],Mi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Ni(){let e=g.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...qi];let t=[...Ai];return e&&t.push({separator:!0},...Mi),t}var Is="sidebar_collapsed",le=j(localStorage.getItem(Is)==="true");function Pi(){let e=!le.get();le.set(e),localStorage.setItem(Is,String(e))}function Fs(){let e=()=>L.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${le.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[ji(),Hi(),Bi()]}}function ji(){let e=()=>L.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function Hi(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>Pi(),title:()=>le.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${le.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function Bi(){return{tag:"nav",props:{class:"sidebar__nav"},children:Ni().map(e=>e.header?Ii(e.header):e.separator?Fi():Ri(e))}}function Ii(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function Fi(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function Ri({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${L.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>le.get()?t:"",onclick:r=>{r.preventDefault(),f(e),Ds()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function Rs(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>Ds()},children:[]}}function Ds(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}h();I();h();var Di=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],Ui=[{path:"/admin",label:"Admin Panel",icon:"bi-shield-lock"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Oversight",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Transactions",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Settings",icon:"bi-sliders"}],Oi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Ji(){let e=g.get();if(e&&e.is_admin)return Ui;let t=[...Di];return e&&t.push({separator:!0},...Oi),t}function Wi({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${L.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:r=>{r.preventDefault(),f(e),fa()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function zi(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>fa()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function Gi(){return{tag:"nav",props:{class:"mobile-nav__list"},children:Ji().map(e=>e.separator?Vi():Wi(e))}}function Vi(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function Us(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[zi(),Gi()]}}function Os(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>fa()},children:[]}}function Js(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function fa(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}Pt();w();function Ws(){return R(()=>A.get(),()=>tn(),()=>en())}function zs(){let e=()=>{let t=F.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>rs(),"data-theme":()=>F.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function Xi(){let e=document.getElementById("topbar-notifications-panel");if(!e)return;let t=e.classList.contains("topbar-notifications--open");document.querySelectorAll(".topbar-notifications--open").forEach(a=>a.classList.remove("topbar-notifications--open")),t||e.classList.add("topbar-notifications--open")}function Yi(){return setTimeout(Ki,0),{tag:"div",props:{class:"topbar__notifications-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__notifications","aria-label":"Notifications",onclick:e=>{e.stopPropagation(),Xi()}},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge",id:"topbar-notification-badge","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-notifications",id:"topbar-notifications-panel"},children:[{tag:"div",props:{class:"topbar-notifications__header"},children:[{tag:"strong",props:{},children:["Notifications"]},{tag:"button",props:{class:"topbar-notifications__close","aria-label":"Close",onclick:()=>{let e=document.getElementById("topbar-notifications-panel");e&&e.classList.remove("topbar-notifications--open")}},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]},{tag:"ul",props:{class:"topbar-notifications__list",id:"topbar-notifications-list"},children:[Qi("Loading notifications\u2026","Your latest updates will appear here.","bi-hourglass-split","info")]},{tag:"div",props:{class:"topbar-notifications__footer"},children:[{tag:"a",props:{href:"#/notifications",class:"topbar-notifications__link"},children:["View all notifications"]}]}]}]}}async function Ki(){let e=document.getElementById("topbar-notifications-list"),t=document.getElementById("topbar-notification-badge");if(!(!e||!t))try{let a=await c.notifications({limit:5}),s=Array.isArray(a.data)?a.data:[],r=Number(a.meta?.unread_count||s.filter(i=>!i.read).length||0);t.textContent=r>99?"99+":String(r),e.innerHTML=s.length?s.map(Zi).join(""):'<li class="topbar-notifications__empty">No notifications yet.</li>',e.querySelectorAll("[data-notification-id]").forEach(i=>{i.addEventListener("click",async()=>{let n=i.getAttribute("data-notification-id");if(!(!n||i.getAttribute("data-read")==="1"))try{await c.notificationRead(n),i.setAttribute("data-read","1"),i.classList.remove("topbar-notification--unread");let o=Math.max(0,Number(t.textContent.replace("+",""))-1);t.textContent=String(o)}catch{}})})}catch{e.innerHTML='<li class="topbar-notifications__empty">Notifications are unavailable right now.</li>',t.textContent="0"}}function Zi(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?` href="#${at(t.action_url)}"`:"";return`<li class="topbar-notification topbar-notification--${a} ${e.read?"":"topbar-notification--unread"}" data-notification-id="${at(e.id)}" data-read="${e.read?"1":"0"}"><i class="bi ${s} topbar-notification__icon"></i><div class="topbar-notification__body"><div class="topbar-notification__title">${at(t.title||"Notification")}</div><div class="topbar-notification__text">${at(t.message||"")}</div>${r?`<a class="topbar-notification__action"${r}>Open</a>`:""}</div></li>`}function at(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Qi(e,t,a,s){return{tag:"li",props:{class:`topbar-notification topbar-notification--${s}`},children:[{tag:"i",props:{class:`bi ${a} topbar-notification__icon`},children:[]},{tag:"div",props:{class:"topbar-notification__body"},children:[{tag:"div",props:{class:"topbar-notification__title"},children:[e]},{tag:"div",props:{class:"topbar-notification__text"},children:[t]}]}]}}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-notifications-panel");t&&t.classList.contains("topbar-notifications--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__notifications")&&t.classList.remove("topbar-notifications--open")});function en(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[zs(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function tn(){let e=g.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>Js(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[zs(),Yi(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await Ae(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}h();I();function Gs(){return R(()=>!!ue.get(),()=>{let e=ue.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}w();function Vs(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{c.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let r=[];a.facebook&&r.push(`<a href="${st(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&r.push(`<a href="${st(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&r.push(`<a href="${st(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&r.push(`<a href="${st(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=r.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function st(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}h();var an=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],sn=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"}];function rn(){let e=g.get();return e&&e.is_admin?sn:an}function nn({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${L.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:r=>{r.preventDefault(),f(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function on(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function ln(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:rn().map(e=>e.separator?on():nn(e))}}function va(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&va()},!0),window.addEventListener("resize",()=>setTimeout(va,50)),document.addEventListener("hnav:rendered",()=>setTimeout(va,0)));function Xs(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[ln()]}}function Ys(){let e=()=>!!g.get()?.is_admin,t=()=>L.get().startsWith("/admin"),a=()=>A.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[R(()=>A.get(),()=>Fs(),()=>null),R(()=>A.get(),()=>Rs(),()=>null),R(()=>A.get(),()=>Us(),()=>null),R(()=>A.get(),()=>Os(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[Ws(),R(()=>A.get()&&!e(),()=>Xs(),()=>null),{tag:"main",props:{class:"app-main"},children:[dn()]},Vs()]},Gs()]}}function dn(){let t=L.get().split("?")[0]||"/",a=tt.find(r=>r.path===t),s=g.get();return s&&s.is_admin&&!t.startsWith("/admin")?(f("/admin"),ha()):a?a.requireAuth&&!A.get()?(f("/login"),ha()):a.requireAdmin&&(!g.get()||!g.get().is_admin)?un():!a.requireAuth&&A.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(f("/"),ha()):cn(a):pn()}function cn(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function pn(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function un(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function ha(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}I();h();ht();ca();ma();ba();ga();$t();Ne();wt();It();xt();Be();Zt();ta();Tt();Ct();At();qt();jt();w();h();var b={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function Zs(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
        ...
        `,b.categories.length===0)try{let t=await c.categories();b.categories=Array.isArray(t.data)?t.data:[];let a=document.getElementById("jobs-category");a&&(a.innerHTML=Ks())}catch{}document.getElementById("jobs-apply")?.addEventListener("click",()=>{mn(),b.page=1,rt()}),document.getElementById("jobs-reset")?.addEventListener("click",()=>{b.search="",b.categoryId="",b.minBudget="",b.maxBudget="",b.sort="latest",b.page=1,bn(),rt()}),document.getElementById("jobs-search")?.addEventListener("keydown",t=>{t.key==="Enter"&&document.getElementById("jobs-apply")?.click()}),await rt()}}}function Ks(){return'<option value="">All categories</option>'+b.categories.map(e=>`<option value="${D(e.id)}" ${String(e.id)===String(b.categoryId)?"selected":""}>${D(e.name)}</option>`).join("")}function mn(){b.search=document.getElementById("jobs-search")?.value.trim()||"",b.categoryId=document.getElementById("jobs-category")?.value||"",b.minBudget=document.getElementById("jobs-min-budget")?.value.trim()||"",b.maxBudget=document.getElementById("jobs-max-budget")?.value.trim()||"",b.sort=document.getElementById("jobs-sort")?.value||"latest"}function bn(){let e={"jobs-search":b.search,"jobs-category":b.categoryId,"jobs-min-budget":b.minBudget,"jobs-max-budget":b.maxBudget,"jobs-sort":b.sort};Object.entries(e).forEach(([t,a])=>{let s=document.getElementById(t);s&&(s.value=a)})}async function rt(){let e=document.getElementById("jobs-grid");if(!e)return;let t=++b.requestSerial;b.loading=!0,e.innerHTML='<div class="spinner"></div>';try{let a={page:b.page,per_page:b.perPage,sort:b.sort};b.search&&(a.search=b.search),b.categoryId&&(a.category_id=b.categoryId),b.minBudget!==""&&(a.min_budget=b.minBudget),b.maxBudget!==""&&(a.max_budget=b.maxBudget);let s=await c.jobs(a);if(t!==b.requestSerial)return;b.jobs=Array.isArray(s.data)?s.data:[],b.total=Number(s.meta?.total||0),b.lastPage=Math.max(1,Number(s.meta?.last_page||1)),gn()}catch(a){if(t!==b.requestSerial)return;e.innerHTML=`<p class="muted">Failed to load jobs: ${D(a.message||"unknown error")}</p>`,Qs(),er()}finally{t===b.requestSerial&&(b.loading=!1)}}function gn(){let e=document.getElementById("jobs-grid");if(e){if(Qs(),er(),b.jobs.length===0){e.innerHTML='<p class="muted">No jobs match your filters. Try clearing them.</p>';return}e.innerHTML=b.jobs.map(t=>`
        <a class="job-card" href="#/jobs/${encodeURIComponent(t.id)}" data-id="${D(t.id)}">
            <div class="job-card__head">
                ${t.category&&t.category.icon_class?`<i class="bi ${fn(t.category.icon_class)} job-card__cat-icon"></i>`:""}
            ...
            <p class="job-card__desc">${D(vn(t.description,140))}</p>
    ...
    `).join(""),e.querySelectorAll("a.job-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function Qs(){let e=document.getElementById("jobs-results-meta");if(!e)return;if(b.total===0){e.textContent="No open jobs found";return}let t=(b.page-1)*b.perPage+1,a=Math.min(b.page*b.perPage,b.total);e.textContent=`Showing ${t}-${a} of ${b.total} open jobs`}function er(){let e=document.getElementById("jobs-pagination");if(e){if(b.lastPage<=1){e.innerHTML="";return}e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>b.lastPage||a===b.page||(b.page=a,rt())})})}}function fn(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function vn(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function D(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var ya={bids:[],loading:!1};function tr(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await c.workerBids();ya.bids=t.data||[],hn()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${ar(t.message||"unknown")}</p>`}}}}function hn(){let e=document.getElementById("bids-list");if(e){if(ya.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=ya.bids.map(t=>`
        <a class="bid-row-card" href="#/jobs/${t.job_id}" data-id="${t.job_id}">
            <div class="bid-row-card__main">
                <div class="bid-row-card__title">${ar(t.job?.title||"Job")}</div>
                <div class="bid-row-card__meta">
                    ...
                    <span class="muted">${yn(t.created_at)}</span>
                </div>
            </div>
            <span class="badge badge--status badge--${t.status}">${t.status.toUpperCase()}</span>
        </a>
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function yn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ar(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var $e={jobs:[],submissions:[],loading:!1};function wa(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);$e.jobs=t.data||[],$e.submissions=a.data||[],wn()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${_a(t.message||"unknown")}</p>`}}}}function wn(){let e=document.getElementById("active-jobs-list");if(e){if($e.jobs.length===0){e.innerHTML=`<p class="muted">No active jobs. Once a poster accepts your bid, it'll appear here.</p>`;return}e.innerHTML=$e.jobs.map(t=>{let a=$e.submissions.find(r=>r.job_id===t.id),s=t.status;return`
        ...
        `}).join(""),Sn()}}function _n(e,t){return`
        <div class="active-job-card__sub">
            <strong>Submitted:</strong> ${xn(t.created_at)}
    ...
    `}function Sn(){document.querySelectorAll("form.submit-form").forEach(e=>{e.addEventListener("submit",async t=>{t.preventDefault();let a=parseInt(e.getAttribute("data-job-id"),10),s=new FormData(e),r=e.querySelector("[data-submit-btn]");r.disabled=!0,r.innerHTML='<i class="bi bi-hourglass"></i> Submitting\u2026';try{await c.submitWork(a,{description:String(s.get("description")||"").trim(),external_link:String(s.get("external_link")||"").trim()||null}),l("Work submitted!","success"),wa()()}catch(i){l(i.message||"Failed to submit.","error")}finally{r.disabled=!1,r.innerHTML='<i class="bi bi-send"></i> Submit Work'}})})}function xn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function _a(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var N={activeTab:"categories",categories:[],subcategories:[],loading:!1};function sr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#tab-cats-btn").addEventListener("click",()=>{N.activeTab="categories",$a(e)}),e.querySelector("#tab-subcats-btn").addEventListener("click",()=>{N.activeTab="subcategories",$a(e)}),await X(e)}}async function X(e){try{let[t,a]=await Promise.all([c.adminCategories(),c.adminSubcategories()]);N.categories=t.data||[],N.subcategories=a.data||[],$a(e)}catch(t){l(t.message||"Failed to load category data.","error")}}function $a(e){let t=e.querySelector("#tab-cats-btn"),a=e.querySelector("#tab-subcats-btn"),s=e.querySelector("#tab-content");s&&(N.activeTab==="categories"?(t&&(t.className="btn btn--primary"),a&&(a.className="btn btn--ghost"),kn(s,e)):(t&&(t.className="btn btn--ghost"),a&&(a.className="btn btn--primary"),Tn(s,e)))}function kn(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
            <h3>Main Categories List</h3>
            ${N.categories.length===0?'<p class="muted">No categories yet.</p>':`
    ...
    `,e.querySelectorAll(".edit-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=N.categories.find(d=>String(d.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Main Category "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateCategory(r,{min_cost:o}),l(`Min cost updated for ${i.name}.`,"success"),await X(t)}catch(d){l(d.message,"error")}})}),e.querySelectorAll(".toggle-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=N.categories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateCategory(r,{is_active:!i.is_active}),l("Category updated.","success"),await X(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete category?"))try{let i=await c.adminDeleteCategory(r);l(i.message||"Deleted.","success"),await X(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-cat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),description:String(r.get("description")||"").trim()||null,is_active:r.get("is_active")==="on"};try{await c.adminCreateCategory(i),l("Main Category created.","success"),await X(t)}catch(n){l(n.message,"error")}})}function Tn(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
            <h3>Subcategories List</h3>
            ${N.subcategories.length===0?'<p class="muted">No subcategories yet.</p>':`
                <div class="table-responsive">
                    <table class="table" style="width:100%; text-align:left; border-collapse:collapse;">
                        <thead>
    ...
    `,e.querySelectorAll(".edit-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=N.subcategories.find(d=>String(d.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Subcategory "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateSubcategory(r,{min_cost:o}),l(`Min cost updated for ${i.name}.`,"success"),await X(t)}catch(d){l(d.message,"error")}})}),e.querySelectorAll(".toggle-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=N.subcategories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateSubcategory(r,{is_active:!i.is_active}),l("Subcategory updated.","success"),await X(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete subcategory?"))try{let i=await c.adminDeleteSubcategory(r);l(i.message||"Deleted.","success"),await X(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-subcat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={category_id:parseInt(r.get("category_id")||"0",10),name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),is_active:r.get("is_active")==="on"};try{await c.adminCreateSubcategory(i),l("Subcategory created.","success"),await X(t)}catch(n){l(n.message,"error")}})}function V(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var Y={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1};function rr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await ir()}}async function ir(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a,s]=await Promise.all([c.adminSettings(),c.socialLinks(),c.notices()]);Y.grouped=t.data||{},Y.social=a||{},Y.noticesData=s||{interval:4,notices:[]},Ln()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${P(t.message||"unknown")}</p>`}}}function Ln(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(Y.grouped).map(n=>`
        <div class="card settings-group">
            <h3 class="card__title">${P(n.charAt(0).toUpperCase()+n.slice(1))}</h3>
            <div class="settings-group__rows">
                ${Y.grouped[n].map(o=>Cn(n,o)).join("")}
            </div>
        </div>
    ...
    `,e.innerHTML=a,document.getElementById("settings-save-btn").addEventListener("click",An),document.getElementById("add-notice-btn").addEventListener("click",En),Sa()}function nr(e,t={image:"",text:""}){let a=typeof t=="string"?t.startsWith("/")||t.startsWith("http")?t:"":t?.image||"",s=typeof t=="string"?!t.startsWith("/")&&!t.startsWith("http")?t:"":t?.text||"",r="";return a?r=`<div class="banner-preview"><img src="${P(a)}" alt="Banner preview"></div>`:s?r=`<div class="banner-preview banner-preview--text"><strong>Text Notice:</strong> <span>${P(s)}</span></div>`:r='<div class="banner-preview banner-preview--empty"><i class="bi bi-image muted"></i> No image uploaded</div>',`
        <div class="banner-message-row card">
            ...
            <div class="banner-message-row__fields">
                <div class="banner-field banner-field--full">
                    ${r}
                    <input type="hidden" class="notice-msg-image" value="${P(a)}">
    ...
    `}async function An(){let e={};for(let n of Object.keys(Y.grouped))for(let o of Y.grouped[n]){let d=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,m=document.getElementById(d);if(!m)continue;let u;o.value_type==="boolean"?u=m.checked:o.value_type==="integer"||o.value_type==="percent"?u=parseInt(m.value,10):o.value_type==="decimal"?u=parseFloat(m.value):o.value_type==="json"?u=m.value?JSON.parse(m.value):null:u=m.value,e[o.key]=u}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".banner-message-row")).map(n=>({image:n.querySelector(".notice-msg-image")?.value.trim()||""})).filter(n=>n.image!==""),r={interval:document.getElementById("notice-interval")?.value||4,direction:document.getElementById("notice-direction")?.value||"right_to_left",notices:s},i=document.getElementById("settings-save-btn");i.disabled=!0,i.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(r)]),l("Settings, notices, and social links saved successfully.","success"),await ir()}catch(n){l(n.message||"Failed to save.","error")}finally{i.disabled=!1,i.textContent="Save All Changes"}}function P(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}we();na();la();Dt();Jt();zt();Xt();Bt();var mr={"/":Me,"/refer":_t,"/webtask":me,"/tasks":me,"/earn":Pe,"/tg-tasks":Je,"/withdraw":je,"/profile":He,"/wallet":He,"/admin":Kt,"/admin/payments":ea,"/admin/categories":sr,"/admin/settings":rr,"/admin/jobs":aa,"/admin/transactions":ia,"/admin/reports":oa,"/deposit":kt,"/leaderboard":Ie,"/achievements":Fe,"/support":Re,"/settings":Ue,"/jobs/available":Zs,"/worker/bids":tr,"/worker/active-jobs":wa,"/poster":Rt,"/poster/post-job":Ut,"/poster/jobs":Wt,"/poster/wallet":Vt,"/notifications":Ht,"/login":da,"/register":ua,"/forgot-password":Qe,"/reset-password":et};function br(){it(),setTimeout(it,50),window.addEventListener("hashchange",it),T(()=>{A.get(),setTimeout(it,0)})}async function it(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!mr[t]){let n=t.match(/^\/jobs\/(\d+)$/);if(n){let d=await Promise.resolve().then(()=>(lr(),or));await ka(()=>d.JobDetailPage(n[1]),t);return}let o=t.match(/^\/poster\/jobs\/(\d+)$/);if(o){if(!A.get()){f("/login");return}let d=await Promise.resolve().then(()=>(ur(),pr));await ka(()=>d.PosterJobDetailPage(o[1]),t);return}t="/"}let a=A.get(),s=g.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?f("/admin"):f("/");return}if(!r.includes(t)&&!a){f("/login");return}if(t==="/"&&s&&s.is_admin){f("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){zn();return}let i=mr[t];await ka(i,t)}async function ka(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function zn(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}h();var gr=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();gr.innerHTML="";O(Ys(),gr);J.get()&&M();br();
