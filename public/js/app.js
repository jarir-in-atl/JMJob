var sr=Object.defineProperty;var v=(e,t)=>()=>(e&&(t=e(e=0)),t);var w=(e,t)=>{for(var a in t)sr(e,a,{get:t[a],enumerable:!0})};function rr(e,t){ha?ha(e,t):console.error("[Ghost] Unhandled effect error:",e)}function A(e){let t=e,a=new Set;return{get(){return C&&(a.add(C),C.dependencies.add(a)),t},set(s){t!==s&&(t=s,ya(a))}}}function ya(e){Ye(()=>{e.forEach(t=>{t.notify?t.notify():be.add(t)})})}function Ye(e){Ve++;try{e()}finally{if(Ve--,Ve===0){let t=Array.from(be);be.clear(),t.forEach(a=>a.run())}}}function $(e){let t={dependencies:new Set,run(){Xe(t),me.push(C),C=t;try{e()}catch(a){rr(a,e)}finally{C=me.pop()}},notify(){be.add(t)}};return t.run(),()=>Xe(t)}function Ke(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,ya(s))}};return{get(){if(C&&(s.add(C),C.dependencies.add(s)),a){Xe(r),me.push(C),C=r;try{t=e()}finally{C=me.pop()}a=!1}return t}}}function Xe(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var C,me,be,Ve,ha,J=v(()=>{C=null,me=[],be=new Set,Ve=0,ha=null});function se(){Ze.totalUpdates++,Ze.recentUpdates++}var ge,Ze,Qe=v(()=>{ge=new Set,Ze={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function F(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){nr(e,t);return}if(e.__ghostWhen){ir(e,t);return}if(e.__ghostLazy){or(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;ge.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let n=s.startsWith("on");typeof r=="function"&&!n?e.effects.push($(()=>{a.setAttribute(s,r()),se(),e.events.update?.forEach(i=>i())})):n?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)F(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push($(()=>{let n=s(),i=document.createTextNode(String(n??""));r?a.replaceChild(i,r):a.appendChild(i),r=i,se(),e.events.update?.forEach(o=>o())}))}else F(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function re(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),ge.delete(e)}}function nr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,n=document.createComment("[ghost-list]"),i=document.createComment("[/ghost-list]");t.appendChild(n),t.appendChild(i);let o=new Map;function d(f){return f.el||null}let b=$(()=>{let f=a(),M=f.map((S,U)=>String(s(S,U))),ar=Array.from(o.keys());for(let S of ar)if(!M.includes(S)){let U=o.get(S);re(U.ghostNode),o.delete(S)}for(let S=0;S<f.length;S++){let U=M[S];if(!o.has(U)){let ae=r(f[S],S),V=document.createElement("ghost-list-slot");for(F(ae,V);V.firstChild;)t.insertBefore(V.firstChild,i);o.set(U,{ghostNode:ae})}}for(let S=M.length-1;S>=0;S--){let U=M[S],ae=o.get(U);if(!ae)continue;let V=d(ae.ghostNode);if(!V)continue;let fa=M[S+1],va=(fa?d(o.get(fa)?.ghostNode):null)||i;V.nextSibling!==va&&t.insertBefore(V,va)}se()});e._listCleanup=()=>{b();for(let f of o.values())re(f.ghostNode);o.clear(),n.remove(),i.remove()}}function N(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function ir(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,n=document.createComment("[ghost-when]");t.appendChild(n);let i=null,o=$(()=>{let b=a()?s:r;if(i&&(re(i),i=null),b&&(i=b(),i)){let f=document.createElement("ghost-when-slot");for(F(i,f);f.firstChild;)t.insertBefore(f.firstChild,n)}se()});e._whenCleanup=()=>{o(),i&&re(i),n.remove()}}function or(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let n=null;if(s){let i=document.createElement("ghost-lazy-slot");for(F(s,i);i.firstChild;)t.insertBefore(i.firstChild,r);n=s}a().then(i=>{let o=i.default||i;n&&(re(n),n=null);let d=typeof o=="function"?o():o,b=document.createElement("ghost-lazy-slot");for(F(d,b);b.firstChild;)t.insertBefore(b.firstChild,r);n=d}).catch(i=>{console.error("[Ghost] lazyNode failed to load:",i)})}var et=v(()=>{J();Qe()});var wa=v(()=>{J()});var fe=v(()=>{});var _a=v(()=>{Qe()});var $a=v(()=>{J()});var Sa=v(()=>{et();J();fe();fe()});function cr(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let n={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){n["@attributes"]={};for(let i of r.attributes)n["@attributes"][i.nodeName]=i.nodeValue}for(let i of r.childNodes){let o=i.nodeName,d=s(i);d!==""&&(n[o]===void 0?n[o]=d:(Array.isArray(n[o])||(n[o]=[n[o]]),n[o].push(d)))}return n}return s(a.documentElement)}function dr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function at(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),n={url:e,...s};for(let M of at.interceptors.request)n=M(n)??n;let i=n.url;delete n.url;let o=dr(i,r);if(a==="memory"&&r==="GET"&&tt.has(o))return tt.get(o);let d=await fetch(i,n),b=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let f;b.includes("application/xml")||b.includes("text/xml")?f=cr(await d.text()):b.includes("application/json")?f=await d.json():f=await d.text();for(let M of at.interceptors.response)f=M(d,f)??f;return a==="memory"&&r==="GET"&&tt.set(o,f),f}var tt,ka=v(()=>{tt=new Map;at.interceptors={request:[],response:[]}});function st(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=A(a);return $(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var Ta=v(()=>{J()});function pr(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var no,xa=v(()=>{no=pr()});var lo,ur,La=v(()=>{J();lo=A("en"),ur=new Map;ur.set("en",{})});var q=v(()=>{J();et();wa();fe();_a();$a();Sa();ka();Ta();xa();La()});function Ea(e){rt=e}function Aa(e){nt=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let n=e.startsWith("http")?e:mr.apiBase+e,i={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};rt&&(i.headers.Authorization=`Bearer ${rt}`),a!==void 0&&(i.body=JSON.stringify(a)),r&&(i.signal=r);let o=await fetch(n,i);if(o.status===401)throw nt&&nt(),new ve("Unauthorized",401,null);let d=null,b=o.headers.get("content-type")||"";try{if(b.includes("application/json"))d=await o.json();else{let f=await o.text();d=f?{message:f}:null}}catch{}if(!o.ok){let f=d&&d.message||`HTTP ${o.status}`;throw new ve(f,o.status,d)}return d}var mr,rt,nt,ve,c,y=v(()=>{mr=window.JMJOB_CONFIG||{apiBase:"/api"},rt=null,nt=null;ve=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),notices:()=>p("/notices"),adminUpdateNotices:e=>p("/admin/notices",{method:"POST",body:e}),adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function l(e,t="info",a=3500){ne.set({message:e,type:t,id:Date.now()}),it&&clearTimeout(it),it=setTimeout(()=>ne.set(null),a)}async function E(){if(!I.get())return null;try{let e=await c.me();return m.set(e.data),e.data}catch{return null}}async function Ca(e,t){let a=await c.login({email:e,password:t});return I.set(a.data.token),m.set(a.data.user),a.data.user}async function Ma(e){return c.requestRegistrationOtp(e)}async function qa(e){let t=await c.verifyRegistrationOtp(e);return I.set(t.data.token),m.set(t.data.user),t.data.user}async function he(){try{await c.logout()}catch{}I.set(null),m.set(null),k.set("/login")}function g(e){window.location.hash=e}var br,gr,I,m,ne,it,k,x,h=v(()=>{q();q();y();br="earnap_token",gr="earnap_user",I=st(br,null),m=st(gr,null),ne=A(null),it=null;k=A(window.location.hash.replace(/^#/,"")||"/"),x=Ke(()=>!!I.get()&&!!m.get());$(()=>{let e=I.get();Ea(e)});Aa(()=>{I.set(null),m.set(null),k.set("/login"),l("Session expired. Please log in.","error")})});var ja={};w(ja,{HomePage:()=>ye});function ye(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=m.get();fr(e),e.appendChild(vr(t)),e.appendChild(hr()),e.appendChild(yr(t))}}function Y(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function fr(e){X&&(clearInterval(X),X=null);let t=Y("div","welcome-popup","");t.innerHTML=`
    ...
    `,t.querySelector("button").addEventListener("click",()=>{X&&(clearInterval(X),X=null),t.remove()}),e.appendChild(t);let a=t.querySelector("#notice-banner-text");try{let s=await c.notices(),r=Array.isArray(s.notices)&&s.notices.length?s.notices:["Complete tasks, watch ads, refer friends, and withdraw anytime."],n=typeof s.interval=="number"&&s.interval>0?s.interval:4,i=0;a.textContent=r[0],r.length>1&&(X=setInterval(()=>{let o;do o=Math.floor(Math.random()*r.length);while(o===i&&r.length>1);i=o,a.style.opacity="0",setTimeout(()=>{a.textContent=r[i],a.style.opacity="1"},200)},n*1e3))}catch{a.textContent="Complete tasks, watch ads, refer friends, and withdraw anytime."}}function vr(e){let t=Y("div","card card--user-header"),a=Y("div","user-header__stats");return a.innerHTML=`
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),r=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let n=s.querySelector("#cd-num"),i=setInterval(async()=>{a--,n.textContent=a,r.textContent=`Reward in ${a}s\u2026`,a<=0&&(clearInterval(i),await kr(e,"simulated",t))},1e3)},300)}async function kr(e,t,a){try{let s=await c.reward({provider:t,started_at:a});l(`+$${parseFloat(s.data.reward).toFixed(4)} credited!`,"success"),await E(),e.remove(),_e()()}catch(s){l(s.message||"Reward failed","error"),e.remove()}}var ct=v(()=>{y();h()});var Ba={};w(Ba,{ReferPage:()=>dt});function dt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--refer";let t=m.get(),a=null;try{a=(await c.referrals()).data}catch{l("Failed to load referrals","error")}let s=a?a.referral_link:t?`${window.location.origin}/?ref=${t.referral_code}`:"";e.innerHTML=`
        ...
        `;let r=e.querySelector("#copy-btn"),n=e.querySelector("#refer-link-input");r.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(n.value),l("Link copied to clipboard!","success")}catch{n.select(),document.execCommand("copy"),l("Link copied!","success")}});let i=e.querySelector("#share-tg");i.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let b=document.createElement("div");b.className="refer-item",b.innerHTML=`
                    ...
                    <div class="refer-item__info">
                        <div class="refer-item__name">${Ha(d.name)}</div>
                        <div class="refer-item__username">@${Ha(d.username)}</div>
                    </div>
                    <div class="refer-item__earned">$${parseFloat(d.lifetime_earned).toFixed(2)}</div>
                `,o.appendChild(b)})}}function Ha(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var pt=v(()=>{y();h()});var Fa={};w(Fa,{WithdrawPage:()=>$e});function $e(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=m.get();e.innerHTML=`
        ...
        ${s}
    `,t}function ut(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var mt=v(()=>{y();h()});var Da={};w(Da,{DepositPage:()=>bt});function bt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=m.get();e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{_.selectedGateway=t.getAttribute("data-gateway"),Ra(),Lr()})})}}function Lr(){let e=_.gateways.find(n=>n.key===_.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let r=(await c.adHistory()).data||[];if(r.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let n=a.querySelector(".ad-history__list");r.forEach(i=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                    ...
                    `,n.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function ft(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ke=v(()=>{y();h()});var Oa={};w(Oa,{default:()=>Te});async function Te(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var ht=v(()=>{h()});var Ua={};w(Ua,{default:()=>xe});async function xe(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var yt=v(()=>{h()});var Ja={};w(Ja,{default:()=>Le});async function Le(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var wt=v(()=>{h()});function Ar(){let e=localStorage.getItem(Wa);return e==="dark"||e==="light"?e:"system"}function Cr(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function _t(e){let t=Cr(e);document.documentElement.setAttribute("data-theme",t)}function Ga(){let e=j.get();j.set(e==="dark"?"light":"dark")}function za(e){j.set(e)}function Mr(){let e=localStorage.getItem(Va);return e&&$t.includes(e)?e:"default"}function Xa(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function Ya(e){$t.includes(e)&&oe.set(e)}function Ka(){return $t}var Wa,j,Va,$t,oe,St=v(()=>{q();Wa="jmjob_theme";j=A(Ar());_t(j.get());$(()=>{let e=j.get();_t(e),localStorage.setItem(Wa,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{j.get()==="system"&&_t("system")});Va="jmjob_color_theme",$t=["default","emerald","amber","rose"];oe=A(Mr());Xa(oe.get());$(()=>{let e=oe.get();Xa(e),localStorage.setItem(Va,e)})});var Za={};w(Za,{default:()=>Ae});async function Ae(){let e=document.querySelector("[data-view]");if(!e)return;let t=m.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=j.get(),s=oe.get(),r=Ka();e.innerHTML=`
                    ...
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${Ee[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${qr[o]};"></span>
    ...
    `;let n=document.getElementById("theme-mode-group");n&&n.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-mode");za(d),l(`Theme mode set to ${d}.`,"info")})});let i=document.getElementById("color-theme-group");i&&i.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-color");Ya(d),l(`Accent color set to ${Ee[d]||d}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await he(),l("Logged out.","info")})}var Ee,qr,kt=v(()=>{h();St();Ee={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},qr={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var es={};w(es,{NotificationsPage:()=>Tt});function Tt(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `,document.getElementById("notifications-read-all")?.addEventListener("click",async()=>{try{await c.notificationsReadAll(),l("All notifications marked as read.","success"),await Qa()}catch(t){l(t.message||"Could not update notifications.","error")}}),await Qa())}}async function Qa(){let e=document.getElementById("notifications-page-list");if(e)try{let t=await c.notifications({limit:100}),a=Array.isArray(t.data)?t.data:[];e.innerHTML=a.length?a.map(jr).join(""):'<p class="muted notifications-page__empty">No notifications yet.</p>',e.querySelectorAll("[data-notification-id]").forEach(s=>{s.querySelector("[data-mark-read]")?.addEventListener("click",async()=>{try{await c.notificationRead(s.getAttribute("data-notification-id")),s.classList.remove("notifications-page__item--unread"),s.querySelector("[data-mark-read]").remove()}catch(r){l(r.message||"Could not mark notification as read.","error")}})})}catch(t){e.innerHTML=`<p class="muted">Failed to load notifications: ${le(t.message||"unknown error")}</p>`}}function jr(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?`<a class="btn btn--ghost btn--sm" href="#${le(t.action_url)}">Open</a>`:"",n=e.read?"":'<button class="btn btn--ghost btn--sm" data-mark-read>Mark read</button>';return`<article class="notifications-page__item ${e.read?"":"notifications-page__item--unread"}" data-notification-id="${le(e.id)}"><i class="bi ${s} notifications-page__icon notifications-page__icon--${a}"></i><div class="notifications-page__body"><h3>${le(t.title||"Notification")}</h3><p>${le(t.message||"")}</p><small>${Pr(e.created_at)}</small></div><div class="notifications-page__actions">${r}${n}</div></article>`}function Pr(e){if(!e)return"";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function le(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var xt=v(()=>{y();h()});var ts={};w(ts,{TgTasksPage:()=>Me});function Me(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--tgtasks",e.innerHTML=`
    ...
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&Hr(e,t)},3e3)})}return t}async function Hr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await E(),Me()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ce(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Lt=v(()=>{y();h()});var rs={};w(rs,{PosterDashboardPage:()=>At});function At(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-dashboard";let t=m.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML=`
        ...
        `;let a=e.querySelector("#poster-new-job");a&&a.addEventListener("click",s=>{s.preventDefault(),g("/poster/post-job")}),await as()}}async function as(){let e=document.getElementById("poster-dashboard-content");if(e)try{let t=await c.posterStats();Fr(e,t.data||{})}catch(t){e.innerHTML=`
            <div class="card">
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",as),l(t.message||"Failed to load poster statistics.","error")}}function Fr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=Et(t.wallet_balance),n=Et(t.frozen_balance),i=Et(t.total_spent);e.innerHTML=`
    ...
    `}function Ir(e){return{open:"bi-megaphone",in_review:"bi-search",assigned:"bi-person-check",submitted:"bi-inbox",revision:"bi-arrow-repeat",completed:"bi-check-circle"}[e]||"bi-circle"}function Et(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function ss(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Br,Ct=v(()=>{y();h();Br={open:"Open",in_review:"In review",assigned:"Assigned",submitted:"Awaiting review",revision:"Revision requested",completed:"Completed",cancelled:"Cancelled",expired:"Expired",disputed:"Disputed"}});var ns={};w(ns,{PostJobPage:()=>Mt});function Mt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--post-job",!Ur()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="poster-filter-bar">
                <label>Status
                    <select class="admin-select" id="poster-job-filter">
                        ${Wr.map(t=>`<option value="${t}" ${t===Pe?"selected":""}>${t?is(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#poster-jobs-new").addEventListener("click",t=>{t.preventDefault(),g("/poster/post-job")}),e.querySelector("#poster-job-filter").addEventListener("change",async t=>{Pe=t.target.value,await je()}),e.querySelector("#poster-jobs-refresh").addEventListener("click",je),await je()}}}async function je(){let e=document.getElementById("poster-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=((await c.posterMyJobs()).data||[]).filter(s=>!Pe||s.status===Pe);e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(Gr(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${ee(t.message||"unknown error")}</p>`}}}function Gr(e){let t=document.createElement("article");return t.className=`admin-row poster-job-row poster-job-row--${ee(e.status)}`,t.innerHTML=`
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>g(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>zr(e.id)),t}async function zr(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await c.posterCancelJob(e,{reason:t}),l("Job cancelled.","success"),await je()}catch(a){l(a.message||"Could not cancel job.","error")}}function Vr(){return!!m.get()}function is(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function Xr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Wr,Pe,Pt=v(()=>{y();h();Wr=["","open","assigned","submitted","revision","completed","cancelled","disputed"],Pe=""});var ls={};w(ls,{PosterWalletPage:()=>Ht});function Ht(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-wallet";let t=m.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([c.posterStats(),c.paymentSubmissions()]);Yr(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${Ne(a.message||"unknown error")}</p>`}}}function Yr(e,t,a){let s=Nt(t.wallet_balance),r=Nt(t.frozen_balance),n=Nt(t.total_spent);e.innerHTML=`
    ...
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>g("/deposit"))}function Kr(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${Ne((t.gateway||"").toUpperCase())}</strong><small>${Ne(t.trxid)} \xB7 ${Zr(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${Ne(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function Nt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function Zr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Ne(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Bt=v(()=>{y();h()});var ps={};w(ps,{AdminPage:()=>It});function It(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(n=>n.classList.remove("admin-tab--active")),r.classList.add("admin-tab--active"),cs(r.dataset.tab,s)})}),cs("stats",s)}}async function cs(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),r=a.data||{},n=s.data||{},i=n.currency_symbol||"\u09F3";t.innerHTML=`
            ...
            `;let r=t.querySelector("#wd-list");s.forEach(n=>r.appendChild(ds(n,r))),t.querySelector("#wd-filter").addEventListener("change",async n=>{let i=await c.adminWithdrawals(n.target.value);r.innerHTML="",(i.data||[]).forEach(o=>r.appendChild(ds(o,r)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list"),n=Number(m.get()?.id||0);s.forEach(i=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                    <div>
    ...
    `,a.querySelector(".provider-save").addEventListener("click",async()=>{let n={block_id:a.querySelector(".provider-block-id").value.trim()||null,weight:parseInt(a.querySelector(".provider-weight").value,10)||0,reward_per_view:parseFloat(a.querySelector(".provider-reward").value)||0,min_duration_seconds:parseInt(a.querySelector(".provider-duration").value,10)||12,enabled:a.querySelector(".provider-enabled").checked};try{await c.adminUpdateProvider(e.id,n),l("Provider saved","success")}catch(i){l(i.message,"error")}}),a}function L(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Rt=v(()=>{y();h();h()});var bs={};w(bs,{AdminPaymentsPage:()=>Ot});function Ot(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{R.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),Dt()})}),await Dt()}}async function Dt(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(R.status);R.items=t.data||[],tn(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${K(t.message||"Failed to load.")}</p>`}}}function tn(e){if(R.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",R.items.forEach(t=>e.appendChild(an(t)))}function an(e){let t=en[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,e.status==="pending"&&(a.querySelector('[data-action="approve"]')?.addEventListener("click",()=>us(e.id,"approve",a)),a.querySelector('[data-action="reject"]')?.addEventListener("click",()=>us(e.id,"reject",a))),a}async function us(e,t,a){let s=prompt(t==="approve"?"Optional note for approval:":"Reason for rejection:");if(s!==null)try{let n=await(t==="approve"?c.adminApprovePayment:c.adminRejectPayment)(e,{note:s||null});l(n.message||"Done.","success"),await Dt()}catch(r){l(r.message||"Action failed.","error")}}function ms(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function K(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var en,R,Ut=v(()=>{y();h();en={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},R={status:"pending",items:[],loading:!1}});var fs={};w(fs,{AdminJobsPage:()=>Gt});function Gt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-jobs",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Status
                    <select class="admin-select" id="admin-job-status">
                        ${sn.map(t=>`<option value="${t}" ${t===Wt?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-job-status").addEventListener("change",async t=>{Wt=t.target.value,await ce()}),e.querySelector("#admin-job-refresh").addEventListener("click",ce),await ce()}}}async function ce(){let e=document.getElementById("admin-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminJobs(Wt)).data||[];e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(rn(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${H(t.message||"unknown error")}</p>`}}}function rn(e){let t=document.createElement("article");t.className=`admin-row admin-job-row admin-job-row--${H(e.status)}`;let a=e.worker?`${H(e.worker.name)} <span class="muted">(${H(e.worker.email||"")})</span>`:'<span class="muted">Unassigned</span>';t.innerHTML=`
    ...
    `;let s=t.querySelector(".admin-row__actions");return["completed","cancelled","disputed"].includes(e.status)||s.appendChild(Jt("Mark disputed","btn--danger",()=>nn(e.id))),e.status==="disputed"&&(s.appendChild(Jt("Release payment","btn--success",()=>gs(e.id,"release"))),s.appendChild(Jt("Cancel and refund","btn--danger",()=>gs(e.id,"cancel")))),t}function Jt(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function nn(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await ce()}catch(t){l(t.message||"Could not flag job.","error")}}async function gs(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ce()}catch(r){l(r.message||"Could not resolve dispute.","error")}}function on(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function H(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var sn,Wt,zt=v(()=>{y();h();sn=["","open","in_review","assigned","submitted","revision","disputed","completed","cancelled","expired"],Wt=""});var vs={};w(vs,{AdminTransactionsPage:()=>Yt});function Yt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Type
                    <select class="admin-select" id="admin-transaction-type">
                        ${ln.map(t=>`<option value="${t}" ${t===Xt?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All transactions"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{Xt=t.target.value,await Vt()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",Vt),await Vt()}}}async function Vt(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminTransactions({type:Xt})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(cn(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${D(t.message||"unknown error")}</p>`}}}function cn(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${D(e.type)}`,t.innerHTML=`
    ...
    `,t}function dn(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function D(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ln,Xt,Kt=v(()=>{y();h();ln=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],Xt=""});var hs={};w(hs,{AdminReportsPage:()=>Zt});function Zt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await pn()}}}async function pn(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            <div class="stat-grid admin-report-summary">
                ...
                ${He("Transaction volume",Fe(s.transaction_volume))}
                ${He("Jobs",Be(s.job_count))}
                ${He("Job value",Fe(s.job_value))}
            </div>
        ...
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${de(t.message||"unknown error")}</p>`}}function He(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${de(e)}</span><strong>${de(t)}</strong></div>`}function un(e){return e.length?e.map(t=>`
    ...
    `).join(""):'<p class="muted">No jobs yet.</p>'}function Be(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Fe(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function de(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Qt=v(()=>{y();h()});var ys={};w(ys,{LoginPage:()=>ea});function ea(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
    ...
    `;let s=document.getElementById("reset-form"),r=document.getElementById("submit-btn");s.addEventListener("submit",async n=>{n.preventDefault();let i=s.email.value.trim(),o=s.otp.value.trim(),d=s.password.value,b=s.password_confirmation.value;if(!i||!o||!d){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(d!==b){l("Passwords do not match.","error");return}if(d.length<6){l("Password must be at least 6 characters.","error");return}r.disabled=!0,r.textContent="Resetting...";try{await c.resetPassword({email:i,otp:o,password:d,password_confirmation:b}),l("Password reset successfully! You can now log in.","success"),g("/login")}catch(f){l(f.message||"Failed to reset password.","error"),r.disabled=!1,r.textContent="Reset Password"}})}function gn(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ia=v(()=>{y();h()});var zs={};w(zs,{JobDetailPage:()=>hi});function hi(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=m.get();t.innerHTML=`
        ...
        `;try{let s=await c.job(e),{job:r,bids:n,bid_count:i,my_bid:o}=s.data;yi(r,n,i,o,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${z(s.message||"unknown")}</p>`}}}function yi(e,t,a,s,r){let n=document.getElementById("job-detail-content");if(!n)return;let i=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,o=i?Math.max(0,Math.floor((i-Date.now())/1e3)):null,d=o!=null?$i(o):"\u2014",b=["open","in_review"].includes(e.status),f=!!s;n.innerHTML=`
    ...
    `:'<div class="card"><p class="muted">Please log in to place a bid.</p></div>':'<div class="card"><p class="muted">Bidding is closed for this job.</p></div>'}function _i(e,t,a){if(t){let r=document.getElementById("withdraw-bid-btn");r&&r.addEventListener("click",async()=>{if(confirm("Withdraw your bid?"))try{await c.withdrawBid(t.id),l("Bid withdrawn.","success"),g(`/jobs/${e.id}`)}catch(n){l(n.message||"Failed to withdraw.","error")}});return}let s=document.getElementById("bid-form");s&&s.addEventListener("submit",async r=>{r.preventDefault();let n=new FormData(s),i=document.getElementById("bid-submit-btn");i.disabled=!0,i.textContent="Submitting\u2026";try{await c.placeBid(e.id,{amount:parseFloat(n.get("amount")),delivery_days:parseInt(n.get("delivery_days"),10),proposal:String(n.get("proposal")||"").trim()}),l("Bid placed!","success"),g(`/jobs/${e.id}`)}catch(o){l(o.message||"Failed to place bid.","error")}finally{i.disabled=!1,i.textContent="Submit Bid"}})}function $i(e){if(e<=0)return"expired";let t=Math.floor(e/86400),a=Math.floor(e%86400/3600);if(t>0)return`${t}d ${a}h`;let s=Math.floor(e%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function z(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Vs=v(()=>{y();h()});var Ks={};w(Ks,{PosterJobDetailPage:()=>Si});function Si(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.innerHTML="",t.className="view view--poster-job-detail",!Mi()){t.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}t.innerHTML='<a href="#/poster/jobs" class="back-link"><i class="bi bi-arrow-left"></i> My jobs</a><div id="poster-job-detail-content"><div class="spinner"></div></div>',await Xs(e)}}}async function Xs(e){let t=document.getElementById("poster-job-detail-content");if(t)try{let s=(await c.posterJobBids(e)).data||{};ki(t,s.job||{},s.bids||[],s.submissions||[])}catch(a){t.innerHTML=`<p class="muted">Failed to load job: ${T(a.message||"unknown error")}</p>`}}function ki(e,t,a,s){e.innerHTML=`
        <div class="card poster-detail-card">
            ...
            <div class="poster-detail-meta"><span>Budget <strong>\u09F3${Number(t.budget||0).toFixed(2)}</strong></span><span>Bids <strong>${Number(t.bid_count||a.length)}</strong></span><span>Views <strong>${Number(t.view_count||0)}</strong></span><span>Created <strong>${Ys(t.created_at)}</strong></span></div>
        </div>
        <div class="poster-detail-grid">
            <div class="card"><div class="card__header"><div><h2 class="card__title">Bid comparison</h2><p class="muted">Choose one pending proposal to assign the job.</p></div></div><div class="poster-bid-list">${Ti(t,a)}</div></div>
            <div class="card"><div class="card__header"><div><h2 class="card__title">Submission review</h2><p class="muted">Approve delivery to release payment or request changes.</p></div></div><div class="poster-submission-list">${xi(t,s)}</div></div>
        </div>
    ...
    `).join(""):'<p class="muted">No bids yet.</p>'}function xi(e,t){return t.length?t.map(a=>`
        <div class="poster-submission-row poster-submission-row--${T(a.status)}"><div><strong>${T(a.worker?.name||"Worker")}</strong><span class="muted">Submitted ${Ys(a.created_at)} \xB7 ${T(String(a.status||"").replace("_"," "))}</span><p>${T(a.description||"")}</p>${a.external_link?`<a href="${T(a.external_link)}" target="_blank" rel="noopener noreferrer">Open delivery link</a>`:""}${a.reviewer_note?`<p class="muted"><strong>Revision note:</strong> ${T(a.reviewer_note)}</p>`:""}</div>${a.status==="pending_review"&&e.status==="submitted"?`<div class="poster-submission-row__actions"><button class="btn btn--success btn--sm" data-release-submission="${Number(a.id)}">Release payment</button><button class="btn btn--ghost btn--sm" data-revision-submission="${Number(a.id)}">Request revision</button></div>`:""}</div>
    `).join(""):'<p class="muted">No work submitted yet.</p>'}async function Li(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await c.posterAcceptBid(e,t),l("Worker selected and escrow held.","success"),await ba(e)}catch(a){l(a.message||"Could not select worker.","error")}}async function Ei(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await c.posterReleasePayment(e,{submission_id:Number(t)}),l("Payment released.","success"),await ba(e)}catch(a){l(a.message||"Could not release payment.","error")}}async function Ai(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await c.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),l("Revision requested.","success"),await ba(e)}catch(s){l(s.message||"Could not request revision.","error")}}async function Ci(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await c.posterCancelJob(e,{reason:"Cancelled by poster"}),l("Job cancelled.","success"),g("/poster/jobs")}catch(t){l(t.message||"Could not cancel job.","error")}}async function ba(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await Xs(e))}function Mi(){return!!m.get()}function qi(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function Ys(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Zs=v(()=>{y();h()});q();h();q();h();var De=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ot(),ja))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(we(),lt))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(we(),lt))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ct(),Na))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(pt(),Ba))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(mt(),Fa))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(gt(),Da))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ke(),vt))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ht(),Oa))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(yt(),Ua))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(wt(),Ja))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(kt(),Za))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(xt(),es))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ke(),vt))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Lt(),ts))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ct(),rs))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(qt(),ns))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Pt(),os))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Bt(),ls))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Rt(),ps))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ut(),bs))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(zt(),fs))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Kt(),vs))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Qt(),hs))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ta(),ys))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ra(),_s))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(na(),$s))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ia(),Ss))}],Bl=$(()=>{let e=k.get().split("?")[0]||"/";return De.find(t=>t.path===e)||De[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";k.set(e)});q();h();q();var fn=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],vn=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],hn=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function yn(){let e=m.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...vn];let t=[...fn];return e&&e.role==="poster"&&t.push({separator:!0},...hn),t}var ks="sidebar_collapsed",te=A(localStorage.getItem(ks)==="true");function wn(){let e=!te.get();te.set(e),localStorage.setItem(ks,String(e))}function Ts(){let e=()=>k.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${te.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[_n(),$n(),Sn()]}}function _n(){let e=()=>k.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function $n(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>wn(),title:()=>te.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${te.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function Sn(){return{tag:"nav",props:{class:"sidebar__nav"},children:yn().map(e=>e.header?kn(e.header):e.separator?Tn():xn(e))}}function kn(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function Tn(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function xn({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${k.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>te.get()?t:"",onclick:r=>{r.preventDefault(),g(e),Ls()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function xs(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>Ls()},children:[]}}function Ls(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}h();q();h();var Ln=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],En=[{path:"/admin",label:"Admin Panel",icon:"bi-shield-lock"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Oversight",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Transactions",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Settings",icon:"bi-sliders"}],An=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Cn(){let e=m.get();if(e&&e.is_admin)return En;let t=[...Ln];return e&&e.role==="poster"&&t.push({separator:!0},...An),t}function Mn({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${k.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:r=>{r.preventDefault(),g(e),oa()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function qn(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>oa()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function jn(){return{tag:"nav",props:{class:"mobile-nav__list"},children:Cn().map(e=>e.separator?Pn():Mn(e))}}function Pn(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function Es(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[qn(),jn()]}}function As(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>oa()},children:[]}}function Cs(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function oa(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}St();y();function Ms(){return N(()=>x.get(),()=>Dn(),()=>Rn())}function qs(){let e=()=>{let t=j.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>Ga(),"data-theme":()=>j.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function Nn(){let e=document.getElementById("topbar-notifications-panel");if(!e)return;let t=e.classList.contains("topbar-notifications--open");document.querySelectorAll(".topbar-notifications--open").forEach(a=>a.classList.remove("topbar-notifications--open")),t||e.classList.add("topbar-notifications--open")}function Hn(){return setTimeout(Bn,0),{tag:"div",props:{class:"topbar__notifications-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__notifications","aria-label":"Notifications",onclick:e=>{e.stopPropagation(),Nn()}},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge",id:"topbar-notification-badge","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-notifications",id:"topbar-notifications-panel"},children:[{tag:"div",props:{class:"topbar-notifications__header"},children:[{tag:"strong",props:{},children:["Notifications"]},{tag:"button",props:{class:"topbar-notifications__close","aria-label":"Close",onclick:()=>{let e=document.getElementById("topbar-notifications-panel");e&&e.classList.remove("topbar-notifications--open")}},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]},{tag:"ul",props:{class:"topbar-notifications__list",id:"topbar-notifications-list"},children:[In("Loading notifications\u2026","Your latest updates will appear here.","bi-hourglass-split","info")]},{tag:"div",props:{class:"topbar-notifications__footer"},children:[{tag:"a",props:{href:"#/notifications",class:"topbar-notifications__link"},children:["View all notifications"]}]}]}]}}async function Bn(){let e=document.getElementById("topbar-notifications-list"),t=document.getElementById("topbar-notification-badge");if(!(!e||!t))try{let a=await c.notifications({limit:5}),s=Array.isArray(a.data)?a.data:[],r=Number(a.meta?.unread_count||s.filter(n=>!n.read).length||0);t.textContent=r>99?"99+":String(r),e.innerHTML=s.length?s.map(Fn).join(""):'<li class="topbar-notifications__empty">No notifications yet.</li>',e.querySelectorAll("[data-notification-id]").forEach(n=>{n.addEventListener("click",async()=>{let i=n.getAttribute("data-notification-id");if(!(!i||n.getAttribute("data-read")==="1"))try{await c.notificationRead(i),n.setAttribute("data-read","1"),n.classList.remove("topbar-notification--unread");let o=Math.max(0,Number(t.textContent.replace("+",""))-1);t.textContent=String(o)}catch{}})})}catch{e.innerHTML='<li class="topbar-notifications__empty">Notifications are unavailable right now.</li>',t.textContent="0"}}function Fn(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?` href="#${Oe(t.action_url)}"`:"";return`<li class="topbar-notification topbar-notification--${a} ${e.read?"":"topbar-notification--unread"}" data-notification-id="${Oe(e.id)}" data-read="${e.read?"1":"0"}"><i class="bi ${s} topbar-notification__icon"></i><div class="topbar-notification__body"><div class="topbar-notification__title">${Oe(t.title||"Notification")}</div><div class="topbar-notification__text">${Oe(t.message||"")}</div>${r?`<a class="topbar-notification__action"${r}>Open</a>`:""}</div></li>`}function Oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function In(e,t,a,s){return{tag:"li",props:{class:`topbar-notification topbar-notification--${s}`},children:[{tag:"i",props:{class:`bi ${a} topbar-notification__icon`},children:[]},{tag:"div",props:{class:"topbar-notification__body"},children:[{tag:"div",props:{class:"topbar-notification__title"},children:[e]},{tag:"div",props:{class:"topbar-notification__text"},children:[t]}]}]}}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-notifications-panel");t&&t.classList.contains("topbar-notifications--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__notifications")&&t.classList.remove("topbar-notifications--open")});function Rn(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[qs(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function Dn(){let e=m.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>Cs(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[qs(),Hn(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await he(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}h();q();function js(){return N(()=>!!ne.get(),()=>{let e=ne.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}y();function Ps(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{c.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let r=[];a.facebook&&r.push(`<a href="${Ue(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&r.push(`<a href="${Ue(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&r.push(`<a href="${Ue(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&r.push(`<a href="${Ue(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=r.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function Ue(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}h();var On=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],Un=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"}];function Jn(){let e=m.get();return e&&e.is_admin?Un:On}function Wn({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${k.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:r=>{r.preventDefault(),g(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function Gn(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function zn(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:Jn().map(e=>e.separator?Gn():Wn(e))}}function la(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&la()},!0),window.addEventListener("resize",()=>setTimeout(la,50)),document.addEventListener("hnav:rendered",()=>setTimeout(la,0)));function Ns(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[zn()]}}function Hs(){let e=()=>!!m.get()?.is_admin,t=()=>k.get().startsWith("/admin"),a=()=>x.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[N(()=>x.get(),()=>Ts(),()=>null),N(()=>x.get(),()=>xs(),()=>null),N(()=>x.get(),()=>Es(),()=>null),N(()=>x.get(),()=>As(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[Ms(),N(()=>x.get()&&!e(),()=>Ns(),()=>null),{tag:"main",props:{class:"app-main"},children:[Vn()]},Ps()]},js()]}}function Vn(){let t=k.get().split("?")[0]||"/",a=De.find(r=>r.path===t),s=m.get();return s&&s.is_admin&&!t.startsWith("/admin")?(g("/admin"),ca()):a?a.requireAuth&&!x.get()?(g("/login"),ca()):a.requireAdmin&&(!m.get()||!m.get().is_admin)?Kn():!a.requireAuth&&x.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(g("/"),ca()):Xn(a):Yn()}function Xn(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function Yn(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>g("/")},children:["Go home"]}]}}function Kn(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>g("/")},children:["Go home"]}]}}function ca(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}q();h();ot();ta();ra();na();ia();pt();we();ct();Lt();mt();ke();Rt();Ut();gt();ht();yt();wt();kt();y();h();var u={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function Fs(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
        ...
        `,u.categories.length===0)try{let t=await c.categories();u.categories=Array.isArray(t.data)?t.data:[];let a=document.getElementById("jobs-category");a&&(a.innerHTML=Bs())}catch{}document.getElementById("jobs-apply")?.addEventListener("click",()=>{Zn(),u.page=1,Je()}),document.getElementById("jobs-reset")?.addEventListener("click",()=>{u.search="",u.categoryId="",u.minBudget="",u.maxBudget="",u.sort="latest",u.page=1,Qn(),Je()}),document.getElementById("jobs-search")?.addEventListener("keydown",t=>{t.key==="Enter"&&document.getElementById("jobs-apply")?.click()}),await Je()}}}function Bs(){return'<option value="">All categories</option>'+u.categories.map(e=>`<option value="${B(e.id)}" ${String(e.id)===String(u.categoryId)?"selected":""}>${B(e.name)}</option>`).join("")}function Zn(){u.search=document.getElementById("jobs-search")?.value.trim()||"",u.categoryId=document.getElementById("jobs-category")?.value||"",u.minBudget=document.getElementById("jobs-min-budget")?.value.trim()||"",u.maxBudget=document.getElementById("jobs-max-budget")?.value.trim()||"",u.sort=document.getElementById("jobs-sort")?.value||"latest"}function Qn(){let e={"jobs-search":u.search,"jobs-category":u.categoryId,"jobs-min-budget":u.minBudget,"jobs-max-budget":u.maxBudget,"jobs-sort":u.sort};Object.entries(e).forEach(([t,a])=>{let s=document.getElementById(t);s&&(s.value=a)})}async function Je(){let e=document.getElementById("jobs-grid");if(!e)return;let t=++u.requestSerial;u.loading=!0,e.innerHTML='<div class="spinner"></div>';try{let a={page:u.page,per_page:u.perPage,sort:u.sort};u.search&&(a.search=u.search),u.categoryId&&(a.category_id=u.categoryId),u.minBudget!==""&&(a.min_budget=u.minBudget),u.maxBudget!==""&&(a.max_budget=u.maxBudget);let s=await c.jobs(a);if(t!==u.requestSerial)return;u.jobs=Array.isArray(s.data)?s.data:[],u.total=Number(s.meta?.total||0),u.lastPage=Math.max(1,Number(s.meta?.last_page||1)),ei()}catch(a){if(t!==u.requestSerial)return;e.innerHTML=`<p class="muted">Failed to load jobs: ${B(a.message||"unknown error")}</p>`,Is(),Rs()}finally{t===u.requestSerial&&(u.loading=!1)}}function ei(){let e=document.getElementById("jobs-grid");if(e){if(Is(),Rs(),u.jobs.length===0){e.innerHTML='<p class="muted">No jobs match your filters. Try clearing them.</p>';return}e.innerHTML=u.jobs.map(t=>`
        <a class="job-card" href="#/jobs/${encodeURIComponent(t.id)}" data-id="${B(t.id)}">
            <div class="job-card__head">
                ${t.category&&t.category.icon_class?`<i class="bi ${ti(t.category.icon_class)} job-card__cat-icon"></i>`:""}
            ...
            <p class="job-card__desc">${B(ai(t.description,140))}</p>
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>u.lastPage||a===u.page||(u.page=a,Je())})})}}function ti(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function ai(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function B(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();h();var da={bids:[],loading:!1};function Ds(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await c.workerBids();da.bids=t.data||[],si()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${Os(t.message||"unknown")}</p>`}}}}function si(){let e=document.getElementById("bids-list");if(e){if(da.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=da.bids.map(t=>`
    ...
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),g(`/jobs/${t.getAttribute("data-id")}`)})})}}function ri(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function Os(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();h();var pe={jobs:[],submissions:[],loading:!1};function pa(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);pe.jobs=t.data||[],pe.submissions=a.data||[],ni()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${ua(t.message||"unknown")}</p>`}}}}function ni(){let e=document.getElementById("active-jobs-list");if(e){if(pe.jobs.length===0){e.innerHTML=`<p class="muted">No active jobs. Once a poster accepts your bid, it'll appear here.</p>`;return}e.innerHTML=pe.jobs.map(t=>{let a=pe.submissions.find(r=>r.job_id===t.id),s=t.status;return`
        ...
        `}).join(""),li()}}function ii(e,t){return`
        <div class="active-job-card__sub">
            <strong>Submitted:</strong> ${ci(t.created_at)}
    ...
    `}function li(){document.querySelectorAll("form.submit-form").forEach(e=>{e.addEventListener("submit",async t=>{t.preventDefault();let a=parseInt(e.getAttribute("data-job-id"),10),s=new FormData(e),r=e.querySelector("[data-submit-btn]");r.disabled=!0,r.innerHTML='<i class="bi bi-hourglass"></i> Submitting\u2026';try{await c.submitWork(a,{description:String(s.get("description")||"").trim(),external_link:String(s.get("external_link")||"").trim()||null}),l("Work submitted!","success"),pa()()}catch(n){l(n.message||"Failed to submit.","error")}finally{r.disabled=!1,r.innerHTML='<i class="bi bi-send"></i> Submit Work'}})})}function ci(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ua(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();h();var We={categories:[],loading:!1};function Us(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,pi(),await Ge()}}async function Ge(){let e=document.getElementById("cat-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminCategories();We.categories=t.data||[],di()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${ue(t.message||"unknown")}</p>`}}}function di(){let e=document.getElementById("cat-list");if(e){if(We.categories.length===0){e.innerHTML='<p class="muted">No categories yet. Add one below.</p>';return}e.innerHTML=We.categories.map(t=>`
    ...
    `).join(""),e.querySelectorAll("[data-toggle]").forEach(t=>t.addEventListener("click",()=>ui(t.getAttribute("data-toggle")))),e.querySelectorAll("[data-delete]").forEach(t=>t.addEventListener("click",()=>mi(t.getAttribute("data-delete"))))}}function pi(){let e=document.getElementById("cat-form");e&&e.addEventListener("submit",async t=>{t.preventDefault();let a=new FormData(e),s={name:String(a.get("name")||"").trim(),slug:String(a.get("slug")||"").trim().toLowerCase(),description:String(a.get("description")||"").trim()||null,icon_class:String(a.get("icon_class")||"").trim()||null,display_order:parseInt(a.get("display_order")||"0",10),is_active:a.get("is_active")==="on"},r=document.getElementById("cat-save-btn");r.disabled=!0,r.textContent="Creating\u2026";try{await c.adminCreateCategory(s),l("Category created.","success"),e.reset(),await Ge()}catch(n){l(n.message||"Failed.","error")}finally{r.disabled=!1,r.textContent="Create Category"}})}async function ui(e){let t=We.categories.find(a=>String(a.id)===String(e));if(t)try{await c.adminUpdateCategory(e,{is_active:!t.is_active}),l(t.is_active?"Category disabled.":"Category enabled.","success"),await Ge()}catch(a){l(a.message||"Failed.","error")}}async function mi(e){if(confirm("Delete this category? It will be deactivated if jobs are attached."))try{let t=await c.adminDeleteCategory(e);l(t.message||"Done.","success"),await Ge()}catch(t){l(t.message||"Failed.","error")}}function ue(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();h();var O={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1};function Js(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await Ws()}}async function Ws(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a,s]=await Promise.all([c.adminSettings(),c.socialLinks(),c.notices()]);O.grouped=t.data||{},O.social=a||{},O.noticesData=s||{interval:4,notices:[]},bi()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${P(t.message||"unknown")}</p>`}}}function bi(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(O.grouped).map(i=>`
        <div class="card settings-group">
            <h3 class="card__title">${P(i.charAt(0).toUpperCase()+i.slice(1))}</h3>
            <div class="settings-group__rows">
                ${O.grouped[i].map(o=>fi(i,o)).join("")}
            </div>
        </div>
    `).join(""),s=O.noticesData,r=Array.isArray(s.notices)&&s.notices.length?s.notices:["Complete tasks, watch ads, refer friends, and withdraw anytime."];a+=`
        ...
        <div class="card settings-group" style="margin-top:20px;">
            ...
            <div class="settings-group__rows">
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-facebook" value="${P(n.facebook||"")}" placeholder="https://facebook.com/yourpage" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-instagram" value="${P(n.instagram||"")}" placeholder="https://instagram.com/yourprofile" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-whatsapp" value="${P(n.whatsapp||"")}" placeholder="https://wa.me/1234567890" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-telegram" value="${P(n.telegram||"")}" placeholder="https://t.me/yourchannel" class="settings-row__input">
                    </div>
                </div>
            </div>
        </div>
    ...
    `,e.innerHTML=a,document.getElementById("settings-save-btn").addEventListener("click",vi),document.getElementById("add-notice-btn").addEventListener("click",gi),ma()}function Gs(e,t=""){return`
        <div class="banner-message-row">
            <span class="banner-message-num">Message ${e}:</span>
            <input type="text" class="settings-row__input notice-msg-input" value="${P(t)}" placeholder="e.g. Complete tasks, watch ads, refer friends...">
            <button type="button" class="btn btn--danger btn--sm remove-notice-btn" title="Remove message">
                <i class="bi bi-trash"></i>
            </button>
        </div>
    `}function gi(){let e=document.getElementById("notice-messages-container");if(!e)return;let t=e.querySelectorAll(".banner-message-row").length+1,a=document.createElement("div");a.innerHTML=Gs(t,"");let s=a.firstElementChild;e.appendChild(s),ma(),s.querySelector("input")?.focus()}function ma(){let e=document.getElementById("notice-messages-container");if(!e)return;e.querySelectorAll(".banner-message-row").forEach((a,s)=>{let r=a.querySelector(".banner-message-num");r&&(r.textContent=`Message ${s+1}:`);let n=a.querySelector(".remove-notice-btn");n&&(n.onclick=()=>{e.querySelectorAll(".banner-message-row").length>1?(a.remove(),ma()):l("At least one message textbox is required.","warning")})})}function fi(e,t){let a=`set-${t.key.replace(/[^a-z0-9]/gi,"_")}`,s;switch(t.value_type){case"boolean":s=`<label class="settings-row__check"><input type="checkbox" id="${a}" ${t.value?"checked":""}></label>`;break;case"integer":case"percent":s=`<input type="number" step="1" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"decimal":s=`<input type="number" step="0.0001" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"json":s=`<textarea id="${a}" rows="3" class="settings-row__input">${P(JSON.stringify(t.value,null,2)||"")}</textarea>`;break;default:s=`<input type="text" id="${a}" value="${P(String(t.value))}" class="settings-row__input">`}return`
        <div class="settings-row">
    ...
    `}async function vi(){let e={};for(let i of Object.keys(O.grouped))for(let o of O.grouped[i]){let d=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,b=document.getElementById(d);if(!b)continue;let f;o.value_type==="boolean"?f=b.checked:o.value_type==="integer"||o.value_type==="percent"?f=parseInt(b.value,10):o.value_type==="decimal"?f=parseFloat(b.value):o.value_type==="json"?f=b.value?JSON.parse(b.value):null:f=b.value,e[o.key]=f}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".notice-msg-input")).map(i=>i.value.trim()).filter(Boolean),r={interval:document.getElementById("notice-interval")?.value||4,notices:s.length?s:["Complete tasks, watch ads, refer friends, and withdraw anytime."]},n=document.getElementById("settings-save-btn");n.disabled=!0,n.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(r)]),l("Settings, notices, and social links saved successfully.","success"),await Ws()}catch(i){l(i.message||"Failed to save.","error")}finally{n.disabled=!1,n.textContent="Save All Changes"}}function P(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}zt();Kt();Qt();Ct();qt();Pt();Bt();xt();var Qs={"/":ye,"/refer":dt,"/webtask":ie,"/tasks":ie,"/earn":_e,"/tg-tasks":Me,"/withdraw":$e,"/profile":Se,"/wallet":Se,"/admin":It,"/admin/payments":Ot,"/admin/categories":Us,"/admin/settings":Js,"/admin/jobs":Gt,"/admin/transactions":Yt,"/admin/reports":Zt,"/deposit":bt,"/leaderboard":Te,"/achievements":xe,"/support":Le,"/settings":Ae,"/jobs/available":Fs,"/worker/bids":Ds,"/worker/active-jobs":pa,"/poster":At,"/poster/post-job":Mt,"/poster/jobs":jt,"/poster/wallet":Ht,"/notifications":Tt,"/login":ea,"/register":sa,"/forgot-password":Ie,"/reset-password":Re};function er(){ze(),setTimeout(ze,50),window.addEventListener("hashchange",ze),$(()=>{x.get(),setTimeout(ze,0)})}async function ze(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!Qs[t]){let i=t.match(/^\/jobs\/(\d+)$/);if(i){let d=await Promise.resolve().then(()=>(Vs(),zs));await ga(()=>d.JobDetailPage(i[1]),t);return}let o=t.match(/^\/poster\/jobs\/(\d+)$/);if(o){if(!x.get()){g("/login");return}let d=await Promise.resolve().then(()=>(Zs(),Ks));await ga(()=>d.PosterJobDetailPage(o[1]),t);return}t="/"}let a=x.get(),s=m.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?g("/admin"):g("/");return}if(!r.includes(t)&&!a){g("/login");return}if(t==="/"&&s&&s.is_admin){g("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){ji();return}let n=Qs[t];await ga(n,t)}async function ga(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function ji(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}h();var tr=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();tr.innerHTML="";F(Hs(),tr);I.get()&&E();er();
