var tr=Object.defineProperty;var f=(e,t)=>()=>(e&&(t=e(e=0)),t);var w=(e,t)=>{for(var a in t)tr(e,a,{get:t[a],enumerable:!0})};function ar(e,t){va?va(e,t):console.error("[Ghost] Unhandled effect error:",e)}function A(e){let t=e,a=new Set;return{get(){return C&&(a.add(C),C.dependencies.add(a)),t},set(s){t!==s&&(t=s,ha(a))}}}function ha(e){Ye(()=>{e.forEach(t=>{t.notify?t.notify():be.add(t)})})}function Ye(e){Ve++;try{e()}finally{if(Ve--,Ve===0){let t=Array.from(be);be.clear(),t.forEach(a=>a.run())}}}function $(e){let t={dependencies:new Set,run(){Xe(t),me.push(C),C=t;try{e()}catch(a){ar(a,e)}finally{C=me.pop()}},notify(){be.add(t)}};return t.run(),()=>Xe(t)}function Ke(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,ha(s))}};return{get(){if(C&&(s.add(C),C.dependencies.add(s)),a){Xe(r),me.push(C),C=r;try{t=e()}finally{C=me.pop()}a=!1}return t}}}function Xe(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var C,me,be,Ve,va,J=f(()=>{C=null,me=[],be=new Set,Ve=0,va=null});function se(){Ze.totalUpdates++,Ze.recentUpdates++}var ge,Ze,Qe=f(()=>{ge=new Set,Ze={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function B(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){sr(e,t);return}if(e.__ghostWhen){rr(e,t);return}if(e.__ghostLazy){ir(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;ge.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let i=s.startsWith("on");typeof r=="function"&&!i?e.effects.push($(()=>{a.setAttribute(s,r()),se(),e.events.update?.forEach(n=>n())})):i?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)B(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push($(()=>{let i=s(),n=document.createTextNode(String(i??""));r?a.replaceChild(n,r):a.appendChild(n),r=n,se(),e.events.update?.forEach(o=>o())}))}else B(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function re(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),ge.delete(e)}}function sr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function d(h){return h.el||null}let g=$(()=>{let h=a(),M=h.map((S,U)=>String(s(S,U))),er=Array.from(o.keys());for(let S of er)if(!M.includes(S)){let U=o.get(S);re(U.ghostNode),o.delete(S)}for(let S=0;S<h.length;S++){let U=M[S];if(!o.has(U)){let ae=r(h[S],S),V=document.createElement("ghost-list-slot");for(B(ae,V);V.firstChild;)t.insertBefore(V.firstChild,n);o.set(U,{ghostNode:ae})}}for(let S=M.length-1;S>=0;S--){let U=M[S],ae=o.get(U);if(!ae)continue;let V=d(ae.ghostNode);if(!V)continue;let ga=M[S+1],fa=(ga?d(o.get(ga)?.ghostNode):null)||n;V.nextSibling!==fa&&t.insertBefore(V,fa)}se()});e._listCleanup=()=>{g();for(let h of o.values())re(h.ghostNode);o.clear(),i.remove(),n.remove()}}function N(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function rr(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=$(()=>{let g=a()?s:r;if(n&&(re(n),n=null),g&&(n=g(),n)){let h=document.createElement("ghost-when-slot");for(B(n,h);h.firstChild;)t.insertBefore(h.firstChild,i)}se()});e._whenCleanup=()=>{o(),n&&re(n),i.remove()}}function ir(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let i=null;if(s){let n=document.createElement("ghost-lazy-slot");for(B(s,n);n.firstChild;)t.insertBefore(n.firstChild,r);i=s}a().then(n=>{let o=n.default||n;i&&(re(i),i=null);let d=typeof o=="function"?o():o,g=document.createElement("ghost-lazy-slot");for(B(d,g);g.firstChild;)t.insertBefore(g.firstChild,r);i=d}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var et=f(()=>{J();Qe()});var ya=f(()=>{J()});var fe=f(()=>{});var wa=f(()=>{Qe()});var _a=f(()=>{J()});var $a=f(()=>{et();J();fe();fe()});function or(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let i={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){i["@attributes"]={};for(let n of r.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of r.childNodes){let o=n.nodeName,d=s(n);d!==""&&(i[o]===void 0?i[o]=d:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(d)))}return i}return s(a.documentElement)}function lr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function at(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),i={url:e,...s};for(let M of at.interceptors.request)i=M(i)??i;let n=i.url;delete i.url;let o=lr(n,r);if(a==="memory"&&r==="GET"&&tt.has(o))return tt.get(o);let d=await fetch(n,i),g=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let h;g.includes("application/xml")||g.includes("text/xml")?h=or(await d.text()):g.includes("application/json")?h=await d.json():h=await d.text();for(let M of at.interceptors.response)h=M(d,h)??h;return a==="memory"&&r==="GET"&&tt.set(o,h),h}var tt,Sa=f(()=>{tt=new Map;at.interceptors={request:[],response:[]}});function st(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=A(a);return $(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var ka=f(()=>{J()});function cr(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var ao,Ta=f(()=>{ao=cr()});var io,dr,xa=f(()=>{J();io=A("en"),dr=new Map;dr.set("en",{})});var q=f(()=>{J();et();ya();fe();wa();_a();$a();Sa();ka();Ta();xa()});function La(e){rt=e}function Ea(e){it=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let i=e.startsWith("http")?e:pr.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};rt&&(n.headers.Authorization=`Bearer ${rt}`),a!==void 0&&(n.body=JSON.stringify(a)),r&&(n.signal=r);let o=await fetch(i,n);if(o.status===401)throw it&&it(),new ve("Unauthorized",401,null);let d=null,g=o.headers.get("content-type")||"";try{if(g.includes("application/json"))d=await o.json();else{let h=await o.text();d=h?{message:h}:null}}catch{}if(!o.ok){let h=d&&d.message||`HTTP ${o.status}`;throw new ve(h,o.status,d)}return d}var pr,rt,it,ve,c,y=f(()=>{pr=window.JMJOB_CONFIG||{apiBase:"/api"},rt=null,it=null;ve=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),notices:()=>p("/notices"),adminUpdateNotices:e=>p("/admin/notices",{method:"POST",body:e}),adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function l(e,t="info",a=3500){ie.set({message:e,type:t,id:Date.now()}),nt&&clearTimeout(nt),nt=setTimeout(()=>ie.set(null),a)}async function E(){if(!I.get())return null;try{let e=await c.me();return m.set(e.data),e.data}catch{return null}}async function Aa(e,t){let a=await c.login({email:e,password:t});return I.set(a.data.token),m.set(a.data.user),a.data.user}async function Ca(e){return c.requestRegistrationOtp(e)}async function Ma(e){let t=await c.verifyRegistrationOtp(e);return I.set(t.data.token),m.set(t.data.user),t.data.user}async function he(){try{await c.logout()}catch{}I.set(null),m.set(null),k.set("/login")}function b(e){window.location.hash=e}var ur,mr,I,m,ie,nt,k,x,v=f(()=>{q();q();y();ur="earnap_token",mr="earnap_user",I=st(ur,null),m=st(mr,null),ie=A(null),nt=null;k=A(window.location.hash.replace(/^#/,"")||"/"),x=Ke(()=>!!I.get()&&!!m.get());$(()=>{let e=I.get();La(e)});Ea(()=>{I.set(null),m.set(null),k.set("/login"),l("Session expired. Please log in.","error")})});var qa={};w(qa,{HomePage:()=>ye});function ye(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=m.get();br(e),e.appendChild(gr(t)),e.appendChild(fr()),e.appendChild(vr(t))}}function Y(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function br(e){X&&(clearInterval(X),X=null);let t=Y("div","welcome-popup","");t.innerHTML=`
    ...
    `;let a=t.querySelector("button");return a&&!a.disabled&&a.addEventListener("click",()=>yr(e,a,t)),t}async function yr(e,t,a){t.disabled=!0,t.textContent="Opening\u2026",window.open(e.target_url,"_blank","noopener,noreferrer");let s=0,r=e.duration_seconds;t.textContent=`Wait ${r}s\u2026`;let n=(await c.webTaskStart({task_id:e.id})).data.completion_id,o=setInterval(()=>{s+=1;let d=r-s;t.textContent=d>0?`Wait ${d}s\u2026`:"Claim Reward",s>=r&&(clearInterval(o),wr(t,n,a))},1e3)}function wr(e,t,a){e.textContent="Claim Reward",e.classList.remove("btn--primary"),e.classList.add("btn--success"),e.disabled=!1,e.onclick=async()=>{e.disabled=!0,e.textContent="Claiming\u2026";try{let s=await c.webTaskClaim({completion_id:t});l("+"+parseFloat(s.data.reward).toFixed(2)+" credited!","success"),await E(),ne()()}catch(s){l(s.message||"Claim failed","error"),e.disabled=!1,e.textContent="Claim Reward"}}}function ja(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var we=f(()=>{y();v()});var Pa={};w(Pa,{EarnPage:()=>_e});function _e(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--earn";let t=m.get(),a=t?t.ads_remaining:0;e.innerHTML=`
        ...
        `;let s=e.querySelector("#watch-btn");s.disabled||s.addEventListener("click",()=>_r())}}function _r(){let e=document.createElement("div");e.className="modal modal--ad",e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{_.selectedGateway=t.getAttribute("data-gateway"),Ia(),Tr()})})}}function Tr(){let e=_.gateways.find(i=>i.key===_.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `,document.getElementById("copy-wallet-btn")?.addEventListener("click",()=>{navigator.clipboard.writeText(e.wallet_number).then(()=>{l("Wallet number copied.","info")}).catch(()=>{l("Could not copy. Please copy manually.","error")})}));let r=document.getElementById("deposit-amount");r&&(r.min=_.minAmount,r.max=_.maxAmount,r.placeholder=`${_.minAmount} \u2013 ${_.maxAmount}`)}function Ba(){let e=document.getElementById("payment-history");if(e){if(_.submissions.length===0){e.innerHTML='<p class="muted">No submissions yet.</p>';return}e.innerHTML=_.submissions.map(t=>{let a=kr[t.status]||{label:t.status,class:""};return`
            <div class="payment-row ${a.class}">
                ...
                <div class="payment-row__date">${xr(t.created_at)}</div>
            </div>
        `}).join("")}}function xr(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function Z(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var kr,_,gt=f(()=>{y();v();kr={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},_={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var vt={};w(vt,{ProfilePage:()=>Se});function Se(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=m.get();e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var wt=f(()=>{v()});function Lr(){let e=localStorage.getItem(Ja);return e==="dark"||e==="light"?e:"system"}function Er(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function _t(e){let t=Er(e);document.documentElement.setAttribute("data-theme",t)}function Wa(){let e=j.get();j.set(e==="dark"?"light":"dark")}function Ga(e){j.set(e)}function Ar(){let e=localStorage.getItem(za);return e&&$t.includes(e)?e:"default"}function Va(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function Xa(e){$t.includes(e)&&oe.set(e)}function Ya(){return $t}var Ja,j,za,$t,oe,St=f(()=>{q();Ja="jmjob_theme";j=A(Lr());_t(j.get());$(()=>{let e=j.get();_t(e),localStorage.setItem(Ja,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{j.get()==="system"&&_t("system")});za="jmjob_color_theme",$t=["default","emerald","amber","rose"];oe=A(Ar());Va(oe.get());$(()=>{let e=oe.get();Va(e),localStorage.setItem(za,e)})});var Ka={};w(Ka,{default:()=>Ae});async function Ae(){let e=document.querySelector("[data-view]");if(!e)return;let t=m.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=j.get(),s=oe.get(),r=Ya();e.innerHTML=`
                    ...
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${Ee[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${Cr[o]};"></span>
    ...
    `;let i=document.getElementById("theme-mode-group");i&&i.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-mode");Ga(d),l(`Theme mode set to ${d}.`,"info")})});let n=document.getElementById("color-theme-group");n&&n.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-color");Xa(d),l(`Accent color set to ${Ee[d]||d}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await he(),l("Logged out.","info")})}var Ee,Cr,kt=f(()=>{v();St();Ee={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},Cr={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var Qa={};w(Qa,{NotificationsPage:()=>Tt});function Tt(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `;let t=e.querySelector("#tg-list");try{let s=(await c.tgTasks()).data||[];if(t.innerHTML="",s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}s.forEach(r=>t.appendChild(jr(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function jr(e){let t=document.createElement("div");if(t.className="card card--task",t.innerHTML=`
    ...
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&Pr(e,t)},3e3)})}return t}async function Pr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await E(),Me()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ce(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Lt=f(()=>{y();v()});var ss={};w(ss,{PosterDashboardPage:()=>At});function At(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-dashboard";let t=m.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML=`
        ...
        `;let a=e.querySelector("#poster-new-job");a&&a.addEventListener("click",s=>{s.preventDefault(),b("/poster/post-job")}),await ts()}}async function ts(){let e=document.getElementById("poster-dashboard-content");if(e)try{let t=await c.posterStats();Hr(e,t.data||{})}catch(t){e.innerHTML=`
            <div class="card">
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",ts),l(t.message||"Failed to load poster statistics.","error")}}function Hr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=Et(t.wallet_balance),i=Et(t.frozen_balance),n=Et(t.total_spent);e.innerHTML=`
    ...
    `}function Q(e,t){let a=Number(t||0);return`
        <div class="poster-status-row">
            <span><i class="bi ${Fr(e)}"></i> ${Nr[e]||e}</span>
            <strong>${a}</strong>
        </div>
    `}function Fr(e){return{open:"bi-megaphone",in_review:"bi-search",assigned:"bi-person-check",submitted:"bi-inbox",revision:"bi-arrow-repeat",completed:"bi-check-circle"}[e]||"bi-circle"}function Et(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function as(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Nr,Ct=f(()=>{y();v();Nr={open:"Open",in_review:"In review",assigned:"Assigned",submitted:"Awaiting review",revision:"Revision requested",completed:"Completed",cancelled:"Cancelled",expired:"Expired",disputed:"Disputed"}});var rs={};w(rs,{PostJobPage:()=>Mt});function Mt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--post-job",!Dr()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#post-job-cancel").addEventListener("click",()=>b("/poster")),await Br(e),Ir(e)}}}async function Br(e){let t=e.querySelector("#post-job-category");try{let s=(await c.categories()).data||[];t.innerHTML=s.length?'<option value="">Choose a category\u2026</option>'+s.map(r=>`<option value="${Number(r.id)}">${Or(r.name)}</option>`).join(""):'<option value="">No active categories</option>'}catch(a){t.innerHTML='<option value="">Unable to load categories</option>',l(a.message||"Could not load categories.","error")}}function Ir(e){let t=e.querySelector("#post-job-form");t.addEventListener("submit",async a=>{a.preventDefault();let s=new FormData(t),r=e.querySelector("#post-job-submit");r.disabled=!0,r.textContent="Publishing\u2026";try{await c.posterCreateJob({category_id:Number(s.get("category_id")),title:String(s.get("title")||"").trim(),description:String(s.get("description")||"").trim(),requirements:String(s.get("requirements")||"").trim()||null,budget:Number(s.get("budget")),deadline_at:Rr(s.get("deadline_at")),bidding_window_hours:Number(s.get("bidding_window_hours"))}),l("Job published successfully.","success"),b("/poster/jobs")}catch(i){l(i.message||"Could not publish job.","error")}finally{r.disabled=!1,r.textContent="Publish job"}})}function Rr(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function Dr(){return!!m.get()}function Or(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var qt=f(()=>{y();v()});var ns={};w(ns,{PosterJobsPage:()=>jt});function jt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--poster-jobs",!Gr()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
            ...
            <div class="poster-filter-bar">
                <label>Status
                    <select class="admin-select" id="poster-job-filter">
                        ${Ur.map(t=>`<option value="${t}" ${t===Pe?"selected":""}>${t?is(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#poster-jobs-new").addEventListener("click",t=>{t.preventDefault(),b("/poster/post-job")}),e.querySelector("#poster-job-filter").addEventListener("change",async t=>{Pe=t.target.value,await je()}),e.querySelector("#poster-jobs-refresh").addEventListener("click",je),await je()}}}async function je(){let e=document.getElementById("poster-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=((await c.posterMyJobs()).data||[]).filter(s=>!Pe||s.status===Pe);e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(Jr(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${ee(t.message||"unknown error")}</p>`}}}function Jr(e){let t=document.createElement("article");return t.className=`admin-row poster-job-row poster-job-row--${ee(e.status)}`,t.innerHTML=`
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>b(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>Wr(e.id)),t}async function Wr(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await c.posterCancelJob(e,{reason:t}),l("Job cancelled.","success"),await je()}catch(a){l(a.message||"Could not cancel job.","error")}}function Gr(){return!!m.get()}function is(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function zr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ur,Pe,Pt=f(()=>{y();v();Ur=["","open","assigned","submitted","revision","completed","cancelled","disputed"],Pe=""});var os={};w(os,{PosterWalletPage:()=>Ht});function Ht(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-wallet";let t=m.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([c.posterStats(),c.paymentSubmissions()]);Vr(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${Ne(a.message||"unknown error")}</p>`}}}function Vr(e,t,a){let s=Nt(t.wallet_balance),r=Nt(t.frozen_balance),i=Nt(t.total_spent);e.innerHTML=`
    ...
    `,a.querySelector(".provider-save").addEventListener("click",async()=>{let i={block_id:a.querySelector(".provider-block-id").value.trim()||null,weight:parseInt(a.querySelector(".provider-weight").value,10)||0,reward_per_view:parseFloat(a.querySelector(".provider-reward").value)||0,min_duration_seconds:parseInt(a.querySelector(".provider-duration").value,10)||12,enabled:a.querySelector(".provider-enabled").checked};try{await c.adminUpdateProvider(e.id,i),l("Provider saved","success")}catch(n){l(n.message,"error")}}),a}function L(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Rt=f(()=>{y();v();v()});var ms={};w(ms,{AdminPaymentsPage:()=>Ot});function Ot(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{R.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),Dt()})}),await Dt()}}async function Dt(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(R.status);R.items=t.data||[],Qr(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${K(t.message||"Failed to load.")}</p>`}}}function Qr(e){if(R.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",R.items.forEach(t=>e.appendChild(ei(t)))}function ei(e){let t=Zr[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,e.status==="pending"&&(a.querySelector('[data-action="approve"]')?.addEventListener("click",()=>ps(e.id,"approve",a)),a.querySelector('[data-action="reject"]')?.addEventListener("click",()=>ps(e.id,"reject",a))),a}async function ps(e,t,a){let s=prompt(t==="approve"?"Optional note for approval:":"Reason for rejection:");if(s!==null)try{let i=await(t==="approve"?c.adminApprovePayment:c.adminRejectPayment)(e,{note:s||null});l(i.message||"Done.","success"),await Dt()}catch(r){l(r.message||"Action failed.","error")}}function us(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function K(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Zr,R,Ut=f(()=>{y();v();Zr={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},R={status:"pending",items:[],loading:!1}});var gs={};w(gs,{AdminJobsPage:()=>Gt});function Gt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-jobs",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Status
                    <select class="admin-select" id="admin-job-status">
                        ${ti.map(t=>`<option value="${t}" ${t===Wt?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-job-status").addEventListener("change",async t=>{Wt=t.target.value,await ce()}),e.querySelector("#admin-job-refresh").addEventListener("click",ce),await ce()}}}async function ce(){let e=document.getElementById("admin-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminJobs(Wt)).data||[];e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(ai(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${H(t.message||"unknown error")}</p>`}}}function ai(e){let t=document.createElement("article");t.className=`admin-row admin-job-row admin-job-row--${H(e.status)}`;let a=e.worker?`${H(e.worker.name)} <span class="muted">(${H(e.worker.email||"")})</span>`:'<span class="muted">Unassigned</span>';t.innerHTML=`
    ...
    `;let s=t.querySelector(".admin-row__actions");return["completed","cancelled","disputed"].includes(e.status)||s.appendChild(Jt("Mark disputed","btn--danger",()=>si(e.id))),e.status==="disputed"&&(s.appendChild(Jt("Release payment","btn--success",()=>bs(e.id,"release"))),s.appendChild(Jt("Cancel and refund","btn--danger",()=>bs(e.id,"cancel")))),t}function Jt(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function si(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await ce()}catch(t){l(t.message||"Could not flag job.","error")}}async function bs(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ce()}catch(r){l(r.message||"Could not resolve dispute.","error")}}function ri(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function H(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ti,Wt,zt=f(()=>{y();v();ti=["","open","in_review","assigned","submitted","revision","disputed","completed","cancelled","expired"],Wt=""});var fs={};w(fs,{AdminTransactionsPage:()=>Yt});function Yt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Type
                    <select class="admin-select" id="admin-transaction-type">
                        ${ii.map(t=>`<option value="${t}" ${t===Xt?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All transactions"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{Xt=t.target.value,await Vt()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",Vt),await Vt()}}}async function Vt(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminTransactions({type:Xt})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(ni(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${D(t.message||"unknown error")}</p>`}}}function ni(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${D(e.type)}`,t.innerHTML=`
        ...
        <div class="admin-transaction-row__meta">
            ...
            <span><strong>Date:</strong> ${oi(e.created_at)}</span>
        </div>
    ...
    `,t}function oi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function D(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ii,Xt,Kt=f(()=>{y();v();ii=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],Xt=""});var vs={};w(vs,{AdminReportsPage:()=>Zt});function Zt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await li()}}}async function li(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            ...
            <div class="admin-report-grid">
                <div class="card">
                    ...
                    <div class="admin-report-list">${ci(a.transactions||[])}</div>
                </div>
                <div class="card">
                    <h3 class="card__title">Jobs by status</h3>
                    <div class="admin-report-list">${di(a.jobs||[])}</div>
                </div>
            </div>
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${de(t.message||"unknown error")}</p>`}}function He(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${de(e)}</span><strong>${de(t)}</strong></div>`}function ci(e){return e.length?e.map(t=>`
    ...
    `).join(""):'<p class="muted">No transactions yet.</p>'}function di(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
    ...
    `).join(""):'<p class="muted">No jobs yet.</p>'}function Fe(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Be(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function de(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Qt=f(()=>{y();v()});var hs={};w(hs,{LoginPage:()=>ea});function ea(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
            ...
            ${t?`<p class="auth-card__referral">Referred by <strong>${pi(t)}</strong></p>`:""}
    ...
    `;let t=document.getElementById("forgot-form"),a=document.getElementById("submit-btn");t.addEventListener("submit",async s=>{s.preventDefault();let r=t.email.value.trim();if(!r){l("Please enter your email address.","error");return}a.disabled=!0,a.textContent="Sending...";try{await c.forgotPassword({email:r}),l("If an account exists with this email, you will receive a reset code.","success"),b(`/reset-password?email=${encodeURIComponent(r)}`)}catch(i){l(i.message||"Failed to send reset code.","error"),a.disabled=!1,a.textContent="Send Reset Code"}})}var ia=f(()=>{y();v()});var $s={};w($s,{default:()=>Re});async function Re(){let e=document.querySelector("[data-view]");if(!e)return;let a=(new URLSearchParams(window.location.hash.split("?")[1]).get("email")||"").trim().toLowerCase();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--auth",e.innerHTML=`
        <div class="auth-card">
            ...
            <form class="auth-form" id="reset-form">
                <label class="auth-form__label">
                    Email Address
                    <input type="email" name="email" value="${ui(a)}" placeholder="you@example.com" required autocomplete="email">
                </label>
    ...
    `).join(""):'<p class="muted">No work submitted yet.</p>'}async function kn(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await c.posterAcceptBid(e,t),l("Worker selected and escrow held.","success"),await ma(e)}catch(a){l(a.message||"Could not select worker.","error")}}async function Tn(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await c.posterReleasePayment(e,{submission_id:Number(t)}),l("Payment released.","success"),await ma(e)}catch(a){l(a.message||"Could not release payment.","error")}}async function xn(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await c.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),l("Revision requested.","success"),await ma(e)}catch(s){l(s.message||"Could not request revision.","error")}}async function Ln(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await c.posterCancelJob(e,{reason:"Cancelled by poster"}),l("Job cancelled.","success"),b("/poster/jobs")}catch(t){l(t.message||"Could not cancel job.","error")}}async function ma(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await zs(e))}function En(){return!!m.get()}function An(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function Vs(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ys=f(()=>{y();v()});q();v();q();v();var De=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ot(),qa))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(we(),lt))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(we(),lt))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ct(),Pa))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(pt(),Ha))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(mt(),Fa))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(gt(),Ra))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ke(),vt))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ht(),Da))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(yt(),Oa))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(wt(),Ua))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(kt(),Ka))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(xt(),Qa))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ke(),vt))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Lt(),es))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ct(),ss))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(qt(),rs))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Pt(),ns))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ft(),os))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Rt(),ds))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ut(),ms))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(zt(),gs))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Kt(),fs))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Qt(),vs))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ta(),hs))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ra(),ws))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ia(),_s))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(na(),$s))}],Pl=$(()=>{let e=k.get().split("?")[0]||"/";return De.find(t=>t.path===e)||De[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";k.set(e)});q();v();q();var mi=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],bi=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],gi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function fi(){let e=m.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...bi];let t=[...mi];return e&&e.role==="poster"&&t.push({separator:!0},...gi),t}var Ss="sidebar_collapsed",te=A(localStorage.getItem(Ss)==="true");function vi(){let e=!te.get();te.set(e),localStorage.setItem(Ss,String(e))}function ks(){let e=()=>k.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${te.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[hi(),yi(),wi()]}}function hi(){let e=()=>k.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function yi(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>vi(),title:()=>te.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${te.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function wi(){return{tag:"nav",props:{class:"sidebar__nav"},children:fi().map(e=>e.header?_i(e.header):e.separator?$i():Si(e))}}function _i(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function $i(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function Si({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${k.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>te.get()?t:"",onclick:r=>{r.preventDefault(),b(e),xs()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function Ts(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>xs()},children:[]}}function xs(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}v();q();v();var ki=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],Ti=[{path:"/admin",label:"Admin Panel",icon:"bi-shield-lock"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Oversight",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Transactions",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Settings",icon:"bi-sliders"}],xi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Li(){let e=m.get();if(e&&e.is_admin)return Ti;let t=[...ki];return e&&e.role==="poster"&&t.push({separator:!0},...xi),t}function Ei({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${k.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:r=>{r.preventDefault(),b(e),oa()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function Ai(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>oa()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function Ci(){return{tag:"nav",props:{class:"mobile-nav__list"},children:Li().map(e=>e.separator?Mi():Ei(e))}}function Mi(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function Ls(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[Ai(),Ci()]}}function Es(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>oa()},children:[]}}function As(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function oa(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}St();y();function Cs(){return N(()=>x.get(),()=>Bi(),()=>Fi())}function Ms(){let e=()=>{let t=j.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>Wa(),"data-theme":()=>j.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function qi(){let e=document.getElementById("topbar-notifications-panel");if(!e)return;let t=e.classList.contains("topbar-notifications--open");document.querySelectorAll(".topbar-notifications--open").forEach(a=>a.classList.remove("topbar-notifications--open")),t||e.classList.add("topbar-notifications--open")}function ji(){return setTimeout(Pi,0),{tag:"div",props:{class:"topbar__notifications-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__notifications","aria-label":"Notifications",onclick:e=>{e.stopPropagation(),qi()}},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge",id:"topbar-notification-badge","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-notifications",id:"topbar-notifications-panel"},children:[{tag:"div",props:{class:"topbar-notifications__header"},children:[{tag:"strong",props:{},children:["Notifications"]},{tag:"button",props:{class:"topbar-notifications__close","aria-label":"Close",onclick:()=>{let e=document.getElementById("topbar-notifications-panel");e&&e.classList.remove("topbar-notifications--open")}},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]},{tag:"ul",props:{class:"topbar-notifications__list",id:"topbar-notifications-list"},children:[Hi("Loading notifications\u2026","Your latest updates will appear here.","bi-hourglass-split","info")]},{tag:"div",props:{class:"topbar-notifications__footer"},children:[{tag:"a",props:{href:"#/notifications",class:"topbar-notifications__link"},children:["View all notifications"]}]}]}]}}async function Pi(){let e=document.getElementById("topbar-notifications-list"),t=document.getElementById("topbar-notification-badge");if(!(!e||!t))try{let a=await c.notifications({limit:5}),s=Array.isArray(a.data)?a.data:[],r=Number(a.meta?.unread_count||s.filter(i=>!i.read).length||0);t.textContent=r>99?"99+":String(r),e.innerHTML=s.length?s.map(Ni).join(""):'<li class="topbar-notifications__empty">No notifications yet.</li>',e.querySelectorAll("[data-notification-id]").forEach(i=>{i.addEventListener("click",async()=>{let n=i.getAttribute("data-notification-id");if(!(!n||i.getAttribute("data-read")==="1"))try{await c.notificationRead(n),i.setAttribute("data-read","1"),i.classList.remove("topbar-notification--unread");let o=Math.max(0,Number(t.textContent.replace("+",""))-1);t.textContent=String(o)}catch{}})})}catch{e.innerHTML='<li class="topbar-notifications__empty">Notifications are unavailable right now.</li>',t.textContent="0"}}function Ni(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?` href="#${Oe(t.action_url)}"`:"";return`<li class="topbar-notification topbar-notification--${a} ${e.read?"":"topbar-notification--unread"}" data-notification-id="${Oe(e.id)}" data-read="${e.read?"1":"0"}"><i class="bi ${s} topbar-notification__icon"></i><div class="topbar-notification__body"><div class="topbar-notification__title">${Oe(t.title||"Notification")}</div><div class="topbar-notification__text">${Oe(t.message||"")}</div>${r?`<a class="topbar-notification__action"${r}>Open</a>`:""}</div></li>`}function Oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Hi(e,t,a,s){return{tag:"li",props:{class:`topbar-notification topbar-notification--${s}`},children:[{tag:"i",props:{class:`bi ${a} topbar-notification__icon`},children:[]},{tag:"div",props:{class:"topbar-notification__body"},children:[{tag:"div",props:{class:"topbar-notification__title"},children:[e]},{tag:"div",props:{class:"topbar-notification__text"},children:[t]}]}]}}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-notifications-panel");t&&t.classList.contains("topbar-notifications--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__notifications")&&t.classList.remove("topbar-notifications--open")});function Fi(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[Ms(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function Bi(){let e=m.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>As(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[Ms(),ji(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await he(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}v();q();function qs(){return N(()=>!!ie.get(),()=>{let e=ie.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}y();function js(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{c.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let r=[];a.facebook&&r.push(`<a href="${Ue(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&r.push(`<a href="${Ue(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&r.push(`<a href="${Ue(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&r.push(`<a href="${Ue(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=r.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function Ue(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}v();var Ii=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],Ri=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"}];function Di(){let e=m.get();return e&&e.is_admin?Ri:Ii}function Oi({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${k.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:r=>{r.preventDefault(),b(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function Ui(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function Ji(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:Di().map(e=>e.separator?Ui():Oi(e))}}function la(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&la()},!0),window.addEventListener("resize",()=>setTimeout(la,50)),document.addEventListener("hnav:rendered",()=>setTimeout(la,0)));function Ps(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[Ji()]}}function Ns(){let e=()=>!!m.get()?.is_admin,t=()=>k.get().startsWith("/admin"),a=()=>x.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[N(()=>x.get(),()=>ks(),()=>null),N(()=>x.get(),()=>Ts(),()=>null),N(()=>x.get(),()=>Ls(),()=>null),N(()=>x.get(),()=>Es(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[Cs(),N(()=>x.get()&&!e(),()=>Ps(),()=>null),{tag:"main",props:{class:"app-main"},children:[Wi()]},js()]},qs()]}}function Wi(){let t=k.get().split("?")[0]||"/",a=De.find(r=>r.path===t),s=m.get();return s&&s.is_admin&&!t.startsWith("/admin")?(b("/admin"),ca()):a?a.requireAuth&&!x.get()?(b("/login"),ca()):a.requireAdmin&&(!m.get()||!m.get().is_admin)?Vi():!a.requireAuth&&x.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(b("/"),ca()):Gi(a):zi()}function Gi(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function zi(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>b("/")},children:["Go home"]}]}}function Vi(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>b("/")},children:["Go home"]}]}}function ca(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}q();v();ot();ta();ra();ia();na();pt();we();ct();Lt();mt();ke();Rt();Ut();gt();ht();yt();wt();kt();y();v();var u={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function Fs(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
        ...
        <a class="job-card" href="#/jobs/${encodeURIComponent(t.id)}" data-id="${F(t.id)}">
            ...
            <p class="job-card__desc">${F(Qi(t.description,140))}</p>
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>u.lastPage||a===u.page||(u.page=a,Je())})})}}function Zi(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function Qi(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function F(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var da={bids:[],loading:!1};function Rs(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await c.workerBids();da.bids=t.data||[],en()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${Ds(t.message||"unknown")}</p>`}}}}function en(){let e=document.getElementById("bids-list");if(e){if(da.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=da.bids.map(t=>`
    ...
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),b(`/jobs/${t.getAttribute("data-id")}`)})})}}function tn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function Ds(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var pe={jobs:[],submissions:[],loading:!1};function pa(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);pe.jobs=t.data||[],pe.submissions=a.data||[],an()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${ua(t.message||"unknown")}</p>`}}}}function an(){let e=document.getElementById("active-jobs-list");if(e){if(pe.jobs.length===0){e.innerHTML=`<p class="muted">No active jobs. Once a poster accepts your bid, it'll appear here.</p>`;return}e.innerHTML=pe.jobs.map(t=>{let a=pe.submissions.find(r=>r.job_id===t.id),s=t.status;return`
    ...
    `}function nn(){document.querySelectorAll("form.submit-form").forEach(e=>{e.addEventListener("submit",async t=>{t.preventDefault();let a=parseInt(e.getAttribute("data-job-id"),10),s=new FormData(e),r=e.querySelector("[data-submit-btn]");r.disabled=!0,r.innerHTML='<i class="bi bi-hourglass"></i> Submitting\u2026';try{await c.submitWork(a,{description:String(s.get("description")||"").trim(),external_link:String(s.get("external_link")||"").trim()||null}),l("Work submitted!","success"),pa()()}catch(i){l(i.message||"Failed to submit.","error")}finally{r.disabled=!1,r.innerHTML='<i class="bi bi-send"></i> Submit Work'}})})}function on(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ua(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var We={categories:[],loading:!1};function Os(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,cn(),await Ge()}}async function Ge(){let e=document.getElementById("cat-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminCategories();We.categories=t.data||[],ln()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${ue(t.message||"unknown")}</p>`}}}function ln(){let e=document.getElementById("cat-list");if(e){if(We.categories.length===0){e.innerHTML='<p class="muted">No categories yet. Add one below.</p>';return}e.innerHTML=We.categories.map(t=>`
    ...
    `).join(""),e.querySelectorAll("[data-toggle]").forEach(t=>t.addEventListener("click",()=>dn(t.getAttribute("data-toggle")))),e.querySelectorAll("[data-delete]").forEach(t=>t.addEventListener("click",()=>pn(t.getAttribute("data-delete"))))}}function cn(){let e=document.getElementById("cat-form");e&&e.addEventListener("submit",async t=>{t.preventDefault();let a=new FormData(e),s={name:String(a.get("name")||"").trim(),slug:String(a.get("slug")||"").trim().toLowerCase(),description:String(a.get("description")||"").trim()||null,icon_class:String(a.get("icon_class")||"").trim()||null,display_order:parseInt(a.get("display_order")||"0",10),is_active:a.get("is_active")==="on"},r=document.getElementById("cat-save-btn");r.disabled=!0,r.textContent="Creating\u2026";try{await c.adminCreateCategory(s),l("Category created.","success"),e.reset(),await Ge()}catch(i){l(i.message||"Failed.","error")}finally{r.disabled=!1,r.textContent="Create Category"}})}async function dn(e){let t=We.categories.find(a=>String(a.id)===String(e));if(t)try{await c.adminUpdateCategory(e,{is_active:!t.is_active}),l(t.is_active?"Category disabled.":"Category enabled.","success"),await Ge()}catch(a){l(a.message||"Failed.","error")}}async function pn(e){if(confirm("Delete this category? It will be deactivated if jobs are attached."))try{let t=await c.adminDeleteCategory(e);l(t.message||"Done.","success"),await Ge()}catch(t){l(t.message||"Failed.","error")}}function ue(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var O={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1};function Us(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await Js()}}async function Js(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a,s]=await Promise.all([c.adminSettings(),c.socialLinks(),c.notices()]);O.grouped=t.data||{},O.social=a||{},O.noticesData=s||{interval:4,notices:[]},un()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${P(t.message||"unknown")}</p>`}}}function un(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(O.grouped).map(n=>`
        <div class="card settings-group">
            <h3 class="card__title">${P(n.charAt(0).toUpperCase()+n.slice(1))}</h3>
            <div class="settings-group__rows">
                ${O.grouped[n].map(o=>mn(n,o)).join("")}
            </div>
        </div>
...
`):"";a+=`
    ...
    `}async function bn(){let e={};for(let r of Object.keys(O.grouped))for(let i of O.grouped[r]){let n=`set-${i.key.replace(/[^a-z0-9]/gi,"_")}`,o=document.getElementById(n);if(!o)continue;let d;i.value_type==="boolean"?d=o.checked:i.value_type==="integer"||i.value_type==="percent"?d=parseInt(o.value,10):i.value_type==="decimal"?d=parseFloat(o.value):i.value_type==="json"?d=o.value?JSON.parse(o.value):null:d=o.value,e[i.key]=d}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},a={interval:document.getElementById("notice-interval")?.value||4,notices:document.getElementById("notice-messages")?.value||""},s=document.getElementById("settings-save-btn");s.disabled=!0,s.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(a)]),l("Settings, notices, and social links saved successfully.","success"),await Js()}catch(r){l(r.message||"Failed to save.","error")}finally{s.disabled=!1,s.textContent="Save All Changes"}}function P(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}zt();Kt();Qt();Ct();qt();Pt();Ft();xt();var Ks={"/":ye,"/refer":dt,"/webtask":ne,"/tasks":ne,"/earn":_e,"/tg-tasks":Me,"/withdraw":$e,"/profile":Se,"/wallet":Se,"/admin":It,"/admin/payments":Ot,"/admin/categories":Os,"/admin/settings":Us,"/admin/jobs":Gt,"/admin/transactions":Yt,"/admin/reports":Zt,"/deposit":bt,"/leaderboard":Te,"/achievements":xe,"/support":Le,"/settings":Ae,"/jobs/available":Fs,"/worker/bids":Rs,"/worker/active-jobs":pa,"/poster":At,"/poster/post-job":Mt,"/poster/jobs":jt,"/poster/wallet":Ht,"/notifications":Tt,"/login":ea,"/register":sa,"/forgot-password":Ie,"/reset-password":Re};function Zs(){ze(),setTimeout(ze,50),window.addEventListener("hashchange",ze),$(()=>{x.get(),setTimeout(ze,0)})}async function ze(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!Ks[t]){let n=t.match(/^\/jobs\/(\d+)$/);if(n){let d=await Promise.resolve().then(()=>(Gs(),Ws));await ba(()=>d.JobDetailPage(n[1]),t);return}let o=t.match(/^\/poster\/jobs\/(\d+)$/);if(o){if(!x.get()){b("/login");return}let d=await Promise.resolve().then(()=>(Ys(),Xs));await ba(()=>d.PosterJobDetailPage(o[1]),t);return}t="/"}let a=x.get(),s=m.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?b("/admin"):b("/");return}if(!r.includes(t)&&!a){b("/login");return}if(t==="/"&&s&&s.is_admin){b("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){Cn();return}let i=Ks[t];await ba(i,t)}async function ba(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function Cn(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}v();var Qs=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();Qs.innerHTML="";B(Ns(),Qs);I.get()&&E();Zs();
