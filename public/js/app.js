var fr=Object.defineProperty;var v=(e,t)=>()=>(e&&(t=e(e=0)),t);var _=(e,t)=>{for(var a in t)fr(e,a,{get:t[a],enumerable:!0})};function vr(e,t){Ea?Ea(e,t):console.error("[Ghost] Unhandled effect error:",e)}function P(e){let t=e,a=new Set;return{get(){return H&&(a.add(H),H.dependencies.add(a)),t},set(s){t!==s&&(t=s,Ca(a))}}}function Ca(e){ot(()=>{e.forEach(t=>{t.notify?t.notify():Te.add(t)})})}function ot(e){it++;try{e()}finally{if(it--,it===0){let t=Array.from(Te);Te.clear(),t.forEach(a=>a.run())}}}function T(e){let t={dependencies:new Set,run(){nt(t),ke.push(H),H=t;try{e()}catch(a){vr(a,e)}finally{H=ke.pop()}},notify(){Te.add(t)}};return t.run(),()=>nt(t)}function lt(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,Ca(s))}};return{get(){if(H&&(s.add(H),H.dependencies.add(s)),a){nt(r),ke.push(H),H=r;try{t=e()}finally{H=ke.pop()}a=!1}return t}}}function nt(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var H,ke,Te,it,Ea,K=v(()=>{H=null,ke=[],Te=new Set,it=0,Ea=null});function le(){dt.totalUpdates++,dt.recentUpdates++}var Le,dt,ct=v(()=>{Le=new Set,dt={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function O(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){hr(e,t);return}if(e.__ghostWhen){yr(e,t);return}if(e.__ghostLazy){wr(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;Le.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let i=s.startsWith("on");typeof r=="function"&&!i?e.effects.push(T(()=>{a.setAttribute(s,r()),le(),e.events.update?.forEach(n=>n())})):i?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)O(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push(T(()=>{let i=s(),n=document.createTextNode(String(i??""));r?a.replaceChild(n,r):a.appendChild(n),r=n,le(),e.events.update?.forEach(o=>o())}))}else O(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function de(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),Le.delete(e)}}function hr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function l(u){return u.el||null}let m=T(()=>{let u=a(),y=u.map(($,k)=>String(s($,k))),C=Array.from(o.keys());for(let $ of C)if(!y.includes($)){let k=o.get($);de(k.ghostNode),o.delete($)}for(let $=0;$<u.length;$++){let k=y[$];if(!o.has(k)){let ae=r(u[$],$),U=document.createElement("ghost-list-slot");for(O(ae,U);U.firstChild;)t.insertBefore(U.firstChild,n);o.set(k,{ghostNode:ae})}}for(let $=y.length-1;$>=0;$--){let k=y[$],ae=o.get(k);if(!ae)continue;let U=l(ae.ghostNode);if(!U)continue;let Se=y[$+1],xe=(Se?l(o.get(Se)?.ghostNode):null)||n;U.nextSibling!==xe&&t.insertBefore(U,xe)}le()});e._listCleanup=()=>{m();for(let u of o.values())de(u.ghostNode);o.clear(),i.remove(),n.remove()}}function R(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function yr(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=T(()=>{let m=a()?s:r;if(n&&(de(n),n=null),m&&(n=m(),n)){let u=document.createElement("ghost-when-slot");for(O(n,u);u.firstChild;)t.insertBefore(u.firstChild,i)}le()});e._whenCleanup=()=>{o(),n&&de(n),i.remove()}}function wr(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let i=null;if(s){let n=document.createElement("ghost-lazy-slot");for(O(s,n);n.firstChild;)t.insertBefore(n.firstChild,r);i=s}a().then(n=>{let o=n.default||n;i&&(de(i),i=null);let l=typeof o=="function"?o():o,m=document.createElement("ghost-lazy-slot");for(O(l,m);m.firstChild;)t.insertBefore(m.firstChild,r);i=l}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var pt=v(()=>{K();ct()});var Aa=v(()=>{K()});var Ee=v(()=>{});var qa=v(()=>{ct()});var Ma=v(()=>{K()});var Na=v(()=>{pt();K();Ee();Ee()});function $r(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let i={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){i["@attributes"]={};for(let n of r.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of r.childNodes){let o=n.nodeName,l=s(n);l!==""&&(i[o]===void 0?i[o]=l:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(l)))}return i}return s(a.documentElement)}function Sr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function mt(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),i={url:e,...s};for(let y of mt.interceptors.request)i=y(i)??i;let n=i.url;delete i.url;let o=Sr(n,r);if(a==="memory"&&r==="GET"&&ut.has(o))return ut.get(o);let l=await fetch(n,i),m=l.headers.get("content-type")||"";if(!l.ok)throw new Error(`Ghost-HTTP Error: ${l.status} ${l.statusText}`);let u;m.includes("application/xml")||m.includes("text/xml")?u=$r(await l.text()):m.includes("application/json")?u=await l.json():u=await l.text();for(let y of mt.interceptors.response)u=y(l,u)??u;return a==="memory"&&r==="GET"&&ut.set(o,u),u}var ut,Pa=v(()=>{ut=new Map;mt.interceptors={request:[],response:[]}});function bt(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=P(a);return T(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var ja=v(()=>{K()});function xr(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var vo,Ha=v(()=>{vo=xr()});var wo,kr,Ba=v(()=>{K();wo=P("en"),kr=new Map;kr.set("en",{})});var I=v(()=>{K();pt();Aa();Ee();qa();Ma();Na();Pa();ja();Ha();Ba()});function Fa(e){Ce=e}function Tr(){return Ce}function Ra(e){gt=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let i=e.startsWith("http")?e:Ia.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};Ce&&(n.headers.Authorization=`Bearer ${Ce}`),a!==void 0&&(n.body=JSON.stringify(a)),r&&(n.signal=r);let o=await fetch(i,n);if(o.status===401)throw gt&&gt(),new ce("Unauthorized",401,null);let l=null,m=o.headers.get("content-type")||"";try{if(m.includes("application/json"))l=await o.json();else{let u=await o.text();l=u?{message:u}:null}}catch{}if(!o.ok){let u=l&&l.message||`HTTP ${o.status}`;throw new ce(u,o.status,l)}return l}var Ia,Ce,gt,ce,c,w=v(()=>{Ia=window.JMJOB_CONFIG||{apiBase:"/api"},Ce=null,gt=null;ce=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>p("/admin/subcategories"),adminCreateSubcategory:e=>p("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>p(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>p(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),notices:()=>p("/notices"),adminUpdateNotices:e=>p("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=Ia.apiBase+"/admin/notices/upload",a={},s=Tr();s&&(a.Authorization=`Bearer ${s}`);let r=await fetch(t,{method:"POST",headers:a,body:e}),i=await r.json();if(!r.ok)throw new ce(i.message||"Upload failed",r.status,i);return i},adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminJobSubmissions:e=>p(`/admin/jobs/${e}/submissions`),adminApproveJob:(e,t={})=>p(`/admin/jobs/${e}/approve`,{method:"POST",body:t}),adminDeclineJob:(e,t={})=>p(`/admin/jobs/${e}/decline`,{method:"POST",body:t}),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function d(e,t="info",a=3500){pe.set({message:e,type:t,id:Date.now()}),ft&&clearTimeout(ft),ft=setTimeout(()=>pe.set(null),a)}async function j(){if(!J.get())return null;try{let e=await c.me();return g.set(e.data),e.data}catch{return null}}async function Da(e,t){let a=await c.login({email:e,password:t});return J.set(a.data.token),g.set(a.data.user),a.data.user}async function Ua(e){return c.requestRegistrationOtp(e)}async function Oa(e){let t=await c.verifyRegistrationOtp(e);return J.set(t.data.token),g.set(t.data.user),t.data.user}async function Ae(){try{await c.logout()}catch{}J.set(null),g.set(null),L.set("/login")}function f(e){window.location.hash=e}var Lr,Er,J,g,pe,ft,L,A,h=v(()=>{I();I();w();Lr="earnap_token",Er="earnap_user",J=bt(Lr,null),g=bt(Er,null),pe=P(null),ft=null;L=P(window.location.hash.replace(/^#/,"")||"/"),A=lt(()=>!!J.get()&&!!g.get());T(()=>{let e=J.get();Fa(e)});Ra(()=>{J.set(null),g.set(null),L.set("/login"),d("Session expired. Please log in.","error")})});var Wa={};_(Wa,{HomePage:()=>vt});function vt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Cr(e),e.appendChild(Ar(t)),e.appendChild(qr())}}function ue(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Cr(e){qe&&(clearInterval(qe),qe=null);try{let t=await c.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(y=>{if(typeof y=="string"){let C=y.trim();return C.startsWith("/")||C.startsWith("http")?{image:C,text:""}:{image:"",text:C}}return{image:y.image||"",text:y.text||""}}).filter(y=>y.image&&y.image.trim()||y.text&&y.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let r=ue("div","welcome-popup welcome-popup--banner","");r.innerHTML=`
            <div id="notice-banner-content" class="welcome-popup__content"></div>
        `,e.firstChild?e.insertBefore(r,e.firstChild):e.appendChild(r);let i=r.querySelector("#notice-banner-content"),n=typeof t.interval=="number"&&t.interval>0?t.interval:4,o=t.direction||"right_to_left",l={right_to_left:{exit:"banner-vanish-left",enter:"banner-enter-right"},left_to_right:{exit:"banner-vanish-right",enter:"banner-enter-left"},top_to_bottom:{exit:"banner-vanish-bottom",enter:"banner-enter-top"},bottom_to_top:{exit:"banner-vanish-top",enter:"banner-enter-bottom"},fade:{exit:"banner-vanish-fade",enter:"banner-enter-fade"}},m=l[o]||l.right_to_left,u=0;Ja(i,s[0]),s.length>1&&(qe=setInterval(()=>{let y;do y=Math.floor(Math.random()*s.length);while(y===u&&s.length>1);u=y,i.className=`welcome-popup__content ${m.exit}`,setTimeout(()=>{Ja(i,s[u]),i.className=`welcome-popup__content ${m.enter}`,setTimeout(()=>{i.className="welcome-popup__content"},350)},350)},n*1e3))}catch{}}function Ja(e,t){e.innerHTML="";let a=!!(t&&t.text&&t.text.trim());if(!!(t&&t.image&&t.image.trim())){let r=document.createElement("img");r.className="welcome-popup__image",r.src=t.image,r.alt=t.text||"Banner Notice",r.onerror=()=>{r.style.display="none"},e.appendChild(r)}if(a){let r=document.createElement("div");r.className="welcome-popup__text-wrap",r.innerHTML=`<strong>JM Job:</strong> <span>${Mr(t.text)}</span>`,e.appendChild(r)}}function Ar(e){let t=ue("div","card card--user-header"),a=ue("div","user-header__stats");return a.innerHTML=`
    ...
    `;let a=t.querySelector("button");return a&&!a.disabled&&a.addEventListener("click",()=>Pr(e,a,t)),t}async function Pr(e,t,a){t.disabled=!0,t.textContent="Opening\u2026",window.open(e.target_url,"_blank","noopener,noreferrer");let s=0,r=e.duration_seconds;t.textContent=`Wait ${r}s\u2026`;let n=(await c.webTaskStart({task_id:e.id})).data.completion_id,o=setInterval(()=>{s+=1;let l=r-s;t.textContent=l>0?`Wait ${l}s\u2026`:"Claim Reward",s>=r&&(clearInterval(o),jr(t,n,a))},1e3)}function jr(e,t,a){e.textContent="Claim Reward",e.classList.remove("btn--primary"),e.classList.add("btn--success"),e.disabled=!1,e.onclick=async()=>{e.disabled=!0,e.textContent="Claiming\u2026";try{let s=await c.webTaskClaim({completion_id:t});d("+"+parseFloat(s.data.reward).toFixed(2)+" credited!","success"),await j(),me()()}catch(s){d(s.message||"Claim failed","error"),e.disabled=!1,e.textContent="Claim Reward"}}}function za(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Me=v(()=>{w();h()});var Ga={};_(Ga,{EarnPage:()=>Ne});function Ne(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--earn";let t=g.get(),a=t?t.ads_remaining:0;e.innerHTML=`
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),r=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let r=e.querySelector("#copy-btn"),i=e.querySelector("#refer-link-input");r.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(i.value),d("Link copied to clipboard!","success")}catch{i.select(),document.execCommand("copy"),d("Link copied!","success")}});let n=e.querySelector("#share-tg");n.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(l=>{let m=document.createElement("div");m.className="refer-item",m.innerHTML=`
                    <img class="avatar" src="${l.avatar_url}" alt="">
                    <div class="refer-item__info">
                        <div class="refer-item__name">${Va(l.name)}</div>
                        <div class="refer-item__username">@${Va(l.username)}</div>
                    </div>
                    <div class="refer-item__earned">$${parseFloat(l.lifetime_earned).toFixed(2)}</div>
                `,o.appendChild(m)})}}function Va(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var $t=v(()=>{w();h()});var Ya={};_(Ya,{WithdrawPage:()=>Pe});function Pe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=g.get();e.innerHTML=`
    ...
    `,t}function St(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var xt=v(()=>{w();h()});var Qa={};_(Qa,{DepositPage:()=>kt});function kt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=g.get();e.innerHTML=`
        ...
        `;try{x.loading=!0;let[s,r]=await Promise.all([c.paymentGateways(),c.paymentSubmissions()]);x.gateways=s.data.gateways,x.minAmount=s.data.min_amount,x.maxAmount=s.data.max_amount,x.submissions=r.data,Za(),Ka()}catch(s){d("Failed to load deposit info: "+s.message,"error")}finally{x.loading=!1}let a=document.getElementById("deposit-form");a&&a.addEventListener("submit",async s=>{if(s.preventDefault(),!x.selectedGateway){d("Please select a payment method.","error");return}let r=new FormData(a),i=document.getElementById("deposit-submit-btn");i.disabled=!0,i.innerHTML='<i class="bi bi-hourglass-split"></i> Submitting\u2026';try{let n=await c.paymentSubmit({gateway:x.selectedGateway,sender_number:String(r.get("sender_number")||"").trim(),amount:parseFloat(r.get("amount")),trxid:String(r.get("trxid")||"").trim().toUpperCase()});d(n.message||"Payment submitted.","success"),a.reset();let o=await c.paymentSubmissions();x.submissions=o.data,Ka(),await j();let l=g.get(),m=document.getElementById("deposit-balance");m&&l&&(m.textContent="\u09F3"+parseFloat(l.role==="poster"?l.wallet_balance||0:l.balance||0).toFixed(2))}catch(n){d(n.message||"Failed to submit payment.","error")}finally{i.disabled=!1,i.innerHTML='<i class="bi bi-send"></i> Submit Payment'}})}}function Za(){let e=document.getElementById("payment-gateways");if(e){if(x.gateways.length===0){e.innerHTML='<p class="muted">No payment methods available right now.</p>';return}e.innerHTML=x.gateways.map(t=>`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{x.selectedGateway=t.getAttribute("data-gateway"),Za(),Rr()})})}}function Rr(){let e=x.gateways.find(i=>i.key===x.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `,document.getElementById("copy-wallet-btn")?.addEventListener("click",()=>{navigator.clipboard.writeText(e.wallet_number).then(()=>{d("Wallet number copied.","info")}).catch(()=>{d("Could not copy. Please copy manually.","error")})}));let r=document.getElementById("deposit-amount");r&&(r.min=x.minAmount,r.max=x.maxAmount,r.placeholder=`${x.minAmount} \u2013 ${x.maxAmount}`)}function Ka(){let e=document.getElementById("payment-history");if(e){if(x.submissions.length===0){e.innerHTML='<p class="muted">No submissions yet.</p>';return}e.innerHTML=x.submissions.map(t=>{let a=Fr[t.status]||{label:t.status,class:""};return`
            <div class="payment-row ${a.class}">
                <div class="payment-row__main">
                    <div class="payment-row__amount">\u09F3 ${parseFloat(t.amount).toFixed(2)}</div>
                    <div class="payment-row__gateway">${re((t.gateway||"").toUpperCase())} \u2022 TRX: ${re(t.trxid)}</div>
                </div>
                <div class="payment-row__status">${a.label}</div>
                <div class="payment-row__date">${Dr(t.created_at)}</div>
            </div>
        `}).join("")}}function Dr(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function re(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Fr,x,Tt=v(()=>{w();h();Fr={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},x={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var Et={};_(Et,{ProfilePage:()=>je});function je(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let r=(await c.adHistory()).data||[];if(r.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let i=a.querySelector(".ad-history__list");r.forEach(n=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                    ...
                    `,i.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function Lt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var He=v(()=>{w();h()});var es={};_(es,{default:()=>Be});async function Be(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var Ct=v(()=>{h()});var ts={};_(ts,{default:()=>Ie});async function Ie(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var At=v(()=>{h()});var as={};_(as,{default:()=>Fe});async function Fe(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
            ...
            <div class="settings-section">
                ...
                <div class="settings-item settings-item--stack">
                    <div class="settings-info">
                        ...
                        <div class="settings-value">${Re[s]||"Default (Purple)"}</div>
                    </div>
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${Re[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${Wr[o]};"></span>
                                <span class="theme-swatch__label">${(Re[o]||o).split(" ")[0]}</span>
                            </button>
                        `).join("")}
                    </div>
                </div>
    ...
    `;let i=document.getElementById("theme-mode-group");i&&i.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let l=o.getAttribute("data-mode");is(l),d(`Theme mode set to ${l}.`,"info")})});let n=document.getElementById("color-theme-group");n&&n.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let l=o.getAttribute("data-color");ls(l),d(`Accent color set to ${Re[l]||l}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await Ae(),d("Logged out.","info")})}var Re,Wr,jt=v(()=>{h();Pt();Re={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},Wr={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var us={};_(us,{NotificationsPage:()=>Ht});function Ht(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `,document.getElementById("notifications-read-all")?.addEventListener("click",async()=>{try{await c.notificationsReadAll(),d("All notifications marked as read.","success"),await ps()}catch(t){d(t.message||"Could not update notifications.","error")}}),await ps())}}async function ps(){let e=document.getElementById("notifications-page-list");if(e)try{let t=await c.notifications({limit:100}),a=Array.isArray(t.data)?t.data:[];e.innerHTML=a.length?a.map(zr).join(""):'<p class="muted notifications-page__empty">No notifications yet.</p>',e.querySelectorAll("[data-notification-id]").forEach(s=>{s.querySelector("[data-mark-read]")?.addEventListener("click",async()=>{try{await c.notificationRead(s.getAttribute("data-notification-id")),s.classList.remove("notifications-page__item--unread"),s.querySelector("[data-mark-read]").remove()}catch(r){d(r.message||"Could not mark notification as read.","error")}})})}catch(t){e.innerHTML=`<p class="muted">Failed to load notifications: ${ge(t.message||"unknown error")}</p>`}}function zr(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?`<a class="btn btn--ghost btn--sm" href="#${ge(t.action_url)}">Open</a>`:"",i=e.read?"":'<button class="btn btn--ghost btn--sm" data-mark-read>Mark read</button>';return`<article class="notifications-page__item ${e.read?"":"notifications-page__item--unread"}" data-notification-id="${ge(e.id)}"><i class="bi ${s} notifications-page__icon notifications-page__icon--${a}"></i><div class="notifications-page__body"><h3>${ge(t.title||"Notification")}</h3><p>${ge(t.message||"")}</p><small>${Gr(e.created_at)}</small></div><div class="notifications-page__actions">${r}${i}</div></article>`}function Gr(e){if(!e)return"";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function ge(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Bt=v(()=>{w();h()});var ms={};_(ms,{TgTasksPage:()=>Oe});function Oe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--tgtasks",e.innerHTML=`
        ...
        <div class="task-header">
            <div class="task-channel">
                <i class="bi bi-telegram"></i>
                <strong>${Ue(e.channel_name)}</strong>
                <span class="muted">${Ue(e.channel_username)}</span>
            </div>
        </div>
        <p class="card__sub">${Ue(e.description||"")}</p>
        <div class="task-meta">
            <span><i class="bi bi-cash"></i> $${parseFloat(e.reward).toFixed(3)}</span>
        </div>
        <div class="task-actions">
            ${e.completed?'<button class="btn btn--ghost" disabled>\u2713 Completed</button>':`<a class="btn btn--primary" href="https://t.me/${Ue(e.channel_username.replace("@",""))}" target="_blank" rel="noopener" data-task-id="${e.id}">Join channel</a>`}
        </div>
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&Xr(e,t)},3e3)})}return t}async function Xr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),d("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await j(),Oe()()}catch(s){d(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ue(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var It=v(()=>{w();h()});var fs={};_(fs,{PosterDashboardPage:()=>Rt});function Rt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--poster-dashboard",!g.get()){e.innerHTML='<div class="card"><h2>Access required</h2><a class="btn btn--primary" href="#/login">Log in</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
                <div>
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",bs),d(t.message||"Failed to load poster statistics.","error")}}function Kr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=Ft(t.wallet_balance),i=Ft(t.frozen_balance),n=Ft(t.total_spent);e.innerHTML=`
        ...
        <div class="poster-dashboard-grid">
            <div class="card">
                ...
                <div class="poster-status-list">
                    ${ie("open",a.open)}
                    ${ie("in_review",a.in_review)}
                    ${ie("assigned",a.assigned)}
                    ${ie("submitted",a.submitted)}
                    ${ie("revision",a.revision)}
                    ${ie("completed",a.completed)}
                </div>
            </div>
    ...
    `,Qr(e,t)}function Qr(e,t){let a=e.querySelector("#wizard-card-body");a&&(t.currentStep===1?hs(a,e,t):t.currentStep===2?ve(a,e,t):t.currentStep===3&&ei(a,e,t))}function hs(e,t,a){let s=a.categories.find(o=>Number(o.id)===Number(a.mainCategoryId)),r=s?s.subcategories||[]:[];e.innerHTML=`
    ...
    `;let s=e.querySelector("#proof-pairs-container");s.addEventListener("change",i=>{if(i.target.classList.contains("proof-type-select"))fe(e,a),ve(e,t,a);else if(i.target.classList.contains("proof-file-input")){let n=i.target.closest(".proof-pair-row"),o=Number(n.getAttribute("data-index")),l=i.target.files[0];if(l){let m=new FileReader;m.onload=u=>{a.proofRequirements[o].fileBase64=u.target.result,a.proofRequirements[o].title=l.name,ve(e,t,a)},m.readAsDataURL(l)}}}),e.querySelector("#add-proof-btn").addEventListener("click",()=>{fe(e,a),a.proofRequirements.push({title:"",type:"text"}),ve(e,t,a)}),s.addEventListener("click",i=>{let n=i.target.closest(".remove-proof-btn");if(n){let o=Number(n.getAttribute("data-index"));fe(e,a),a.proofRequirements.splice(o,1),ve(e,t,a)}}),e.querySelector("#job-thumbnail-input").addEventListener("change",i=>{let n=i.target.files[0];if(n){let o=new FileReader;o.onload=l=>{a.thumbnailBase64=l.target.result},o.readAsDataURL(n)}}),e.querySelector("#step-cancel").addEventListener("click",Ot),e.querySelector("#step-2-back").addEventListener("click",()=>{fe(e,a),a.currentStep=1,ye(t,a)}),e.querySelector("#step-2-form").addEventListener("submit",i=>{if(i.preventDefault(),fe(e,a),!a.title.trim()){d("Job title is required.","error");return}if(!a.description.trim()){d("Task instructions are required.","error");return}a.currentStep=3,ye(t,a)})}function fe(e,t){t.title=e.querySelector("#job-title-input")?.value||"",t.description=e.querySelector("#job-desc-input")?.value||"";let a=e.querySelectorAll(".proof-pair-row");t.proofRequirements=Array.from(a).map((s,r)=>{let i=s.querySelector(".proof-type-select")?.value||"text",n=s.querySelector(".proof-title-input"),o=n?n.value:t.proofRequirements[r]?.title||"Screenshot Proof",l=t.proofRequirements[r]?.fileBase64||null;return{title:o,type:i,fileBase64:l}})}function ei(e,t,a){let s=Number(a.workerCount||0)*Number(a.costPerWorker||0),r=s*(a.feePercentage/100),i=s+r;e.innerHTML=`
            ...
            <div class="poster-filter-bar" style="margin-bottom: 16px;">
                <label>Filter Status
                    <select class="admin-select" id="poster-job-filter">
                        ${si.map(t=>`<option value="${t}" ${t===ze?"selected":""}>${t?ws(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>f(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>ii(e.id)),t}async function ii(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await c.posterCancelJob(e,{reason:t}),d("Job cancelled.","success"),await We()}catch(a){d(a.message||"Could not cancel job.","error")}}function ni(){return!!g.get()}function ws(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function oi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function W(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var si,ze,zt=v(()=>{w();h();si=["","pending_approval","open","assigned","submitted","revision","completed","declined","cancelled","disputed"],ze=""});var $s={};_($s,{PosterWalletPage:()=>Vt});function Vt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-wallet";let t=g.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([c.posterStats(),c.paymentSubmissions()]);li(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${Ge(a.message||"unknown error")}</p>`}}}function li(e,t,a){let s=Gt(t.wallet_balance),r=Gt(t.frozen_balance),i=Gt(t.total_spent);e.innerHTML=`
        ...
        <div class="card"><h2 class="card__title">Deposit history</h2><div class="poster-deposit-list">${di(a)}</div></div>
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>f("/deposit"))}function di(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${Ge((t.gateway||"").toUpperCase())}</strong><small>${Ge(t.trxid)} \xB7 ${ci(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${Ge(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function Gt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function ci(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Ge(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Xt=v(()=>{w();h()});var ks={};_(ks,{AdminPage:()=>Kt});function Kt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),r.classList.add("admin-tab--active"),Ss(r.dataset.tab,s)})}),Ss("stats",s)}}async function Ss(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),r=a.data||{},i=s.data||{},n=i.currency_symbol||"\u09F3";t.innerHTML=`
            ...
            `;let o=t.querySelector("#btn-reset-counters");o&&o.addEventListener("click",async()=>{if(confirm("Reset daily ad view counters for all users?"))try{let l=await c.adminResetDailyCounters();d(l.message||"Daily counters reset.","success")}catch(l){d(l.message||"Reset failed.","error")}})}else if(e==="withdrawals"){let s=(await c.adminWithdrawals("pending")).data||[];t.innerHTML=`
            ...
            `;let r=t.querySelector("#wd-list");s.forEach(i=>r.appendChild(xs(i,r))),t.querySelector("#wd-filter").addEventListener("change",async i=>{let n=await c.adminWithdrawals(i.target.value);r.innerHTML="",(n.data||[]).forEach(o=>r.appendChild(xs(o,r)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list"),i=Number(g.get()?.id||0);s.forEach(n=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                ...
                `;let l=o.querySelector(".admin-user-role");l?.addEventListener("change",async()=>{let m=n.role||(n.is_admin?"admin":"worker");try{let u=await c.adminUpdateUserRole(n.id,l.value);n.role=u.data?.role||l.value,n.is_admin=!!u.data?.is_admin,o.querySelector(".user-role-badge").textContent=n.role.toUpperCase(),d("User role updated","success")}catch(u){l.value=m,d(u.message||"Role update failed","error")}}),r.appendChild(o)})}else if(e==="providers"){let s=(await c.adminProviders()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list");s.forEach(i=>r.appendChild(pi(i,r)))}}catch{t.innerHTML='<p class="muted">Failed to load.</p>'}}function Z(e,t,a){return`
    ...
    `,e.status==="pending"){let s=document.createElement("div");s.className="admin-row__actions";let r=document.createElement("button");r.className="btn btn--success btn--sm",r.textContent="Approve",r.addEventListener("click",async()=>{try{await c.adminApprove(e.id,{admin_note:"Approved by admin"}),d("Withdrawal approved","success"),a.remove()}catch(n){d(n.message,"error")}});let i=document.createElement("button");i.className="btn btn--danger btn--sm",i.textContent="Reject",i.addEventListener("click",async()=>{let n=prompt("Reason for rejection (optional):","Invalid wallet address");try{await c.adminReject(e.id,{admin_note:n||""}),d("Withdrawal rejected (refunded)","info"),a.remove()}catch(o){d(o.message,"error")}}),s.appendChild(r),s.appendChild(i),a.appendChild(s)}else if(e.status==="approved"){let s=document.createElement("div");s.className="admin-row__actions";let r=document.createElement("button");r.className="btn btn--primary btn--sm",r.textContent="Mark as Paid",r.addEventListener("click",async()=>{try{await c.adminPay(e.id,{admin_note:"Paid by admin"}),d("Marked as paid","success"),a.remove()}catch(i){d(i.message,"error")}}),s.appendChild(r),a.appendChild(s)}return a}function pi(e,t){let a=document.createElement("div");a.className="admin-row admin-row--provider";let s=!!e.enabled,r=e.block_id||"";return a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,a.querySelector(".provider-save").addEventListener("click",async()=>{let i={block_id:a.querySelector(".provider-block-id").value.trim()||null,weight:parseInt(a.querySelector(".provider-weight").value,10)||0,reward_per_view:parseFloat(a.querySelector(".provider-reward").value)||0,min_duration_seconds:parseInt(a.querySelector(".provider-duration").value,10)||12,enabled:a.querySelector(".provider-enabled").checked};try{await c.adminUpdateProvider(e.id,i),d("Provider saved","success")}catch(n){d(n.message,"error")}}),a}function q(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Zt=v(()=>{w();h();h()});var Es={};_(Es,{AdminPaymentsPage:()=>ea});function ea(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{z.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),Qt()})}),await Qt()}}async function Qt(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(z.status);z.items=t.data||[],mi(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${se(t.message||"Failed to load.")}</p>`}}}function mi(e){if(z.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",z.items.forEach(t=>e.appendChild(bi(t)))}function bi(e){let t=ui[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
            <div class="admin-row__amount">\u09F3 ${parseFloat(e.amount).toFixed(2)} <span class="badge badge--gateway">${se((e.gateway||"").toUpperCase())}</span></div>
            <div class="admin-row__sub">
                <strong>TRX:</strong> <code>${se(e.trxid)}</code>
                &nbsp;\u2022&nbsp;
                <strong>From:</strong> ${se(e.sender_number)}
                ${e.user?`&nbsp;\u2022&nbsp;<strong>User:</strong> ${se(e.user.name)} <span class="muted">(${se(e.user.email)})</span>`:""}
            </div>
            ...
            ${e.admin_note?`<div class="admin-row__note"><em>Note:</em> ${se(e.admin_note)}</div>`:""}
        </div>
        ${e.status==="pending"?`
    ...
    `;let i=t.querySelector(".admin-row__actions");return!a&&!s&&i.appendChild(ne("View Proofs & Screenshots","btn--ghost",()=>vi(e.id,e.title))),a?(i.appendChild(ne("Activate Job","btn--success",()=>hi(e.id))),i.appendChild(ne("Decline","btn--danger",()=>yi(e.id)))):e.status==="disputed"?(i.appendChild(ne("Release Payment","btn--success",()=>Cs(e.id,"release"))),i.appendChild(ne("Cancel & Refund","btn--danger",()=>Cs(e.id,"cancel")))):["completed","cancelled","declined"].includes(e.status)||i.appendChild(ne("Mark Disputed","btn--danger",()=>wi(e.id))),t}function ne(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function vi(e,t){let a=document.getElementById("admin-proof-modal-container");if(!a)return;a.innerHTML=`
    ...
    `,a.querySelector("#close-proof-modal").addEventListener("click",()=>{a.innerHTML=""});let r=a.querySelector("#proof-modal-content");try{let o=((await c.adminJobSubmissions(e)).data||{}).submissions||[];if(!o.length){r.innerHTML='<p class="muted" style="text-align:center; padding:30px;">No worker submissions or proof screenshots submitted yet for this job.</p>';return}r.innerHTML=o.map(l=>{let m=l.work_proof_data||{},u=l.attachment_path?l.attachment_path.startsWith("http")?l.attachment_path:`/storage/${l.attachment_path}`:null,y=u&&/\.(jpg|jpeg|png|gif|webp)$/i.test(u);return`
                <div class="card" style="margin-bottom:16px; padding:16px; border:1px solid #e2e8f0; border-radius:8px; background:#f9fafb;">
                    <div style="display:flex; justify-content:space-between; margin-bottom:8px;">
                        <div>
                            <strong><i class="bi bi-person"></i> ${S(l.worker_name)}</strong>
                            <span class="muted">(${S(l.worker_email||l.worker_username||"")})</span>
                        </div>
                        <span class="badge badge--${l.status==="approved"?"success":"warning"}">${S(l.status.toUpperCase())}</span>
                    </div>

                    ${l.description?`<p style="margin:8px 0; font-size:14px; background:#fff; padding:10px; border-radius:6px; border:1px solid #edf2f7;"><strong>Proof Description:</strong><br>${S(l.description)}</p>`:""}

                    ${l.external_link?`<div style="margin:8px 0;"><a href="${S(l.external_link)}" target="_blank" class="btn btn--ghost btn--sm"><i class="bi bi-box-arrow-up-right"></i> Open External Proof Link</a></div>`:""}
                    ...
                    ${l.trx_id?`<div style="font-size:12px; color:#475569; margin-top:6px;"><strong>TrxID:</strong> ${S(l.trx_id)} | <strong>bKash:</strong> ${S(l.bkash_number||"N/A")}</div>`:""}

                    <div style="font-size:12px; color:#64748b; margin-top:8px;">Submitted on: ${As(l.created_at)}</div>
                </div>
            `}).join("")}catch(i){r.innerHTML=`<p class="muted">Failed to load submissions: ${S(i.message||"unknown error")}</p>`}}async function hi(e){if(confirm("Approve and activate this job post?"))try{await c.adminApproveJob(e),d("Job approved and activated!","success"),await ee()}catch(t){d(t.message||"Could not approve job.","error")}}async function yi(e){let t=prompt("Reason for declining this job post:");if(t!==null)try{await c.adminDeclineJob(e,{reason:t}),d("Job declined.","info"),await ee()}catch(a){d(a.message||"Could not decline job.","error")}}async function wi(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),d("Job flagged for dispute review.","success"),await ee()}catch(t){d(t.message||"Could not flag job.","error")}}async function Cs(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),d(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ee()}catch(r){d(r.message||"Could not resolve dispute.","error")}}function As(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function S(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var gi,B,we=v(()=>{w();h();gi=[{value:"pending_approval",label:"Job Post (Pending Approval)"},{value:"open",label:"Active Job"},{value:"all",label:"All Jobs"},{value:"in_review",label:"In Review"},{value:"assigned",label:"Assigned"},{value:"submitted",label:"Submitted"},{value:"revision",label:"Revision"},{value:"disputed",label:"Disputed"},{value:"completed",label:"Completed"},{value:"declined",label:"Declined"},{value:"cancelled",label:"Cancelled"},{value:"expired",label:"Expired"}],B="pending_approval"});var qs={};_(qs,{AdminTransactionsPage:()=>ia});function ia(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
    ...
    `,t}function Si(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function G(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var _i,ra,na=v(()=>{w();h();_i=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],ra=""});var Ms={};_(Ms,{AdminReportsPage:()=>oa});function oa(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await xi()}}}async function xi(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            <div class="stat-grid admin-report-summary">
                ${Xe("Transactions",Ye(s.transaction_count))}
                ${Xe("Transaction volume",Ke(s.transaction_volume))}
                ${Xe("Jobs",Ye(s.job_count))}
                ${Xe("Job value",Ke(s.job_value))}
            </div>
        ...
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${_e(t.message||"unknown error")}</p>`}}function Xe(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${_e(e)}</span><strong>${_e(t)}</strong></div>`}function ki(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${_e(String(t.type||"").replace("_"," "))}</strong><small>${Ye(t.transaction_count)} entries</small></span>
            <strong>${Ke(t.amount)}</strong>
        </div>
    `).join(""):'<p class="muted">No transactions yet.</p>'}function Ti(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${_e(String(t.status||"").replace("_"," "))}</strong><small>${Ye(t.job_count)} jobs</small></span>
            <strong>${Ke(t.budget)}</strong>
        </div>
    `).join(""):'<p class="muted">No jobs yet.</p>'}function Ye(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Ke(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function _e(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var la=v(()=>{w();h()});var Ns={};_(Ns,{LoginPage:()=>da});function da(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
    ...
    `;let t=document.getElementById("forgot-form"),a=document.getElementById("submit-btn");t.addEventListener("submit",async s=>{s.preventDefault();let r=t.email.value.trim();if(!r){d("Please enter your email address.","error");return}a.disabled=!0,a.textContent="Sending...";try{await c.forgotPassword({email:r}),d("If an account exists with this email, you will receive a reset code.","success"),f(`/reset-password?email=${encodeURIComponent(r)}`)}catch(i){d(i.message||"Failed to send reset code.","error"),a.disabled=!1,a.textContent="Send Reset Code"}})}var ba=v(()=>{w();h()});var Bs={};_(Bs,{default:()=>Qe});async function Qe(){let e=document.querySelector("[data-view]");if(!e)return;let a=(new URLSearchParams(window.location.hash.split("?")[1]).get("email")||"").trim().toLowerCase();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--auth",e.innerHTML=`
        <div class="auth-card">
    ...
    `;let s=document.getElementById("reset-form"),r=document.getElementById("submit-btn");s.addEventListener("submit",async i=>{i.preventDefault();let n=s.email.value.trim(),o=s.otp.value.trim(),l=s.password.value,m=s.password_confirmation.value;if(!n||!o||!l){d("Please fill in all fields.","error");return}if(o.length!==6){d("Please enter a valid 6-digit code.","error");return}if(l!==m){d("Passwords do not match.","error");return}if(l.length<6){d("Password must be at least 6 characters.","error");return}r.disabled=!0,r.textContent="Resetting...";try{await c.resetPassword({email:n,otp:o,password:l,password_confirmation:m}),d("Password reset successfully! You can now log in.","success"),f("/login")}catch(u){d(u.message||"Failed to reset password.","error"),r.disabled=!1,r.textContent="Reset Password"}})}function Ei(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ga=v(()=>{w();h()});var or={};_(or,{JobDetailPage:()=>An});function An(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=g.get();t.innerHTML=`
            ...
            <div class="job-detail__head">
                <div>
                    ...
                    <div class="job-detail__meta">
                        ...
                        <span><i class="bi bi-clock"></i> Bidding closes in <strong>${l}</strong></span>
                    </div>
                </div>
    ...
    `:'<div class="card"><p class="muted">Please log in to place a bid.</p></div>':'<div class="card"><p class="muted">Bidding is closed for this job.</p></div>'}function Nn(e,t,a){if(t){let r=document.getElementById("withdraw-bid-btn");r&&r.addEventListener("click",async()=>{if(confirm("Withdraw your bid?"))try{await c.withdrawBid(t.id),d("Bid withdrawn.","success"),f(`/jobs/${e.id}`)}catch(i){d(i.message||"Failed to withdraw.","error")}});return}let s=document.getElementById("bid-form");s&&s.addEventListener("submit",async r=>{r.preventDefault();let i=new FormData(s),n=document.getElementById("bid-submit-btn");n.disabled=!0,n.textContent="Submitting\u2026";try{await c.placeBid(e.id,{amount:parseFloat(i.get("amount")),delivery_days:parseInt(i.get("delivery_days"),10),proposal:String(i.get("proposal")||"").trim()}),d("Bid placed!","success"),f(`/jobs/${e.id}`)}catch(o){d(o.message||"Failed to place bid.","error")}finally{n.disabled=!1,n.textContent="Submit Bid"}})}function Pn(e){if(e<=0)return"expired";let t=Math.floor(e/86400),a=Math.floor(e%86400/3600);if(t>0)return`${t}d ${a}h`;let s=Math.floor(e%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function te(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var lr=v(()=>{w();h()});var pr={};_(pr,{PosterJobDetailPage:()=>jn});function jn(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.innerHTML="",t.className="view view--poster-job-detail",!On()){t.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}t.innerHTML='<a href="#/poster/jobs" class="back-link"><i class="bi bi-arrow-left"></i> My jobs</a><div id="poster-job-detail-content"><div class="spinner"></div></div>',await dr(e)}}}async function dr(e){let t=document.getElementById("poster-job-detail-content");if(t)try{let s=(await c.posterJobBids(e)).data||{};Hn(t,s.job||{},s.bids||[],s.submissions||[])}catch(a){t.innerHTML=`<p class="muted">Failed to load job: ${E(a.message||"unknown error")}</p>`}}function Hn(e,t,a,s){e.innerHTML=`
        <div class="card poster-detail-card">
            <div class="poster-detail-card__header"><div><h1 class="page-title">${E(t.title)}</h1><p class="muted">${E(t.description||"")}</p></div><span class="badge badge--status badge--${E(t.status)}">${E(Jn(t.status).toUpperCase())}</span></div>
    ...
    `).join(""):'<p class="muted">No work submitted yet.</p>'}async function Fn(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await c.posterAcceptBid(e,t),d("Worker selected and escrow held.","success"),await xa(e)}catch(a){d(a.message||"Could not select worker.","error")}}async function Rn(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await c.posterReleasePayment(e,{submission_id:Number(t)}),d("Payment released.","success"),await xa(e)}catch(a){d(a.message||"Could not release payment.","error")}}async function Dn(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await c.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),d("Revision requested.","success"),await xa(e)}catch(s){d(s.message||"Could not request revision.","error")}}async function Un(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await c.posterCancelJob(e,{reason:"Cancelled by poster"}),d("Job cancelled.","success"),f("/poster/jobs")}catch(t){d(t.message||"Could not cancel job.","error")}}async function xa(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await dr(e))}function On(){return!!g.get()}function Jn(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function cr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function E(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ur=v(()=>{w();h()});I();h();I();h();var et=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ht(),Wa))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Me(),yt))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Me(),yt))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(wt(),Ga))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>($t(),Xa))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(xt(),Ya))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Tt(),Qa))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(He(),Et))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ct(),es))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(At(),ts))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(qt(),as))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(jt(),cs))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Bt(),us))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(He(),Et))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(It(),ms))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Dt(),fs))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Jt(),ys))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(zt(),_s))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Xt(),$s))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Zt(),ks))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ta(),Es))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(we(),Ve))},{path:"/admin/pending-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(we(),Ve))},{path:"/admin/active-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(we(),Ve))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(na(),qs))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(la(),Ms))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ca(),Ns))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ma(),js))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ba(),Hs))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ga(),Bs))}],Vl=T(()=>{let e=L.get().split("?")[0]||"/";return et.find(t=>t.path===e)||et[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";L.set(e)});I();h();I();var Ci=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],Ai=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],qi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Mi(){let e=g.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...Ai];let t=[...Ci];return e&&t.push({separator:!0},...qi),t}var Is="sidebar_collapsed",oe=P(localStorage.getItem(Is)==="true");function Ni(){let e=!oe.get();oe.set(e),localStorage.setItem(Is,String(e))}function Fs(){let e=()=>L.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${oe.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[Pi(),ji(),Hi()]}}function Pi(){let e=()=>L.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function ji(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>Ni(),title:()=>oe.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${oe.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function Hi(){return{tag:"nav",props:{class:"sidebar__nav"},children:Mi().map(e=>e.header?Bi(e.header):e.separator?Ii():Fi(e))}}function Bi(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function Ii(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function Fi({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${L.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>oe.get()?t:"",onclick:r=>{r.preventDefault(),f(e),Ds()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function Rs(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>Ds()},children:[]}}function Ds(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}h();I();h();var Ri=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],Di=[{path:"/admin",label:"Admin Panel",icon:"bi-shield-lock"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Oversight",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Transactions",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Settings",icon:"bi-sliders"}],Ui=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Oi(){let e=g.get();if(e&&e.is_admin)return Di;let t=[...Ri];return e&&t.push({separator:!0},...Ui),t}function Ji({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${L.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:r=>{r.preventDefault(),f(e),fa()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function Wi(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>fa()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function zi(){return{tag:"nav",props:{class:"mobile-nav__list"},children:Oi().map(e=>e.separator?Gi():Ji(e))}}function Gi(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function Us(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[Wi(),zi()]}}function Os(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>fa()},children:[]}}function Js(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function fa(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}Pt();w();function Ws(){return R(()=>A.get(),()=>en(),()=>Qi())}function zs(){let e=()=>{let t=F.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>rs(),"data-theme":()=>F.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function Vi(){let e=document.getElementById("topbar-notifications-panel");if(!e)return;let t=e.classList.contains("topbar-notifications--open");document.querySelectorAll(".topbar-notifications--open").forEach(a=>a.classList.remove("topbar-notifications--open")),t||e.classList.add("topbar-notifications--open")}function Xi(){return setTimeout(Yi,0),{tag:"div",props:{class:"topbar__notifications-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__notifications","aria-label":"Notifications",onclick:e=>{e.stopPropagation(),Vi()}},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge",id:"topbar-notification-badge","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-notifications",id:"topbar-notifications-panel"},children:[{tag:"div",props:{class:"topbar-notifications__header"},children:[{tag:"strong",props:{},children:["Notifications"]},{tag:"button",props:{class:"topbar-notifications__close","aria-label":"Close",onclick:()=>{let e=document.getElementById("topbar-notifications-panel");e&&e.classList.remove("topbar-notifications--open")}},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]},{tag:"ul",props:{class:"topbar-notifications__list",id:"topbar-notifications-list"},children:[Zi("Loading notifications\u2026","Your latest updates will appear here.","bi-hourglass-split","info")]},{tag:"div",props:{class:"topbar-notifications__footer"},children:[{tag:"a",props:{href:"#/notifications",class:"topbar-notifications__link"},children:["View all notifications"]}]}]}]}}async function Yi(){let e=document.getElementById("topbar-notifications-list"),t=document.getElementById("topbar-notification-badge");if(!(!e||!t))try{let a=await c.notifications({limit:5}),s=Array.isArray(a.data)?a.data:[],r=Number(a.meta?.unread_count||s.filter(i=>!i.read).length||0);t.textContent=r>99?"99+":String(r),e.innerHTML=s.length?s.map(Ki).join(""):'<li class="topbar-notifications__empty">No notifications yet.</li>',e.querySelectorAll("[data-notification-id]").forEach(i=>{i.addEventListener("click",async()=>{let n=i.getAttribute("data-notification-id");if(!(!n||i.getAttribute("data-read")==="1"))try{await c.notificationRead(n),i.setAttribute("data-read","1"),i.classList.remove("topbar-notification--unread");let o=Math.max(0,Number(t.textContent.replace("+",""))-1);t.textContent=String(o)}catch{}})})}catch{e.innerHTML='<li class="topbar-notifications__empty">Notifications are unavailable right now.</li>',t.textContent="0"}}function Ki(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?` href="#${tt(t.action_url)}"`:"";return`<li class="topbar-notification topbar-notification--${a} ${e.read?"":"topbar-notification--unread"}" data-notification-id="${tt(e.id)}" data-read="${e.read?"1":"0"}"><i class="bi ${s} topbar-notification__icon"></i><div class="topbar-notification__body"><div class="topbar-notification__title">${tt(t.title||"Notification")}</div><div class="topbar-notification__text">${tt(t.message||"")}</div>${r?`<a class="topbar-notification__action"${r}>Open</a>`:""}</div></li>`}function tt(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Zi(e,t,a,s){return{tag:"li",props:{class:`topbar-notification topbar-notification--${s}`},children:[{tag:"i",props:{class:`bi ${a} topbar-notification__icon`},children:[]},{tag:"div",props:{class:"topbar-notification__body"},children:[{tag:"div",props:{class:"topbar-notification__title"},children:[e]},{tag:"div",props:{class:"topbar-notification__text"},children:[t]}]}]}}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-notifications-panel");t&&t.classList.contains("topbar-notifications--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__notifications")&&t.classList.remove("topbar-notifications--open")});function Qi(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[zs(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function en(){let e=g.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>Js(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[zs(),Xi(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await Ae(),d("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}h();I();function Gs(){return R(()=>!!pe.get(),()=>{let e=pe.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}w();function Vs(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{c.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let r=[];a.facebook&&r.push(`<a href="${at(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&r.push(`<a href="${at(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&r.push(`<a href="${at(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&r.push(`<a href="${at(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=r.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function at(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}h();var tn=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],an=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"}];function sn(){let e=g.get();return e&&e.is_admin?an:tn}function rn({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${L.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:r=>{r.preventDefault(),f(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function nn(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function on(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:sn().map(e=>e.separator?nn():rn(e))}}function va(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&va()},!0),window.addEventListener("resize",()=>setTimeout(va,50)),document.addEventListener("hnav:rendered",()=>setTimeout(va,0)));function Xs(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[on()]}}function Ys(){let e=()=>!!g.get()?.is_admin,t=()=>L.get().startsWith("/admin"),a=()=>A.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[R(()=>A.get(),()=>Fs(),()=>null),R(()=>A.get(),()=>Rs(),()=>null),R(()=>A.get(),()=>Us(),()=>null),R(()=>A.get(),()=>Os(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[Ws(),R(()=>A.get()&&!e(),()=>Xs(),()=>null),{tag:"main",props:{class:"app-main"},children:[ln()]},Vs()]},Gs()]}}function ln(){let t=L.get().split("?")[0]||"/",a=et.find(r=>r.path===t),s=g.get();return s&&s.is_admin&&!t.startsWith("/admin")?(f("/admin"),ha()):a?a.requireAuth&&!A.get()?(f("/login"),ha()):a.requireAdmin&&(!g.get()||!g.get().is_admin)?pn():!a.requireAuth&&A.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(f("/"),ha()):dn(a):cn()}function dn(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function cn(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function pn(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function ha(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}I();h();ht();ca();ma();ba();ga();$t();Me();wt();It();xt();He();Zt();ta();Tt();Ct();At();qt();jt();w();h();var b={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function Zs(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
        ...
        `,b.categories.length===0)try{let t=await c.categories();b.categories=Array.isArray(t.data)?t.data:[];let a=document.getElementById("jobs-category");a&&(a.innerHTML=Ks())}catch{}document.getElementById("jobs-apply")?.addEventListener("click",()=>{un(),b.page=1,st()}),document.getElementById("jobs-reset")?.addEventListener("click",()=>{b.search="",b.categoryId="",b.minBudget="",b.maxBudget="",b.sort="latest",b.page=1,mn(),st()}),document.getElementById("jobs-search")?.addEventListener("keydown",t=>{t.key==="Enter"&&document.getElementById("jobs-apply")?.click()}),await st()}}}function Ks(){return'<option value="">All categories</option>'+b.categories.map(e=>`<option value="${D(e.id)}" ${String(e.id)===String(b.categoryId)?"selected":""}>${D(e.name)}</option>`).join("")}function un(){b.search=document.getElementById("jobs-search")?.value.trim()||"",b.categoryId=document.getElementById("jobs-category")?.value||"",b.minBudget=document.getElementById("jobs-min-budget")?.value.trim()||"",b.maxBudget=document.getElementById("jobs-max-budget")?.value.trim()||"",b.sort=document.getElementById("jobs-sort")?.value||"latest"}function mn(){let e={"jobs-search":b.search,"jobs-category":b.categoryId,"jobs-min-budget":b.minBudget,"jobs-max-budget":b.maxBudget,"jobs-sort":b.sort};Object.entries(e).forEach(([t,a])=>{let s=document.getElementById(t);s&&(s.value=a)})}async function st(){let e=document.getElementById("jobs-grid");if(!e)return;let t=++b.requestSerial;b.loading=!0,e.innerHTML='<div class="spinner"></div>';try{let a={page:b.page,per_page:b.perPage,sort:b.sort};b.search&&(a.search=b.search),b.categoryId&&(a.category_id=b.categoryId),b.minBudget!==""&&(a.min_budget=b.minBudget),b.maxBudget!==""&&(a.max_budget=b.maxBudget);let s=await c.jobs(a);if(t!==b.requestSerial)return;b.jobs=Array.isArray(s.data)?s.data:[],b.total=Number(s.meta?.total||0),b.lastPage=Math.max(1,Number(s.meta?.last_page||1)),bn()}catch(a){if(t!==b.requestSerial)return;e.innerHTML=`<p class="muted">Failed to load jobs: ${D(a.message||"unknown error")}</p>`,Qs(),er()}finally{t===b.requestSerial&&(b.loading=!1)}}function bn(){let e=document.getElementById("jobs-grid");if(e){if(Qs(),er(),b.jobs.length===0){e.innerHTML='<p class="muted">No jobs match your filters. Try clearing them.</p>';return}e.innerHTML=b.jobs.map(t=>`
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>b.lastPage||a===b.page||(b.page=a,st())})})}}function gn(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function fn(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function D(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var ya={bids:[],loading:!1};function tr(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await c.workerBids();ya.bids=t.data||[],vn()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${ar(t.message||"unknown")}</p>`}}}}function vn(){let e=document.getElementById("bids-list");if(e){if(ya.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=ya.bids.map(t=>`
    ...
    `,e.querySelectorAll(".edit-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=M.categories.find(l=>String(l.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Main Category "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){d("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateCategory(r,{min_cost:o}),d(`Min cost updated for ${i.name}.`,"success"),await X(t)}catch(l){d(l.message,"error")}})}),e.querySelectorAll(".toggle-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=M.categories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateCategory(r,{is_active:!i.is_active}),d("Category updated.","success"),await X(t)}catch(n){d(n.message,"error")}})}),e.querySelectorAll(".del-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete category?"))try{let i=await c.adminDeleteCategory(r);d(i.message||"Deleted.","success"),await X(t)}catch(i){d(i.message,"error")}})});let a=e.querySelector("#add-cat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),description:String(r.get("description")||"").trim()||null,is_active:r.get("is_active")==="on"};try{await c.adminCreateCategory(i),d("Main Category created.","success"),await X(t)}catch(n){d(n.message,"error")}})}function kn(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
    ...
    `,e.querySelectorAll(".edit-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=M.subcategories.find(l=>String(l.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Subcategory "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){d("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateSubcategory(r,{min_cost:o}),d(`Min cost updated for ${i.name}.`,"success"),await X(t)}catch(l){d(l.message,"error")}})}),e.querySelectorAll(".toggle-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=M.subcategories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateSubcategory(r,{is_active:!i.is_active}),d("Subcategory updated.","success"),await X(t)}catch(n){d(n.message,"error")}})}),e.querySelectorAll(".del-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete subcategory?"))try{let i=await c.adminDeleteSubcategory(r);d(i.message||"Deleted.","success"),await X(t)}catch(i){d(i.message,"error")}})});let a=e.querySelector("#add-subcat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={category_id:parseInt(r.get("category_id")||"0",10),name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),is_active:r.get("is_active")==="on"};try{await c.adminCreateSubcategory(i),d("Subcategory created.","success"),await X(t)}catch(n){d(n.message,"error")}})}function V(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var Y={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1};function rr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
    ...
    `}async function Cn(){let e={};for(let n of Object.keys(Y.grouped))for(let o of Y.grouped[n]){let l=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,m=document.getElementById(l);if(!m)continue;let u;o.value_type==="boolean"?u=m.checked:o.value_type==="integer"||o.value_type==="percent"?u=parseInt(m.value,10):o.value_type==="decimal"?u=parseFloat(m.value):o.value_type==="json"?u=m.value?JSON.parse(m.value):null:u=m.value,e[o.key]=u}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".banner-message-row")).map(n=>({image:n.querySelector(".notice-msg-image")?.value.trim()||""})).filter(n=>n.image!==""),r={interval:document.getElementById("notice-interval")?.value||4,direction:document.getElementById("notice-direction")?.value||"right_to_left",notices:s},i=document.getElementById("settings-save-btn");i.disabled=!0,i.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(r)]),d("Settings, notices, and social links saved successfully.","success"),await ir()}catch(n){d(n.message||"Failed to save.","error")}finally{i.disabled=!1,i.textContent="Save All Changes"}}function N(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}we();na();la();Dt();Jt();zt();Xt();Bt();var mr={"/":vt,"/refer":_t,"/webtask":me,"/tasks":me,"/earn":Ne,"/tg-tasks":Oe,"/withdraw":Pe,"/profile":je,"/wallet":je,"/admin":Kt,"/admin/payments":ea,"/admin/categories":sr,"/admin/settings":rr,"/admin/jobs":aa,"/admin/transactions":ia,"/admin/reports":oa,"/deposit":kt,"/leaderboard":Be,"/achievements":Ie,"/support":Fe,"/settings":De,"/jobs/available":Zs,"/worker/bids":tr,"/worker/active-jobs":wa,"/poster":Rt,"/poster/post-job":Ut,"/poster/jobs":Wt,"/poster/wallet":Vt,"/notifications":Ht,"/login":da,"/register":ua,"/forgot-password":Ze,"/reset-password":Qe};function br(){rt(),setTimeout(rt,50),window.addEventListener("hashchange",rt),T(()=>{A.get(),setTimeout(rt,0)})}async function rt(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!mr[t]){let n=t.match(/^\/jobs\/(\d+)$/);if(n){let l=await Promise.resolve().then(()=>(lr(),or));await ka(()=>l.JobDetailPage(n[1]),t);return}let o=t.match(/^\/poster\/jobs\/(\d+)$/);if(o){if(!A.get()){f("/login");return}let l=await Promise.resolve().then(()=>(ur(),pr));await ka(()=>l.PosterJobDetailPage(o[1]),t);return}t="/"}let a=A.get(),s=g.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?f("/admin"):f("/");return}if(!r.includes(t)&&!a){f("/login");return}if(t==="/"&&s&&s.is_admin){f("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){Wn();return}let i=mr[t];await ka(i,t)}async function ka(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function Wn(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}h();var gr=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();gr.innerHTML="";O(Ys(),gr);J.get()&&j();br();
