var qn=Object.defineProperty;var _=(e,t)=>()=>(e&&(t=e(e=0)),t);var T=(e,t)=>{for(var a in t)qn(e,a,{get:t[a],enumerable:!0})};function Nn(e,t){Ha?Ha(e,t):console.error("[Ghost] Unhandled effect error:",e)}function B(e){let t=e,a=new Set;return{get(){return D&&(a.add(D),D.dependencies.add(a)),t},set(s){t!==s&&(t=s,Fa(a))}}}function Fa(e){gt(()=>{e.forEach(t=>{t.notify?t.notify():He.add(t)})})}function gt(e){mt++;try{e()}finally{if(mt--,mt===0){let t=Array.from(He);He.clear(),t.forEach(a=>a.run())}}}function E(e){let t={dependencies:new Set,run(){bt(t),Re.push(D),D=t;try{e()}catch(a){Nn(a,e)}finally{D=Re.pop()}},notify(){He.add(t)}};return t.run(),()=>bt(t)}function vt(e){let t,a=!0,s=new Set,n={dependencies:new Set,notify(){a||(a=!0,Fa(s))}};return{get(){if(D&&(s.add(D),D.dependencies.add(s)),a){bt(n),Re.push(D),D=n;try{t=e()}finally{D=Re.pop()}a=!1}return t}}}function bt(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var D,Re,He,mt,Ha,re=_(()=>{D=null,Re=[],He=new Set,mt=0,Ha=null});function he(){ft.totalUpdates++,ft.recentUpdates++}var Fe,ft,ht=_(()=>{Fe=new Set,ft={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function K(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){Pn(e,t);return}if(e.__ghostWhen){Mn(e,t);return}if(e.__ghostLazy){jn(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;Fe.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,n])=>{if(s==="ghostStyle"&&n?.mount){n.mount(a);return}let r=s.startsWith("on");typeof n=="function"&&!r?e.effects.push(E(()=>{a.setAttribute(s,n()),he(),e.events.update?.forEach(i=>i())})):r?a[s.toLowerCase()]=n:a.setAttribute(s,n)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)K(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let n=null;e.effects.push(E(()=>{let r=s(),i=document.createTextNode(String(r??""));n?a.replaceChild(i,n):a.appendChild(i),n=i,he(),e.events.update?.forEach(o=>o())}))}else K(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function ye(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),Fe.delete(e)}}function Pn(e,t){let{getItems:a,keyFn:s,renderFn:n}=e,r=document.createComment("[ghost-list]"),i=document.createComment("[/ghost-list]");t.appendChild(r),t.appendChild(i);let o=new Map;function d(u){return u.el||null}let p=E(()=>{let u=a(),b=u.map((h,k)=>String(s(h,k))),y=Array.from(o.keys());for(let h of y)if(!b.includes(h)){let k=o.get(h);ye(k.ghostNode),o.delete(h)}for(let h=0;h<u.length;h++){let k=b[h];if(!o.has(k)){let j=n(u[h],h),Y=document.createElement("ghost-list-slot");for(K(j,Y);Y.firstChild;)t.insertBefore(Y.firstChild,i);o.set(k,{ghostNode:j})}}for(let h=b.length-1;h>=0;h--){let k=b[h],j=o.get(k);if(!j)continue;let Y=d(j.ghostNode);if(!Y)continue;let Me=b[h+1],je=(Me?d(o.get(Me)?.ghostNode):null)||i;Y.nextSibling!==je&&t.insertBefore(Y,je)}he()});e._listCleanup=()=>{p();for(let u of o.values())ye(u.ghostNode);o.clear(),r.remove(),i.remove()}}function z(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function Mn(e,t){let{conditionGetter:a,trueFn:s,falseFn:n}=e,r=document.createComment("[ghost-when]");t.appendChild(r);let i=null,o=E(()=>{let p=a()?s:n;if(i&&(ye(i),i=null),p&&(i=p(),i)){let u=document.createElement("ghost-when-slot");for(K(i,u);u.firstChild;)t.insertBefore(u.firstChild,r)}he()});e._whenCleanup=()=>{o(),i&&ye(i),r.remove()}}function jn(e,t){let{importFn:a,fallback:s}=e,n=document.createComment("[ghost-lazy]");t.appendChild(n);let r=null;if(s){let i=document.createElement("ghost-lazy-slot");for(K(s,i);i.firstChild;)t.insertBefore(i.firstChild,n);r=s}a().then(i=>{let o=i.default||i;r&&(ye(r),r=null);let d=typeof o=="function"?o():o,p=document.createElement("ghost-lazy-slot");for(K(d,p);p.firstChild;)t.insertBefore(p.firstChild,n);r=d}).catch(i=>{console.error("[Ghost] lazyNode failed to load:",i)})}var yt=_(()=>{re();ht()});var Ba=_(()=>{re()});var Be=_(()=>{});var Da=_(()=>{ht()});var Ia=_(()=>{re()});var Ua=_(()=>{yt();re();Be();Be()});function Hn(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(n){let r={};if(n.nodeType===3)return n.nodeValue.trim();if(n.attributes?.length){r["@attributes"]={};for(let i of n.attributes)r["@attributes"][i.nodeName]=i.nodeValue}for(let i of n.childNodes){let o=i.nodeName,d=s(i);d!==""&&(r[o]===void 0?r[o]=d:(Array.isArray(r[o])||(r[o]=[r[o]]),r[o].push(d)))}return r}return s(a.documentElement)}function Fn(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function _t(e,t={}){let{cache:a=!1,...s}=t,n=(s.method||"GET").toUpperCase(),r={url:e,...s};for(let b of _t.interceptors.request)r=b(r)??r;let i=r.url;delete r.url;let o=Fn(i,n);if(a==="memory"&&n==="GET"&&wt.has(o))return wt.get(o);let d=await fetch(i,r),p=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let u;p.includes("application/xml")||p.includes("text/xml")?u=Hn(await d.text()):p.includes("application/json")?u=await d.json():u=await d.text();for(let b of _t.interceptors.response)u=b(d,u)??u;return a==="memory"&&n==="GET"&&wt.set(o,u),u}var wt,Oa=_(()=>{wt=new Map;_t.interceptors={request:[],response:[]}});function $t(e,t){let a;try{let n=localStorage.getItem(e);a=n?JSON.parse(n):t}catch{a=t}let s=B(a);return E(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(n){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,n)}}),s}var Ja=_(()=>{re()});function Bn(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var Jo,Wa=_(()=>{Jo=Bn()});var zo,Dn,Va=_(()=>{re();zo=B("en"),Dn=new Map;Dn.set("en",{})});var U=_(()=>{re();yt();Ba();Be();Da();Ia();Ua();Oa();Ja();Wa();Va()});function za(e){le=e}function xt(){return le}function Ga(e){St=e}async function m(e,{method:t="GET",body:a,headers:s={},signal:n}={}){let r=e.startsWith("http")?e:kt.apiBase+e,i=typeof FormData<"u"&&a instanceof FormData,o={method:t,headers:{Accept:"application/json",...i?{}:{"Content-Type":"application/json"},...s}};le&&(o.headers.Authorization=`Bearer ${le}`),a!==void 0&&(o.body=i?a:JSON.stringify(a)),n&&(o.signal=n);let d=await fetch(r,o);if(d.status===401)throw St&&St(),new ce("Unauthorized",401,null);let p=null,u=d.headers.get("content-type")||"";try{if(u.includes("application/json"))p=await d.json();else{let b=await d.text();p=b?{message:b}:null}}catch{}if(!d.ok){let b=p&&p.message||`HTTP ${d.status}`;throw new ce(b,d.status,p)}return p}async function In(e){let t=e.startsWith("http")?e:kt.apiBase+e,a={Accept:"text/csv"};le&&(a.Authorization=`Bearer ${le}`);let s=await fetch(t,{headers:a});if(!s.ok){let n=`HTTP ${s.status}`;try{n=(await s.json())?.message||n}catch{}throw new ce(n,s.status,null)}return s.blob()}var kt,le,St,ce,c,S=_(()=>{kt=window.JMJOB_CONFIG||{apiBase:"/api"},le=null,St=null;ce=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>m("/health"),register:e=>m("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>m("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>m("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>m("/auth/login",{method:"POST",body:e}),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>m("/auth/reset-password",{method:"POST",body:e}),logout:()=>m("/auth/logout",{method:"POST"}),me:()=>m("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/notifications${t?"?"+t:""}`)},notificationRead:e=>m(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>m("/notifications/read-all",{method:"POST"}),meUser:()=>m("/user"),reward:e=>m("/user/reward",{method:"POST",body:e}),withdraw:e=>m("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>m("/user/withdrawals"),referrals:()=>m("/user/referrals"),adHistory:()=>m("/user/ads"),adsConfig:()=>m("/ads/config"),adsNext:()=>m("/ads/next"),videoAds:()=>m("/ads/videos"),videoAdStart:e=>m("/ads/videos/start",{method:"POST",body:e}),videoAdClaim:e=>m("/ads/videos/claim",{method:"POST",body:e}),webTasks:()=>m("/tasks/web"),webTaskStart:e=>m("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>m("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>m("/tasks/telegram"),tgTaskVerify:e=>m("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>m("/admin/stats"),adminWithdrawals:(e="pending")=>m(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>m(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>m(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>m(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>m("/admin/users"),adminUpdateUserRole:(e,t)=>m(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminBanUser:(e,t={})=>m(`/admin/users/${e}/ban`,{method:"POST",body:t}),adminUnbanUser:(e,t={})=>m(`/admin/users/${e}/unban`,{method:"POST",body:t}),adminBanHistory:e=>m(`/admin/users/${e}/ban-history`),adminProviders:()=>m("/admin/ad-providers"),adminUpdateProvider:(e,t)=>m(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminVideoAds:()=>m("/admin/video-ads"),adminCreateVideoAd:e=>m("/admin/video-ads",{method:"POST",body:e}),adminUpdateVideoAd:(e,t)=>m(`/admin/video-ads/${e}`,{method:"POST",body:t}),adminDeleteVideoAd:e=>m(`/admin/video-ads/${e}`,{method:"DELETE"}),adminResetDailyCounters:()=>m("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>m("/payment/gateways"),paymentSubmit:e=>m("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>m("/payment/submissions"),adminPayments:(e="")=>m(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>m(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>m(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>m("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/jobs${t?"?"+t:""}`)},job:e=>m(`/jobs/${e}`),createWorkflowJob:e=>m("/jobs/workflow",{method:"POST",body:e}),applyForJob:(e,t={})=>m(`/jobs/${e}/apply`,{method:"POST",body:t}),extendDeadline:(e,t={})=>m(`/jobs/${e}/extend-deadline`,{method:"POST",body:t}),placeBid:(e,t)=>m(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>m(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>m("/worker/bids"),workerActiveJobs:()=>m("/worker/active-jobs"),submitWork:(e,t)=>m(`/jobs/${e}/submit`,{method:"POST",body:t}),workerCancelAssignment:(e,t={})=>m(`/worker/assignments/${e}/cancel`,{method:"POST",body:t}),workerSubmissions:()=>m("/worker/submissions"),posterStats:()=>m("/poster/stats"),posterCreateJob:e=>m("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>m("/poster/jobs"),posterJobBids:e=>m(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>m(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>m(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>m(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>m(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>m("/admin/categories"),adminCreateCategory:e=>m("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>m(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>m(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>m("/admin/subcategories"),adminCreateSubcategory:e=>m("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>m(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>m(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>m("/admin/settings"),adminUpdateSettings:e=>m("/admin/settings",{method:"POST",body:e}),socialLinks:()=>m("/social-links"),adminUpdateSocialLinks:e=>m("/admin/social-links",{method:"POST",body:e}),notices:()=>m("/notices"),adminUpdateNotices:e=>m("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=kt.apiBase+"/admin/notices/upload",a={},s=xt();s&&(a.Authorization=`Bearer ${s}`);let n=await fetch(t,{method:"POST",headers:a,body:e}),r=await n.json();if(!n.ok)throw new ce(r.message||"Upload failed",n.status,r);return r},adminJobs:(e="")=>m(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminCreateJob:e=>m("/admin/jobs",{method:"POST",body:e}),adminJobDetail:e=>m(`/admin/jobs/${e}/detail`),adminUpdateJob:(e,t)=>m(`/admin/jobs/${e}/edit`,{method:"POST",body:t}),adminDeleteJob:e=>m(`/admin/jobs/${e}`,{method:"DELETE"}),adminJobSubmissions:e=>m(`/admin/jobs/${e}/submissions`),adminFraudSubmissions:()=>m("/admin/fraud/submissions"),adminReviewFraud:(e,t={})=>m(`/admin/fraud/submissions/${e}/review`,{method:"POST",body:t}),adminReviewSubmission:(e,t={})=>m(`/admin/submissions/${e}/review`,{method:"POST",body:t}),adminCancelAssignment:(e,t={})=>m(`/admin/assignments/${e}/cancel`,{method:"POST",body:t}),adminReassignAssignment:(e,t={})=>m(`/admin/assignments/${e}/reassign`,{method:"POST",body:t}),adminApproveJob:(e,t={})=>m(`/admin/jobs/${e}/approve`,{method:"POST",body:t}),adminDeclineJob:(e,t={})=>m(`/admin/jobs/${e}/decline`,{method:"POST",body:t}),adminApproveApplication:(e,t={})=>m(`/admin/applications/${e}/approve`,{method:"POST",body:t}),adminFlagJobDispute:e=>m(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>m(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>m("/admin/reports"),adminReportsExport:()=>In("/admin/reports?format=csv"),adminRevenue:()=>m("/admin/revenue")}});function l(e,t="info",a=3500){we.set({message:e,type:t,id:Date.now()}),Tt&&clearTimeout(Tt),Tt=setTimeout(()=>we.set(null),a)}async function R(){if(!G.get())return null;try{let e=await c.me();return g.set(e.data),e.data}catch{return null}}async function Xa(e,t){let a=await c.login({email:e,password:t});return G.set(a.data.token),g.set(a.data.user),a.data.user}async function Ya(e){let t=await c.register(e);return t.data&&t.data.token&&t.data.user&&(G.set(t.data.token),g.set(t.data.user)),t}async function Ka(e){let t=await c.verifyRegistrationOtp(e);return G.set(t.data.token),g.set(t.data.user),t.data.user}async function De(){try{await c.logout()}catch{}G.set(null),g.set(null),N.set("/login")}function f(e){window.location.hash=e}var Un,On,G,g,we,Tt,N,q,w=_(()=>{U();U();S();Un="earnap_token",On="earnap_user",G=$t(Un,null),g=$t(On,null),we=B(null),Tt=null;N=B(window.location.hash.replace(/^#/,"")||"/"),q=vt(()=>!!G.get()&&!!g.get());E(()=>{let e=G.get();za(e)});Ga(()=>{G.set(null),g.set(null),N.set("/login"),l("Session expired. Please log in.","error")})});var Qa={};T(Qa,{HomePage:()=>Lt});function Lt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Jn(e),e.appendChild(Wn(t)),e.appendChild(Vn())}}function _e(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Jn(e){Ie&&(clearInterval(Ie),Ie=null);try{let t=await c.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(b=>{if(typeof b=="string"){let y=b.trim();return y.startsWith("/")||y.startsWith("http")?{image:y,text:""}:{image:"",text:y}}return{image:b.image||"",text:b.text||""}}).filter(b=>b.image&&b.image.trim()||b.text&&b.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let n=_e("div","welcome-popup welcome-popup--banner","");n.innerHTML=`
    ...
    `,document.body.appendChild(s);let n=()=>s.remove();s.querySelector(".modal__close").addEventListener("click",n),s.querySelector(".modal__backdrop").addEventListener("click",n);let r=s.querySelector("#video-ad-player"),i=s.querySelector("#video-ad-countdown"),o=!1;try{if(String(a.stream_url||"").startsWith("https://"))r.src=a.stream_url,await r.play().catch(()=>{});else{let u=await fetch(a.stream_url,{headers:{Authorization:"Bearer "+xt()}});if(!u.ok)throw new Error("Video could not be loaded.");r.src=URL.createObjectURL(await u.blob()),await r.play().catch(()=>{})}}catch(u){i.textContent=u.message||"Video could not be loaded.";return}let d=Number(a.started_at_unix||Math.floor(Date.now()/1e3))*1e3,p=setInterval(async()=>{let u=Math.max(0,a.duration_seconds-Math.floor((Date.now()-d)/1e3));if(i.textContent=u>0?`Reward unlocks in ${u}s\u2026`:"Claiming reward\u2026",u<=0&&!o){o=!0,clearInterval(p);try{let b=await c.videoAdClaim({view_id:a.view_id});l(`+$${Number(b.data?.reward||0).toFixed(4)} credited!`,"success"),await R(),URL.revokeObjectURL(r.src),n(),Se()()}catch(b){o=!1,i.textContent=b.message||"Reward claim failed."}}},1e3)}function Zn(){let e=document.createElement("div");e.className="modal modal--ad",e.innerHTML=`
        <div class="modal__backdrop"></div>
        <div class="modal__content modal__content--ad">
            <button class="modal__close" aria-label="Close">\xD7</button>
            <h3>Watch the ad</h3>
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),n=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let n=e.querySelector("#copy-btn"),r=e.querySelector("#refer-link-input");n.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(r.value),l("Link copied to clipboard!","success")}catch{r.select(),document.execCommand("copy"),l("Link copied!","success")}});let i=e.querySelector("#share-tg");i.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let p=document.createElement("div");p.className="refer-item",p.innerHTML=`
                ...
                `,o.appendChild(p)})}}function as(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Pt=_(()=>{S();w()});var ns={};T(ns,{WithdrawPage:()=>Oe});function Oe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=g.get();e.innerHTML=`
        ...
        ${s}
    `,t}function Mt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var jt=_(()=>{S();w()});var os={};T(os,{DepositPage:()=>Rt});function Rt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=g.get();e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{A.selectedGateway=t.getAttribute("data-gateway"),is(),ar()})})}}function ar(){let e=A.gateways.find(r=>r.key===A.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let n=(await c.adHistory()).data||[];if(n.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let r=a.querySelector(".ad-history__list");n.forEach(i=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                    ...
                    `,r.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function Ft(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var We=_(()=>{S();w()});var ds={};T(ds,{default:()=>Ve});async function Ve(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var Dt=_(()=>{w()});var ls={};T(ls,{default:()=>ze});async function ze(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var It=_(()=>{w()});var cs={};T(cs,{default:()=>Ge});async function Ge(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var Ut=_(()=>{w()});function nr(){let e=localStorage.getItem(ps);return e==="dark"||e==="light"?e:"system"}function rr(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function Ot(e){let t=rr(e);document.documentElement.setAttribute("data-theme",t)}function us(){let e=O.get();O.set(e==="dark"?"light":"dark")}function ms(e){O.set(e)}function ir(){let e=localStorage.getItem(bs);return e&&Jt.includes(e)?e:"default"}function gs(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function vs(e){Jt.includes(e)&&ke.set(e)}function fs(){return Jt}var ps,O,bs,Jt,ke,Wt=_(()=>{U();ps="jmjob_theme";O=B(nr());Ot(O.get());E(()=>{let e=O.get();Ot(e),localStorage.setItem(ps,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{O.get()==="system"&&Ot("system")});bs="jmjob_color_theme",Jt=["default","emerald","amber","rose"];ke=B(ir());gs(ke.get());E(()=>{let e=ke.get();gs(e),localStorage.setItem(bs,e)})});var hs={};T(hs,{default:()=>Ye});async function Ye(){let e=document.querySelector("[data-view]");if(!e)return;let t=g.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=O.get(),s=ke.get(),n=fs();e.innerHTML=`
    ...
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let n=a.href;window.open(n,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&pr(e,t)},3e3)})}return t}async function pr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await R(),Ze()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ke(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Xt=_(()=>{S();w()});var ks={};T(ks,{PosterDashboardPage:()=>Kt});function Kt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--poster-dashboard",!g.get()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
                <div>
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",$s),l(t.message||"Failed to load poster statistics.","error")}}function mr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),n=Yt(t.wallet_balance),r=Yt(t.frozen_balance),i=Yt(t.total_spent);e.innerHTML=`
    ...
    `;let s=e.querySelector("#video-ad-list");a.length||(s.innerHTML='<p class="muted">No video ads configured.</p>'),a.forEach(n=>s.appendChild(Ar(n,s))),e.querySelector("#video-ad-form").addEventListener("submit",async n=>{n.preventDefault();let r=n.currentTarget;try{await c.adminCreateVideoAd(new FormData(r)),l("Video ad uploaded.","success"),await da(e)}catch(i){l(i.message||"Video upload failed.","error")}})}function Ar(e,t){let a=document.createElement("div");return a.className="admin-row admin-row--provider",a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,a.querySelector(".video-ad-toggle").addEventListener("click",async()=>{let s=new FormData;s.append("status",e.status==="active"?"paused":"active");try{await c.adminUpdateVideoAd(e.id,s),l("Video ad status updated.","success"),await da(t.parentElement)}catch(n){l(n.message||"Could not update video ad.","error")}}),a.querySelector(".video-ad-delete").addEventListener("click",async()=>{if(confirm(`Delete \u201C${e.title}\u201D?`))try{await c.adminDeleteVideoAd(e.id),l("Video ad deleted.","success"),a.remove()}catch(s){l(s.message||"Could not delete video ad.","error")}}),a}function L(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var la=_(()=>{S();w();w()});var Rs={};T(Rs,{AdminPaymentsPage:()=>pa});function pa(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
    ...
    `,a.querySelector("#close-proof-modal").addEventListener("click",()=>{a.innerHTML=""});let n=a.querySelector("#proof-modal-content");try{let o=((await c.adminJobSubmissions(e)).data||{}).submissions||[];if(!o.length){n.innerHTML='<p class="muted" style="text-align:center; padding:30px;">No worker submissions or proof screenshots submitted yet for this job.</p>';return}n.innerHTML=o.map(d=>{let p=d.work_proof_data||{},u=d.attachment_url||(d.attachment_path?d.attachment_path.startsWith("http")?d.attachment_path:`/storage/${d.attachment_path}`:null),b=u&&/\.(jpg|jpeg|png|gif|webp)$/i.test(u);return`
            ...
            <div class="admin-toolbar">
                <label>Type
                    <select class="admin-select" id="admin-transaction-type">
                        ${Hr.map(t=>`<option value="${t}" ${t===ba?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All transactions"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{ba=t.target.value,await ma()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",ma),await ma()}}}async function ma(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminTransactions({type:ba})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(Fr(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${ee(t.message||"unknown error")}</p>`}}}function Fr(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${ee(e.type)}`,t.innerHTML=`
    ...
    `,t}function Br(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Hr,ba,va=_(()=>{S();w();Hr=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],ba=""});var Us={};T(Us,{AdminReportsPage:()=>fa});function fa(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#export-admin-report")?.addEventListener("click",Dr),await Ir()}}}async function Dr(){try{let e=await c.adminReportsExport(),t=URL.createObjectURL(e),a=document.createElement("a");a.href=t,a.download="jmjob-report.csv",document.body.appendChild(a),a.click(),a.remove(),URL.revokeObjectURL(t)}catch(e){alert(e.message||"Could not export the report.")}}async function Ir(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            <div class="stat-grid admin-report-summary">
                ${nt("Transactions",be(s.transaction_count))}
                ${nt("Transaction volume",qe(s.transaction_volume))}
                ${nt("Jobs",be(s.job_count))}
    ...
    `).join(""):'<p class="muted">No submissions yet.</p>'}function be(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function qe(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function te(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ha=_(()=>{S();w()});var Os={};T(Os,{LoginPage:()=>ya});function ya(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
    ...
    `;let s=document.getElementById("reset-form"),n=document.getElementById("submit-btn");s.addEventListener("submit",async r=>{r.preventDefault();let i=s.email.value.trim(),o=s.otp.value.trim(),d=s.password.value,p=s.password_confirmation.value;if(!i||!o||!d){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(d!==p){l("Passwords do not match.","error");return}if(d.length<6){l("Password must be at least 6 characters.","error");return}n.disabled=!0,n.textContent="Resetting...";try{await c.resetPassword({email:i,otp:o,password:d,password_confirmation:p}),l("Password reset successfully! You can now log in.","success"),f("/login")}catch(u){l(u.message||"Failed to reset password.","error"),n.disabled=!1,n.textContent="Reset Password"}})}function zr(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var xa=_(()=>{S();w()});var _n={};T(_n,{JobDetailPage:()=>ao});function ao(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=g.get();t.innerHTML=`
        ...
        `;try{let s=await c.job(e),{job:n,bids:r,bid_count:i,my_bid:o,my_submission:d}=s.data;so(n,r,i,o,d,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${F(s.message||"unknown")}</p>`}}}function so(e,t,a,s,n,r){let i=document.getElementById("job-detail-content");if(!i)return;let o=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,d=o?Math.max(0,Math.floor((o-Date.now())/1e3)):null,p=d!=null?lo(d):"\u2014",u=["open","in_review"].includes(e.status),b=!!r&&!r.is_admin,y=!!r&&Number(e.poster?.id||0)===Number(r.id),h=b&&(!!e.assignment_id||Number(e.assigned_worker_id||0)===Number(r.id)),k=h&&e.assignment_status?e.assignment_status:e.status;i.innerHTML=`
        ...
        ${no(e,n,h)}
        ${h?"":io(e,t,s,r,u,y)}
    `,oo(e,s,r),ro(e)}function no(e,t,a){if(!a)return"";let s=e.assignment_status||e.status,n=t?.status||s;if(t&&(t.status==="pending_review"||s==="submitted"))return`
            <div class="card">
    ...
    `:'<div class="card"><p class="muted">Please log in to place a bid.</p></div>':'<div class="card"><p class="muted">Bidding is closed for this job.</p></div>'}function oo(e,t,a){if(t){let n=document.getElementById("withdraw-bid-btn");n&&n.addEventListener("click",async()=>{if(confirm("Withdraw your bid?"))try{await c.withdrawBid(t.id),l("Bid withdrawn.","success"),f(`/jobs/${e.id}`)}catch(r){l(r.message||"Failed to withdraw.","error")}});return}let s=document.getElementById("bid-form");s&&s.addEventListener("submit",async n=>{n.preventDefault();let r=new FormData(s),i=document.getElementById("bid-submit-btn");i.disabled=!0,i.textContent="Submitting\u2026";try{await c.placeBid(e.id,{amount:parseFloat(r.get("amount")),delivery_days:parseInt(r.get("delivery_days"),10),proposal:String(r.get("proposal")||"").trim()}),l("Bid placed!","success"),f(`/jobs/${e.id}`)}catch(o){l(o.message||"Failed to place bid.","error")}finally{i.disabled=!1,i.textContent="Submit Bid"}})}function lo(e){if(e<=0)return"expired";let t=Math.floor(e/86400),a=Math.floor(e%86400/3600);if(t>0)return`${t}d ${a}h`;let s=Math.floor(e%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function F(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var $n=_(()=>{S();w()});var xn={};T(xn,{PosterJobDetailPage:()=>co});function co(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.innerHTML="",t.className="view view--poster-job-detail",!ho()){t.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}t.innerHTML='<a href="#/poster/jobs" class="back-link"><i class="bi bi-arrow-left"></i> My jobs</a><div id="poster-job-detail-content"><div class="spinner"></div></div>',await Sn(e)}}}async function Sn(e){let t=document.getElementById("poster-job-detail-content");if(t)try{let s=(await c.posterJobBids(e)).data||{};po(t,s.job||{},s.bids||[],s.submissions||[])}catch(a){t.innerHTML=`<p class="muted">Failed to load job: ${M(a.message||"unknown error")}</p>`}}function po(e,t,a,s){e.innerHTML=`
        <div class="card poster-detail-card">
            <div class="poster-detail-card__header"><div><h1 class="page-title">${M(t.title)}</h1><p class="muted">${M(t.description||"")}</p></div><span class="badge badge--status badge--${M(t.status)}">${M(yo(t.status).toUpperCase())}</span></div>
        ...
        <div class="poster-detail-grid">
            <div class="card"><div class="card__header"><div><h2 class="card__title">Bid comparison</h2><p class="muted">Choose one pending proposal to assign the job.</p></div></div><div class="poster-bid-list">${uo(t,a)}</div></div>
            <div class="card"><div class="card__header"><div><h2 class="card__title">Submission review</h2><p class="muted">Approve delivery to release payment or request changes.</p></div></div><div class="poster-submission-list">${mo(t,s)}</div></div>
        </div>
    ...
    `,e.querySelectorAll("[data-accept-bid]").forEach(n=>n.addEventListener("click",()=>bo(t.id,n.dataset.acceptBid))),e.querySelectorAll("[data-release-submission]").forEach(n=>n.addEventListener("click",()=>go(t.id,n.dataset.releaseSubmission))),e.querySelectorAll("[data-revision-submission]").forEach(n=>n.addEventListener("click",()=>vo(t.id,n.dataset.revisionSubmission))),e.querySelector("#poster-detail-cancel")?.addEventListener("click",()=>fo(t.id))}function uo(e,t){return t.length?t.map(a=>`
    ...
    `).join(""):'<p class="muted">No bids yet.</p>'}function mo(e,t){return t.length?t.map(a=>`
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>v.lastPage||a===v.page||(v.page=a,ct())})})}}function Pi(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function Mi(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function V(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var Ca={bids:[],loading:!1};function un(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await c.workerBids();Ca.bids=t.data||[],ji()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${mn(t.message||"unknown")}</p>`}}}}function ji(){let e=document.getElementById("bids-list");if(e){if(Ca.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=Ca.bids.map(t=>`
    ...
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function Ri(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function mn(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var ve={jobs:[],submissions:[],loading:!1};function Ea(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);ve.jobs=t.data||[],ve.submissions=a.data||[],Hi()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${fe(t.message||"unknown")}</p>`}}}}function Hi(){let e=document.getElementById("active-jobs-list");if(e){if(ve.jobs.length===0){e.innerHTML='<p class="muted">No activated or assigned jobs are available right now. New jobs appear here after admin activation.</p>';return}e.innerHTML=ve.jobs.map(t=>{let a=t.assignment_id?ve.submissions.find(i=>Number(i.assignment_id)===Number(t.assignment_id)):ve.submissions.find(i=>i.job_id===t.id),s=t.worker_state==="available"?"available":t.assignment_status||t.status,n=String(t.description||"").trim(),r=Number(t.remaining_workers??t.remaining_tasks_count??0);return`
            <div class="active-job-card" data-id="${t.id}">
                <div class="active-job-card__head">
                    <div>
                        <h3>${fe(t.title)}</h3>
                       ${t.subtitle?`<div class="muted">${fe(t.subtitle)}</div>`:""}
                        ${n?`<p class="muted">${fe(n.slice(0,180))}${n.length>180?"\u2026":""}</p>`:""}
                        <div class="muted">Pay: \u09F3${parseFloat(t.cost_per_worker||t.budget||0).toFixed(2)} \xB7 Available slots: ${r} \xB7 Deadline: ${fe(t.deadline_at||"None")}</div>
                    </div>
        ...
        `}).join(""),Bi()}}function Fi(e){return`
        <div class="active-job-card__sub">
            <strong>Submitted:</strong> ${Di(e.created_at)}
    ...
    `}async function zi(){let e={};for(let i of Object.keys(ne.grouped))for(let o of ne.grouped[i]){let d=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,p=document.getElementById(d);if(!p)continue;let u;o.value_type==="boolean"?u=p.checked:o.value_type==="integer"||o.value_type==="percent"?u=parseInt(p.value,10):o.value_type==="decimal"?u=parseFloat(p.value):o.value_type==="json"?u=p.value?JSON.parse(p.value):null:u=p.value,e[o.key]=u}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".banner-message-row")).map(i=>({image:i.querySelector(".notice-msg-image")?.value.trim()||""})).filter(i=>i.image!==""),n={interval:document.getElementById("notice-interval")?.value||4,direction:document.getElementById("notice-direction")?.value||"right_to_left",notices:s},r=document.getElementById("settings-save-btn");r.disabled=!0,r.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(n)]),l("Settings, notices, and social links saved successfully.","success"),await vn()}catch(i){l(i.message||"Failed to save.","error")}finally{r.disabled=!1,r.textContent="Save All Changes"}}function H(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}Ee();S();w();function hn(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.className="view view--admin-job-post",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p></div>';return}let t=new URLSearchParams(window.location.hash.split("?")[1]||""),a=Number(t.get("edit")||0);e.innerHTML='<div class="card"><p class="muted">Loading job form\u2026</p></div>';try{let s=await c.categories(),n=a?(await c.adminJobDetail(a)).data:null;Gi(e,s.data||[],n?.job||null,a)}catch(s){e.innerHTML=`<div class="card"><p class="muted">Could not load job form: ${X(s.message||"unknown error")}</p></div>`}}}function Gi(e,t,a,s){let n=a?.proof_requirements||[],r=n.some(o=>o.type==="screenshot"),i=n.some(o=>o.type==="text");e.innerHTML=`
        ...
        <form class="card admin-job-form" id="admin-job-form">
            ...
            <label>Deadline <input name="deadline_at" type="datetime-local" value="${Xi(a?.deadline_at)}"></label>
    ...
    `,e.querySelector("#admin-job-cancel").addEventListener("click",()=>f("/admin/jobs")),e.querySelector("#admin-job-form").addEventListener("submit",async o=>{o.preventDefault();let d=o.currentTarget,p=new FormData(d),u=[];p.get("requires_screenshot")&&u.push({title:"Screenshot proof",type:"screenshot"}),p.get("requires_written")&&u.push({title:"Written report",type:"text"});let b={category_id:Number(p.get("category_id")),title:String(p.get("title")||"").trim(),subtitle:String(p.get("subtitle")||"").trim(),customer_name:String(p.get("customer_name")||"").trim(),customer_phone:String(p.get("customer_phone")||"").trim(),customer_email:String(p.get("customer_email")||"").trim(),description:String(p.get("description")||"").trim(),requirements:String(p.get("requirements")||"").trim(),worker_count:Number(p.get("worker_count")),cost_per_worker:Number(p.get("cost_per_worker")),deadline_at:Yi(String(p.get("deadline_at")||"")),proof_requirements:u,admin_notes:String(p.get("admin_notes")||"").trim(),publish:!!p.get("publish")},y=d.querySelector('[type="submit"]');y.disabled=!0;try{let h=s?await c.adminUpdateJob(s,b):await c.adminCreateJob(b);l(h.message||"Job saved.","success"),f(s?`/admin/jobs/${s}`:"/admin/jobs")}catch(h){l(h.message||"Could not save job.","error"),y.disabled=!1}})}function Xi(e){if(!e)return"";let t=new Date(String(e).replace(" ","T")+"Z");if(Number.isNaN(t.getTime()))return"";let a=s=>String(s).padStart(2,"0");return`${t.getFullYear()}-${a(t.getMonth()+1)}-${a(t.getDate())}T${a(t.getHours())}:${a(t.getMinutes())}`}function Yi(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function X(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();function yn(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.className="view view--admin-job-detail",!g.get()?.is_admin){t.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p></div>';return}t.innerHTML='<div class="card"><p class="muted">Loading job detail\u2026</p></div>',await Pe(t,e)}}}async function Pe(e,t){try{let a=await c.adminJobDetail(t);Ki(e,a.data||{},t)}catch(a){e.innerHTML=`<div class="card"><p class="muted">Could not load job: ${$(a.message||"unknown error")}</p></div>`}}function Ki(e,t,a){let s=t.job||{},n=t.progress||{},r=t.assignments||[],i=t.bids||[],o=t.submissions||[],d=s.currency||"BDT",p=Array.isArray(s.proof_requirements)?s.proof_requirements:[],u=p.length?`<ul>${p.map(b=>`<li>${$(b.title||"Proof")} <span class="muted">(${$(b.type||"text")})</span></li>`).join("")}</ul>`:'<p class="muted">No structured proof requirements configured.</p>';e.innerHTML=`
        <a href="#/admin/jobs" class="back-link"><i class="bi bi-arrow-left"></i> Job management</a>
        <div class="page-heading-row"><div><h1 class="page-title">${$(s.title)}</h1><p class="muted">${$(s.subtitle||"")}</p></div><div class="admin-row__actions"><button class="btn btn--ghost btn--sm" id="edit-job">Edit job</button>${to(s,r)?'<button class="btn btn--danger btn--sm" id="delete-job">Delete job</button>':""}</div></div>
   ...
   `,e.querySelector("#edit-job")?.addEventListener("click",()=>f(`/admin/admin-job-post?edit=${a}`)),e.querySelector("#delete-job")?.addEventListener("click",async()=>{if(confirm("Delete this job and its unassigned bids?"))try{await c.adminDeleteJob(a),l("Job deleted.","success"),f("/admin/jobs")}catch(b){l(b.message||"Could not delete job.","error")}}),e.querySelectorAll("[data-review-id]").forEach(b=>b.addEventListener("click",async()=>{let y=b.dataset.reviewDecision,h=y==="reject"?prompt("Rejection reason:"):prompt("Optional admin note:")||"";if(!(h===null||y==="reject"&&!h.trim()))try{await c.adminReviewSubmission(b.dataset.reviewId,{decision:y,note:h}),l("Submission reviewed.","success"),await Pe(e,a)}catch(k){l(k.message||"Could not review submission.","error")}})),e.querySelectorAll("[data-ban-worker]").forEach(b=>b.addEventListener("click",async()=>{let y=b.dataset.banWorker,h=b.dataset.banState==="1",k=prompt(h?"Reason for unbanning this worker:":"Reason for banning this worker:",h?"Restored by administrator":"");if(!(k===null||!h&&!k.trim())){b.disabled=!0;try{h?await c.adminUnbanUser(y,{reason:k.trim()}):await c.adminBanUser(y,{reason:k.trim()}),l(h?"Worker unbanned.":"Worker banned and active sessions revoked.","success"),await Pe(e,a)}catch(j){b.disabled=!1,l(j.message||"Could not update worker ban state.","error")}}})),e.querySelectorAll("[data-cancel-assignment]").forEach(b=>b.addEventListener("click",async()=>{let y=prompt("Reason for cancelling this assignment:");if(!(!y||!y.trim()))try{await c.adminCancelAssignment(b.dataset.cancelAssignment,{reason:y.trim()}),l("Assignment cancelled and refunded.","success"),await Pe(e,a)}catch(h){l(h.message||"Could not cancel assignment.","error")}})),e.querySelectorAll("[data-reassign-assignment]").forEach(b=>b.addEventListener("click",async()=>{let y=e.querySelector(`[data-reassign-select="${b.dataset.reassignAssignment}"]`),h=Number(y?.value||0);if(!h){l("Select a pending replacement bid first.","error");return}let k=prompt("Reason for reassignment:")||"Reassigned by administrator";try{await c.adminReassignAssignment(b.dataset.reassignAssignment,{bid_id:h,reason:k.trim()}),l("Worker reassigned.","success"),await Pe(e,a)}catch(j){l(j.message||"Could not reassign worker.","error")}}))}function Zi(e,t){let a=e.payment_status==="held"&&!["cancelled","completed"].includes(e.status),s=t.filter(r=>r.status==="pending"&&r.worker_id!==e.worker_id),n=a?`<div class="admin-row__actions"><button class="btn btn--danger btn--sm" data-cancel-assignment="${e.id}">Cancel/refund</button>${s.length?`<select data-reassign-select="${e.id}" aria-label="Replacement worker"><option value="">Replace with\u2026</option>${s.map(r=>`<option value="${r.id}">${$(r.worker?.name||`Worker #${r.worker_id}`)} \xB7 \u09F3${Number(r.amount||0).toFixed(2)}</option>`).join("")}</select><button class="btn btn--ghost btn--sm" data-reassign-assignment="${e.id}">Reassign</button>`:""}</div>`:"";return`<div class="admin-row"><div><strong>${$(e.worker?.name||"Unknown worker")}</strong><span class="muted">${$(e.worker?.email||"")} \xB7 ${$(e.worker?.phone||"")}</span></div><div><span class="badge">${$(String(e.status||"").toUpperCase())}</span><span class="muted"> ${$(String(e.payment_status||"").toUpperCase())} \xB7 ${Number(e.payment_amount||0).toFixed(2)}</span>${n}</div></div>`}function Qi(e){return`<div class="admin-row"><div><strong>${$(e.worker?.name||`Worker #${e.worker_id}`)}</strong><span class="muted">${$(e.worker?.email||"")} \xB7 ${$(e.worker?.phone||"")}</span><p>${$(e.proposal||"")}</p></div><div><span class="badge">PENDING</span><span class="muted"> \u09F3${Number(e.amount||0).toFixed(2)}</span></div></div>`}function eo(e){let t=e.worker||{},a=e.status==="pending_review"?`<button class="btn btn--success btn--sm" data-review-id="${e.id}" data-review-decision="approve">Approve</button><button class="btn btn--danger btn--sm" data-review-id="${e.id}" data-review-decision="reject">Reject</button>`:"",s=t.id?`<button class="btn ${t.is_banned?"btn--success":"btn--danger"} btn--sm" data-ban-worker="${t.id}" data-ban-state="${t.is_banned?"1":"0"}">${t.is_banned?"Unban worker":"Ban worker"}</button>`:"",n=a||s?`<div class="admin-row__actions">${a}${s}</div>`:"",r=`User ID #${$(e.worker_id)} \xB7 ${$(t.phone||"Phone unavailable")} \xB7 ${$(t.email||"Email unavailable")}`,i=e.reviewer_note||e.rejection_reason,o=e.risk_status&&e.risk_status!=="clear"?` \xB7 Risk ${$(String(e.risk_status).replace("_"," "))} (${Number(e.risk_score||0).toFixed(0)})`:"";return`<div class="admin-row"><div><strong>${$(t.name||"Unknown worker")}</strong><span class="muted">${r}</span><span class="muted">Submitted ${$(Pa(e.submitted_at||e.created_at))} \xB7 Attempt ${Number(e.attempt_number||1)} \xB7 ${$(String(e.status||"").replace("_"," "))}${o}</span><p>${$(e.description||"")}</p>${e.external_link?`<a href="${$(e.external_link)}" target="_blank" rel="noopener">Open delivery link</a>`:""}${e.attachment_url?`${e.external_link?" \xB7 ":""}<a href="${$(e.attachment_url)}" target="_blank" rel="noopener">Open screenshot</a>`:""}${i?`<p class="muted"><strong>Review note:</strong> ${$(i)}</p>`:""}</div>${n}</div>`}function to(e,t){return!["completed","disputed"].includes(e.status)&&!t.some(a=>!["cancelled"].includes(a.status))}function Pa(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Ne(e,t){return`${$(t||"BDT")} ${Number(e||0).toFixed(2)}`}function $(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}va();ha();w();function wn(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-advertisement",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `}}}Zt();ta();sa();ia();Gt();var Ln={"/":Lt,"/refer":Nt,"/webtask":$e,"/tasks":$e,"/earn":Se,"/tg-tasks":Ze,"/withdraw":Oe,"/profile":Je,"/wallet":Je,"/admin":oa,"/admin/payments":pa,"/admin/categories":bn,"/admin/settings":gn,"/admin/jobs":Ce,"/admin/pending-jobs":Ce,"/admin/active-jobs":Ce,"/admin/admin-job-post":hn,"/admin/transactions":ga,"/admin/reports":fa,"/admin/advertisement":wn,"/deposit":Rt,"/leaderboard":Ve,"/achievements":ze,"/support":Ge,"/settings":Ye,"/jobs/available":ln,"/worker/bids":un,"/worker/active-jobs":Ea,"/poster":Kt,"/poster/post-job":Qt,"/poster/jobs":aa,"/poster/wallet":ra,"/notifications":zt,"/login":ya,"/register":$a,"/forgot-password":rt,"/reset-password":it};function Cn(){pt(),setTimeout(pt,50),window.addEventListener("hashchange",pt),E(()=>{q.get(),setTimeout(pt,0)})}async function pt(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!Ln[t]){let i=t.match(/^\/admin\/jobs\/(\d+)$/);if(i){if(!q.get()){f("/login");return}let p=g.get();if(!p||!p.is_admin){An();return}await ut(()=>yn(i[1]),t);return}let o=t.match(/^\/jobs\/(\d+)$/);if(o){if(!q.get()){f("/login");return}let p=await Promise.resolve().then(()=>($n(),_n));await ut(()=>p.JobDetailPage(o[1]),t);return}let d=t.match(/^\/poster\/jobs\/(\d+)$/);if(d){if(!q.get()){f("/login");return}let p=await Promise.resolve().then(()=>(Tn(),xn));await ut(()=>p.PosterJobDetailPage(d[1]),t);return}t="/"}let a=q.get(),s=g.get(),n=["/login","/register","/forgot-password","/reset-password"];if(n.includes(t)&&a){s&&s.is_admin?f("/admin"):f("/");return}if(!n.includes(t)&&!a){f("/login");return}if(t==="/"&&s&&s.is_admin){f("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){An();return}let r=Ln[t];await ut(r,t)}async function ut(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let n=a.querySelector(".bottomnav");n?a.insertBefore(s,n):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let n=typeof e=="function"?e():e;typeof n=="function"?await n():n&&typeof n.then=="function"&&await n}catch(n){console.error("View render threw synchronously for",t,n),s.innerHTML=`<div class="card"><h2>Error</h2><p>${n.message}</p></div>`}}function An(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
