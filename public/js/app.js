var mr=Object.defineProperty;var v=(e,t)=>()=>(e&&(t=e(e=0)),t);var _=(e,t)=>{for(var a in t)mr(e,a,{get:t[a],enumerable:!0})};function br(e,t){xa?xa(e,t):console.error("[Ghost] Unhandled effect error:",e)}function P(e){let t=e,a=new Set;return{get(){return j&&(a.add(j),j.dependencies.add(a)),t},set(s){t!==s&&(t=s,Ta(a))}}}function Ta(e){tt(()=>{e.forEach(t=>{t.notify?t.notify():ye.add(t)})})}function tt(e){Qe++;try{e()}finally{if(Qe--,Qe===0){let t=Array.from(ye);ye.clear(),t.forEach(a=>a.run())}}}function k(e){let t={dependencies:new Set,run(){et(t),he.push(j),j=t;try{e()}catch(a){br(a,e)}finally{j=he.pop()}},notify(){ye.add(t)}};return t.run(),()=>et(t)}function at(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,Ta(s))}};return{get(){if(j&&(s.add(j),j.dependencies.add(s)),a){et(r),he.push(j),j=r;try{t=e()}finally{j=he.pop()}a=!1}return t}}}function et(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var j,he,ye,Qe,xa,V=v(()=>{j=null,he=[],ye=new Set,Qe=0,xa=null});function ne(){st.totalUpdates++,st.recentUpdates++}var we,st,rt=v(()=>{we=new Set,st={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function D(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){gr(e,t);return}if(e.__ghostWhen){fr(e,t);return}if(e.__ghostLazy){vr(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;we.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let i=s.startsWith("on");typeof r=="function"&&!i?e.effects.push(k(()=>{a.setAttribute(s,r()),ne(),e.events.update?.forEach(n=>n())})):i?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)D(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push(k(()=>{let i=s(),n=document.createTextNode(String(i??""));r?a.replaceChild(n,r):a.appendChild(n),r=n,ne(),e.events.update?.forEach(o=>o())}))}else D(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function oe(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),we.delete(e)}}function gr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function d(m){return m.el||null}let u=k(()=>{let m=a(),y=m.map(($,N)=>String(s($,N))),L=Array.from(o.keys());for(let $ of L)if(!y.includes($)){let N=o.get($);oe(N.ghostNode),o.delete($)}for(let $=0;$<m.length;$++){let N=y[$];if(!o.has(N)){let ie=r(m[$],$),Z=document.createElement("ghost-list-slot");for(D(ie,Z);Z.firstChild;)t.insertBefore(Z.firstChild,n);o.set(N,{ghostNode:ie})}}for(let $=y.length-1;$>=0;$--){let N=y[$],ie=o.get(N);if(!ie)continue;let Z=d(ie.ghostNode);if(!Z)continue;let Sa=y[$+1],ka=(Sa?d(o.get(Sa)?.ghostNode):null)||n;Z.nextSibling!==ka&&t.insertBefore(Z,ka)}ne()});e._listCleanup=()=>{u();for(let m of o.values())oe(m.ghostNode);o.clear(),i.remove(),n.remove()}}function I(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function fr(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=k(()=>{let u=a()?s:r;if(n&&(oe(n),n=null),u&&(n=u(),n)){let m=document.createElement("ghost-when-slot");for(D(n,m);m.firstChild;)t.insertBefore(m.firstChild,i)}ne()});e._whenCleanup=()=>{o(),n&&oe(n),i.remove()}}function vr(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let i=null;if(s){let n=document.createElement("ghost-lazy-slot");for(D(s,n);n.firstChild;)t.insertBefore(n.firstChild,r);i=s}a().then(n=>{let o=n.default||n;i&&(oe(i),i=null);let d=typeof o=="function"?o():o,u=document.createElement("ghost-lazy-slot");for(D(d,u);u.firstChild;)t.insertBefore(u.firstChild,r);i=d}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var it=v(()=>{V();rt()});var La=v(()=>{V()});var _e=v(()=>{});var Ea=v(()=>{rt()});var Ca=v(()=>{V()});var qa=v(()=>{it();V();_e();_e()});function yr(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let i={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){i["@attributes"]={};for(let n of r.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of r.childNodes){let o=n.nodeName,d=s(n);d!==""&&(i[o]===void 0?i[o]=d:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(d)))}return i}return s(a.documentElement)}function wr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function ot(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),i={url:e,...s};for(let y of ot.interceptors.request)i=y(i)??i;let n=i.url;delete i.url;let o=wr(n,r);if(a==="memory"&&r==="GET"&&nt.has(o))return nt.get(o);let d=await fetch(n,i),u=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let m;u.includes("application/xml")||u.includes("text/xml")?m=yr(await d.text()):u.includes("application/json")?m=await d.json():m=await d.text();for(let y of ot.interceptors.response)m=y(d,m)??m;return a==="memory"&&r==="GET"&&nt.set(o,m),m}var nt,Aa=v(()=>{nt=new Map;ot.interceptors={request:[],response:[]}});function lt(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=P(a);return k(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var Ma=v(()=>{V()});function _r(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var bo,Na=v(()=>{bo=_r()});var vo,$r,Pa=v(()=>{V();vo=P("en"),$r=new Map;$r.set("en",{})});var H=v(()=>{V();it();La();_e();Ea();Ca();qa();Aa();Ma();Na();Pa()});function Ha(e){$e=e}function Sr(){return $e}function Ba(e){ct=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let i=e.startsWith("http")?e:ja.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};$e&&(n.headers.Authorization=`Bearer ${$e}`),a!==void 0&&(n.body=JSON.stringify(a)),r&&(n.signal=r);let o=await fetch(i,n);if(o.status===401)throw ct&&ct(),new le("Unauthorized",401,null);let d=null,u=o.headers.get("content-type")||"";try{if(u.includes("application/json"))d=await o.json();else{let m=await o.text();d=m?{message:m}:null}}catch{}if(!o.ok){let m=d&&d.message||`HTTP ${o.status}`;throw new le(m,o.status,d)}return d}var ja,$e,ct,le,c,w=v(()=>{ja=window.JMJOB_CONFIG||{apiBase:"/api"},$e=null,ct=null;le=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>p("/admin/subcategories"),adminCreateSubcategory:e=>p("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>p(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>p(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),notices:()=>p("/notices"),adminUpdateNotices:e=>p("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=ja.apiBase+"/admin/notices/upload",a={},s=Sr();s&&(a.Authorization=`Bearer ${s}`);let r=await fetch(t,{method:"POST",headers:a,body:e}),i=await r.json();if(!r.ok)throw new le(i.message||"Upload failed",r.status,i);return i},adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function l(e,t="info",a=3500){ce.set({message:e,type:t,id:Date.now()}),dt&&clearTimeout(dt),dt=setTimeout(()=>ce.set(null),a)}async function q(){if(!U.get())return null;try{let e=await c.me();return g.set(e.data),e.data}catch{return null}}async function Ia(e,t){let a=await c.login({email:e,password:t});return U.set(a.data.token),g.set(a.data.user),a.data.user}async function Fa(e){return c.requestRegistrationOtp(e)}async function Ra(e){let t=await c.verifyRegistrationOtp(e);return U.set(t.data.token),g.set(t.data.user),t.data.user}async function Se(){try{await c.logout()}catch{}U.set(null),g.set(null),x.set("/login")}function f(e){window.location.hash=e}var kr,xr,U,g,ce,dt,x,E,h=v(()=>{H();H();w();kr="earnap_token",xr="earnap_user",U=lt(kr,null),g=lt(xr,null),ce=P(null),dt=null;x=P(window.location.hash.replace(/^#/,"")||"/"),E=at(()=>!!U.get()&&!!g.get());k(()=>{let e=U.get();Ha(e)});Ba(()=>{U.set(null),g.set(null),x.set("/login"),l("Session expired. Please log in.","error")})});var Ua={};_(Ua,{HomePage:()=>xe});function xe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Tr(e),e.appendChild(Lr(t)),e.appendChild(Er()),e.appendChild(Cr(t))}}function Q(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Tr(e){ke&&(clearInterval(ke),ke=null);try{let t=await c.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(y=>{if(typeof y=="string"){let L=y.trim();return L.startsWith("/")||L.startsWith("http")?{image:L,text:""}:{image:"",text:L}}return{image:y.image||"",text:y.text||""}}).filter(y=>y.image&&y.image.trim()||y.text&&y.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let r=Q("div","welcome-popup welcome-popup--banner","");r.innerHTML=`
            <div id="notice-banner-content" class="welcome-popup__content"></div>
        `,e.firstChild?e.insertBefore(r,e.firstChild):e.appendChild(r);let i=r.querySelector("#notice-banner-content"),n=typeof t.interval=="number"&&t.interval>0?t.interval:4,o=t.direction||"right_to_left",d={right_to_left:{exit:"banner-vanish-left",enter:"banner-enter-right"},left_to_right:{exit:"banner-vanish-right",enter:"banner-enter-left"},top_to_bottom:{exit:"banner-vanish-bottom",enter:"banner-enter-top"},bottom_to_top:{exit:"banner-vanish-top",enter:"banner-enter-bottom"},fade:{exit:"banner-vanish-fade",enter:"banner-enter-fade"}},u=d[o]||d.right_to_left,m=0;Da(i,s[0]),s.length>1&&(ke=setInterval(()=>{let y;do y=Math.floor(Math.random()*s.length);while(y===m&&s.length>1);m=y,i.className=`welcome-popup__content ${u.exit}`,setTimeout(()=>{Da(i,s[m]),i.className=`welcome-popup__content ${u.enter}`,setTimeout(()=>{i.className="welcome-popup__content"},350)},350)},n*1e3))}catch{}}function Da(e,t){e.innerHTML="";let a=!!(t&&t.text&&t.text.trim());if(!!(t&&t.image&&t.image.trim())){let r=document.createElement("img");r.className="welcome-popup__image",r.src=t.image,r.alt=t.text||"Banner Notice",r.onerror=()=>{r.style.display="none"},e.appendChild(r)}if(a){let r=document.createElement("div");r.className="welcome-popup__text-wrap",r.innerHTML=`<strong>JM Job:</strong> <span>${qr(t.text)}</span>`,e.appendChild(r)}}function Lr(e){let t=Q("div","card card--user-header"),a=Q("div","user-header__stats");return a.innerHTML=`
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),r=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let r=e.querySelector("#copy-btn"),i=e.querySelector("#refer-link-input");r.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(i.value),l("Link copied to clipboard!","success")}catch{i.select(),document.execCommand("copy"),l("Link copied!","success")}});let n=e.querySelector("#share-tg");n.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let u=document.createElement("div");u.className="refer-item",u.innerHTML=`
                ...
                `,o.appendChild(u)})}}function Ja(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var gt=v(()=>{w();h()});var za={};_(za,{WithdrawPage:()=>Ee});function Ee(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#withdraw-form");a.addEventListener("submit",async r=>{r.preventDefault();let i=new FormData(a),n=a.querySelector("button");n.disabled=!0,n.textContent="Submitting\u2026";try{let o=await c.withdraw({amount:parseFloat(i.get("amount")),wallet_address:String(i.get("wallet_address")),gateway:String(i.get("gateway"))});l("Withdrawal requested!","success"),await q(),Ee()()}catch(o){let d=o.payload&&o.payload.errors;if(d){let u=Object.values(d)[0];l(Array.isArray(u)?u[0]:u,"error")}else l(o.message||"Withdrawal failed","error");n.disabled=!1,n.textContent="Confirm Withdrawal"}});let s=e.querySelector("#withdraw-history");try{let i=(await c.withdrawals()).data||[];i.length===0?s.innerHTML='<p class="muted">No withdrawals yet.</p>':(s.innerHTML="",i.forEach(n=>s.appendChild(Hr(n))))}catch{s.innerHTML='<p class="muted">Failed to load history.</p>'}}}function Hr(e){let t=document.createElement("div");t.className="withdraw-row withdraw-row--"+e.status;let a=(e.status||"pending").toUpperCase(),s=e.admin_note?`<div class="withdraw-row__note">"${ft(e.admin_note)}"</div>`:"";return t.innerHTML=`
        ...
        ${s}
    `,t}function ft(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var vt=v(()=>{w();h()});var Ya={};_(Ya,{DepositPage:()=>ht});function ht(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=g.get();e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{S.selectedGateway=t.getAttribute("data-gateway"),Xa(),Ir()})})}}function Ir(){let e=S.gateways.find(i=>i.key===S.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `}).join("")}}function Fr(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function te(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Br,S,yt=v(()=>{w();h();Br={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},S={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var _t={};_(_t,{ProfilePage:()=>Ce});function Ce(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let r=(await c.adHistory()).data||[];if(r.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let i=a.querySelector(".ad-history__list");r.forEach(n=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                    ...
                    `,i.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function wt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var qe=v(()=>{w();h()});var Ka={};_(Ka,{default:()=>Ae});async function Ae(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var $t=v(()=>{h()});var Za={};_(Za,{default:()=>Me});async function Me(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var St=v(()=>{h()});var Qa={};_(Qa,{default:()=>Ne});async function Ne(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var kt=v(()=>{h()});function Rr(){let e=localStorage.getItem(es);return e==="dark"||e==="light"?e:"system"}function Dr(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function xt(e){let t=Dr(e);document.documentElement.setAttribute("data-theme",t)}function ts(){let e=B.get();B.set(e==="dark"?"light":"dark")}function as(e){B.set(e)}function Ur(){let e=localStorage.getItem(ss);return e&&Tt.includes(e)?e:"default"}function rs(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function is(e){Tt.includes(e)&&pe.set(e)}function ns(){return Tt}var es,B,ss,Tt,pe,Lt=v(()=>{H();es="jmjob_theme";B=P(Rr());xt(B.get());k(()=>{let e=B.get();xt(e),localStorage.setItem(es,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{B.get()==="system"&&xt("system")});ss="jmjob_color_theme",Tt=["default","emerald","amber","rose"];pe=P(Ur());rs(pe.get());k(()=>{let e=pe.get();rs(e),localStorage.setItem(ss,e)})});var os={};_(os,{default:()=>je});async function je(){let e=document.querySelector("[data-view]");if(!e)return;let t=g.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=B.get(),s=pe.get(),r=ns();e.innerHTML=`
            ...
            <div class="settings-section">
                ...
                <div class="settings-item settings-item--stack">
                    <div class="settings-info">
                        ...
                        <div class="settings-value">${Pe[s]||"Default (Purple)"}</div>
                    </div>
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${Pe[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${Or[o]};"></span>
                                <span class="theme-swatch__label">${(Pe[o]||o).split(" ")[0]}</span>
                            </button>
                        `).join("")}
                    </div>
                </div>
    ...
    `;let i=document.getElementById("theme-mode-group");i&&i.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-mode");as(d),l(`Theme mode set to ${d}.`,"info")})});let n=document.getElementById("color-theme-group");n&&n.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-color");is(d),l(`Accent color set to ${Pe[d]||d}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await Se(),l("Logged out.","info")})}var Pe,Or,Et=v(()=>{h();Lt();Pe={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},Or={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var cs={};_(cs,{NotificationsPage:()=>Ct});function Ct(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `;let t=e.querySelector("#tg-list");try{let s=(await c.tgTasks()).data||[];if(t.innerHTML="",s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}s.forEach(r=>t.appendChild(Gr(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function Gr(e){let t=document.createElement("div");if(t.className="card card--task",t.innerHTML=`
        <div class="task-header">
            <div class="task-channel">
                <i class="bi bi-telegram"></i>
                <strong>${He(e.channel_name)}</strong>
                <span class="muted">${He(e.channel_username)}</span>
            </div>
        </div>
        <p class="card__sub">${He(e.description||"")}</p>
        <div class="task-meta">
            <span><i class="bi bi-cash"></i> $${parseFloat(e.reward).toFixed(3)}</span>
        </div>
        <div class="task-actions">
            ${e.completed?'<button class="btn btn--ghost" disabled>\u2713 Completed</button>':`<a class="btn btn--primary" href="https://t.me/${He(e.channel_username.replace("@",""))}" target="_blank" rel="noopener" data-task-id="${e.id}">Join channel</a>`}
        </div>
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&zr(e,t)},3e3)})}return t}async function zr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await q(),Be()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function He(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var At=v(()=>{w();h()});var ms={};_(ms,{PosterDashboardPage:()=>Nt});function Nt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-dashboard";let t=g.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML=`
        ...
        `;let a=e.querySelector("#poster-new-job");a&&a.addEventListener("click",s=>{s.preventDefault(),f("/poster/post-job")}),await ps()}}async function ps(){let e=document.getElementById("poster-dashboard-content");if(e)try{let t=await c.posterStats();Xr(e,t.data||{})}catch(t){e.innerHTML=`
            <div class="card">
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",ps),l(t.message||"Failed to load poster statistics.","error")}}function Xr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=Mt(t.wallet_balance),i=Mt(t.frozen_balance),n=Mt(t.total_spent);e.innerHTML=`
        <div class="stat-grid poster-stat-grid">
            ${Ie("bi-briefcase","Total jobs",a.total||0)}
            ${Ie("bi-lightning-charge","Active jobs",s)}
            ${Ie("bi-wallet2","Available wallet",r,"\u09F3")}
            ${Ie("bi-lock","In escrow",i,"\u09F3")}
        </div>
    ...
    `,e.querySelectorAll("[data-poster-link]").forEach(o=>{o.addEventListener("click",d=>{d.preventDefault(),f(o.getAttribute("href").replace(/^#/,""))})})}function Ie(e,t,a,s=""){return`
    ...
    `,Kr(e,t)}function Kr(e,t){let a=e.querySelector("#wizard-card-body");a&&(t.currentStep===1?gs(a,e,t):t.currentStep===2?jt(a,e,t):t.currentStep===3&&Zr(a,e,t))}function gs(e,t,a){let s=a.categories.find(o=>Number(o.id)===Number(a.mainCategoryId)),r=s?s.subcategories||[]:[];e.innerHTML=`
                ...
                <div id="proof-pairs-container">
                    ${a.proofRequirements.map((i,n)=>`
                        <div class="proof-pair-row" style="display:flex; gap:0.5rem; align-items:center; margin-bottom:0.5rem;" data-index="${n}">
                            <input type="text" class="proof-title-input" placeholder="Proof Requirement Title (e.g. Provide Username)" value="${me(i.title)}" style="flex:2;" required>
    ...
    `;let s=e.querySelector("#proof-pairs-container");e.querySelector("#add-proof-btn").addEventListener("click",()=>{Fe(e,a),a.proofRequirements.push({title:"",type:"text"}),jt(e,t,a)}),s.addEventListener("click",i=>{let n=i.target.closest(".remove-proof-btn");if(n){let o=Number(n.getAttribute("data-index"));Fe(e,a),a.proofRequirements.splice(o,1),jt(e,t,a)}}),e.querySelector("#job-thumbnail-input").addEventListener("change",i=>{let n=i.target.files[0];if(n){let o=new FileReader;o.onload=d=>{a.thumbnailBase64=d.target.result},o.readAsDataURL(n)}}),e.querySelector("#step-cancel").addEventListener("click",Bt),e.querySelector("#step-2-back").addEventListener("click",()=>{Fe(e,a),a.currentStep=1,be(t,a)}),e.querySelector("#step-2-form").addEventListener("submit",i=>{if(i.preventDefault(),Fe(e,a),!a.title.trim()){l("Job title is required.","error");return}if(!a.description.trim()){l("Task instructions are required.","error");return}a.currentStep=3,be(t,a)})}function Fe(e,t){t.title=e.querySelector("#job-title-input")?.value||"",t.description=e.querySelector("#job-desc-input")?.value||"";let a=e.querySelectorAll(".proof-pair-row");t.proofRequirements=Array.from(a).map(s=>({title:s.querySelector(".proof-title-input")?.value||"",type:s.querySelector(".proof-type-select")?.value||"text"}))}function Zr(e,t,a){let s=Number(a.workerCount||0)*Number(a.costPerWorker||0),r=s*(a.feePercentage/100),i=s+r;e.innerHTML=`
    ...
    `;let n=e.querySelector("#worker-count-input"),o=e.querySelector("#cost-per-worker-input"),d=()=>{a.workerCount=Math.max(1,parseInt(n.value,10)||1),a.costPerWorker=Math.max(0,parseFloat(o.value)||0);let u=a.workerCount*a.costPerWorker,m=u*(a.feePercentage/100),y=u+m;e.querySelector("#summary-subtotal").textContent=`\u09F3${u.toFixed(2)}`,e.querySelector("#summary-fee").textContent=`\u09F3${m.toFixed(2)}`,e.querySelector("#summary-total").textContent=`\u09F3${y.toFixed(2)}`};n.addEventListener("input",d),o.addEventListener("input",d),e.querySelector("#step-cancel").addEventListener("click",Bt),e.querySelector("#step-3-back").addEventListener("click",()=>{bs(e,a),a.currentStep=2,be(t,a)}),e.querySelector("#step-3-form").addEventListener("submit",async u=>{u.preventDefault(),bs(e,a);let m=e.querySelector("#post-job-publish");m.disabled=!0,m.textContent="Publishing\u2026";let y=0,L=Number(a.biddingValue||0);L>0&&(a.biddingUnit==="minutes"?y=L/60:a.biddingUnit==="hours"?y=L:a.biddingUnit==="days"?y=L*24:a.biddingUnit==="months"&&(y=L*24*30));try{await c.posterCreateJob({category_id:Number(a.mainCategoryId),subcategory_id:a.subCategoryId?Number(a.subCategoryId):null,title:a.title.trim(),description:a.description.trim(),thumbnail:a.thumbnailBase64||null,proof_requirements:a.proofRequirements,worker_count:Number(a.workerCount),cost_per_worker:Number(a.costPerWorker),budget:Number(a.workerCount)*Number(a.costPerWorker),deadline_at:Qr(a.deadlineAt),bidding_window_hours:y}),l("Job published successfully.","success"),f("/poster/jobs")}catch($){l($.message||"Could not publish job.","error"),m.disabled=!1,m.textContent="Publish Job"}})}function bs(e,t){t.workerCount=Number(e.querySelector("#worker-count-input")?.value||1),t.costPerWorker=Number(e.querySelector("#cost-per-worker-input")?.value||0),t.biddingValue=Number(e.querySelector("#bidding-val-input")?.value||0),t.biddingUnit=e.querySelector("#bidding-unit-input")?.value||"days",t.deadlineAt=e.querySelector("#deadline-input")?.value||""}function Bt(){confirm("Are you sure you want to cancel posting this job?")&&f("/poster")}function Qr(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function ei(){return!!g.get()}function me(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var It=v(()=>{w();h()});var hs={};_(hs,{PosterJobsPage:()=>Ft});function Ft(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--poster-jobs",!ri()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="poster-filter-bar">
                <label>Status
                    <select class="admin-select" id="poster-job-filter">
                        ${ti.map(t=>`<option value="${t}" ${t===De?"selected":""}>${t?vs(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#poster-jobs-new").addEventListener("click",t=>{t.preventDefault(),f("/poster/post-job")}),e.querySelector("#poster-job-filter").addEventListener("change",async t=>{De=t.target.value,await Re()}),e.querySelector("#poster-jobs-refresh").addEventListener("click",Re),await Re()}}}async function Re(){let e=document.getElementById("poster-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=((await c.posterMyJobs()).data||[]).filter(s=>!De||s.status===De);e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(ai(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${se(t.message||"unknown error")}</p>`}}}function ai(e){let t=document.createElement("article");return t.className=`admin-row poster-job-row poster-job-row--${se(e.status)}`,t.innerHTML=`
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>f(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>si(e.id)),t}async function si(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await c.posterCancelJob(e,{reason:t}),l("Job cancelled.","success"),await Re()}catch(a){l(a.message||"Could not cancel job.","error")}}function ri(){return!!g.get()}function vs(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function ii(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function se(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ti,De,Rt=v(()=>{w();h();ti=["","open","assigned","submitted","revision","completed","cancelled","disputed"],De=""});var ys={};_(ys,{PosterWalletPage:()=>Ut});function Ut(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-wallet";let t=g.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([c.posterStats(),c.paymentSubmissions()]);ni(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${Ue(a.message||"unknown error")}</p>`}}}function ni(e,t,a){let s=Dt(t.wallet_balance),r=Dt(t.frozen_balance),i=Dt(t.total_spent);e.innerHTML=`
    ...
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>f("/deposit"))}function oi(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${Ue((t.gateway||"").toUpperCase())}</strong><small>${Ue(t.trxid)} \xB7 ${li(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${Ue(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function Dt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function li(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Ue(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ot=v(()=>{w();h()});var $s={};_($s,{AdminPage:()=>Jt});function Jt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),r.classList.add("admin-tab--active"),ws(r.dataset.tab,s)})}),ws("stats",s)}}async function ws(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),r=a.data||{},i=s.data||{},n=i.currency_symbol||"\u09F3";t.innerHTML=`
            ...
            `;let r=t.querySelector("#wd-list");s.forEach(i=>r.appendChild(_s(i,r))),t.querySelector("#wd-filter").addEventListener("change",async i=>{let n=await c.adminWithdrawals(i.target.value);r.innerHTML="",(n.data||[]).forEach(o=>r.appendChild(_s(o,r)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list"),i=Number(g.get()?.id||0);s.forEach(n=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                    <div>
    ...
    `,e.status==="pending"&&(a.querySelector('[data-action="approve"]')?.addEventListener("click",()=>Ss(e.id,"approve",a)),a.querySelector('[data-action="reject"]')?.addEventListener("click",()=>Ss(e.id,"reject",a))),a}async function Ss(e,t,a){let s=prompt(t==="approve"?"Optional note for approval:":"Reason for rejection:");if(s!==null)try{let i=await(t==="approve"?c.adminApprovePayment:c.adminRejectPayment)(e,{note:s||null});l(i.message||"Done.","success"),await zt()}catch(r){l(r.message||"Action failed.","error")}}function ks(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ee(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var di,O,Xt=v(()=>{w();h();di={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},O={status:"pending",items:[],loading:!1}});var Ls={};_(Ls,{AdminJobsPage:()=>Zt});function Zt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-jobs",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#admin-job-status").addEventListener("change",async t=>{Kt=t.target.value,await ge()}),e.querySelector("#admin-job-refresh").addEventListener("click",ge),await ge()}}}async function ge(){let e=document.getElementById("admin-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminJobs(Kt)).data||[];e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(bi(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${F(t.message||"unknown error")}</p>`}}}function bi(e){let t=document.createElement("article");t.className=`admin-row admin-job-row admin-job-row--${F(e.status)}`;let a=e.worker?`${F(e.worker.name)} <span class="muted">(${F(e.worker.email||"")})</span>`:'<span class="muted">Unassigned</span>';t.innerHTML=`
    ...
    `;let s=t.querySelector(".admin-row__actions");return["completed","cancelled","disputed"].includes(e.status)||s.appendChild(Yt("Mark disputed","btn--danger",()=>gi(e.id))),e.status==="disputed"&&(s.appendChild(Yt("Release payment","btn--success",()=>Ts(e.id,"release"))),s.appendChild(Yt("Cancel and refund","btn--danger",()=>Ts(e.id,"cancel")))),t}function Yt(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function gi(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await ge()}catch(t){l(t.message||"Could not flag job.","error")}}async function Ts(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ge()}catch(r){l(r.message||"Could not resolve dispute.","error")}}function fi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function F(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var mi,Kt,Qt=v(()=>{w();h();mi=["","open","in_review","assigned","submitted","revision","disputed","completed","cancelled","expired"],Kt=""});var Es={};_(Es,{AdminTransactionsPage:()=>aa});function aa(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{ta=t.target.value,await ea()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",ea),await ea()}}}async function ea(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminTransactions({type:ta})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(hi(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${W(t.message||"unknown error")}</p>`}}}function hi(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${W(e.type)}`,t.innerHTML=`
    ...
    `,t}function yi(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function W(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var vi,ta,sa=v(()=>{w();h();vi=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],ta=""});var Cs={};_(Cs,{AdminReportsPage:()=>ra});function ra(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await wi()}}}async function wi(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            <div class="stat-grid admin-report-summary">
                ${Oe("Transactions",We(s.transaction_count))}
                ${Oe("Transaction volume",Je(s.transaction_volume))}
                ${Oe("Jobs",We(s.job_count))}
                ${Oe("Job value",Je(s.job_value))}
            </div>
        ...
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${fe(t.message||"unknown error")}</p>`}}function Oe(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${fe(e)}</span><strong>${fe(t)}</strong></div>`}function _i(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${fe(String(t.type||"").replace("_"," "))}</strong><small>${We(t.transaction_count)} entries</small></span>
            <strong>${Je(t.amount)}</strong>
        </div>
    `).join(""):'<p class="muted">No transactions yet.</p>'}function $i(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${fe(String(t.status||"").replace("_"," "))}</strong><small>${We(t.job_count)} jobs</small></span>
            <strong>${Je(t.budget)}</strong>
        </div>
    `).join(""):'<p class="muted">No jobs yet.</p>'}function We(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Je(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function fe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ia=v(()=>{w();h()});var qs={};_(qs,{LoginPage:()=>na});function na(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
    ...
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function bn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function Qs(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var ve={jobs:[],submissions:[],loading:!1};function va(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);ve.jobs=t.data||[],ve.submissions=a.data||[],gn()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${ha(t.message||"unknown")}</p>`}}}}function gn(){let e=document.getElementById("active-jobs-list");if(e){if(ve.jobs.length===0){e.innerHTML=`<p class="muted">No active jobs. Once a poster accepts your bid, it'll appear here.</p>`;return}e.innerHTML=ve.jobs.map(t=>{let a=ve.submissions.find(r=>r.job_id===t.id),s=t.status;return`
    ...
    `,e.querySelectorAll(".edit-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.categories.find(d=>String(d.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Main Category "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateCategory(r,{min_cost:o}),l(`Min cost updated for ${i.name}.`,"success"),await G(t)}catch(d){l(d.message,"error")}})}),e.querySelectorAll(".toggle-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.categories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateCategory(r,{is_active:!i.is_active}),l("Category updated.","success"),await G(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete category?"))try{let i=await c.adminDeleteCategory(r);l(i.message||"Deleted.","success"),await G(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-cat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),description:String(r.get("description")||"").trim()||null,is_active:r.get("is_active")==="on"};try{await c.adminCreateCategory(i),l("Main Category created.","success"),await G(t)}catch(n){l(n.message,"error")}})}function _n(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
    ...
    `,e.querySelectorAll(".edit-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.subcategories.find(d=>String(d.id)===String(r));if(!i)return;let n=prompt(`Update Min Cost (\u09F3) for Subcategory "${i.name}":`,String(i.min_cost||1));if(n===null)return;let o=parseFloat(n);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateSubcategory(r,{min_cost:o}),l(`Min cost updated for ${i.name}.`,"success"),await G(t)}catch(d){l(d.message,"error")}})}),e.querySelectorAll(".toggle-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=A.subcategories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateSubcategory(r,{is_active:!i.is_active}),l("Subcategory updated.","success"),await G(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete subcategory?"))try{let i=await c.adminDeleteSubcategory(r);l(i.message||"Deleted.","success"),await G(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-subcat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={category_id:parseInt(r.get("category_id")||"0",10),name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),is_active:r.get("is_active")==="on"};try{await c.adminCreateSubcategory(i),l("Subcategory created.","success"),await G(t)}catch(n){l(n.message,"error")}})}function J(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var z={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1};function tr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
    ...
    `}async function xn(){let e={};for(let n of Object.keys(z.grouped))for(let o of z.grouped[n]){let d=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,u=document.getElementById(d);if(!u)continue;let m;o.value_type==="boolean"?m=u.checked:o.value_type==="integer"||o.value_type==="percent"?m=parseInt(u.value,10):o.value_type==="decimal"?m=parseFloat(u.value):o.value_type==="json"?m=u.value?JSON.parse(u.value):null:m=u.value,e[o.key]=m}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".banner-message-row")).map(n=>({image:n.querySelector(".notice-msg-image")?.value.trim()||""})).filter(n=>n.image!==""),r={interval:document.getElementById("notice-interval")?.value||4,direction:document.getElementById("notice-direction")?.value||"right_to_left",notices:s},i=document.getElementById("settings-save-btn");i.disabled=!0,i.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(r)]),l("Settings, notices, and social links saved successfully.","success"),await ar()}catch(n){l(n.message||"Failed to save.","error")}finally{i.disabled=!1,i.textContent="Save All Changes"}}function M(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}Qt();sa();ia();Pt();It();Rt();Ot();qt();var dr={"/":xe,"/refer":bt,"/webtask":de,"/tasks":de,"/earn":Le,"/tg-tasks":Be,"/withdraw":Ee,"/profile":Ce,"/wallet":Ce,"/admin":Jt,"/admin/payments":Vt,"/admin/categories":er,"/admin/settings":tr,"/admin/jobs":Zt,"/admin/transactions":aa,"/admin/reports":ra,"/deposit":ht,"/leaderboard":Ae,"/achievements":Me,"/support":Ne,"/settings":je,"/jobs/available":Xs,"/worker/bids":Zs,"/worker/active-jobs":va,"/poster":Nt,"/poster/post-job":Ht,"/poster/jobs":Ft,"/poster/wallet":Ut,"/notifications":Ct,"/login":na,"/register":ca,"/forgot-password":Ge,"/reset-password":ze};function pr(){Ze(),setTimeout(Ze,50),window.addEventListener("hashchange",Ze),k(()=>{E.get(),setTimeout(Ze,0)})}async function Ze(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!dr[t]){let n=t.match(/^\/jobs\/(\d+)$/);if(n){let d=await Promise.resolve().then(()=>(ir(),rr));await $a(()=>d.JobDetailPage(n[1]),t);return}let o=t.match(/^\/poster\/jobs\/(\d+)$/);if(o){if(!E.get()){f("/login");return}let d=await Promise.resolve().then(()=>(cr(),lr));await $a(()=>d.PosterJobDetailPage(o[1]),t);return}t="/"}let a=E.get(),s=g.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?f("/admin"):f("/");return}if(!r.includes(t)&&!a){f("/login");return}if(t==="/"&&s&&s.is_admin){f("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){Dn();return}let i=dr[t];await $a(i,t)}async function $a(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function Dn(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
