var qn=Object.defineProperty;var _=(e,t)=>()=>(e&&(t=e(e=0)),t);var x=(e,t)=>{for(var a in t)qn(e,a,{get:t[a],enumerable:!0})};function Nn(e,t){Ha?Ha(e,t):console.error("[Ghost] Unhandled effect error:",e)}function F(e){let t=e,a=new Set;return{get(){return B&&(a.add(B),B.dependencies.add(a)),t},set(s){t!==s&&(t=s,Fa(a))}}}function Fa(e){vt(()=>{e.forEach(t=>{t.notify?t.notify():Re.add(t)})})}function vt(e){bt++;try{e()}finally{if(bt--,bt===0){let t=Array.from(Re);Re.clear(),t.forEach(a=>a.run())}}}function E(e){let t={dependencies:new Set,run(){gt(t),je.push(B),B=t;try{e()}catch(a){Nn(a,e)}finally{B=je.pop()}},notify(){Re.add(t)}};return t.run(),()=>gt(t)}function ft(e){let t,a=!0,s=new Set,n={dependencies:new Set,notify(){a||(a=!0,Fa(s))}};return{get(){if(B&&(s.add(B),B.dependencies.add(s)),a){gt(n),je.push(B),B=n;try{t=e()}finally{B=je.pop()}a=!1}return t}}}function gt(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var B,je,Re,bt,Ha,re=_(()=>{B=null,je=[],Re=new Set,bt=0,Ha=null});function fe(){ht.totalUpdates++,ht.recentUpdates++}var He,ht,yt=_(()=>{He=new Set,ht={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function Y(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){Pn(e,t);return}if(e.__ghostWhen){Mn(e,t);return}if(e.__ghostLazy){jn(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;He.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,n])=>{if(s==="ghostStyle"&&n?.mount){n.mount(a);return}let r=s.startsWith("on");typeof n=="function"&&!r?e.effects.push(E(()=>{a.setAttribute(s,n()),fe(),e.events.update?.forEach(i=>i())})):r?a[s.toLowerCase()]=n:a.setAttribute(s,n)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)Y(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let n=null;e.effects.push(E(()=>{let r=s(),i=document.createTextNode(String(r??""));n?a.replaceChild(i,n):a.appendChild(i),n=i,fe(),e.events.update?.forEach(o=>o())}))}else Y(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function he(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),He.delete(e)}}function Pn(e,t){let{getItems:a,keyFn:s,renderFn:n}=e,r=document.createComment("[ghost-list]"),i=document.createComment("[/ghost-list]");t.appendChild(r),t.appendChild(i);let o=new Map;function d(u){return u.el||null}let p=E(()=>{let u=a(),b=u.map((y,T)=>String(s(y,T))),h=Array.from(o.keys());for(let y of h)if(!b.includes(y)){let T=o.get(y);he(T.ghostNode),o.delete(y)}for(let y=0;y<u.length;y++){let T=b[y];if(!o.has(T)){let G=n(u[y],y),X=document.createElement("ghost-list-slot");for(Y(G,X);X.firstChild;)t.insertBefore(X.firstChild,i);o.set(T,{ghostNode:G})}}for(let y=b.length-1;y>=0;y--){let T=b[y],G=o.get(T);if(!G)continue;let X=d(G.ghostNode);if(!X)continue;let Pe=b[y+1],Me=(Pe?d(o.get(Pe)?.ghostNode):null)||i;X.nextSibling!==Me&&t.insertBefore(X,Me)}fe()});e._listCleanup=()=>{p();for(let u of o.values())he(u.ghostNode);o.clear(),r.remove(),i.remove()}}function V(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function Mn(e,t){let{conditionGetter:a,trueFn:s,falseFn:n}=e,r=document.createComment("[ghost-when]");t.appendChild(r);let i=null,o=E(()=>{let p=a()?s:n;if(i&&(he(i),i=null),p&&(i=p(),i)){let u=document.createElement("ghost-when-slot");for(Y(i,u);u.firstChild;)t.insertBefore(u.firstChild,r)}fe()});e._whenCleanup=()=>{o(),i&&he(i),r.remove()}}function jn(e,t){let{importFn:a,fallback:s}=e,n=document.createComment("[ghost-lazy]");t.appendChild(n);let r=null;if(s){let i=document.createElement("ghost-lazy-slot");for(Y(s,i);i.firstChild;)t.insertBefore(i.firstChild,n);r=s}a().then(i=>{let o=i.default||i;r&&(he(r),r=null);let d=typeof o=="function"?o():o,p=document.createElement("ghost-lazy-slot");for(Y(d,p);p.firstChild;)t.insertBefore(p.firstChild,n);r=d}).catch(i=>{console.error("[Ghost] lazyNode failed to load:",i)})}var wt=_(()=>{re();yt()});var Ba=_(()=>{re()});var Fe=_(()=>{});var Da=_(()=>{yt()});var Ia=_(()=>{re()});var Ua=_(()=>{wt();re();Fe();Fe()});function Hn(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(n){let r={};if(n.nodeType===3)return n.nodeValue.trim();if(n.attributes?.length){r["@attributes"]={};for(let i of n.attributes)r["@attributes"][i.nodeName]=i.nodeValue}for(let i of n.childNodes){let o=i.nodeName,d=s(i);d!==""&&(r[o]===void 0?r[o]=d:(Array.isArray(r[o])||(r[o]=[r[o]]),r[o].push(d)))}return r}return s(a.documentElement)}function Fn(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function $t(e,t={}){let{cache:a=!1,...s}=t,n=(s.method||"GET").toUpperCase(),r={url:e,...s};for(let b of $t.interceptors.request)r=b(r)??r;let i=r.url;delete r.url;let o=Fn(i,n);if(a==="memory"&&n==="GET"&&_t.has(o))return _t.get(o);let d=await fetch(i,r),p=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let u;p.includes("application/xml")||p.includes("text/xml")?u=Hn(await d.text()):p.includes("application/json")?u=await d.json():u=await d.text();for(let b of $t.interceptors.response)u=b(d,u)??u;return a==="memory"&&n==="GET"&&_t.set(o,u),u}var _t,Oa=_(()=>{_t=new Map;$t.interceptors={request:[],response:[]}});function St(e,t){let a;try{let n=localStorage.getItem(e);a=n?JSON.parse(n):t}catch{a=t}let s=F(a);return E(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(n){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,n)}}),s}var Ja=_(()=>{re()});function Bn(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var Wo,Wa=_(()=>{Wo=Bn()});var Go,Dn,Va=_(()=>{re();Go=F("en"),Dn=new Map;Dn.set("en",{})});var I=_(()=>{re();wt();Ba();Fe();Da();Ia();Ua();Oa();Ja();Wa();Va()});function za(e){le=e}function Tt(){return le}function Ga(e){kt=e}async function m(e,{method:t="GET",body:a,headers:s={},signal:n}={}){let r=e.startsWith("http")?e:xt.apiBase+e,i=typeof FormData<"u"&&a instanceof FormData,o={method:t,headers:{Accept:"application/json",...i?{}:{"Content-Type":"application/json"},...s}};le&&(o.headers.Authorization=`Bearer ${le}`),a!==void 0&&(o.body=i?a:JSON.stringify(a)),n&&(o.signal=n);let d=await fetch(r,o);if(d.status===401)throw kt&&kt(),new ce("Unauthorized",401,null);let p=null,u=d.headers.get("content-type")||"";try{if(u.includes("application/json"))p=await d.json();else{let b=await d.text();p=b?{message:b}:null}}catch{}if(!d.ok){let b=p&&p.message||`HTTP ${d.status}`;throw new ce(b,d.status,p)}return p}async function In(e){let t=e.startsWith("http")?e:xt.apiBase+e,a={Accept:"text/csv"};le&&(a.Authorization=`Bearer ${le}`);let s=await fetch(t,{headers:a});if(!s.ok){let n=`HTTP ${s.status}`;try{n=(await s.json())?.message||n}catch{}throw new ce(n,s.status,null)}return s.blob()}var xt,le,kt,ce,c,S=_(()=>{xt=window.JMJOB_CONFIG||{apiBase:"/api"},le=null,kt=null;ce=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>m("/health"),register:e=>m("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>m("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>m("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>m("/auth/login",{method:"POST",body:e}),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>m("/auth/reset-password",{method:"POST",body:e}),logout:()=>m("/auth/logout",{method:"POST"}),me:()=>m("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/notifications${t?"?"+t:""}`)},notificationRead:e=>m(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>m("/notifications/read-all",{method:"POST"}),meUser:()=>m("/user"),reward:e=>m("/user/reward",{method:"POST",body:e}),withdraw:e=>m("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>m("/user/withdrawals"),referrals:()=>m("/user/referrals"),adHistory:()=>m("/user/ads"),adsConfig:()=>m("/ads/config"),adsNext:()=>m("/ads/next"),videoAds:()=>m("/ads/videos"),videoAdStart:e=>m("/ads/videos/start",{method:"POST",body:e}),videoAdClaim:e=>m("/ads/videos/claim",{method:"POST",body:e}),webTasks:()=>m("/tasks/web"),webTaskStart:e=>m("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>m("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>m("/tasks/telegram"),tgTaskVerify:e=>m("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>m("/admin/stats"),adminWithdrawals:(e="pending")=>m(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>m(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>m(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>m(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>m("/admin/users"),adminUpdateUserRole:(e,t)=>m(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminBanUser:(e,t={})=>m(`/admin/users/${e}/ban`,{method:"POST",body:t}),adminUnbanUser:(e,t={})=>m(`/admin/users/${e}/unban`,{method:"POST",body:t}),adminBanHistory:e=>m(`/admin/users/${e}/ban-history`),adminProviders:()=>m("/admin/ad-providers"),adminUpdateProvider:(e,t)=>m(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminVideoAds:()=>m("/admin/video-ads"),adminCreateVideoAd:e=>m("/admin/video-ads",{method:"POST",body:e}),adminUpdateVideoAd:(e,t)=>m(`/admin/video-ads/${e}`,{method:"POST",body:t}),adminDeleteVideoAd:e=>m(`/admin/video-ads/${e}`,{method:"DELETE"}),adminResetDailyCounters:()=>m("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>m("/payment/gateways"),paymentSubmit:e=>m("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>m("/payment/submissions"),adminPayments:(e="")=>m(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>m(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>m(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>m("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/jobs${t?"?"+t:""}`)},job:e=>m(`/jobs/${e}`),createWorkflowJob:e=>m("/jobs/workflow",{method:"POST",body:e}),applyForJob:(e,t={})=>m(`/jobs/${e}/apply`,{method:"POST",body:t}),extendDeadline:(e,t={})=>m(`/jobs/${e}/extend-deadline`,{method:"POST",body:t}),placeBid:(e,t)=>m(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>m(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>m("/worker/bids"),workerActiveJobs:()=>m("/worker/active-jobs"),submitWork:(e,t)=>m(`/jobs/${e}/submit`,{method:"POST",body:t}),workerCancelAssignment:(e,t={})=>m(`/worker/assignments/${e}/cancel`,{method:"POST",body:t}),workerSubmissions:()=>m("/worker/submissions"),posterStats:()=>m("/poster/stats"),posterCreateJob:e=>m("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>m("/poster/jobs"),posterJobBids:e=>m(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>m(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>m(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>m(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>m(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>m("/admin/categories"),adminCreateCategory:e=>m("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>m(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>m(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>m("/admin/subcategories"),adminCreateSubcategory:e=>m("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>m(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>m(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>m("/admin/settings"),adminUpdateSettings:e=>m("/admin/settings",{method:"POST",body:e}),socialLinks:()=>m("/social-links"),adminUpdateSocialLinks:e=>m("/admin/social-links",{method:"POST",body:e}),notices:()=>m("/notices"),adminUpdateNotices:e=>m("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=xt.apiBase+"/admin/notices/upload",a={},s=Tt();s&&(a.Authorization=`Bearer ${s}`);let n=await fetch(t,{method:"POST",headers:a,body:e}),r=await n.json();if(!n.ok)throw new ce(r.message||"Upload failed",n.status,r);return r},adminJobs:(e="")=>m(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminCreateJob:e=>m("/admin/jobs",{method:"POST",body:e}),adminJobDetail:e=>m(`/admin/jobs/${e}/detail`),adminUpdateJob:(e,t)=>m(`/admin/jobs/${e}/edit`,{method:"POST",body:t}),adminDeleteJob:e=>m(`/admin/jobs/${e}`,{method:"DELETE"}),adminJobSubmissions:e=>m(`/admin/jobs/${e}/submissions`),adminFraudSubmissions:()=>m("/admin/fraud/submissions"),adminReviewFraud:(e,t={})=>m(`/admin/fraud/submissions/${e}/review`,{method:"POST",body:t}),adminReviewSubmission:(e,t={})=>m(`/admin/submissions/${e}/review`,{method:"POST",body:t}),adminCancelAssignment:(e,t={})=>m(`/admin/assignments/${e}/cancel`,{method:"POST",body:t}),adminReassignAssignment:(e,t={})=>m(`/admin/assignments/${e}/reassign`,{method:"POST",body:t}),adminApproveJob:(e,t={})=>m(`/admin/jobs/${e}/approve`,{method:"POST",body:t}),adminDeclineJob:(e,t={})=>m(`/admin/jobs/${e}/decline`,{method:"POST",body:t}),adminApproveApplication:(e,t={})=>m(`/admin/applications/${e}/approve`,{method:"POST",body:t}),adminFlagJobDispute:e=>m(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>m(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>m("/admin/reports"),adminReportsExport:()=>In("/admin/reports?format=csv"),adminRevenue:()=>m("/admin/revenue")}});function l(e,t="info",a=3500){ye.set({message:e,type:t,id:Date.now()}),Lt&&clearTimeout(Lt),Lt=setTimeout(()=>ye.set(null),a)}async function M(){if(!K.get())return null;try{let e=await c.me();return g.set(e.data),e.data}catch{return null}}async function Xa(e,t){let a=await c.login({email:e,password:t});return K.set(a.data.token),g.set(a.data.user),a.data.user}async function Ya(e){return c.requestRegistrationOtp(e)}async function Ka(e){let t=await c.verifyRegistrationOtp(e);return K.set(t.data.token),g.set(t.data.user),t.data.user}async function Be(){try{await c.logout()}catch{}K.set(null),g.set(null),N.set("/login")}function f(e){window.location.hash=e}var Un,On,K,g,ye,Lt,N,q,w=_(()=>{I();I();S();Un="earnap_token",On="earnap_user",K=St(Un,null),g=St(On,null),ye=F(null),Lt=null;N=F(window.location.hash.replace(/^#/,"")||"/"),q=ft(()=>!!K.get()&&!!g.get());E(()=>{let e=K.get();za(e)});Ga(()=>{K.set(null),g.set(null),N.set("/login"),l("Session expired. Please log in.","error")})});var Qa={};x(Qa,{HomePage:()=>At});function At(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Jn(e),e.appendChild(Wn(t)),e.appendChild(Vn())}}function we(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Jn(e){De&&(clearInterval(De),De=null);try{let t=await c.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(b=>{if(typeof b=="string"){let h=b.trim();return h.startsWith("/")||h.startsWith("http")?{image:h,text:""}:{image:"",text:h}}return{image:b.image||"",text:b.text||""}}).filter(b=>b.image&&b.image.trim()||b.text&&b.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let n=we("div","welcome-popup welcome-popup--banner","");n.innerHTML=`
            <div id="notice-banner-content" class="welcome-popup__content"></div>
        `,e.firstChild?e.insertBefore(n,e.firstChild):e.appendChild(n);let r=n.querySelector("#notice-banner-content"),i=typeof t.interval=="number"&&t.interval>0?t.interval:4,o=t.direction||"right_to_left",d={right_to_left:{exit:"banner-vanish-left",enter:"banner-enter-right"},left_to_right:{exit:"banner-vanish-right",enter:"banner-enter-left"},top_to_bottom:{exit:"banner-vanish-bottom",enter:"banner-enter-top"},bottom_to_top:{exit:"banner-vanish-top",enter:"banner-enter-bottom"},fade:{exit:"banner-vanish-fade",enter:"banner-enter-fade"}},p=d[o]||d.right_to_left,u=0;Za(r,s[0]),s.length>1&&(De=setInterval(()=>{let b;do b=Math.floor(Math.random()*s.length);while(b===u&&s.length>1);u=b,r.className=`welcome-popup__content ${p.exit}`,setTimeout(()=>{Za(r,s[u]),r.className=`welcome-popup__content ${p.enter}`,setTimeout(()=>{r.className="welcome-popup__content"},350)},350)},i*1e3))}catch{}}function Za(e,t){e.innerHTML="";let a=!!(t&&t.text&&t.text.trim());if(!!(t&&t.image&&t.image.trim())){let n=document.createElement("img");n.className="welcome-popup__image",n.src=t.image,n.alt=t.text||"Banner Notice",n.onerror=()=>{n.style.display="none"},e.appendChild(n)}if(a){let n=document.createElement("div");n.className="welcome-popup__text-wrap",n.innerHTML=`<strong>JM Job:</strong> <span>${zn(t.text)}</span>`,e.appendChild(n)}}function Wn(e){let t=we("div","card card--user-header"),a=we("div","user-header__stats");return a.innerHTML=`
    ...
    `;let a=t.querySelector("button");return a&&!a.disabled&&a.addEventListener("click",()=>Xn(e,a,t)),t}async function Xn(e,t,a){t.disabled=!0,t.textContent="Opening\u2026",window.open(e.target_url,"_blank","noopener,noreferrer");let s=0,n=e.duration_seconds;t.textContent=`Wait ${n}s\u2026`;let i=(await c.webTaskStart({task_id:e.id})).data.completion_id,o=setInterval(()=>{s+=1;let d=n-s;t.textContent=d>0?`Wait ${d}s\u2026`:"Claim Reward",s>=n&&(clearInterval(o),Yn(t,i,a))},1e3)}function Yn(e,t,a){e.textContent="Claim Reward",e.classList.remove("btn--primary"),e.classList.add("btn--success"),e.disabled=!1,e.onclick=async()=>{e.disabled=!0,e.textContent="Claiming\u2026";try{let s=await c.webTaskClaim({completion_id:t});l("+"+parseFloat(s.data.reward).toFixed(2)+" credited!","success"),await M(),_e()()}catch(s){l(s.message||"Claim failed","error"),e.disabled=!1,e.textContent="Claim Reward"}}}function es(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Ie=_(()=>{S();w()});var ts={};x(ts,{EarnPage:()=>$e});function $e(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML='<div class="card"><p class="muted">Loading available ads\u2026</p></div>',e.className="view view--earn";let t=g.get(),a=t?t.ads_remaining:0;try{let[s,n]=await Promise.all([c.videoAds(),c.adHistory().catch(()=>({meta:{}}))]),r=s.data||[],i=n.meta||{},o=s.meta?.enabled!==!1;e.innerHTML=`
            ...
            `;let d=e.querySelector(".video-ad-list");r.forEach(u=>{let b=document.createElement("div");b.className="admin-row",b.innerHTML=`<div><strong>${qt(u.title)}</strong><span class="muted">${u.duration_seconds}s \xB7 +${Number(u.reward_amount||0).toFixed(4)} \xB7 ${u.watched_today}/${u.daily_limit||"\u221E"} today</span></div>`;let h=document.createElement("button");h.className="btn btn--primary btn--sm",h.textContent=u.can_start&&a>0?"Watch & earn":"Unavailable",h.disabled=!u.can_start||a<=0,h.addEventListener("click",()=>Kn(u)),b.appendChild(h),d.appendChild(b)});let p=e.querySelector("#watch-btn");p&&!p.disabled&&p.addEventListener("click",()=>Zn())}catch(s){e.innerHTML=`<div class="card card--earn"><h2 class="card__title">Ads Reward Center</h2><p class="muted">${qt(s.message||"Could not load ads.")}</p></div>`}}}async function Kn(e){let t;try{t=await c.videoAdStart({video_ad_id:e.id})}catch(u){l(u.message||"Could not start this ad.","error");return}let a=t.data,s=document.createElement("div");s.className="modal modal--ad",s.innerHTML=`
    ...
    `,document.body.appendChild(s);let n=()=>s.remove();s.querySelector(".modal__close").addEventListener("click",n),s.querySelector(".modal__backdrop").addEventListener("click",n);let r=s.querySelector("#video-ad-player"),i=s.querySelector("#video-ad-countdown"),o=!1;try{let u=await fetch(a.stream_url,{headers:{Authorization:`Bearer ${Tt()}`}});if(!u.ok)throw new Error("Video could not be loaded.");r.src=URL.createObjectURL(await u.blob()),await r.play().catch(()=>{})}catch(u){i.textContent=u.message||"Video could not be loaded.";return}let d=Number(a.started_at_unix||Math.floor(Date.now()/1e3))*1e3,p=setInterval(async()=>{let u=Math.max(0,a.duration_seconds-Math.floor((Date.now()-d)/1e3));if(i.textContent=u>0?`Reward unlocks in ${u}s\u2026`:"Claiming reward\u2026",u<=0&&!o){o=!0,clearInterval(p);try{let b=await c.videoAdClaim({view_id:a.view_id});l(`+$${Number(b.data?.reward||0).toFixed(4)} credited!`,"success"),await M(),URL.revokeObjectURL(r.src),n(),$e()()}catch(b){o=!1,i.textContent=b.message||"Reward claim failed."}}},1e3)}function Zn(){let e=document.createElement("div");e.className="modal modal--ad",e.innerHTML=`
        <div class="modal__backdrop"></div>
        <div class="modal__content modal__content--ad">
            <button class="modal__close" aria-label="Close">\xD7</button>
            <h3>Watch the ad</h3>
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),n=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let n=e.querySelector("#copy-btn"),r=e.querySelector("#refer-link-input");n.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(r.value),l("Link copied to clipboard!","success")}catch{r.select(),document.execCommand("copy"),l("Link copied!","success")}});let i=e.querySelector("#share-tg");i.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let p=document.createElement("div");p.className="refer-item",p.innerHTML=`
                ...
                `,o.appendChild(p)})}}function as(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Mt=_(()=>{S();w()});var ns={};x(ns,{WithdrawPage:()=>Ue});function Ue(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=g.get();e.innerHTML=`
        ...
        ${s}
    `,t}function jt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Rt=_(()=>{S();w()});var os={};x(os,{DepositPage:()=>Ht});function Ht(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=g.get();e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{A.selectedGateway=t.getAttribute("data-gateway"),is(),ar()})})}}function ar(){let e=A.gateways.find(r=>r.key===A.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `}).join("")}}function sr(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function pe(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var tr,A,Ft=_(()=>{S();w();tr={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},A={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var Dt={};x(Dt,{ProfilePage:()=>Oe});function Oe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let n=(await c.adHistory()).data||[];if(n.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let r=a.querySelector(".ad-history__list");n.forEach(i=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                    ...
                    `,r.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function Bt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Je=_(()=>{S();w()});var ds={};x(ds,{default:()=>We});async function We(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var It=_(()=>{w()});var ls={};x(ls,{default:()=>Ve});async function Ve(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var Ut=_(()=>{w()});var cs={};x(cs,{default:()=>ze});async function ze(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var Ot=_(()=>{w()});function nr(){let e=localStorage.getItem(ps);return e==="dark"||e==="light"?e:"system"}function rr(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function Jt(e){let t=rr(e);document.documentElement.setAttribute("data-theme",t)}function us(){let e=U.get();U.set(e==="dark"?"light":"dark")}function ms(e){U.set(e)}function ir(){let e=localStorage.getItem(bs);return e&&Wt.includes(e)?e:"default"}function gs(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function vs(e){Wt.includes(e)&&Se.set(e)}function fs(){return Wt}var ps,U,bs,Wt,Se,Vt=_(()=>{I();ps="jmjob_theme";U=F(nr());Jt(U.get());E(()=>{let e=U.get();Jt(e),localStorage.setItem(ps,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{U.get()==="system"&&Jt("system")});bs="jmjob_color_theme",Wt=["default","emerald","amber","rose"];Se=F(ir());gs(Se.get());E(()=>{let e=Se.get();gs(e),localStorage.setItem(bs,e)})});var hs={};x(hs,{default:()=>Xe});async function Xe(){let e=document.querySelector("[data-view]");if(!e)return;let t=g.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=U.get(),s=Se.get(),n=fs();e.innerHTML=`
            ...
            <div class="settings-section">
                ...
                <div class="settings-item settings-item--stack">
                    <div class="settings-info">
                        ...
                        <div class="settings-value">${Ge[s]||"Default (Purple)"}</div>
                    </div>
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${n.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${Ge[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${or[o]};"></span>
                                <span class="theme-swatch__label">${(Ge[o]||o).split(" ")[0]}</span>
                            </button>
                        `).join("")}
                    </div>
                </div>
    ...
    `;let r=document.getElementById("theme-mode-group");r&&r.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-mode");ms(d),l(`Theme mode set to ${d}.`,"info")})});let i=document.getElementById("color-theme-group");i&&i.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-color");vs(d),l(`Accent color set to ${Ge[d]||d}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await Be(),l("Logged out.","info")})}var Ge,or,zt=_(()=>{w();Vt();Ge={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},or={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var ws={};x(ws,{NotificationsPage:()=>Gt});function Gt(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        <div class="task-header">
            <div class="task-channel">
                <i class="bi bi-telegram"></i>
                <strong>${Ye(e.channel_name)}</strong>
                <span class="muted">${Ye(e.channel_username)}</span>
            </div>
        </div>
        ...
        <div class="task-actions">
            ${e.completed?'<button class="btn btn--ghost" disabled>\u2713 Completed</button>':`<a class="btn btn--primary" href="https://t.me/${Ye(e.channel_username.replace("@",""))}" target="_blank" rel="noopener" data-task-id="${e.id}">Join channel</a>`}
        </div>
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let n=a.href;window.open(n,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&pr(e,t)},3e3)})}return t}async function pr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await M(),Ke()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ye(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Yt=_(()=>{S();w()});var ks={};x(ks,{PosterDashboardPage:()=>Zt});function Zt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--poster-dashboard",!g.get()){e.innerHTML='<div class="card"><h2>Access required</h2><a class="btn btn--primary" href="#/login">Log in</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
                <div>
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",$s),l(t.message||"Failed to load poster statistics.","error")}}function mr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),n=Kt(t.wallet_balance),r=Kt(t.frozen_balance),i=Kt(t.total_spent);e.innerHTML=`
        <div class="stat-grid poster-stat-grid">
            ${Ze("bi-briefcase","Total jobs",a.total||0)}
            ${Ze("bi-lightning-charge","Active jobs",s)}
            ${Ze("bi-wallet2","Available wallet",n,"\u09F3")}
            ${Ze("bi-lock","In escrow",r,"\u09F3")}
        </div>
    ...
    `,e.querySelectorAll("[data-poster-link]").forEach(o=>{o.addEventListener("click",d=>{d.preventDefault(),f(o.getAttribute("href").replace(/^#/,""))})})}function Ze(e,t,a,s=""){return`
    ...
    `,gr(e,t)}function gr(e,t){let a=e.querySelector("#wizard-card-body");a&&(t.currentStep===1?Ts(a,e,t):t.currentStep===2?Te(a,e,t):t.currentStep===3&&vr(a,e,t))}function Ts(e,t,a){let s=a.categories.find(o=>Number(o.id)===Number(a.mainCategoryId)),n=s?s.subcategories||[]:[];e.innerHTML=`
    ...
    `;let s=e.querySelector("#proof-pairs-container");s.addEventListener("change",r=>{if(r.target.classList.contains("proof-type-select"))xe(e,a),Te(e,t,a);else if(r.target.classList.contains("proof-file-input")){let i=r.target.closest(".proof-pair-row"),o=Number(i.getAttribute("data-index")),d=r.target.files[0];if(d){let p=new FileReader;p.onload=u=>{a.proofRequirements[o].fileBase64=u.target.result,a.proofRequirements[o].title=d.name,Te(e,t,a)},p.readAsDataURL(d)}}}),e.querySelector("#add-proof-btn").addEventListener("click",()=>{xe(e,a),a.proofRequirements.push({title:"",type:"text"}),Te(e,t,a)}),s.addEventListener("click",r=>{let i=r.target.closest(".remove-proof-btn");if(i){let o=Number(i.getAttribute("data-index"));xe(e,a),a.proofRequirements.splice(o,1),Te(e,t,a)}}),e.querySelector("#job-thumbnail-input").addEventListener("change",r=>{let i=r.target.files[0];if(i){let o=new FileReader;o.onload=d=>{a.thumbnailBase64=d.target.result},o.readAsDataURL(i)}}),e.querySelector("#step-cancel").addEventListener("click",ta),e.querySelector("#step-2-back").addEventListener("click",()=>{xe(e,a),a.currentStep=1,Le(t,a)}),e.querySelector("#step-2-form").addEventListener("submit",r=>{if(r.preventDefault(),xe(e,a),!a.title.trim()){l("Job title is required.","error");return}if(!a.description.trim()){l("Task instructions are required.","error");return}a.currentStep=3,Le(t,a)})}function xe(e,t){t.title=e.querySelector("#job-title-input")?.value||"",t.subtitle=e.querySelector("#job-subtitle-input")?.value||"",t.description=e.querySelector("#job-desc-input")?.value||"";let a=e.querySelectorAll(".proof-pair-row");t.proofRequirements=Array.from(a).map((s,n)=>{let r=s.querySelector(".proof-type-select")?.value||"text",i=s.querySelector(".proof-title-input"),o=i?i.value:t.proofRequirements[n]?.title||"Screenshot Proof",d=t.proofRequirements[n]?.fileBase64||null;return{title:o,type:r,fileBase64:d}})}function vr(e,t,a){let s=Number(a.workerCount||0)*Number(a.costPerWorker||0),n=s*(a.feePercentage/100),r=s+n;e.innerHTML=`
            ...
            <div class="poster-filter-bar" style="margin-bottom: 16px;">
                <label>Filter Status
                    <select class="admin-select" id="poster-job-filter">
                        ${yr.map(t=>`<option value="${t}" ${t===et?"selected":""}>${t?As(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
    ...
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>f("/deposit"))}function xr(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${tt((t.gateway||"").toUpperCase())}</strong><small>${tt(t.trxid)} \xB7 ${Tr(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${tt(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function ra(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function Tr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function tt(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var oa=_(()=>{S();w()});var Ps={};x(Ps,{AdminPage:()=>da});function da(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(o=>{o.addEventListener("click",()=>{a.forEach(d=>d.classList.remove("admin-tab--active")),o.classList.add("admin-tab--active"),qs(o.dataset.tab,s)})});let r=new URLSearchParams(window.location.hash.split("?")[1]||"").get("tab"),i=["stats","withdrawals","payments","users","providers","video-ads","fraud"].includes(r)?r:"stats";a.forEach(o=>o.classList.toggle("admin-tab--active",o.dataset.tab===i)),qs(i,s)}}async function qs(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),n=a.data||{},r=s.data||{},i=n.marketplace||{},o=r.currency_symbol||"\u09F3";t.innerHTML=`
                <div class="stat-grid admin-revenue-grid">
                    ${O("bi-graph-up-arrow","Platform revenue",J(r.platform_revenue,o))}
                    ${O("bi-percent","Commission rate",`${(Number(r.commission_rate||0)*100).toFixed(2)}%`)}
                    ${O("bi-briefcase","Total jobs",C(r.total_jobs))}
                    ${O("bi-check2-circle","Completed jobs",C(r.completed_jobs))}
                    ${O("bi-lightning-charge","Active jobs",C(r.active_jobs))}
                    ${O("bi-people","Total users",C(r.total_users))}
                    ${O("bi-person-check","Active users",C(n.active_users))}
                    ${O("bi-hourglass-split","Pending deposits",C(r.pending_payments))}
                    ${O("bi-lock","Held in escrow",J(r.escrow_total,o))}
                ...
                <div class="card admin-operations-card">
                    ...
                    <div class="admin-operations-grid">
                        ...
                        <div><span class="muted">Video rewards paid</span><strong>${J(n.video_rewards_paid,o)}</strong></div>
                        <div><span class="muted">Eligible rewards</span><strong>${C(n.eligible_rewards)}</strong></div>
                        <div><span class="muted">User ad rewards</span><strong>${J(n.user_ad_rewards,o)}</strong></div>
                        <div><span class="muted">Banned users</span><strong>${C(n.banned_users)}</strong></div>
                        <div><span class="muted">Lifetime paid</span><strong>${J(n.total_lifetime_paid,o)}</strong></div>
                        ...
                        <div><span class="muted">Job budget</span><strong>${J(i.total_job_budget,o)}</strong></div>
                        <div><span class="muted">Completed payments</span><strong>${J(i.completed_payment,o)}</strong></div>
                        <div><span class="muted">Pending payments</span><strong>${J(i.pending_payment,o)}</strong></div>
                        <div><span class="muted">Commissions</span><strong>${J(i.commissions,o)}</strong></div>
                        <div><span class="muted">Worker earnings</span><strong>${J(i.worker_earnings,o)}</strong></div>
                        <div><span class="muted">Ad rewards</span><strong>${J(i.ad_earnings,o)}</strong></div>
                    </div>
                </div>
            ...
            `;let n=t.querySelector("#wd-list");s.forEach(r=>n.appendChild(Ns(r,n))),t.querySelector("#wd-filter").addEventListener("change",async r=>{let i=await c.adminWithdrawals(r.target.value);n.innerHTML="",(i.data||[]).forEach(o=>n.appendChild(Ns(o,n)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let n=t.querySelector(".admin-list"),r=Number(g.get()?.id||0);s.forEach(i=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                ...
                `,i.querySelectorAll("[data-fraud-decision]").forEach(o=>o.addEventListener("click",async()=>{let d=o.dataset.fraudDecision,p=d==="confirmed_fraud"?prompt("Reason for confirming fraud:"):prompt("Optional review note:")||"";if(p===null||d==="confirmed_fraud"&&!p.trim())return;let u=d==="confirmed_fraud"&&confirm("Also ban this worker and revoke active sessions?");try{let b=await c.adminReviewFraud(r.id,{decision:d,note:p,ban_user:u});l(b.data?.user_banned?"Fraud review saved and worker banned.":"Fraud review saved.","success"),i.remove(),n.children.length||(n.innerHTML='<p class="muted">No flagged submissions.</p>')}catch(b){l(b.message||"Fraud review failed.","error")}})),n.appendChild(i)})}}catch{t.innerHTML='<p class="muted">Failed to load.</p>'}}function O(e,t,a){return`
        <div class="stat-tile admin-stat-tile">
            <i class="bi ${e} admin-stat-tile__icon"></i>
            <span class="muted">${L(t)}</span>
            <strong>${L(String(a))}</strong>
        </div>
    `}function C(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function J(e,t){let a=Number(e||0);return`${t}${Number.isFinite(a)?a.toFixed(2):"0.00"}`}function Ns(e,t){let a=document.createElement("div");if(a.className="admin-row admin-row--withdrawal",a.innerHTML=`
    ...
    `;let s=e.querySelector("#video-ad-list");a.length||(s.innerHTML='<p class="muted">No video ads configured.</p>'),a.forEach(n=>s.appendChild(Ar(n,s))),e.querySelector("#video-ad-form").addEventListener("submit",async n=>{n.preventDefault();let r=n.currentTarget;try{await c.adminCreateVideoAd(new FormData(r)),l("Video ad uploaded.","success"),await la(e)}catch(i){l(i.message||"Video upload failed.","error")}})}function Ar(e,t){let a=document.createElement("div");return a.className="admin-row admin-row--provider",a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,a.querySelector(".video-ad-toggle").addEventListener("click",async()=>{let s=new FormData;s.append("status",e.status==="active"?"paused":"active");try{await c.adminUpdateVideoAd(e.id,s),l("Video ad status updated.","success"),await la(t.parentElement)}catch(n){l(n.message||"Could not update video ad.","error")}}),a.querySelector(".video-ad-delete").addEventListener("click",async()=>{if(confirm(`Delete \u201C${e.title}\u201D?`))try{await c.adminDeleteVideoAd(e.id),l("Video ad deleted.","success"),a.remove()}catch(s){l(s.message||"Could not delete video ad.","error")}}),a}function L(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ca=_(()=>{S();w();w()});var Rs={};x(Rs,{AdminPaymentsPage:()=>ua});function ua(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{Q.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),pa()})}),await pa()}}async function pa(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(Q.status);Q.items=t.data||[],Er(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${oe(t.message||"Failed to load.")}</p>`}}}function Er(e){if(Q.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",Q.items.forEach(t=>e.appendChild(qr(t)))}function qr(e){let t=Cr[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,a.querySelector("#close-proof-modal").addEventListener("click",()=>{a.innerHTML=""});let n=a.querySelector("#proof-modal-content");try{let o=((await c.adminJobSubmissions(e)).data||{}).submissions||[];if(!o.length){n.innerHTML='<p class="muted" style="text-align:center; padding:30px;">No worker submissions or proof screenshots submitted yet for this job.</p>';return}n.innerHTML=o.map(d=>{let p=d.work_proof_data||{},u=d.attachment_url||(d.attachment_path?d.attachment_path.startsWith("http")?d.attachment_path:`/storage/${d.attachment_path}`:null),b=u&&/\.(jpg|jpeg|png|gif|webp)$/i.test(u);return`
                <div class="card" style="margin-bottom:16px; padding:16px; border:1px solid #e2e8f0; border-radius:8px; background:#f9fafb;">
                    <div style="display:flex; justify-content:space-between; margin-bottom:8px;">
                        <div>
                            ...
                            <span class="muted">User ID #${k(d.worker_id)} \xB7 ${k(d.worker_phone||"Phone unavailable")} \xB7 ${k(d.worker_email||d.worker_username||"")}</span>
                        </div>
            ...
            `}).join(""),n.querySelectorAll(".card").forEach((d,p)=>{let u=o[p];if(!u||u.status!=="pending_review")return;let b=document.createElement("div");b.style.cssText="display:flex; gap:8px; margin-top:12px;";let h=document.createElement("button");h.className="btn btn--success btn--sm",h.textContent="Approve for payment review",h.addEventListener("click",()=>Hs(u,e,t,h,y));let y=document.createElement("button");y.className="btn btn--danger btn--sm",y.textContent="Reject",y.addEventListener("click",()=>Hs(u,e,t,y,h)),b.append(h,y),d.appendChild(b)})}catch(r){n.innerHTML=`<p class="muted">Failed to load submissions: ${k(r.message||"unknown error")}</p>`}}async function Hs(e,t,a,s,n){let r=s.textContent.startsWith("Approve")?"approve":"reject",i=r==="reject"?prompt("Rejection reason:"):prompt("Optional admin note:")||"";if(i!==null){if(r==="reject"&&!i.trim()){l("A rejection reason is required.","error");return}s.disabled=!0,n.disabled=!0;try{await c.adminReviewSubmission(e.id,{decision:r,note:i}),l(r==="approve"?"Submission approved for payment review.":"Submission rejected.","success"),await Bs(t,a)}catch(o){s.disabled=!1,n.disabled=!1,l(o.message||"Could not review submission.","error")}}}async function Mr(e){if(confirm("Approve and activate this job post?"))try{await c.adminApproveJob(e),l("Job approved and activated!","success"),await ie()}catch(t){l(t.message||"Could not approve job.","error")}}async function jr(e){let t=prompt("Reason for declining this job post:");if(t!==null)try{await c.adminDeclineJob(e,{reason:t}),l("Job declined.","info"),await ie()}catch(a){l(a.message||"Could not decline job.","error")}}async function Rr(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await ie()}catch(t){l(t.message||"Could not flag job.","error")}}async function Fs(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ie()}catch(n){l(n.message||"Could not resolve dispute.","error")}}function Ds(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function k(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Nr,D,Ce=_(()=>{S();w();Nr=[{value:"pending_approval",label:"Job Post (Pending Approval)"},{value:"open",label:"Active Job"},{value:"all",label:"All Jobs"},{value:"in_review",label:"In Review"},{value:"assigned",label:"Assigned"},{value:"submitted",label:"Submitted"},{value:"revision",label:"Revision"},{value:"disputed",label:"Disputed"},{value:"completed",label:"Completed"},{value:"declined",label:"Declined"},{value:"cancelled",label:"Cancelled"},{value:"expired",label:"Expired"}],D="pending_approval"});var Is={};x(Is,{AdminTransactionsPage:()=>va});function va(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
    ...
    `,t}function Br(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Hr,ga,fa=_(()=>{S();w();Hr=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],ga=""});var Us={};x(Us,{AdminReportsPage:()=>ha});function ha(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#export-admin-report")?.addEventListener("click",Dr),await Ir()}}}async function Dr(){try{let e=await c.adminReportsExport(),t=URL.createObjectURL(e),a=document.createElement("a");a.href=t,a.download="jmjob-report.csv",document.body.appendChild(a),a.click(),a.remove(),URL.revokeObjectURL(t)}catch(e){alert(e.message||"Could not export the report.")}}async function Ir(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            <div class="stat-grid admin-report-summary">
                ${st("Transactions",be(s.transaction_count))}
                ${st("Transaction volume",Ee(s.transaction_volume))}
                ${st("Jobs",be(s.job_count))}
                ${st("Job value",Ee(s.job_value))}
            </div>
        ...
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${te(t.message||"unknown error")}</p>`}}function st(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${te(e)}</span><strong>${te(t)}</strong></div>`}function Ur(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${te(String(t.type||"").replace("_"," "))}</strong><small>${be(t.transaction_count)} entries</small></span>
            <strong>${Ee(t.amount)}</strong>
        </div>
    ...
    `).join(""):'<p class="muted">No submissions yet.</p>'}function be(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Ee(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function te(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ya=_(()=>{S();w()});var Os={};x(Os,{LoginPage:()=>wa});function wa(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
    ...
    `;let s=document.getElementById("reset-form"),n=document.getElementById("submit-btn");s.addEventListener("submit",async r=>{r.preventDefault();let i=s.email.value.trim(),o=s.otp.value.trim(),d=s.password.value,p=s.password_confirmation.value;if(!i||!o||!d){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(d!==p){l("Passwords do not match.","error");return}if(d.length<6){l("Password must be at least 6 characters.","error");return}n.disabled=!0,n.textContent="Resetting...";try{await c.resetPassword({email:i,otp:o,password:d,password_confirmation:p}),l("Password reset successfully! You can now log in.","success"),f("/login")}catch(u){l(u.message||"Failed to reset password.","error"),n.disabled=!1,n.textContent="Reset Password"}})}function zr(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Ta=_(()=>{S();w()});var _n={};x(_n,{JobDetailPage:()=>so});function so(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=g.get();t.innerHTML=`
        ...
        `;try{let s=await c.job(e),{job:n,bids:r,bid_count:i,my_bid:o,my_submission:d}=s.data;no(n,r,i,o,d,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${H(s.message||"unknown")}</p>`}}}function no(e,t,a,s,n,r){let i=document.getElementById("job-detail-content");if(!i)return;let o=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,d=o?Math.max(0,Math.floor((o-Date.now())/1e3)):null,p=d!=null?co(d):"\u2014",u=["open","in_review"].includes(e.status),h=!!r&&!r.is_admin&&(!r.role||r.role==="worker")&&(!!e.assignment_id||Number(e.assigned_worker_id||0)===Number(r.id)),y=h&&e.assignment_status?e.assignment_status:e.status;i.innerHTML=`
        <div class="card job-detail__card">
            <div class="job-detail__head">
                ...
                <span class="badge badge--status badge--${y}">${y.replace("_"," ").toUpperCase()}</span>
            </div>
            <div class="job-detail__body">
                <h3>Description</h3>
                <p>${H(e.description).replace(/\n/g,"<br>")}</p>
                ${e.requirements?`<h3>Requirements</h3><p>${H(e.requirements).replace(/\n/g,"<br>")}</p>`:""}
                ${Array.isArray(e.proof_requirements)&&e.proof_requirements.length?`<h3>Proof required</h3><ul>${e.proof_requirements.map(T=>`<li>${H(T.title||(T.type==="screenshot"?"Screenshot":"Written report"))}</li>`).join("")}</ul>`:""}
                <h3>Posted by</h3>
    ...
    `,lo(e,s,r),io(e)}function ro(e,t,a){if(!a)return"";let s=e.assignment_status||e.status,n=t?.status||s;if(t&&(t.status==="pending_review"||s==="submitted"))return`
        ...
        `;if(!["assigned","in_progress","revision"].includes(s))return`<div class="card"><p class="muted">This assignment is ${H(String(s).replace("_"," "))}.</p></div>`;let i=Array.isArray(e.proof_requirements)&&e.proof_requirements.some(d=>d&&d.type==="screenshot"),o=t?.reviewer_note||t?.rejection_reason;return`
        <div class="card">
    ...
    `).join(""):'<p class="muted">No work submitted yet.</p>'}async function go(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await c.posterAcceptBid(e,t),l("Worker selected and escrow held.","success"),await Ma(e)}catch(a){l(a.message||"Could not select worker.","error")}}async function vo(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await c.posterReleasePayment(e,{submission_id:Number(t)}),l("Payment released.","success"),await Ma(e)}catch(a){l(a.message||"Could not release payment.","error")}}async function fo(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await c.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),l("Revision requested.","success"),await Ma(e)}catch(s){l(s.message||"Could not request revision.","error")}}async function ho(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await c.posterCancelJob(e,{reason:"Cancelled by poster"}),l("Job cancelled.","success"),f("/poster/jobs")}catch(t){l(t.message||"Could not cancel job.","error")}}async function Ma(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await Sn(e))}function yo(){return!!g.get()}function wo(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function kn(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function P(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Tn=_(()=>{S();w()});I();w();I();w();var it=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ct(),Qa))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ie(),Et))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ie(),Et))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Nt(),ts))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Mt(),ss))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Rt(),ns))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ft(),os))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Je(),Dt))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(It(),ds))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ut(),ls))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ot(),cs))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(zt(),hs))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Xt(),ws))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Je(),Dt))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Yt(),_s))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Qt(),ks))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(aa(),Ls))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(na(),Cs))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(oa(),Es))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ca(),Ps))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ma(),Rs))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ce(),at))},{path:"/admin/pending-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ce(),at))},{path:"/admin/active-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ce(),at))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(fa(),Is))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ya(),Us))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(_a(),Os))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ka(),Ws))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(xa(),Vs))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(Ta(),zs))}],$l=E(()=>{let e=N.get().split("?")[0]||"/";return it.find(t=>t.path===e)||it[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";N.set(e)});I();w();I();var Gr=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],Xr=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/admin-job-post",label:"Admin Job Post",icon:"bi-plus-square"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/advertisement",label:"Advertisement",icon:"bi-megaphone"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],Yr=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Kr(){let e=g.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...Xr];let t=[...Gr];return e&&(e.is_admin||e.role==="poster")&&t.push({separator:!0},...Yr),t}var Gs="sidebar_collapsed",ge=F(localStorage.getItem(Gs)==="true");function Zr(){let e=!ge.get();ge.set(e),localStorage.setItem(Gs,String(e))}function Xs(){let e=()=>N.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${ge.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[Qr(),ei(),ti()]}}function Qr(){let e=()=>N.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function ei(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>Zr(),title:()=>ge.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${ge.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function ti(){return{tag:"nav",props:{class:"sidebar__nav"},children:Kr().map(e=>e.header?ai(e.header):e.separator?si():ni(e))}}function ai(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function si(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function ni({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${N.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>ge.get()?t:"",onclick:n=>{n.preventDefault(),f(e),Ks()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function Ys(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>Ks()},children:[]}}function Ks(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}w();I();w();var ri=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],ii=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/admin-job-post",label:"Admin Job Post",icon:"bi-plus-square"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/advertisement",label:"Advertisement",icon:"bi-megaphone"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],oi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function di(){let e=g.get();if(e&&e.is_admin)return ii;let t=[...ri];return e&&(e.is_admin||e.role==="poster")&&t.push({separator:!0},...oi),t}function li({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${N.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:n=>{n.preventDefault(),f(e),La()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function ci(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>La()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function pi(){return{tag:"nav",props:{class:"mobile-nav__list"},children:di().map(e=>e.separator?ui():li(e))}}function ui(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function Zs(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[ci(),pi()]}}function Qs(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>La()},children:[]}}function en(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function La(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}Vt();S();function tn(){return V(()=>q.get(),()=>yi(),()=>hi())}function an(){let e=()=>{let t=U.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>us(),"data-theme":()=>U.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function mi(){let e=document.getElementById("topbar-notifications-panel");if(!e)return;let t=e.classList.contains("topbar-notifications--open");document.querySelectorAll(".topbar-notifications--open").forEach(a=>a.classList.remove("topbar-notifications--open")),t||e.classList.add("topbar-notifications--open")}function bi(){return setTimeout(gi,0),{tag:"div",props:{class:"topbar__notifications-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__notifications","aria-label":"Notifications",onclick:e=>{e.stopPropagation(),mi()}},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge",id:"topbar-notification-badge","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-notifications",id:"topbar-notifications-panel"},children:[{tag:"div",props:{class:"topbar-notifications__header"},children:[{tag:"strong",props:{},children:["Notifications"]},{tag:"button",props:{class:"topbar-notifications__close","aria-label":"Close",onclick:()=>{let e=document.getElementById("topbar-notifications-panel");e&&e.classList.remove("topbar-notifications--open")}},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]},{tag:"ul",props:{class:"topbar-notifications__list",id:"topbar-notifications-list"},children:[fi("Loading notifications\u2026","Your latest updates will appear here.","bi-hourglass-split","info")]},{tag:"div",props:{class:"topbar-notifications__footer"},children:[{tag:"a",props:{href:"#/notifications",class:"topbar-notifications__link"},children:["View all notifications"]}]}]}]}}async function gi(){let e=document.getElementById("topbar-notifications-list"),t=document.getElementById("topbar-notification-badge");if(!(!e||!t))try{let a=await c.notifications({limit:5}),s=Array.isArray(a.data)?a.data:[],n=Number(a.meta?.unread_count||s.filter(r=>!r.read).length||0);t.textContent=n>99?"99+":String(n),e.innerHTML=s.length?s.map(vi).join(""):'<li class="topbar-notifications__empty">No notifications yet.</li>',e.querySelectorAll("[data-notification-id]").forEach(r=>{r.addEventListener("click",async()=>{let i=r.getAttribute("data-notification-id");if(!(!i||r.getAttribute("data-read")==="1"))try{await c.notificationRead(i),r.setAttribute("data-read","1"),r.classList.remove("topbar-notification--unread");let o=Math.max(0,Number(t.textContent.replace("+",""))-1);t.textContent=String(o)}catch{}})})}catch{e.innerHTML='<li class="topbar-notifications__empty">Notifications are unavailable right now.</li>',t.textContent="0"}}function vi(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",n=typeof t.action_url=="string"&&t.action_url.startsWith("/")?` href="#${ot(t.action_url)}"`:"";return`<li class="topbar-notification topbar-notification--${a} ${e.read?"":"topbar-notification--unread"}" data-notification-id="${ot(e.id)}" data-read="${e.read?"1":"0"}"><i class="bi ${s} topbar-notification__icon"></i><div class="topbar-notification__body"><div class="topbar-notification__title">${ot(t.title||"Notification")}</div><div class="topbar-notification__text">${ot(t.message||"")}</div>${n?`<a class="topbar-notification__action"${n}>Open</a>`:""}</div></li>`}function ot(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function fi(e,t,a,s){return{tag:"li",props:{class:`topbar-notification topbar-notification--${s}`},children:[{tag:"i",props:{class:`bi ${a} topbar-notification__icon`},children:[]},{tag:"div",props:{class:"topbar-notification__body"},children:[{tag:"div",props:{class:"topbar-notification__title"},children:[e]},{tag:"div",props:{class:"topbar-notification__text"},children:[t]}]}]}}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-notifications-panel");t&&t.classList.contains("topbar-notifications--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__notifications")&&t.classList.remove("topbar-notifications--open")});function hi(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[an(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function yi(){let e=g.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>en(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[an(),bi(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await Be(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}w();I();function sn(){return V(()=>!!ye.get(),()=>{let e=ye.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}S();function nn(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{c.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let n=[];a.facebook&&n.push(`<a href="${dt(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&n.push(`<a href="${dt(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&n.push(`<a href="${dt(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&n.push(`<a href="${dt(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=n.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function dt(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}w();var wi=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],_i=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/admin-job-post",label:"Admin Job Post",icon:"bi-plus-square"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/advertisement",label:"Advertisement",icon:"bi-megaphone"}];function $i(){let e=g.get();return e&&e.is_admin?_i:wi}function Si({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${N.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:n=>{n.preventDefault(),f(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function ki(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function xi(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:$i().map(e=>e.separator?ki():Si(e))}}function Aa(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&Aa()},!0),window.addEventListener("resize",()=>setTimeout(Aa,50)),document.addEventListener("hnav:rendered",()=>setTimeout(Aa,0)));function rn(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[xi()]}}function on(){let e=()=>!!g.get()?.is_admin,t=()=>N.get().startsWith("/admin"),a=()=>q.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[V(()=>q.get(),()=>Xs(),()=>null),V(()=>q.get(),()=>Ys(),()=>null),V(()=>q.get(),()=>Zs(),()=>null),V(()=>q.get(),()=>Qs(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[tn(),V(()=>q.get()&&!e(),()=>rn(),()=>null),{tag:"main",props:{class:"app-main"},children:[Ti()]},nn()]},sn()]}}function Ti(){let t=N.get().split("?")[0]||"/",a=it.find(n=>n.path===t),s=g.get();return s&&s.is_admin&&!t.startsWith("/admin")?(f("/admin"),Ca()):a?a.requireAuth&&!q.get()?(f("/login"),Ca()):a.requireAdmin&&(!g.get()||!g.get().is_admin)?Ci():!a.requireAuth&&q.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(f("/"),Ca()):Li(a):Ai()}function Li(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function Ai(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function Ci(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function Ca(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}I();w();Ct();_a();ka();xa();Ta();Mt();Ie();Nt();Yt();Rt();Je();ca();ma();Ft();It();Ut();Ot();zt();S();w();var v={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function ln(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
            ...
            <div class="card jobs-filters">
                <div class="jobs-filters__row">
                    <label class="jobs-filters__field jobs-filters__field--search">
                        <span>Search</span>
                        <input type="search" class="jobs-filters__search" id="jobs-search" maxlength="80" placeholder="Search jobs\u2026" value="${W(v.search)}">
                    </label>
                    ...
                    <label class="jobs-filters__field jobs-filters__field--amount">
                        ...
                        <input type="number" min="0" step="0.01" inputmode="decimal" id="jobs-min-budget" placeholder="\u09F30" value="${W(v.minBudget)}">
                    </label>
                    <label class="jobs-filters__field jobs-filters__field--amount">
                        <span>Max budget</span>
                        <input type="number" min="0" step="0.01" inputmode="decimal" id="jobs-max-budget" placeholder="No limit" value="${W(v.maxBudget)}">
                    </label>
                    <label class="jobs-filters__field">
                        <span>Sort by</span>
        ...
        `,v.categories.length===0)try{let t=await c.categories();v.categories=Array.isArray(t.data)?t.data:[];let a=document.getElementById("jobs-category");a&&(a.innerHTML=dn())}catch{}document.getElementById("jobs-apply")?.addEventListener("click",()=>{Ei(),v.page=1,lt()}),document.getElementById("jobs-reset")?.addEventListener("click",()=>{v.search="",v.categoryId="",v.minBudget="",v.maxBudget="",v.sort="latest",v.page=1,qi(),lt()}),document.getElementById("jobs-search")?.addEventListener("keydown",t=>{t.key==="Enter"&&document.getElementById("jobs-apply")?.click()}),await lt()}}}function dn(){return'<option value="">All categories</option>'+v.categories.map(e=>`<option value="${W(e.id)}" ${String(e.id)===String(v.categoryId)?"selected":""}>${W(e.name)}</option>`).join("")}function Ei(){v.search=document.getElementById("jobs-search")?.value.trim()||"",v.categoryId=document.getElementById("jobs-category")?.value||"",v.minBudget=document.getElementById("jobs-min-budget")?.value.trim()||"",v.maxBudget=document.getElementById("jobs-max-budget")?.value.trim()||"",v.sort=document.getElementById("jobs-sort")?.value||"latest"}function qi(){let e={"jobs-search":v.search,"jobs-category":v.categoryId,"jobs-min-budget":v.minBudget,"jobs-max-budget":v.maxBudget,"jobs-sort":v.sort};Object.entries(e).forEach(([t,a])=>{let s=document.getElementById(t);s&&(s.value=a)})}async function lt(){let e=document.getElementById("jobs-grid");if(!e)return;let t=++v.requestSerial;v.loading=!0,e.innerHTML='<div class="spinner"></div>';try{let a={page:v.page,per_page:v.perPage,sort:v.sort};v.search&&(a.search=v.search),v.categoryId&&(a.category_id=v.categoryId),v.minBudget!==""&&(a.min_budget=v.minBudget),v.maxBudget!==""&&(a.max_budget=v.maxBudget);let s=await c.jobs(a);if(t!==v.requestSerial)return;v.jobs=Array.isArray(s.data)?s.data:[],v.total=Number(s.meta?.total||0),v.lastPage=Math.max(1,Number(s.meta?.last_page||1)),Ni()}catch(a){if(t!==v.requestSerial)return;e.innerHTML=`<p class="muted">Failed to load jobs: ${W(a.message||"unknown error")}</p>`,cn(),pn()}finally{t===v.requestSerial&&(v.loading=!1)}}function Ni(){let e=document.getElementById("jobs-grid");if(e){if(cn(),pn(),v.jobs.length===0){e.innerHTML='<p class="muted">No jobs match your filters. Try clearing them.</p>';return}e.innerHTML=v.jobs.map(t=>`
        <a class="job-card" href="#/jobs/${encodeURIComponent(t.id)}" data-id="${W(t.id)}">
            <div class="job-card__head">
                ${t.category&&t.category.icon_class?`<i class="bi ${Pi(t.category.icon_class)} job-card__cat-icon"></i>`:""}
                <span class="job-card__cat">${W(t.category?.name||"")}</span>
                ${t.is_featured?'<span class="job-card__badge">Featured</span>':""}
            </div>
            <h3 class="job-card__title">${W(t.title)}</h3>
            ${t.subtitle?`<p class="job-card__subtitle muted">${W(t.subtitle)}</p>`:""}
            <p class="job-card__desc">${W(Mi(t.description,140))}</p>
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>v.lastPage||a===v.page||(v.page=a,lt())})})}}function Pi(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function Mi(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function W(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var Ea={bids:[],loading:!1};function un(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function Ri(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function mn(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var qe={jobs:[],submissions:[],loading:!1};function ct(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);qe.jobs=t.data||[],qe.submissions=a.data||[],Hi()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${ve(t.message||"unknown")}</p>`}}}}function Hi(){let e=document.getElementById("active-jobs-list");if(e){if(qe.jobs.length===0){e.innerHTML=`<p class="muted">No active jobs. Once a poster accepts your bid, it'll appear here.</p>`;return}e.innerHTML=qe.jobs.map(t=>{let a=qe.submissions.find(i=>i.job_id===t.id),s=t.assignment_status||t.status,n=String(t.description||"").trim(),r=Number(t.remaining_workers??t.remaining_tasks_count??0);return`
            <div class="active-job-card" data-id="${t.id}">
                <div class="active-job-card__head">
                    <div>
                        <h3>${ve(t.title)}</h3>
                       ${t.subtitle?`<div class="muted">${ve(t.subtitle)}</div>`:""}
                        ${n?`<p class="muted">${ve(n.slice(0,180))}${n.length>180?"\u2026":""}</p>`:""}
                        <div class="muted">Pay: \u09F3${parseFloat(t.cost_per_worker||t.budget||0).toFixed(2)} \xB7 Available slots: ${r} \xB7 Deadline: ${ve(t.deadline_at||"None")}</div>
                    </div>
        ...
        <div class="active-job-card__sub">
            ...
            <div class="muted">${ve((t.description||"").slice(0,200))}${(t.description||"").length>200?"\u2026":""}</div>
    ...
    `}function Bi(e){let t=Array.isArray(e.proof_requirements)&&e.proof_requirements.some(a=>a&&a.type==="screenshot");return`
    ...
    `}function Di(){document.querySelectorAll("form.submit-form").forEach(e=>{e.addEventListener("submit",async t=>{t.preventDefault();let a=parseInt(e.getAttribute("data-job-id"),10),s=new FormData(e),n=e.querySelector("[data-submit-btn]");n.disabled=!0,n.innerHTML='<i class="bi bi-hourglass"></i> Submitting\u2026';try{let r=new FormData;r.append("description",String(s.get("description")||"").trim()),r.append("external_link",String(s.get("external_link")||"").trim());let i=s.get("screenshot");i instanceof File&&i.size>0&&r.append("screenshot",i),await c.submitWork(a,r),l("Work submitted!","success"),ct()()}catch(r){l(r.message||"Failed to submit.","error")}finally{n.disabled=!1,n.innerHTML='<i class="bi bi-send"></i> Submit Work'}})}),document.querySelectorAll("[data-cancel-assignment]").forEach(e=>{e.addEventListener("click",async()=>{let t=prompt("Why do you need to cancel this assignment?");if(!(!t||!t.trim())){e.disabled=!0;try{await c.workerCancelAssignment(e.dataset.cancelAssignment,{reason:t.trim()}),l("Assignment cancelled and returned for reassignment.","success"),ct()()}catch(a){l(a.message||"Could not cancel assignment.","error"),e.disabled=!1}}})})}function Ii(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ve(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var j={activeTab:"categories",categories:[],subcategories:[],loading:!1};function bn(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#tab-cats-btn").addEventListener("click",()=>{j.activeTab="categories",qa(e)}),e.querySelector("#tab-subcats-btn").addEventListener("click",()=>{j.activeTab="subcategories",qa(e)}),await se(e)}}async function se(e){try{let[t,a]=await Promise.all([c.adminCategories(),c.adminSubcategories()]);j.categories=t.data||[],j.subcategories=a.data||[],qa(e)}catch(t){l(t.message||"Failed to load category data.","error")}}function qa(e){let t=e.querySelector("#tab-cats-btn"),a=e.querySelector("#tab-subcats-btn"),s=e.querySelector("#tab-content");s&&(j.activeTab==="categories"?(t&&(t.className="btn btn--primary"),a&&(a.className="btn btn--ghost"),Ui(s,e)):(t&&(t.className="btn btn--ghost"),a&&(a.className="btn btn--primary"),Oi(s,e)))}function Ui(e,t){e.innerHTML=`
    ...
    `,e.querySelectorAll(".edit-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let n=s.getAttribute("data-id"),r=j.categories.find(d=>String(d.id)===String(n));if(!r)return;let i=prompt(`Update Min Cost (\u09F3) for Main Category "${r.name}":`,String(r.min_cost||1));if(i===null)return;let o=parseFloat(i);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateCategory(n,{min_cost:o}),l(`Min cost updated for ${r.name}.`,"success"),await se(t)}catch(d){l(d.message,"error")}})}),e.querySelectorAll(".toggle-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let n=s.getAttribute("data-id"),r=j.categories.find(i=>String(i.id)===String(n));if(r)try{await c.adminUpdateCategory(n,{is_active:!r.is_active}),l("Category updated.","success"),await se(t)}catch(i){l(i.message,"error")}})}),e.querySelectorAll(".del-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let n=s.getAttribute("data-id");if(confirm("Delete category?"))try{let r=await c.adminDeleteCategory(n);l(r.message||"Deleted.","success"),await se(t)}catch(r){l(r.message,"error")}})});let a=e.querySelector("#add-cat-form");a.addEventListener("submit",async s=>{s.preventDefault();let n=new FormData(a),r={name:String(n.get("name")||"").trim(),slug:String(n.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(n.get("min_cost")||"1.00"),display_order:parseInt(n.get("display_order")||"0",10),description:String(n.get("description")||"").trim()||null,is_active:n.get("is_active")==="on"};try{await c.adminCreateCategory(r),l("Main Category created.","success"),await se(t)}catch(i){l(i.message,"error")}})}function Oi(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
    ...
    `,e.querySelectorAll(".edit-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let n=s.getAttribute("data-id"),r=j.subcategories.find(d=>String(d.id)===String(n));if(!r)return;let i=prompt(`Update Min Cost (\u09F3) for Subcategory "${r.name}":`,String(r.min_cost||1));if(i===null)return;let o=parseFloat(i);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateSubcategory(n,{min_cost:o}),l(`Min cost updated for ${r.name}.`,"success"),await se(t)}catch(d){l(d.message,"error")}})}),e.querySelectorAll(".toggle-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let n=s.getAttribute("data-id"),r=j.subcategories.find(i=>String(i.id)===String(n));if(r)try{await c.adminUpdateSubcategory(n,{is_active:!r.is_active}),l("Subcategory updated.","success"),await se(t)}catch(i){l(i.message,"error")}})}),e.querySelectorAll(".del-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let n=s.getAttribute("data-id");if(confirm("Delete subcategory?"))try{let r=await c.adminDeleteSubcategory(n);l(r.message||"Deleted.","success"),await se(t)}catch(r){l(r.message,"error")}})});let a=e.querySelector("#add-subcat-form");a.addEventListener("submit",async s=>{s.preventDefault();let n=new FormData(a),r={category_id:parseInt(n.get("category_id")||"0",10),name:String(n.get("name")||"").trim(),slug:String(n.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(n.get("min_cost")||"1.00"),display_order:parseInt(n.get("display_order")||"0",10),is_active:n.get("is_active")==="on"};try{await c.adminCreateSubcategory(r),l("Subcategory created.","success"),await se(t)}catch(i){l(i.message,"error")}})}function ae(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var ne={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1},Ji={advertisement_system_enabled:"Advertisement System",video_ads_enabled:"Video Ads",watch_earn_enabled:"User Watch & Earn",reward_system_enabled:"Reward System",ad_network_enabled:"External Ad Network",website_ads_enabled:"Website Ads",app_ads_enabled:"Android App Ads",ad_frequency_seconds:"Ad Frequency (seconds)"};function gn(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await vn()}}async function vn(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a,s]=await Promise.all([c.adminSettings(),c.socialLinks(),c.notices()]);ne.grouped=t.data||{},ne.social=a||{},ne.noticesData=s||{interval:4,notices:[]},Wi()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${R(t.message||"unknown")}</p>`}}}function Wi(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(ne.grouped).map(i=>`
        <div class="card settings-group">
            <h3 class="card__title">${R(i.charAt(0).toUpperCase()+i.slice(1))}</h3>
            <div class="settings-group__rows">
                ${ne.grouped[i].map(o=>zi(i,o)).join("")}
            </div>
        </div>
    `).join(""),s=ne.noticesData,n=[];Array.isArray(s.notices)&&s.notices.length&&(n=s.notices.map(i=>typeof i=="string"?i.startsWith("/")||i.startsWith("http")?{image:i,text:""}:{image:"",text:i}:{image:i.image||"",text:i.text||""})),n.length||(n=[{image:"",text:""}]),a+=`
    ...
    `}async function Gi(){let e={};for(let i of Object.keys(ne.grouped))for(let o of ne.grouped[i]){let d=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,p=document.getElementById(d);if(!p)continue;let u;o.value_type==="boolean"?u=p.checked:o.value_type==="integer"||o.value_type==="percent"?u=parseInt(p.value,10):o.value_type==="decimal"?u=parseFloat(p.value):o.value_type==="json"?u=p.value?JSON.parse(p.value):null:u=p.value,e[o.key]=u}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".banner-message-row")).map(i=>({image:i.querySelector(".notice-msg-image")?.value.trim()||""})).filter(i=>i.image!==""),n={interval:document.getElementById("notice-interval")?.value||4,direction:document.getElementById("notice-direction")?.value||"right_to_left",notices:s},r=document.getElementById("settings-save-btn");r.disabled=!0,r.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(n)]),l("Settings, notices, and social links saved successfully.","success"),await vn()}catch(i){l(i.message||"Failed to save.","error")}finally{r.disabled=!1,r.textContent="Save All Changes"}}function R(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}Ce();S();w();function hn(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.className="view view--admin-job-post",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p></div>';return}let t=new URLSearchParams(window.location.hash.split("?")[1]||""),a=Number(t.get("edit")||0);e.innerHTML='<div class="card"><p class="muted">Loading job form\u2026</p></div>';try{let s=await c.categories(),n=a?(await c.adminJobDetail(a)).data:null;Xi(e,s.data||[],n?.job||null,a)}catch(s){e.innerHTML=`<div class="card"><p class="muted">Could not load job form: ${z(s.message||"unknown error")}</p></div>`}}}function Xi(e,t,a,s){let n=a?.proof_requirements||[],r=n.some(o=>o.type==="screenshot"),i=n.some(o=>o.type==="text");e.innerHTML=`
        ...
        <form class="card admin-job-form" id="admin-job-form">
            <div class="poster-form__grid">
                <label>Category
                    <select name="category_id" required><option value="">Choose category\u2026</option>${t.map(o=>`<option value="${o.id}" ${Number(o.id)===Number(a?.category_id)?"selected":""}>${z(o.name)}</option>`).join("")}</select>
                </label>
                <label>Subtitle
                    <input name="subtitle" maxlength="255" value="${z(a?.subtitle||"")}" placeholder="Short job-card summary">
                </label>
            </div>
            <label>Job title <input name="title" maxlength="160" required value="${z(a?.title||"")}"></label>
            <label>Customer name <input name="customer_name" maxlength="160" value="${z(a?.customer_name||"")}"></label>
            <div class="poster-form__grid">
                <label>Customer phone <input name="customer_phone" maxlength="32" value="${z(a?.customer_phone||"")}"></label>
                <label>Customer email <input name="customer_email" type="email" maxlength="190" value="${z(a?.customer_email||"")}"></label>
            </div>
            <label>Job details / instructions <textarea name="description" rows="7" required>${z(a?.description||"")}</textarea></label>
            <label>Customer requirements <textarea name="requirements" rows="4">${z(a?.requirements||"")}</textarea></label>
            <div class="poster-form__grid">
            ...
            <label>Admin notes <textarea name="admin_notes" rows="3">${z(a?.admin_notes||"")}</textarea></label>
   ...
   `,e.querySelector("#edit-job")?.addEventListener("click",()=>f(`/admin/admin-job-post?edit=${a}`)),e.querySelector("#delete-job")?.addEventListener("click",async()=>{if(confirm("Delete this job and its unassigned bids?"))try{await c.adminDeleteJob(a),l("Job deleted.","success"),f("/admin/jobs")}catch(b){l(b.message||"Could not delete job.","error")}}),e.querySelectorAll("[data-review-id]").forEach(b=>b.addEventListener("click",async()=>{let h=b.dataset.reviewDecision,y=h==="reject"?prompt("Rejection reason:"):prompt("Optional admin note:")||"";if(!(y===null||h==="reject"&&!y.trim()))try{await c.adminReviewSubmission(b.dataset.reviewId,{decision:h,note:y}),l("Submission reviewed.","success"),await pt(e,a)}catch(T){l(T.message||"Could not review submission.","error")}})),e.querySelectorAll("[data-cancel-assignment]").forEach(b=>b.addEventListener("click",async()=>{let h=prompt("Reason for cancelling this assignment:");if(!(!h||!h.trim()))try{await c.adminCancelAssignment(b.dataset.cancelAssignment,{reason:h.trim()}),l("Assignment cancelled and refunded.","success"),await pt(e,a)}catch(y){l(y.message||"Could not cancel assignment.","error")}})),e.querySelectorAll("[data-reassign-assignment]").forEach(b=>b.addEventListener("click",async()=>{let h=e.querySelector(`[data-reassign-select="${b.dataset.reassignAssignment}"]`),y=Number(h?.value||0);if(!y){l("Select a pending replacement bid first.","error");return}let T=prompt("Reason for reassignment:")||"Reassigned by administrator";try{await c.adminReassignAssignment(b.dataset.reassignAssignment,{bid_id:y,reason:T.trim()}),l("Worker reassigned.","success"),await pt(e,a)}catch(G){l(G.message||"Could not reassign worker.","error")}}))}function Qi(e,t){let a=e.payment_status==="held"&&!["cancelled","completed"].includes(e.status),s=t.filter(r=>r.status==="pending"&&r.worker_id!==e.worker_id),n=a?`<div class="admin-row__actions"><button class="btn btn--danger btn--sm" data-cancel-assignment="${e.id}">Cancel/refund</button>${s.length?`<select data-reassign-select="${e.id}" aria-label="Replacement worker"><option value="">Replace with\u2026</option>${s.map(r=>`<option value="${r.id}">${$(r.worker?.name||`Worker #${r.worker_id}`)} \xB7 \u09F3${Number(r.amount||0).toFixed(2)}</option>`).join("")}</select><button class="btn btn--ghost btn--sm" data-reassign-assignment="${e.id}">Reassign</button>`:""}</div>`:"";return`<div class="admin-row"><div><strong>${$(e.worker?.name||"Unknown worker")}</strong><span class="muted">${$(e.worker?.email||"")} \xB7 ${$(e.worker?.phone||"")}</span></div><div><span class="badge">${$(String(e.status||"").toUpperCase())}</span><span class="muted"> ${$(String(e.payment_status||"").toUpperCase())} \xB7 ${Number(e.payment_amount||0).toFixed(2)}</span>${n}</div></div>`}function eo(e){return`<div class="admin-row"><div><strong>${$(e.worker?.name||`Worker #${e.worker_id}`)}</strong><span class="muted">${$(e.worker?.email||"")} \xB7 ${$(e.worker?.phone||"")}</span><p>${$(e.proposal||"")}</p></div><div><span class="badge">PENDING</span><span class="muted"> \u09F3${Number(e.amount||0).toFixed(2)}</span></div></div>`}function to(e){let t=e.status==="pending_review"?`<div class="admin-row__actions"><button class="btn btn--success btn--sm" data-review-id="${e.id}" data-review-decision="approve">Approve</button><button class="btn btn--danger btn--sm" data-review-id="${e.id}" data-review-decision="reject">Reject</button></div>`:"",a=e.worker||{},s=`User ID #${$(e.worker_id)} \xB7 ${$(a.phone||"Phone unavailable")} \xB7 ${$(a.email||"Email unavailable")}`,n=e.reviewer_note||e.rejection_reason,r=e.risk_status&&e.risk_status!=="clear"?` \xB7 Risk ${$(String(e.risk_status).replace("_"," "))} (${Number(e.risk_score||0).toFixed(0)})`:"";return`<div class="admin-row"><div><strong>${$(a.name||"Unknown worker")}</strong><span class="muted">${s}</span><span class="muted">Submitted ${$(Pa(e.submitted_at||e.created_at))} \xB7 Attempt ${Number(e.attempt_number||1)} \xB7 ${$(String(e.status||"").replace("_"," "))}${r}</span><p>${$(e.description||"")}</p>${e.external_link?`<a href="${$(e.external_link)}" target="_blank" rel="noopener">Open delivery link</a>`:""}${e.attachment_url?`${e.external_link?" \xB7 ":""}<a href="${$(e.attachment_url)}" target="_blank" rel="noopener">Open screenshot</a>`:""}${n?`<p class="muted"><strong>Review note:</strong> ${$(n)}</p>`:""}</div>${t}</div>`}function ao(e,t){return!["completed","disputed"].includes(e.status)&&!t.some(a=>!["cancelled"].includes(a.status))}function Pa(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Ne(e,t){return`${$(t||"BDT")} ${Number(e||0).toFixed(2)}`}function $(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}fa();ya();w();function wn(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-advertisement",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
                <div>
        ...
        `}}}Qt();aa();na();oa();Xt();var Ln={"/":At,"/refer":Pt,"/webtask":_e,"/tasks":_e,"/earn":$e,"/tg-tasks":Ke,"/withdraw":Ue,"/profile":Oe,"/wallet":Oe,"/admin":da,"/admin/payments":ua,"/admin/categories":bn,"/admin/settings":gn,"/admin/jobs":Ae,"/admin/pending-jobs":Ae,"/admin/active-jobs":Ae,"/admin/admin-job-post":hn,"/admin/transactions":va,"/admin/reports":ha,"/admin/advertisement":wn,"/deposit":Ht,"/leaderboard":We,"/achievements":Ve,"/support":ze,"/settings":Xe,"/jobs/available":ln,"/worker/bids":un,"/worker/active-jobs":ct,"/poster":Zt,"/poster/post-job":ea,"/poster/jobs":sa,"/poster/wallet":ia,"/notifications":Gt,"/login":wa,"/register":Sa,"/forgot-password":nt,"/reset-password":rt};function Cn(){ut(),setTimeout(ut,50),window.addEventListener("hashchange",ut),E(()=>{q.get(),setTimeout(ut,0)})}async function ut(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!Ln[t]){let i=t.match(/^\/admin\/jobs\/(\d+)$/);if(i){if(!q.get()){f("/login");return}let p=g.get();if(!p||!p.is_admin){An();return}await mt(()=>yn(i[1]),t);return}let o=t.match(/^\/jobs\/(\d+)$/);if(o){if(!q.get()){f("/login");return}let p=await Promise.resolve().then(()=>($n(),_n));await mt(()=>p.JobDetailPage(o[1]),t);return}let d=t.match(/^\/poster\/jobs\/(\d+)$/);if(d){if(!q.get()){f("/login");return}let p=await Promise.resolve().then(()=>(Tn(),xn));await mt(()=>p.PosterJobDetailPage(d[1]),t);return}t="/"}let a=q.get(),s=g.get(),n=["/login","/register","/forgot-password","/reset-password"];if(n.includes(t)&&a){s&&s.is_admin?f("/admin"):f("/");return}if(!n.includes(t)&&!a){f("/login");return}if(t==="/"&&s&&s.is_admin){f("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){An();return}let r=Ln[t];await mt(r,t)}async function mt(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let n=a.querySelector(".bottomnav");n?a.insertBefore(s,n):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let n=typeof e=="function"?e():e;typeof n=="function"?await n():n&&typeof n.then=="function"&&await n}catch(n){console.error("View render threw synchronously for",t,n),s.innerHTML=`<div class="card"><h2>Error</h2><p>${n.message}</p></div>`}}function An(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}w();var En=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();En.innerHTML="";Y(on(),En);K.get()&&M();Cn();
