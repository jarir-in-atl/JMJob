var mr=Object.defineProperty;var v=(e,t)=>()=>(e&&(t=e(e=0)),t);var _=(e,t)=>{for(var a in t)mr(e,a,{get:t[a],enumerable:!0})};function br(e,t){xa?xa(e,t):console.error("[Ghost] Unhandled effect error:",e)}function N(e){let t=e,a=new Set;return{get(){return P&&(a.add(P),P.dependencies.add(a)),t},set(s){t!==s&&(t=s,Ta(a))}}}function Ta(e){tt(()=>{e.forEach(t=>{t.notify?t.notify():ye.add(t)})})}function tt(e){Qe++;try{e()}finally{if(Qe--,Qe===0){let t=Array.from(ye);ye.clear(),t.forEach(a=>a.run())}}}function k(e){let t={dependencies:new Set,run(){et(t),he.push(P),P=t;try{e()}catch(a){br(a,e)}finally{P=he.pop()}},notify(){ye.add(t)}};return t.run(),()=>et(t)}function at(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,Ta(s))}};return{get(){if(P&&(s.add(P),P.dependencies.add(s)),a){et(r),he.push(P),P=r;try{t=e()}finally{P=he.pop()}a=!1}return t}}}function et(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var P,he,ye,Qe,xa,z=v(()=>{P=null,he=[],ye=new Set,Qe=0,xa=null});function ne(){st.totalUpdates++,st.recentUpdates++}var we,st,rt=v(()=>{we=new Set,st={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function D(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){gr(e,t);return}if(e.__ghostWhen){fr(e,t);return}if(e.__ghostLazy){vr(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;we.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let i=s.startsWith("on");typeof r=="function"&&!i?e.effects.push(k(()=>{a.setAttribute(s,r()),ne(),e.events.update?.forEach(n=>n())})):i?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)D(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push(k(()=>{let i=s(),n=document.createTextNode(String(i??""));r?a.replaceChild(n,r):a.appendChild(n),r=n,ne(),e.events.update?.forEach(o=>o())}))}else D(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function oe(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),we.delete(e)}}function gr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function d(m){return m.el||null}let u=k(()=>{let m=a(),y=m.map(($,M)=>String(s($,M))),L=Array.from(o.keys());for(let $ of L)if(!y.includes($)){let M=o.get($);oe(M.ghostNode),o.delete($)}for(let $=0;$<m.length;$++){let M=y[$];if(!o.has(M)){let ie=r(m[$],$),K=document.createElement("ghost-list-slot");for(D(ie,K);K.firstChild;)t.insertBefore(K.firstChild,n);o.set(M,{ghostNode:ie})}}for(let $=y.length-1;$>=0;$--){let M=y[$],ie=o.get(M);if(!ie)continue;let K=d(ie.ghostNode);if(!K)continue;let Sa=y[$+1],ka=(Sa?d(o.get(Sa)?.ghostNode):null)||n;K.nextSibling!==ka&&t.insertBefore(K,ka)}ne()});e._listCleanup=()=>{u();for(let m of o.values())oe(m.ghostNode);o.clear(),i.remove(),n.remove()}}function I(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function fr(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=k(()=>{let u=a()?s:r;if(n&&(oe(n),n=null),u&&(n=u(),n)){let m=document.createElement("ghost-when-slot");for(D(n,m);m.firstChild;)t.insertBefore(m.firstChild,i)}ne()});e._whenCleanup=()=>{o(),n&&oe(n),i.remove()}}function vr(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let i=null;if(s){let n=document.createElement("ghost-lazy-slot");for(D(s,n);n.firstChild;)t.insertBefore(n.firstChild,r);i=s}a().then(n=>{let o=n.default||n;i&&(oe(i),i=null);let d=typeof o=="function"?o():o,u=document.createElement("ghost-lazy-slot");for(D(d,u);u.firstChild;)t.insertBefore(u.firstChild,r);i=d}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var it=v(()=>{z();rt()});var La=v(()=>{z()});var _e=v(()=>{});var Ea=v(()=>{rt()});var Ca=v(()=>{z()});var qa=v(()=>{it();z();_e();_e()});function yr(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let i={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){i["@attributes"]={};for(let n of r.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of r.childNodes){let o=n.nodeName,d=s(n);d!==""&&(i[o]===void 0?i[o]=d:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(d)))}return i}return s(a.documentElement)}function wr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function ot(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),i={url:e,...s};for(let y of ot.interceptors.request)i=y(i)??i;let n=i.url;delete i.url;let o=wr(n,r);if(a==="memory"&&r==="GET"&&nt.has(o))return nt.get(o);let d=await fetch(n,i),u=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let m;u.includes("application/xml")||u.includes("text/xml")?m=yr(await d.text()):u.includes("application/json")?m=await d.json():m=await d.text();for(let y of ot.interceptors.response)m=y(d,m)??m;return a==="memory"&&r==="GET"&&nt.set(o,m),m}var nt,Aa=v(()=>{nt=new Map;ot.interceptors={request:[],response:[]}});function lt(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=N(a);return k(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var Ma=v(()=>{z()});function _r(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var bo,Na=v(()=>{bo=_r()});var vo,$r,Pa=v(()=>{z();vo=N("en"),$r=new Map;$r.set("en",{})});var H=v(()=>{z();it();La();_e();Ea();Ca();qa();Aa();Ma();Na();Pa()});function Ha(e){$e=e}function Sr(){return $e}function Ba(e){ct=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let i=e.startsWith("http")?e:ja.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};$e&&(n.headers.Authorization=`Bearer ${$e}`),a!==void 0&&(n.body=JSON.stringify(a)),r&&(n.signal=r);let o=await fetch(i,n);if(o.status===401)throw ct&&ct(),new le("Unauthorized",401,null);let d=null,u=o.headers.get("content-type")||"";try{if(u.includes("application/json"))d=await o.json();else{let m=await o.text();d=m?{message:m}:null}}catch{}if(!o.ok){let m=d&&d.message||`HTTP ${o.status}`;throw new le(m,o.status,d)}return d}var ja,$e,ct,le,c,w=v(()=>{ja=window.JMJOB_CONFIG||{apiBase:"/api"},$e=null,ct=null;le=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>p("/admin/subcategories"),adminCreateSubcategory:e=>p("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>p(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>p(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),notices:()=>p("/notices"),adminUpdateNotices:e=>p("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=ja.apiBase+"/admin/notices/upload",a={},s=Sr();s&&(a.Authorization=`Bearer ${s}`);let r=await fetch(t,{method:"POST",headers:a,body:e}),i=await r.json();if(!r.ok)throw new le(i.message||"Upload failed",r.status,i);return i},adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function l(e,t="info",a=3500){ce.set({message:e,type:t,id:Date.now()}),dt&&clearTimeout(dt),dt=setTimeout(()=>ce.set(null),a)}async function q(){if(!U.get())return null;try{let e=await c.me();return g.set(e.data),e.data}catch{return null}}async function Ia(e,t){let a=await c.login({email:e,password:t});return U.set(a.data.token),g.set(a.data.user),a.data.user}async function Fa(e){return c.requestRegistrationOtp(e)}async function Ra(e){let t=await c.verifyRegistrationOtp(e);return U.set(t.data.token),g.set(t.data.user),t.data.user}async function Se(){try{await c.logout()}catch{}U.set(null),g.set(null),x.set("/login")}function f(e){window.location.hash=e}var kr,xr,U,g,ce,dt,x,E,h=v(()=>{H();H();w();kr="earnap_token",xr="earnap_user",U=lt(kr,null),g=lt(xr,null),ce=N(null),dt=null;x=N(window.location.hash.replace(/^#/,"")||"/"),E=at(()=>!!U.get()&&!!g.get());k(()=>{let e=U.get();Ha(e)});Ba(()=>{U.set(null),g.set(null),x.set("/login"),l("Session expired. Please log in.","error")})});var Ua={};_(Ua,{HomePage:()=>xe});function xe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Tr(e),e.appendChild(Lr(t)),e.appendChild(Er()),e.appendChild(Cr(t))}}function Z(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Tr(e){ke&&(clearInterval(ke),ke=null);try{let t=await c.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(y=>{if(typeof y=="string"){let L=y.trim();return L.startsWith("/")||L.startsWith("http")?{image:L,text:""}:{image:"",text:L}}return{image:y.image||"",text:y.text||""}}).filter(y=>y.image&&y.image.trim()||y.text&&y.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let r=Z("div","welcome-popup welcome-popup--banner","");r.innerHTML=`
    ...
    `,t.appendChild(a),t}function Er(){let e=Z("div","icon-grid");return[{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill",tone:"purple"},{path:"/earn",label:"Earn Ad",icon:"bi-play-circle-fill",tone:"green"},{path:"/tasks",label:"Web Task",icon:"bi-link-45deg",tone:"blue"},{path:"/webtask",label:"Tasks",icon:"bi-telegram",tone:"blue"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2",tone:"amber"},{path:"/refer",label:"Referral",icon:"bi-gift-fill",tone:"pink"},{path:"/profile",label:"Profile",icon:"bi-person-bounding-box",tone:"gray"},{path:"/support",label:"Support",icon:"bi-headset",tone:"red"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin",tone:"green"}].forEach(a=>{let s=Z("a",`icon-grid__item icon-grid__item--${a.tone}`);s.href=`#${a.path}`,s.innerHTML=`
            <span class="icon-grid__chip">
                <i class="bi ${a.icon}"></i>
            </span>
            <span class="icon-grid__label">${a.label}</span>
        `,s.addEventListener("click",r=>{r.preventDefault(),f(a.path)}),e.appendChild(s)}),e}function Cr(e){let t=Z("div","card card--daily-mission"),a=e&&e.today_ads||0,s=e&&e.ads_limit||50,r=Math.min(100,a/Math.max(1,s)*100);t.innerHTML=`
        <div class="card__row">
    ...
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>f("/deposit"))}function oi(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${Ue((t.gateway||"").toUpperCase())}</strong><small>${Ue(t.trxid)} \xB7 ${li(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${Ue(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function Dt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function li(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Ue(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ot=v(()=>{w();h()});var $s={};_($s,{AdminPage:()=>Jt});function Jt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),r.classList.add("admin-tab--active"),ws(r.dataset.tab,s)})}),ws("stats",s)}}async function ws(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),r=a.data||{},i=s.data||{},n=i.currency_symbol||"\u09F3";t.innerHTML=`
                <div class="stat-grid admin-revenue-grid">
                    ${V("bi-graph-up-arrow","Platform revenue",Wt(i.platform_revenue,n))}
                    ${V("bi-percent","Commission rate",`${(Number(i.commission_rate||0)*100).toFixed(2)}%`)}
                    ${V("bi-briefcase","Total jobs",X(i.total_jobs))}
                    ${V("bi-check2-circle","Completed jobs",X(i.completed_jobs))}
                    ${V("bi-lightning-charge","Active jobs",X(i.active_jobs))}
                    ${V("bi-people","Total users",X(i.total_users))}
                    ${V("bi-hourglass-split","Pending deposits",X(i.pending_payments))}
                    ${V("bi-lock","Held in escrow",Wt(i.escrow_total,n))}
                </div>
                <div class="card admin-operations-card">
                    ...
                    <div class="admin-operations-grid">
                        <div><span class="muted">Withdrawals</span><strong>${X(r.total_withdrawals)}</strong></div>
                        <div><span class="muted">Pending withdrawals</span><strong>${X(r.pending_withdrawals)}</strong></div>
                        <div><span class="muted">Total ad views</span><strong>${X(r.total_ad_views)}</strong></div>
    ...
    `,a.querySelector(".provider-save").addEventListener("click",async()=>{let i={block_id:a.querySelector(".provider-block-id").value.trim()||null,weight:parseInt(a.querySelector(".provider-weight").value,10)||0,reward_per_view:parseFloat(a.querySelector(".provider-reward").value)||0,min_duration_seconds:parseInt(a.querySelector(".provider-duration").value,10)||12,enabled:a.querySelector(".provider-enabled").checked};try{await c.adminUpdateProvider(e.id,i),l("Provider saved","success")}catch(n){l(n.message,"error")}}),a}function C(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Gt=v(()=>{w();h();h()});var xs={};_(xs,{AdminPaymentsPage:()=>Vt});function Vt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{O.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),zt()})}),await zt()}}async function zt(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(O.status);O.items=t.data||[],pi(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${Q(t.message||"Failed to load.")}</p>`}}}function pi(e){if(O.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",O.items.forEach(t=>e.appendChild(ui(t)))}function ui(e){let t=di[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
            <div class="admin-row__amount">\u09F3 ${parseFloat(e.amount).toFixed(2)} <span class="badge badge--gateway">${Q((e.gateway||"").toUpperCase())}</span></div>
            <div class="admin-row__sub">
                <strong>TRX:</strong> <code>${Q(e.trxid)}</code>
                &nbsp;\u2022&nbsp;
                <strong>From:</strong> ${Q(e.sender_number)}
                ${e.user?`&nbsp;\u2022&nbsp;<strong>User:</strong> ${Q(e.user.name)} <span class="muted">(${Q(e.user.email)})</span>`:""}
            </div>
            ...
            ${e.admin_note?`<div class="admin-row__note"><em>Note:</em> ${Q(e.admin_note)}</div>`:""}
        </div>
        ${e.status==="pending"?`
    ...
    `;let s=document.getElementById("reset-form"),r=document.getElementById("submit-btn");s.addEventListener("submit",async i=>{i.preventDefault();let n=s.email.value.trim(),o=s.otp.value.trim(),d=s.password.value,u=s.password_confirmation.value;if(!n||!o||!d){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(d!==u){l("Passwords do not match.","error");return}if(d.length<6){l("Password must be at least 6 characters.","error");return}r.disabled=!0,r.textContent="Resetting...";try{await c.resetPassword({email:n,otp:o,password:d,password_confirmation:u}),l("Password reset successfully! You can now log in.","success"),f("/login")}catch(m){l(m.message||"Failed to reset password.","error"),r.disabled=!1,r.textContent="Reset Password"}})}function ki(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ua=v(()=>{w();h()});var rr={};_(rr,{JobDetailPage:()=>Tn});function Tn(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=g.get();t.innerHTML=`
        ...
        `;try{let s=await c.job(e),{job:r,bids:i,bid_count:n,my_bid:o}=s.data;Ln(r,i,n,o,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${Y(s.message||"unknown")}</p>`}}}function Ln(e,t,a,s,r){let i=document.getElementById("job-detail-content");if(!i)return;let n=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,o=n?Math.max(0,Math.floor((n-Date.now())/1e3)):null,d=o!=null?qn(o):"\u2014",u=["open","in_review"].includes(e.status),m=!!s;i.innerHTML=`
        <div class="card job-detail__card">
            <div class="job-detail__head">
                <div>
                    ${e.category?`<span class="job-detail__cat"><i class="bi ${e.category.icon_class||""}"></i> ${Y(e.category.name)}</span>`:""}
                    <h1 class="job-detail__title">${Y(e.title)}</h1>
            ...
            <div class="job-detail__body">
                <h3>Description</h3>
                <p>${Y(e.description).replace(/\n/g,"<br>")}</p>
                ${e.requirements?`<h3>Requirements</h3><p>${Y(e.requirements).replace(/\n/g,"<br>")}</p>`:""}
                <h3>Posted by</h3>
                <p>${e.poster?Y(e.poster.name):"Unknown"} <span class="muted">@${e.poster?.username||"?"}</span></p>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="bid-row bid-row--${a.status}">
                    <div>
                        ...
                        <div class="muted">${Y(a.proposal)}</div>
                    </div>
                    ...
                    ${t.map(i=>`
                        <div class="bid-row">
                            <div>
                                ...
                                <div class="muted">${Y(i.proposal).slice(0,100)}${i.proposal.length>100?"\u2026":""}</div>
                            </div>
    ...
    `}function hn(){document.querySelectorAll("form.submit-form").forEach(e=>{e.addEventListener("submit",async t=>{t.preventDefault();let a=parseInt(e.getAttribute("data-job-id"),10),s=new FormData(e),r=e.querySelector("[data-submit-btn]");r.disabled=!0,r.innerHTML='<i class="bi bi-hourglass"></i> Submitting\u2026';try{await c.submitWork(a,{description:String(s.get("description")||"").trim(),external_link:String(s.get("external_link")||"").trim()||null}),l("Work submitted!","success"),va()()}catch(i){l(i.message||"Failed to submit.","error")}finally{r.disabled=!1,r.innerHTML='<i class="bi bi-send"></i> Submit Work'}})})}function yn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function ha(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var j={activeTab:"categories",categories:[],subcategories:[],loading:!1};function er(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#tab-cats-btn").addEventListener("click",()=>{j.activeTab="categories",ya(e)}),e.querySelector("#tab-subcats-btn").addEventListener("click",()=>{j.activeTab="subcategories",ya(e)}),await ee(e)}}async function ee(e){try{let[t,a]=await Promise.all([c.adminCategories(),c.adminSubcategories()]);j.categories=t.data||[],j.subcategories=a.data||[],ya(e)}catch(t){l(t.message||"Failed to load category data.","error")}}function ya(e){let t=e.querySelector("#tab-cats-btn"),a=e.querySelector("#tab-subcats-btn"),s=e.querySelector("#tab-content");s&&(j.activeTab==="categories"?(t&&(t.className="btn btn--primary"),a&&(a.className="btn btn--ghost"),wn(s,e)):(t&&(t.className="btn btn--ghost"),a&&(a.className="btn btn--primary"),_n(s,e)))}function wn(e,t){e.innerHTML=`
    ...
    `,e.querySelectorAll(".toggle-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=j.categories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateCategory(r,{is_active:!i.is_active}),l("Category updated.","success"),await ee(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-cat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete category?"))try{let i=await c.adminDeleteCategory(r);l(i.message||"Deleted.","success"),await ee(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-cat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),description:String(r.get("description")||"").trim()||null,is_active:r.get("is_active")==="on"};try{await c.adminCreateCategory(i),l("Main Category created.","success"),await ee(t)}catch(n){l(n.message,"error")}})}function _n(e,t){e.innerHTML=`
        <div class="card" style="margin-bottom: 1rem;">
    ...
    `,e.querySelectorAll(".toggle-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),i=j.subcategories.find(n=>String(n.id)===String(r));if(i)try{await c.adminUpdateSubcategory(r,{is_active:!i.is_active}),l("Subcategory updated.","success"),await ee(t)}catch(n){l(n.message,"error")}})}),e.querySelectorAll(".del-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete subcategory?"))try{let i=await c.adminDeleteSubcategory(r);l(i.message||"Deleted.","success"),await ee(t)}catch(i){l(i.message,"error")}})});let a=e.querySelector("#add-subcat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),i={category_id:parseInt(r.get("category_id")||"0",10),name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),is_active:r.get("is_active")==="on"};try{await c.adminCreateSubcategory(i),l("Subcategory created.","success"),await ee(t)}catch(n){l(n.message,"error")}})}function J(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}w();h();var G={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1};function tr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await ar()}}async function ar(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a,s]=await Promise.all([c.adminSettings(),c.socialLinks(),c.notices()]);G.grouped=t.data||{},G.social=a||{},G.noticesData=s||{interval:4,notices:[]},$n()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${A(t.message||"unknown")}</p>`}}}function $n(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(G.grouped).map(n=>`
        <div class="card settings-group">
            <h3 class="card__title">${A(n.charAt(0).toUpperCase()+n.slice(1))}</h3>
            <div class="settings-group__rows">
                ${G.grouped[n].map(o=>kn(n,o)).join("")}
            </div>
        </div>
    `).join(""),s=G.noticesData,r=[];Array.isArray(s.notices)&&s.notices.length&&(r=s.notices.map(n=>typeof n=="string"?n.startsWith("/")||n.startsWith("http")?{image:n,text:""}:{image:"",text:n}:{image:n.image||"",text:n.text||""})),r.length||(r=[{image:"",text:""}]),a+=`
