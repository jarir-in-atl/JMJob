var Rr=Object.defineProperty;var _=(e,t)=>()=>(e&&(t=e(e=0)),t);var x=(e,t)=>{for(var a in t)Rr(e,a,{get:t[a],enumerable:!0})};function Hr(e,t){Ba?Ba(e,t):console.error("[Ghost] Unhandled effect error:",e)}function B(e){let t=e,a=new Set;return{get(){return D&&(a.add(D),D.dependencies.add(a)),t},set(s){t!==s&&(t=s,Da(a))}}}function Da(e){gt(()=>{e.forEach(t=>{t.notify?t.notify():Fe.add(t)})})}function gt(e){mt++;try{e()}finally{if(mt--,mt===0){let t=Array.from(Fe);Fe.clear(),t.forEach(a=>a.run())}}}function E(e){let t={dependencies:new Set,run(){bt(t),He.push(D),D=t;try{e()}catch(a){Hr(a,e)}finally{D=He.pop()}},notify(){Fe.add(t)}};return t.run(),()=>bt(t)}function vt(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,Da(s))}};return{get(){if(D&&(s.add(D),D.dependencies.add(s)),a){bt(r),He.push(D),D=r;try{t=e()}finally{D=He.pop()}a=!1}return t}}}function bt(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var D,He,Fe,mt,Ba,ne=_(()=>{D=null,He=[],Fe=new Set,mt=0,Ba=null});function ye(){ft.totalUpdates++,ft.recentUpdates++}var Be,ft,ht=_(()=>{Be=new Set,ft={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function K(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){Fr(e,t);return}if(e.__ghostWhen){Br(e,t);return}if(e.__ghostLazy){Dr(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;Be.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let n=s.startsWith("on");typeof r=="function"&&!n?e.effects.push(E(()=>{a.setAttribute(s,r()),ye(),e.events.update?.forEach(i=>i())})):n?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)K(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push(E(()=>{let n=s(),i=document.createTextNode(String(n??""));r?a.replaceChild(i,r):a.appendChild(i),r=i,ye(),e.events.update?.forEach(o=>o())}))}else K(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function we(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),Be.delete(e)}}function Fr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,n=document.createComment("[ghost-list]"),i=document.createComment("[/ghost-list]");t.appendChild(n),t.appendChild(i);let o=new Map;function d(u){return u.el||null}let p=E(()=>{let u=a(),b=u.map((h,k)=>String(s(h,k))),y=Array.from(o.keys());for(let h of y)if(!b.includes(h)){let k=o.get(h);we(k.ghostNode),o.delete(h)}for(let h=0;h<u.length;h++){let k=b[h];if(!o.has(k)){let F=r(u[h],h),Y=document.createElement("ghost-list-slot");for(K(F,Y);Y.firstChild;)t.insertBefore(Y.firstChild,i);o.set(k,{ghostNode:F})}}for(let h=b.length-1;h>=0;h--){let k=b[h],F=o.get(k);if(!F)continue;let Y=d(F.ghostNode);if(!Y)continue;let Me=b[h+1],Re=(Me?d(o.get(Me)?.ghostNode):null)||i;Y.nextSibling!==Re&&t.insertBefore(Y,Re)}ye()});e._listCleanup=()=>{p();for(let u of o.values())we(u.ghostNode);o.clear(),n.remove(),i.remove()}}function z(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function Br(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,n=document.createComment("[ghost-when]");t.appendChild(n);let i=null,o=E(()=>{let p=a()?s:r;if(i&&(we(i),i=null),p&&(i=p(),i)){let u=document.createElement("ghost-when-slot");for(K(i,u);u.firstChild;)t.insertBefore(u.firstChild,n)}ye()});e._whenCleanup=()=>{o(),i&&we(i),n.remove()}}function Dr(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let n=null;if(s){let i=document.createElement("ghost-lazy-slot");for(K(s,i);i.firstChild;)t.insertBefore(i.firstChild,r);n=s}a().then(i=>{let o=i.default||i;n&&(we(n),n=null);let d=typeof o=="function"?o():o,p=document.createElement("ghost-lazy-slot");for(K(d,p);p.firstChild;)t.insertBefore(p.firstChild,r);n=d}).catch(i=>{console.error("[Ghost] lazyNode failed to load:",i)})}var yt=_(()=>{ne();ht()});var Ia=_(()=>{ne()});var De=_(()=>{});var Ua=_(()=>{ht()});var Oa=_(()=>{ne()});var Ja=_(()=>{yt();ne();De();De()});function Ur(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let n={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){n["@attributes"]={};for(let i of r.attributes)n["@attributes"][i.nodeName]=i.nodeValue}for(let i of r.childNodes){let o=i.nodeName,d=s(i);d!==""&&(n[o]===void 0?n[o]=d:(Array.isArray(n[o])||(n[o]=[n[o]]),n[o].push(d)))}return n}return s(a.documentElement)}function Or(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function _t(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),n={url:e,...s};for(let b of _t.interceptors.request)n=b(n)??n;let i=n.url;delete n.url;let o=Or(i,r);if(a==="memory"&&r==="GET"&&wt.has(o))return wt.get(o);let d=await fetch(i,n),p=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let u;p.includes("application/xml")||p.includes("text/xml")?u=Ur(await d.text()):p.includes("application/json")?u=await d.json():u=await d.text();for(let b of _t.interceptors.response)u=b(d,u)??u;return a==="memory"&&r==="GET"&&wt.set(o,u),u}var wt,Wa=_(()=>{wt=new Map;_t.interceptors={request:[],response:[]}});function $t(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=B(a);return E(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var Va=_(()=>{ne()});function Jr(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var ad,za=_(()=>{ad=Jr()});var nd,Wr,Ga=_(()=>{ne();nd=B("en"),Wr=new Map;Wr.set("en",{})});var U=_(()=>{ne();yt();Ia();De();Ua();Oa();Ja();Wa();Va();za();Ga()});function Ya(e){le=e}function xt(){return le}function Ka(e){St=e}async function m(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let n=e.startsWith("http")?e:kt.apiBase+e,i=typeof FormData<"u"&&a instanceof FormData,o={method:t,headers:{Accept:"application/json",...i?{}:{"Content-Type":"application/json"},...s}};le&&(o.headers.Authorization=`Bearer ${le}`),a!==void 0&&(o.body=i?a:JSON.stringify(a)),r&&(o.signal=r);let d=await fetch(n,o);if(d.status===401)throw St&&St(),new ce("Unauthorized",401,null);let p=null,u=d.headers.get("content-type")||"";try{if(u.includes("application/json"))p=await d.json();else{let b=await d.text();p=b?{message:b}:null}}catch{}if(!d.ok){let b=p&&p.message||`HTTP ${d.status}`;throw new ce(b,d.status,p)}return p}async function Xa(e){let t=e.startsWith("http")?e:kt.apiBase+e,a={Accept:"text/csv"};le&&(a.Authorization=`Bearer ${le}`);let s=await fetch(t,{headers:a});if(!s.ok){let r=`HTTP ${s.status}`;try{r=(await s.json())?.message||r}catch{}throw new ce(r,s.status,null)}return s.blob()}var kt,le,St,ce,c,S=_(()=>{kt=window.JMJOB_CONFIG||{apiBase:"/api"},le=null,St=null;ce=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>m("/health"),register:e=>m("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>m("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>m("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>m("/auth/login",{method:"POST",body:e}),forgotPassword:e=>m("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>m("/auth/reset-password",{method:"POST",body:e}),logout:()=>m("/auth/logout",{method:"POST"}),me:()=>m("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/notifications${t?"?"+t:""}`)},notificationRead:e=>m(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>m("/notifications/read-all",{method:"POST"}),meUser:()=>m("/user"),reward:e=>m("/user/reward",{method:"POST",body:e}),withdraw:e=>m("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>m("/user/withdrawals"),referrals:()=>m("/user/referrals"),adHistory:()=>m("/user/ads"),adsConfig:()=>m("/ads/config"),adsNext:()=>m("/ads/next"),videoAds:()=>m("/ads/videos"),videoAdStart:e=>m("/ads/videos/start",{method:"POST",body:e}),videoAdClaim:e=>m("/ads/videos/claim",{method:"POST",body:e}),webTasks:()=>m("/tasks/web"),webTaskStart:e=>m("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>m("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>m("/tasks/telegram"),tgTaskVerify:e=>m("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>m("/admin/stats"),adminWithdrawals:(e="pending")=>m(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>m(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>m(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>m(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>m("/admin/users"),adminUpdateUserRole:(e,t)=>m(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminBanUser:(e,t={})=>m(`/admin/users/${e}/ban`,{method:"POST",body:t}),adminUnbanUser:(e,t={})=>m(`/admin/users/${e}/unban`,{method:"POST",body:t}),adminBanHistory:e=>m(`/admin/users/${e}/ban-history`),adminProviders:()=>m("/admin/ad-providers"),adminUpdateProvider:(e,t)=>m(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminVideoAds:()=>m("/admin/video-ads"),adminCreateVideoAd:e=>m("/admin/video-ads",{method:"POST",body:e}),adminUpdateVideoAd:(e,t)=>m(`/admin/video-ads/${e}`,{method:"POST",body:t}),adminDeleteVideoAd:e=>m(`/admin/video-ads/${e}`,{method:"DELETE"}),adminResetDailyCounters:()=>m("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>m("/payment/gateways"),paymentSubmit:e=>m("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>m("/payment/submissions"),adminPayments:(e="")=>m(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>m(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>m(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>m("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/jobs${t?"?"+t:""}`)},job:e=>m(`/jobs/${e}`),createWorkflowJob:e=>m("/jobs/workflow",{method:"POST",body:e}),applyForJob:(e,t={})=>m(`/jobs/${e}/apply`,{method:"POST",body:t}),extendDeadline:(e,t={})=>m(`/jobs/${e}/extend-deadline`,{method:"POST",body:t}),placeBid:(e,t)=>m(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>m(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>m("/worker/bids"),workerActiveJobs:()=>m("/worker/active-jobs"),submitWork:(e,t)=>m(`/jobs/${e}/submit`,{method:"POST",body:t}),proofAttachment:e=>Xa(`/jobs/submissions/${encodeURIComponent(e)}/attachment`),workerCancelAssignment:(e,t={})=>m(`/worker/assignments/${e}/cancel`,{method:"POST",body:t}),workerSubmissions:()=>m("/worker/submissions"),posterStats:()=>m("/poster/stats"),posterCreateJob:e=>m("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>m("/poster/jobs"),posterJobBids:e=>m(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>m(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>m(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>m(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>m(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>m("/admin/categories"),adminCreateCategory:e=>m("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>m(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>m(`/admin/categories/${e}/delete`,{method:"POST"}),adminSubcategories:()=>m("/admin/subcategories"),adminCreateSubcategory:e=>m("/admin/subcategories",{method:"POST",body:e}),adminUpdateSubcategory:(e,t)=>m(`/admin/subcategories/${e}`,{method:"POST",body:t}),adminDeleteSubcategory:e=>m(`/admin/subcategories/${e}/delete`,{method:"POST"}),adminSettings:()=>m("/admin/settings"),adminUpdateSettings:e=>m("/admin/settings",{method:"POST",body:e}),socialLinks:()=>m("/social-links"),adminUpdateSocialLinks:e=>m("/admin/social-links",{method:"POST",body:e}),notices:()=>m("/notices"),adminUpdateNotices:e=>m("/admin/notices",{method:"POST",body:e}),adminUploadBannerImage:async e=>{let t=kt.apiBase+"/admin/notices/upload",a={},s=xt();s&&(a.Authorization=`Bearer ${s}`);let r=await fetch(t,{method:"POST",headers:a,body:e}),n=await r.json();if(!r.ok)throw new ce(n.message||"Upload failed",r.status,n);return n},adminJobs:(e="")=>m(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminCreateJob:e=>m("/admin/jobs",{method:"POST",body:e}),adminJobDetail:e=>m(`/admin/jobs/${e}/detail`),adminUpdateJob:(e,t)=>m(`/admin/jobs/${e}/edit`,{method:"POST",body:t}),adminDeleteJob:e=>m(`/admin/jobs/${e}`,{method:"DELETE"}),adminJobSubmissions:e=>m(`/admin/jobs/${e}/submissions`),adminFraudSubmissions:()=>m("/admin/fraud/submissions"),adminReviewFraud:(e,t={})=>m(`/admin/fraud/submissions/${e}/review`,{method:"POST",body:t}),adminReviewSubmission:(e,t={})=>m(`/admin/submissions/${e}/review`,{method:"POST",body:t}),adminCancelAssignment:(e,t={})=>m(`/admin/assignments/${e}/cancel`,{method:"POST",body:t}),adminReassignAssignment:(e,t={})=>m(`/admin/assignments/${e}/reassign`,{method:"POST",body:t}),adminApproveJob:(e,t={})=>m(`/admin/jobs/${e}/approve`,{method:"POST",body:t}),adminDeclineJob:(e,t={})=>m(`/admin/jobs/${e}/decline`,{method:"POST",body:t}),adminApproveApplication:(e,t={})=>m(`/admin/applications/${e}/approve`,{method:"POST",body:t}),adminFlagJobDispute:e=>m(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>m(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return m(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>m("/admin/reports"),adminReportsExport:()=>Xa("/admin/reports?format=csv"),adminRevenue:()=>m("/admin/revenue")}});function l(e,t="info",a=3500){_e.set({message:e,type:t,id:Date.now()}),Tt&&clearTimeout(Tt),Tt=setTimeout(()=>_e.set(null),a)}async function M(){if(!G.get())return null;try{let e=await c.me();return g.set(e.data),e.data}catch{return null}}async function Za(e,t){let a=await c.login({email:e,password:t});return G.set(a.data.token),g.set(a.data.user),a.data.user}async function Qa(e){let t=await c.register(e);return t.data&&t.data.token&&t.data.user&&(G.set(t.data.token),g.set(t.data.user)),t}async function es(e){let t=await c.verifyRegistrationOtp(e);return G.set(t.data.token),g.set(t.data.user),t.data.user}async function Ie(){try{await c.logout()}catch{}G.set(null),g.set(null),N.set("/login")}function f(e){window.location.hash=e}var Vr,zr,G,g,_e,Tt,N,q,w=_(()=>{U();U();S();Vr="earnap_token",zr="earnap_user",G=$t(Vr,null),g=$t(zr,null),_e=B(null),Tt=null;N=B(window.location.hash.replace(/^#/,"")||"/"),q=vt(()=>!!G.get()&&!!g.get());E(()=>{let e=G.get();Ya(e)});Ka(()=>{G.set(null),g.set(null),N.set("/login"),l("Session expired. Please log in.","error")})});var as={};x(as,{HomePage:()=>Lt});function Lt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=g.get();Gr(e),e.appendChild(Xr(t)),e.appendChild(Yr())}}function $e(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}async function Gr(e){Ue&&(clearInterval(Ue),Ue=null);try{let t=await c.notices(),s=(Array.isArray(t.notices)&&t.notices.length?t.notices:[]).map(b=>{if(typeof b=="string"){let y=b.trim();return y.startsWith("/")||y.startsWith("http")?{image:y,text:""}:{image:"",text:y}}return{image:b.image||"",text:b.text||""}}).filter(b=>b.image&&b.image.trim()||b.text&&b.text.trim());s.length||s.push({text:"Complete tasks, watch ads, refer friends, and withdraw anytime.",image:""});let r=$e("div","welcome-popup welcome-popup--banner","");r.innerHTML=`
            <div id="notice-banner-content" class="welcome-popup__content"></div>
        `,e.firstChild?e.insertBefore(r,e.firstChild):e.appendChild(r);let n=r.querySelector("#notice-banner-content"),i=typeof t.interval=="number"&&t.interval>0?t.interval:4,o=t.direction||"right_to_left",d={right_to_left:{exit:"banner-vanish-left",enter:"banner-enter-right"},left_to_right:{exit:"banner-vanish-right",enter:"banner-enter-left"},top_to_bottom:{exit:"banner-vanish-bottom",enter:"banner-enter-top"},bottom_to_top:{exit:"banner-vanish-top",enter:"banner-enter-bottom"},fade:{exit:"banner-vanish-fade",enter:"banner-enter-fade"}},p=d[o]||d.right_to_left,u=0;ts(n,s[0]),s.length>1&&(Ue=setInterval(()=>{let b;do b=Math.floor(Math.random()*s.length);while(b===u&&s.length>1);u=b,n.className=`welcome-popup__content ${p.exit}`,setTimeout(()=>{ts(n,s[u]),n.className=`welcome-popup__content ${p.enter}`,setTimeout(()=>{n.className="welcome-popup__content"},350)},350)},i*1e3))}catch{}}function ts(e,t){e.innerHTML="";let a=!!(t&&t.text&&t.text.trim());if(!!(t&&t.image&&t.image.trim())){let r=document.createElement("img");r.className="welcome-popup__image",r.src=t.image,r.alt=t.text||"Banner Notice",r.onerror=()=>{r.style.display="none"},e.appendChild(r)}if(a){let r=document.createElement("div");r.className="welcome-popup__text-wrap",r.innerHTML=`<strong>JM Job:</strong> <span>${Kr(t.text)}</span>`,e.appendChild(r)}}function Xr(e){let t=$e("div","card card--user-header"),a=$e("div","user-header__stats");return a.innerHTML=`
    ...
    `,t.appendChild(a),t}function Yr(){let e=$e("div","icon-grid");return[{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill",tone:"purple"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill",tone:"blue"},{path:"/earn",label:"Earn Ad",icon:"bi-play-circle-fill",tone:"green"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2",tone:"amber"},{path:"/refer",label:"Referral",icon:"bi-gift-fill",tone:"pink"},{path:"/profile",label:"Profile",icon:"bi-person-bounding-box",tone:"gray"},{path:"/support",label:"Support",icon:"bi-headset",tone:"red"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin",tone:"green"}].forEach(a=>{let s=$e("a",`icon-grid__item icon-grid__item--${a.tone}`);s.href=`#${a.path}`,s.innerHTML=`
            <span class="icon-grid__chip">
                <i class="bi ${a.icon}"></i>
            </span>
            <span class="icon-grid__label">${a.label}</span>
        `,s.addEventListener("click",r=>{r.preventDefault(),f(a.path)}),e.appendChild(s)}),e}function Kr(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}var Ue,At=_(()=>{w();S();Ue=null});var Ct={};x(Ct,{WebTaskPage:()=>Se});function Se(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--webtask",e.innerHTML='<h2 class="page-title">Web Task Center</h2><div class="task-list" id="task-list">Loading\u2026</div>';let t=e.querySelector("#task-list");try{let s=(await c.webTasks()).data||[];if(s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}t.innerHTML="",s.forEach(r=>t.appendChild(Zr(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function Zr(e){let t=document.createElement("div");t.className="card card--task",t.innerHTML=`
        <h3 class="card__title">${ss(e.title)}</h3>
        <p class="card__sub">${ss(e.description||"")}</p>
        <div class="task-meta">
    ...
    `;let a=t.querySelector("button");return a&&!a.disabled&&a.addEventListener("click",()=>Qr(e,a,t)),t}async function Qr(e,t,a){t.disabled=!0,t.textContent="Opening\u2026",window.open(e.target_url,"_blank","noopener,noreferrer");let s=0,r=e.duration_seconds;t.textContent=`Wait ${r}s\u2026`;let i=(await c.webTaskStart({task_id:e.id})).data.completion_id,o=setInterval(()=>{s+=1;let d=r-s;t.textContent=d>0?`Wait ${d}s\u2026`:"Claim Reward",s>=r&&(clearInterval(o),en(t,i,a))},1e3)}function en(e,t,a){e.textContent="Claim Reward",e.classList.remove("btn--primary"),e.classList.add("btn--success"),e.disabled=!1,e.onclick=async()=>{e.disabled=!0,e.textContent="Claiming\u2026";try{let s=await c.webTaskClaim({completion_id:t});l("+"+parseFloat(s.data.reward).toFixed(2)+" credited!","success"),await M(),Se()()}catch(s){l(s.message||"Claim failed","error"),e.disabled=!1,e.textContent="Claim Reward"}}}function ss(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Oe=_(()=>{S();w()});var rs={};x(rs,{EarnPage:()=>ke});function ke(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML='<div class="card"><p class="muted">Loading available ads\u2026</p></div>',e.className="view view--earn";let t=g.get(),a=t?t.ads_remaining:0;try{let[s,r]=await Promise.all([c.videoAds(),c.adHistory().catch(()=>({meta:{}}))]),n=s.data||[],i=r.meta||{},o=s.meta?.enabled!==!1;e.innerHTML=`
            ...
            `;let d=e.querySelector(".video-ad-list");n.forEach(u=>{let b=document.createElement("div");b.className="admin-row",b.innerHTML=`<div><strong>${Et(u.title)}</strong><span class="muted">${u.duration_seconds}s \xB7 +${Number(u.reward_amount||0).toFixed(4)} \xB7 ${u.watched_today}/${u.daily_limit||"\u221E"} today</span></div>`;let y=document.createElement("button");y.className="btn btn--primary btn--sm",y.textContent=u.can_start&&a>0?"Watch & earn":"Unavailable",y.disabled=!u.can_start||a<=0,y.addEventListener("click",()=>tn(u)),b.appendChild(y),d.appendChild(b)});let p=e.querySelector("#watch-btn");p&&!p.disabled&&p.addEventListener("click",()=>an())}catch(s){e.innerHTML=`<div class="card card--earn"><h2 class="card__title">Ads Reward Center</h2><p class="muted">${Et(s.message||"Could not load ads.")}</p></div>`}}}async function tn(e){let t;try{t=await c.videoAdStart({video_ad_id:e.id})}catch(u){l(u.message||"Could not start this ad.","error");return}let a=t.data,s=document.createElement("div");s.className="modal modal--ad",s.innerHTML=`
    ...
    `,document.body.appendChild(s);let r=()=>s.remove();s.querySelector(".modal__close").addEventListener("click",r),s.querySelector(".modal__backdrop").addEventListener("click",r);let n=s.querySelector("#video-ad-player"),i=s.querySelector("#video-ad-countdown"),o=!1;try{if(String(a.stream_url||"").startsWith("https://"))n.src=a.stream_url,await n.play().catch(()=>{});else{let u=await fetch(a.stream_url,{headers:{Authorization:"Bearer "+xt()}});if(!u.ok)throw new Error("Video could not be loaded.");n.src=URL.createObjectURL(await u.blob()),await n.play().catch(()=>{})}}catch(u){i.textContent=u.message||"Video could not be loaded.";return}let d=Number(a.started_at_unix||Math.floor(Date.now()/1e3))*1e3,p=setInterval(async()=>{let u=Math.max(0,a.duration_seconds-Math.floor((Date.now()-d)/1e3));if(i.textContent=u>0?`Reward unlocks in ${u}s\u2026`:"Claiming reward\u2026",u<=0&&!o){o=!0,clearInterval(p);try{let b=await c.videoAdClaim({view_id:a.view_id});l(`+$${Number(b.data?.reward||0).toFixed(4)} credited!`,"success"),await M(),URL.revokeObjectURL(n.src),r(),ke()()}catch(b){o=!1,i.textContent=b.message||"Reward claim failed."}}},1e3)}function an(){let e=document.createElement("div");e.className="modal modal--ad",e.innerHTML=`
        <div class="modal__backdrop"></div>
        <div class="modal__content modal__content--ad">
            <button class="modal__close" aria-label="Close">\xD7</button>
            <h3>Watch the ad</h3>
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),r=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let n=s.querySelector("#cd-num"),i=setInterval(async()=>{a--,n.textContent=a,r.textContent=`Reward in ${a}s\u2026`,a<=0&&(clearInterval(i),await sn(e,"simulated",t))},1e3)},300)}async function sn(e,t,a){try{let s=await c.reward({provider:t,started_at:a});l(`+$${parseFloat(s.data.reward).toFixed(4)} credited!`,"success"),await M(),e.remove(),ke()()}catch(s){l(s.message||"Reward failed","error"),e.remove()}}function Et(e){return String(e??"").replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}var qt=_(()=>{S();w()});var is={};x(is,{ReferPage:()=>Nt});function Nt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--refer";let t=g.get(),a=null;try{a=(await c.referrals()).data}catch{l("Failed to load referrals","error")}let s=a?a.referral_link:t?`${window.location.origin}/?ref=${t.referral_code}`:"";e.innerHTML=`
        ...
        `;let r=e.querySelector("#copy-btn"),n=e.querySelector("#refer-link-input");r.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(n.value),l("Link copied to clipboard!","success")}catch{n.select(),document.execCommand("copy"),l("Link copied!","success")}});let i=e.querySelector("#share-tg");i.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let p=document.createElement("div");p.className="refer-item",p.innerHTML=`
                    ...
                    <div class="refer-item__info">
                        <div class="refer-item__name">${ns(d.name)}</div>
                        <div class="refer-item__username">@${ns(d.username)}</div>
                    </div>
                    <div class="refer-item__earned">$${parseFloat(d.lifetime_earned).toFixed(2)}</div>
                `,o.appendChild(p)})}}function ns(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var jt=_(()=>{S();w()});var os={};x(os,{WithdrawPage:()=>Je});function Je(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#withdraw-form");a.addEventListener("submit",async r=>{r.preventDefault();let n=new FormData(a),i=a.querySelector("button");i.disabled=!0,i.textContent="Submitting\u2026";try{let o=await c.withdraw({amount:parseFloat(n.get("amount")),wallet_address:String(n.get("wallet_address")),gateway:String(n.get("gateway"))});l("Withdrawal requested!","success"),await M(),Je()()}catch(o){let d=o.payload&&o.payload.errors;if(d){let p=Object.values(d)[0];l(Array.isArray(p)?p[0]:p,"error")}else l(o.message||"Withdrawal failed","error");i.disabled=!1,i.textContent="Confirm Withdrawal"}});let s=e.querySelector("#withdraw-history");try{let n=(await c.withdrawals()).data||[];n.length===0?s.innerHTML='<p class="muted">No withdrawals yet.</p>':(s.innerHTML="",n.forEach(i=>s.appendChild(rn(i))))}catch{s.innerHTML='<p class="muted">Failed to load history.</p>'}}}function rn(e){let t=document.createElement("div");t.className="withdraw-row withdraw-row--"+e.status;let a=(e.status||"pending").toUpperCase(),s=e.admin_note?`<div class="withdraw-row__note">"${Pt(e.admin_note)}"</div>`:"";return t.innerHTML=`
        ...
        ${s}
    `,t}function Pt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Mt=_(()=>{S();w()});var cs={};x(cs,{DepositPage:()=>Rt});function Rt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--deposit";let t=g.get();e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{A.selectedGateway=t.getAttribute("data-gateway"),ls(),on()})})}}function on(){let e=A.gateways.find(n=>n.key===A.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `,document.getElementById("copy-wallet-btn")?.addEventListener("click",()=>{navigator.clipboard.writeText(e.wallet_number).then(()=>{l("Wallet number copied.","info")}).catch(()=>{l("Could not copy. Please copy manually.","error")})}));let r=document.getElementById("deposit-amount");r&&(r.min=A.minAmount,r.max=A.maxAmount,r.placeholder=`${A.minAmount} \u2013 ${A.maxAmount}`)}function ds(){let e=document.getElementById("payment-history");if(e){if(A.submissions.length===0){e.innerHTML='<p class="muted">No submissions yet.</p>';return}e.innerHTML=A.submissions.map(t=>{let a=nn[t.status]||{label:t.status,class:""};return`
            <div class="payment-row ${a.class}">
                ...
                <div class="payment-row__date">${dn(t.created_at)}</div>
            </div>
        `}).join("")}}function dn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function pe(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var nn,A,Ht=_(()=>{S();w();nn={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},A={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var Bt={};x(Bt,{ProfilePage:()=>We});function We(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=g.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let r=(await c.adHistory()).data||[];if(r.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let n=a.querySelector(".ad-history__list");r.forEach(i=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                        <span class="ad-history__provider">${Ft(i.provider)}</span>
                    ...
                    `,n.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function Ft(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Ve=_(()=>{S();w()});var ps={};x(ps,{default:()=>ze});async function ze(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `)}var Dt=_(()=>{w()});var us={};x(us,{default:()=>Ge});async function Ge(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--achievements",e.innerHTML=`
    ...
    `)}var It=_(()=>{w()});var ms={};x(ms,{default:()=>Xe});async function Xe(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--support",e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var Ut=_(()=>{w()});function ln(){let e=localStorage.getItem(bs);return e==="dark"||e==="light"?e:"system"}function cn(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function Ot(e){let t=cn(e);document.documentElement.setAttribute("data-theme",t)}function gs(){let e=O.get();O.set(e==="dark"?"light":"dark")}function vs(e){O.set(e)}function pn(){let e=localStorage.getItem(fs);return e&&Jt.includes(e)?e:"default"}function hs(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function ys(e){Jt.includes(e)&&xe.set(e)}function ws(){return Jt}var bs,O,fs,Jt,xe,Wt=_(()=>{U();bs="jmjob_theme";O=B(ln());Ot(O.get());E(()=>{let e=O.get();Ot(e),localStorage.setItem(bs,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{O.get()==="system"&&Ot("system")});fs="jmjob_color_theme",Jt=["default","emerald","amber","rose"];xe=B(pn());hs(xe.get());E(()=>{let e=xe.get();hs(e),localStorage.setItem(fs,e)})});var _s={};x(_s,{default:()=>Ke});async function Ke(){let e=document.querySelector("[data-view]");if(!e)return;let t=g.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=O.get(),s=xe.get(),r=ws();e.innerHTML=`
            ...
            <div class="settings-section">
                ...
                <div class="settings-item settings-item--stack">
                    <div class="settings-info">
                        ...
                        <div class="settings-value">${Ye[s]||"Default (Purple)"}</div>
                    </div>
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${Ye[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${un[o]};"></span>
                                <span class="theme-swatch__label">${(Ye[o]||o).split(" ")[0]}</span>
                            </button>
                        `).join("")}
                    </div>
                </div>
    ...
    `;let n=document.getElementById("theme-mode-group");n&&n.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-mode");vs(d),l(`Theme mode set to ${d}.`,"info")})});let i=document.getElementById("color-theme-group");i&&i.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-color");ys(d),l(`Accent color set to ${Ye[d]||d}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await Ie(),l("Logged out.","info")})}var Ye,un,Vt=_(()=>{w();Wt();Ye={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},un={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var Ss={};x(Ss,{NotificationsPage:()=>zt});function zt(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `,document.getElementById("notifications-read-all")?.addEventListener("click",async()=>{try{await c.notificationsReadAll(),l("All notifications marked as read.","success"),await $s()}catch(t){l(t.message||"Could not update notifications.","error")}}),await $s())}}async function $s(){let e=document.getElementById("notifications-page-list");if(e)try{let t=await c.notifications({limit:100}),a=Array.isArray(t.data)?t.data:[];e.innerHTML=a.length?a.map(mn).join(""):'<p class="muted notifications-page__empty">No notifications yet.</p>',e.querySelectorAll("[data-notification-id]").forEach(s=>{s.querySelector("[data-mark-read]")?.addEventListener("click",async()=>{try{await c.notificationRead(s.getAttribute("data-notification-id")),s.classList.remove("notifications-page__item--unread"),s.querySelector("[data-mark-read]").remove()}catch(r){l(r.message||"Could not mark notification as read.","error")}})})}catch(t){e.innerHTML=`<p class="muted">Failed to load notifications: ${Te(t.message||"unknown error")}</p>`}}function mn(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?`<a class="btn btn--ghost btn--sm" href="#${Te(t.action_url)}">Open</a>`:"",n=e.read?"":'<button class="btn btn--ghost btn--sm" data-mark-read>Mark read</button>';return`<article class="notifications-page__item ${e.read?"":"notifications-page__item--unread"}" data-notification-id="${Te(e.id)}"><i class="bi ${s} notifications-page__icon notifications-page__icon--${a}"></i><div class="notifications-page__body"><h3>${Te(t.title||"Notification")}</h3><p>${Te(t.message||"")}</p><small>${bn(e.created_at)}</small></div><div class="notifications-page__actions">${r}${n}</div></article>`}function bn(e){if(!e)return"";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Te(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Gt=_(()=>{S();w()});var ks={};x(ks,{TgTasksPage:()=>Qe});function Qe(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--tgtasks",e.innerHTML=`
        ...
        `;let t=e.querySelector("#tg-list");try{let s=(await c.tgTasks()).data||[];if(t.innerHTML="",s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}s.forEach(r=>t.appendChild(gn(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function gn(e){let t=document.createElement("div");if(t.className="card card--task",t.innerHTML=`
        <div class="task-header">
            <div class="task-channel">
                <i class="bi bi-telegram"></i>
                <strong>${Ze(e.channel_name)}</strong>
                <span class="muted">${Ze(e.channel_username)}</span>
            </div>
        </div>
        <p class="card__sub">${Ze(e.description||"")}</p>
        <div class="task-meta">
            <span><i class="bi bi-cash"></i> $${parseFloat(e.reward).toFixed(3)}</span>
        </div>
        <div class="task-actions">
            ${e.completed?'<button class="btn btn--ghost" disabled>\u2713 Completed</button>':`<a class="btn btn--primary" href="https://t.me/${Ze(e.channel_username.replace("@",""))}" target="_blank" rel="noopener" data-task-id="${e.id}">Join channel</a>`}
        </div>
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&vn(e,t)},3e3)})}return t}async function vn(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await M(),Qe()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ze(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Xt=_(()=>{S();w()});var Ls={};x(Ls,{PosterDashboardPage:()=>Kt});function Kt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--poster-dashboard",!g.get()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
                <div>
        ...
        `;let a=e.querySelector("#poster-new-job");a&&a.addEventListener("click",s=>{s.preventDefault(),f("/poster/post-job")}),await xs()}}async function xs(){let e=document.getElementById("poster-dashboard-content");if(e)try{let t=await c.posterStats();hn(e,t.data||{})}catch(t){e.innerHTML=`
            <div class="card">
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",xs),l(t.message||"Failed to load poster statistics.","error")}}function hn(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=Yt(t.wallet_balance),n=Yt(t.frozen_balance),i=Yt(t.total_spent);e.innerHTML=`
        <div class="stat-grid poster-stat-grid">
            ${et("bi-briefcase","Total jobs",a.total||0)}
            ${et("bi-lightning-charge","Active jobs",s)}
            ${et("bi-wallet2","Available wallet",r,"\u09F3")}
            ${et("bi-lock","In escrow",n,"\u09F3")}
        </div>
    ...
    `,e.querySelectorAll("[data-poster-link]").forEach(o=>{o.addEventListener("click",d=>{d.preventDefault(),f(o.getAttribute("href").replace(/^#/,""))})})}function et(e,t,a,s=""){return`
    ...
    `}function ue(e,t){let a=Number(t||0);return`
        <div class="poster-status-row">
            <span><i class="bi ${yn(e)}"></i> ${fn[e]||e}</span>
            <strong>${a}</strong>
        </div>
    `}function yn(e){return{open:"bi-megaphone",in_review:"bi-search",assigned:"bi-person-check",submitted:"bi-inbox",revision:"bi-arrow-repeat",completed:"bi-check-circle"}[e]||"bi-circle"}function Yt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function Ts(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var fn,Zt=_(()=>{S();w();fn={open:"Open",in_review:"In review",assigned:"Assigned",submitted:"Awaiting review",revision:"Revision requested",completed:"Completed",cancelled:"Cancelled",expired:"Expired",disputed:"Disputed"}});var Es={};x(Es,{PostJobPage:()=>Qt});function Qt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--post-job",!Sn()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}let t={currentStep:1,categories:[],mainCategoryId:"",subCategoryId:"",title:"",subtitle:"",description:"",thumbnailBase64:"",proofRequirements:[{title:"",type:"text"}],workerCount:1,costPerWorker:10,biddingValue:3,biddingUnit:"days",deadlineAt:"",feePercentage:30};try{let a=await c.categories();t.categories=a.data||[]}catch(a){l(a.message||"Could not load categories.","error")}Ce(e,t)}}function Ce(e,t){e.innerHTML=`
    ...
    `,wn(e,t)}function wn(e,t){let a=e.querySelector("#wizard-card-body");a&&(t.currentStep===1?Cs(a,e,t):t.currentStep===2?Ae(a,e,t):t.currentStep===3&&_n(a,e,t))}function Cs(e,t,a){let s=a.categories.find(o=>Number(o.id)===Number(a.mainCategoryId)),r=s?s.subcategories||[]:[];e.innerHTML=`
    ...
    `;let s=e.querySelector("#proof-pairs-container");s.addEventListener("change",n=>{if(n.target.classList.contains("proof-type-select"))Le(e,a),Ae(e,t,a);else if(n.target.classList.contains("proof-file-input")){let i=n.target.closest(".proof-pair-row"),o=Number(i.getAttribute("data-index")),d=n.target.files[0];if(d){let p=new FileReader;p.onload=u=>{a.proofRequirements[o].fileBase64=u.target.result,a.proofRequirements[o].title=d.name,Ae(e,t,a)},p.readAsDataURL(d)}}}),e.querySelector("#add-proof-btn").addEventListener("click",()=>{Le(e,a),a.proofRequirements.push({title:"",type:"text"}),Ae(e,t,a)}),s.addEventListener("click",n=>{let i=n.target.closest(".remove-proof-btn");if(i){let o=Number(i.getAttribute("data-index"));Le(e,a),a.proofRequirements.splice(o,1),Ae(e,t,a)}}),e.querySelector("#job-thumbnail-input").addEventListener("change",n=>{let i=n.target.files[0];if(i){let o=new FileReader;o.onload=d=>{a.thumbnailBase64=d.target.result},o.readAsDataURL(i)}}),e.querySelector("#step-cancel").addEventListener("click",ea),e.querySelector("#step-2-back").addEventListener("click",()=>{Le(e,a),a.currentStep=1,Ce(t,a)}),e.querySelector("#step-2-form").addEventListener("submit",n=>{if(n.preventDefault(),Le(e,a),!a.title.trim()){l("Job title is required.","error");return}if(!a.description.trim()){l("Task instructions are required.","error");return}a.currentStep=3,Ce(t,a)})}function Le(e,t){t.title=e.querySelector("#job-title-input")?.value||"",t.subtitle=e.querySelector("#job-subtitle-input")?.value||"",t.description=e.querySelector("#job-desc-input")?.value||"";let a=e.querySelectorAll(".proof-pair-row");t.proofRequirements=Array.from(a).map((s,r)=>{let n=s.querySelector(".proof-type-select")?.value||"text",i=s.querySelector(".proof-title-input"),o=i?i.value:t.proofRequirements[r]?.title||"Screenshot Proof",d=t.proofRequirements[r]?.fileBase64||null;return{title:o,type:n,fileBase64:d}})}function _n(e,t,a){let s=Number(a.workerCount||0)*Number(a.costPerWorker||0),r=s*(a.feePercentage/100),n=s+r;e.innerHTML=`
    ...
    `;let i=e.querySelector("#worker-count-input"),o=e.querySelector("#cost-per-worker-input"),d=()=>{a.workerCount=Math.max(1,parseInt(i.value,10)||1),a.costPerWorker=Math.max(0,parseFloat(o.value)||0);let p=a.workerCount*a.costPerWorker,u=p*(a.feePercentage/100),b=p+u;e.querySelector("#summary-subtotal").textContent=`\u09F3${p.toFixed(2)}`,e.querySelector("#summary-fee").textContent=`\u09F3${u.toFixed(2)}`,e.querySelector("#summary-total").textContent=`\u09F3${b.toFixed(2)}`};i.addEventListener("input",d),o.addEventListener("input",d),e.querySelector("#step-cancel").addEventListener("click",ea),e.querySelector("#step-3-back").addEventListener("click",()=>{As(e,a),a.currentStep=2,Ce(t,a)}),e.querySelector("#step-3-form").addEventListener("submit",async p=>{p.preventDefault(),As(e,a);let u=e.querySelector("#post-job-publish");u.disabled=!0,u.textContent="Publishing\u2026";let b=0,y=Number(a.biddingValue||0);y>0&&(a.biddingUnit==="minutes"?b=y/60:a.biddingUnit==="hours"?b=y:a.biddingUnit==="days"?b=y*24:a.biddingUnit==="months"&&(b=y*24*30));try{let h=await c.posterCreateJob({category_id:Number(a.mainCategoryId),subcategory_id:a.subCategoryId?Number(a.subCategoryId):null,title:a.title.trim(),subtitle:a.subtitle.trim(),description:a.description.trim(),thumbnail:a.thumbnailBase64||null,proof_requirements:a.proofRequirements,worker_count:Number(a.workerCount),cost_per_worker:Number(a.costPerWorker),budget:Number(a.workerCount)*Number(a.costPerWorker),deadline_at:$n(a.deadlineAt),bidding_window_hours:b});l("Job submitted for admin review.","success");let k=g.get(),F=k&&(k.username||k.name)||"User",Y=h?.data?.id||"",Me=`${window.location.origin}/#/poster/jobs/${Y}`,Ha=`I, the user ${F}, has submitted this job ${Me} for publishing. Let's talk about payment and approval`,Re=`https://wa.me/8801775722083?text=${encodeURIComponent(Ha)}`,Fa=t.querySelector("#wizard-card-body");Fa&&(Fa.innerHTML=`
                    <div style="text-align:center; padding: 2rem 1rem;">
                        ...
                        <div style="margin-bottom:1.5rem;">
                            <a href="${Re}" target="_blank" rel="noopener noreferrer" class="btn btn--primary btn--xl" style="background:#25D366; border-color:#25D366; color:#fff; display:inline-flex; align-items:center; gap:0.5rem; text-decoration:none;">
                ...
                `)}catch(h){l(h.message||"Could not publish job.","error"),u.disabled=!1,u.textContent="Publish Job"}})}function As(e,t){t.workerCount=Number(e.querySelector("#worker-count-input")?.value||1),t.costPerWorker=Number(e.querySelector("#cost-per-worker-input")?.value||0),t.biddingValue=Number(e.querySelector("#bidding-val-input")?.value||0),t.biddingUnit=e.querySelector("#bidding-unit-input")?.value||"days",t.deadlineAt=e.querySelector("#deadline-input")?.value||""}function ea(){confirm("Are you sure you want to cancel posting this job?")&&f("/poster")}function $n(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function Sn(){return!!g.get()}function me(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ta=_(()=>{S();w()});var Ns={};x(Ns,{PosterJobsPage:()=>aa});function aa(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--poster-jobs",!Ln()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
            ...
            <div class="poster-filter-bar" style="margin-bottom: 16px;">
                <label>Filter Status
                    <select class="admin-select" id="poster-job-filter">
                        ${kn.map(t=>`<option value="${t}" ${t===at?"selected":""}>${t?qs(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#poster-jobs-new").addEventListener("click",t=>{t.preventDefault(),f("/poster/post-job")}),e.querySelector("#poster-job-filter").addEventListener("change",async t=>{at=t.target.value,await tt()}),e.querySelector("#poster-jobs-refresh").addEventListener("click",tt),await tt()}}}async function tt(){let e=document.getElementById("poster-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=((await c.posterMyJobs()).data||[]).filter(s=>!at||s.status===at);e.innerHTML=a.length?"":'<p class="muted card" style="padding: 20px; text-align: center;">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(xn(s)))}catch(t){e.innerHTML=`<p class="muted card" style="padding: 20px;">Failed to load jobs: ${Z(t.message||"unknown error")}</p>`}}}function xn(e){let t=document.createElement("article");t.className=`admin-row poster-job-row poster-job-row--${Z(e.status)}`;let a=e.status==="pending_approval",s=e.status==="declined",r="";return!a&&!s&&(r=`
        ...
        <div class="poster-job-row__header">
            <div>
                ...
                <span class="badge badge--${a?"warning":s?"danger":"success"}">${Z(qs(e.status).toUpperCase())}</span>
            </div>
        ...
        <div class="admin-job-row__meta">
            ...
            <span><strong>Created:</strong> ${An(e.created_at)}</span>
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>f(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>Tn(e.id)),t}async function Tn(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await c.posterCancelJob(e,{reason:t}),l("Job cancelled.","success"),await tt()}catch(a){l(a.message||"Could not cancel job.","error")}}function Ln(){return!!g.get()}function qs(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function An(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Z(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var kn,at,sa=_(()=>{S();w();kn=["","pending_approval","open","assigned","submitted","revision","completed","declined","cancelled","disputed"],at=""});var js={};x(js,{PosterWalletPage:()=>na});function na(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--poster-wallet",!g.get()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([c.posterStats(),c.paymentSubmissions()]);Cn(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${st(a.message||"unknown error")}</p>`}}}function Cn(e,t,a){let s=ra(t.wallet_balance),r=ra(t.frozen_balance),n=ra(t.total_spent);e.innerHTML=`
        ...
        <div class="card"><h2 class="card__title">Deposit history</h2><div class="poster-deposit-list">${En(a)}</div></div>
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>f("/deposit"))}function En(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${st((t.gateway||"").toUpperCase())}</strong><small>${st(t.trxid)} \xB7 ${qn(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${st(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function ra(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function qn(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function st(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ia=_(()=>{S();w()});var Rs={};x(Rs,{AdminPage:()=>oa});function oa(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(o=>{o.addEventListener("click",()=>{a.forEach(d=>d.classList.remove("admin-tab--active")),o.classList.add("admin-tab--active"),Ps(o.dataset.tab,s)})});let n=new URLSearchParams(window.location.hash.split("?")[1]||"").get("tab"),i=["stats","withdrawals","payments","users","providers","video-ads","fraud"].includes(n)?n:"stats";a.forEach(o=>o.classList.toggle("admin-tab--active",o.dataset.tab===i)),Ps(i,s)}}async function Ps(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),r=a.data||{},n=s.data||{},i=r.marketplace||{},o=n.currency_symbol||"\u09F3";t.innerHTML=`
                <div class="stat-grid admin-revenue-grid">
                    ${J("bi-graph-up-arrow","Platform revenue",W(n.platform_revenue,o))}
                    ${J("bi-percent","Commission rate",`${(Number(n.commission_rate||0)*100).toFixed(2)}%`)}
                    ${J("bi-briefcase","Total jobs",C(n.total_jobs))}
                    ${J("bi-check2-circle","Completed jobs",C(n.completed_jobs))}
                    ${J("bi-lightning-charge","Active jobs",C(n.active_jobs))}
                    ${J("bi-people","Total users",C(n.total_users))}
                    ${J("bi-person-check","Active users",C(r.active_users))}
                    ${J("bi-hourglass-split","Pending deposits",C(n.pending_payments))}
                    ${J("bi-lock","Held in escrow",W(n.escrow_total,o))}
            ...
            `;let r=t.querySelector("#wd-list");s.forEach(n=>r.appendChild(Ms(n,r))),t.querySelector("#wd-filter").addEventListener("change",async n=>{let i=await c.adminWithdrawals(n.target.value);r.innerHTML="",(i.data||[]).forEach(o=>r.appendChild(Ms(o,r)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list"),n=Number(g.get()?.id||0);s.forEach(i=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                    <div>
                ...
                `,i.querySelectorAll("[data-fraud-decision]").forEach(o=>o.addEventListener("click",async()=>{let d=o.dataset.fraudDecision,p=d==="confirmed_fraud"?prompt("Reason for confirming fraud:"):prompt("Optional review note:")||"";if(p===null||d==="confirmed_fraud"&&!p.trim())return;let u=d==="confirmed_fraud"&&confirm("Also ban this worker and revoke active sessions?");try{let b=await c.adminReviewFraud(n.id,{decision:d,note:p,ban_user:u});l(b.data?.user_banned?"Fraud review saved and worker banned.":"Fraud review saved.","success"),i.remove(),r.children.length||(r.innerHTML='<p class="muted">No flagged submissions.</p>')}catch(b){l(b.message||"Fraud review failed.","error")}})),r.appendChild(i)})}}catch{t.innerHTML='<p class="muted">Failed to load.</p>'}}function J(e,t,a){return`
        <div class="stat-tile admin-stat-tile">
            <i class="bi ${e} admin-stat-tile__icon"></i>
            <span class="muted">${L(t)}</span>
            <strong>${L(String(a))}</strong>
        </div>
    `}function C(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function W(e,t){let a=Number(e||0);return`${t}${Number.isFinite(a)?a.toFixed(2):"0.00"}`}function Ms(e,t){let a=document.createElement("div");if(a.className="admin-row admin-row--withdrawal",a.innerHTML=`
    ...
    `;let s=e.querySelector("#video-ad-list");a.length||(s.innerHTML='<p class="muted">No video ads configured.</p>'),a.forEach(r=>s.appendChild(jn(r,s))),e.querySelector("#video-ad-form").addEventListener("submit",async r=>{r.preventDefault();let n=r.currentTarget;try{await c.adminCreateVideoAd(new FormData(n)),l("Video ad uploaded.","success"),await da(e)}catch(i){l(i.message||"Video upload failed.","error")}})}function jn(e,t){let a=document.createElement("div");return a.className="admin-row admin-row--provider",a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,a.querySelector(".video-ad-toggle").addEventListener("click",async()=>{let s=new FormData;s.append("status",e.status==="active"?"paused":"active");try{await c.adminUpdateVideoAd(e.id,s),l("Video ad status updated.","success"),await da(t.parentElement)}catch(r){l(r.message||"Could not update video ad.","error")}}),a.querySelector(".video-ad-delete").addEventListener("click",async()=>{if(confirm(`Delete \u201C${e.title}\u201D?`))try{await c.adminDeleteVideoAd(e.id),l("Video ad deleted.","success"),a.remove()}catch(s){l(s.message||"Could not delete video ad.","error")}}),a}function L(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var la=_(()=>{S();w();w()});var Bs={};x(Bs,{AdminPaymentsPage:()=>pa});function pa(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{Q.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),ca()})}),await ca()}}async function ca(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(Q.status);Q.items=t.data||[],Mn(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${oe(t.message||"Failed to load.")}</p>`}}}function Mn(e){if(Q.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",Q.items.forEach(t=>e.appendChild(Rn(t)))}function Rn(e){let t=Pn[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
            ...
            <div class="admin-row__meta">
                ...
                ${e.verified_at?`&nbsp;\u2022&nbsp;<span class="muted">Verified: ${Fs(e.verified_at)}</span>`:""}
            </div>
    ...
    `,e.status==="pending"&&(a.querySelector('[data-action="approve"]')?.addEventListener("click",()=>Hs(e.id,"approve",a)),a.querySelector('[data-action="reject"]')?.addEventListener("click",()=>Hs(e.id,"reject",a))),a}async function Hs(e,t,a){let s=prompt(t==="approve"?"Optional note for approval:":"Reason for rejection:");if(s!==null)try{let n=await(t==="approve"?c.adminApprovePayment:c.adminRejectPayment)(e,{note:s||null});l(n.message||"Done.","success"),await ca()}catch(r){l(r.message||"Action failed.","error")}}function Fs(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function oe(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Pn,Q,ua=_(()=>{S();w();Pn={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},Q={status:"pending",items:[],loading:!1}});var rt={};x(rt,{AdminJobsPage:()=>Ee});function Ee(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.innerHTML="",e.className="view view--admin-jobs",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}let t=window.location.hash.replace(/^#/,"").split("?")[0];t==="/admin/pending-jobs"?I="pending_approval":t==="/admin/active-jobs"&&(I="open"),e.innerHTML=`
            <div class="page-heading-row">
                <div>
            ...
            <div class="admin-toolbar" style="margin-bottom: 16px;">
                <label>Filter Status
                    <select class="admin-select" id="admin-job-status">
                        ${Hn.map(s=>`<option value="${s.value}" ${s.value===I?"selected":""}>${s.label}</option>`).join("")}
                    </select>
                </label>
        ...
        `;let a=e.querySelectorAll(".admin-tab");a.forEach(s=>{s.addEventListener("click",async()=>{a.forEach(n=>n.classList.remove("admin-tab--active")),s.classList.add("admin-tab--active"),I=s.dataset.status;let r=e.querySelector("#admin-job-status");r&&(r.value=I),await ie()})}),e.querySelector("#admin-job-status").addEventListener("change",async s=>{I=s.target.value,a.forEach(r=>r.classList.toggle("admin-tab--active",r.dataset.status===I)),await ie()}),e.querySelector("#admin-job-refresh").addEventListener("click",ie),e.querySelector("#admin-create-job").addEventListener("click",()=>f("/admin/admin-job-post")),await ie()}}async function ie(){let e=document.getElementById("admin-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=I==="all"?"":I,s=(await c.adminJobs(t)).data||[];e.innerHTML=s.length?"":'<p class="muted card" style="padding:20px; text-align:center;">No jobs found for this section.</p>',s.forEach(r=>e.appendChild(Fn(r)))}catch(t){e.innerHTML=`<p class="muted card" style="padding:20px;">Failed to load jobs: ${T(t.message||"unknown error")}</p>`}}}function Fn(e){let t=document.createElement("article");t.className=`admin-row admin-job-row admin-job-row--${T(e.status)}`;let a=e.status==="pending_approval",s=e.status==="declined",r="";!a&&!s&&(r=`
            <div class="admin-job-row__metrics" style="display: flex; gap: 16px; margin: 10px 0; background: rgba(0,0,0,0.03); padding: 10px 14px; border-radius: 6px; font-size: 13px;">
                <div><i class="bi bi-clock-history"></i> <strong>Days Remaining:</strong> <span style="color:#d97706;">${T(e.days_remaining||"N/A")}</span></div>
                ...
                <div><i class="bi bi-cash-stack"></i> <strong>Paid:</strong> ${T(e.currency||"BDT")} ${Number(e.completed_amount||0).toFixed(2)} / <strong>Remaining:</strong> ${Number(e.remaining_amount||0).toFixed(2)}</div>
            </div>
        `),t.innerHTML=`
        <div class="admin-job-row__header">
            <div>
                <strong>${T(e.title)}</strong>
                <span class="badge badge--${a?"warning":s?"danger":"success"}">${T(String(e.status||"").replace("_"," ").toUpperCase())}</span>
            </div>
            <strong class="admin-row__amount">${T(e.currency||"BDT")} ${Number(e.total_payable_amount||e.budget||0).toFixed(2)}</strong>
        </div>

        <p class="admin-job-row__description muted">${T(e.description||"")}</p>
        ${e.subtitle?`<p class="muted"><strong>Subtitle:</strong> ${T(e.subtitle)}</p>`:""}

        ${r}

        <div class="admin-job-row__meta">
            <span><strong>Customer:</strong> ${T(e.customer_name||e.poster?.name||"(deleted)")} (${T(e.customer_email||e.poster?.email||"")})</span>
            ${e.customer_phone?`<span><strong>Phone:</strong> ${T(e.customer_phone)}</span>`:""}
            <span><strong>Category:</strong> ${T(e.category_name||"Uncategorized")}</span>
            <span><strong>Workers Needed:</strong> ${Number(e.worker_count||1)}</span>
            <span><strong>Cost/Worker:</strong> ${T(e.currency||"BDT")} ${Number(e.cost_per_worker||0).toFixed(2)}</span>
            ${e.decline_reason?`<span style="color:#dc2626;"><strong>Decline Reason:</strong> ${T(e.decline_reason)}</span>`:""}
        </div>
    ...
    `;let n=t.querySelector(".admin-row__actions");if(!a&&!s&&(n.appendChild(de("View Job Details","btn--ghost",()=>f(`/admin/jobs/${e.id}`))),n.appendChild(de("View Proofs & Screenshots","btn--ghost",()=>Os(e.id,e.title)))),a){let i=de("Activate Job","btn--success",()=>Dn(e.id,i));be.has(e.id)&&ma(i),n.appendChild(i),n.appendChild(de("Decline","btn--danger",()=>In(e.id)))}else e.status==="disputed"?(n.appendChild(de("Release Payment","btn--success",()=>Us(e.id,"release"))),n.appendChild(de("Cancel & Refund","btn--danger",()=>Us(e.id,"cancel")))):["completed","cancelled","declined"].includes(e.status)||n.appendChild(de("Mark Disputed","btn--danger",()=>Un(e.id)));return t}function de(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function Os(e,t){let a=document.getElementById("admin-proof-modal-container");if(!a)return;a.innerHTML=`
        <div class="modal-backdrop" style="position:fixed; top:0; left:0; right:0; bottom:0; background:rgba(0,0,0,0.6); display:flex; align-items:center; justify-content:center; z-index:99999;">
            <div class="modal-card" style="background:#fff; width:90%; max-width:800px; max-height:85vh; border-radius:12px; padding:24px; overflow-y:auto; box-shadow:0 10px 30px rgba(0,0,0,0.2);">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
                    <h2 style="margin:0; font-size:18px;"><i class="bi bi-file-earmark-check"></i> Proof Submissions for "${T(t)}"</h2>
    ...
    `,a.querySelector("#close-proof-modal").addEventListener("click",()=>{a.innerHTML=""});let r=a.querySelector("#proof-modal-content");try{let o=((await c.adminJobSubmissions(e)).data||{}).submissions||[];if(!o.length){r.innerHTML='<p class="muted" style="text-align:center; padding:30px;">No worker submissions or proof screenshots submitted yet for this job.</p>';return}r.innerHTML=o.map(d=>{let p=d.work_proof_data||{},u=d.attachment_url||(d.attachment_path?d.attachment_path.startsWith("http")?d.attachment_path:`/storage/${d.attachment_path}`:null),b=String(d.attachment_path||""),y=!!(u&&(/\.(jpg|jpeg|png|gif|webp)$/i.test(u)||/\.(jpg|jpeg|png|gif|webp)$/i.test(b))),h=y?"View screenshot":"Open proof attachment";return`
                <div class="card" style="margin-bottom:16px; padding:16px; border:1px solid #e2e8f0; border-radius:8px; background:#f9fafb;">
                    <div style="display:flex; justify-content:space-between; margin-bottom:8px;">
                        <div>
                            <strong><i class="bi bi-person"></i> ${T(d.worker_name)}</strong>
                            <span class="muted">User ID #${T(d.worker_id)} \xB7 ${T(d.worker_phone||"Phone unavailable")} \xB7 ${T(d.worker_email||d.worker_username||"")}</span>
                        </div>
                        <span class="badge badge--${d.status==="approved"?"success":"warning"}">${T(d.status.toUpperCase())}</span>
                    </div>

                    ${d.description?`<p style="margin:8px 0; font-size:14px; background:#fff; padding:10px; border-radius:6px; border:1px solid #edf2f7;"><strong>Proof Description:</strong><br>${T(d.description)}</p>`:""}

                    ${d.external_link?`<div style="margin:8px 0;"><a href="${T(d.external_link)}" target="_blank" class="btn btn--ghost btn--sm"><i class="bi bi-box-arrow-up-right"></i> Open External Proof Link</a></div>`:""}

                    ${u?`
                        <div style="margin:10px 0;">
                            <strong>Proof Screenshot / Attachment:</strong><br>
                            <button type="button" class="btn btn--ghost btn--sm" data-proof-attachment="${Number(d.id)}"><i class="bi ${y?"bi-image":"bi-file-earmark-text"}"></i> ${h}</button>
                        </div>
                    `:""}

                    ${d.trx_id?`<div style="font-size:12px; color:#475569; margin-top:6px;"><strong>TrxID:</strong> ${T(d.trx_id)} | <strong>bKash:</strong> ${T(d.bkash_number||"N/A")}</div>`:""}

                    <div style="font-size:12px; color:#64748b; margin-top:8px;">Submitted on: ${Js(d.submitted_at||d.created_at)} \xB7 Attempt ${Number(d.attempt_number||1)}</div>
                </div>
            `}).join(""),r.querySelectorAll("[data-proof-attachment]").forEach(d=>d.addEventListener("click",()=>Bn(d.dataset.proofAttachment))),r.querySelectorAll(".card").forEach((d,p)=>{let u=o[p];if(!u||u.status!=="pending_review")return;let b=document.createElement("div");b.style.cssText="display:flex; gap:8px; margin-top:12px;";let y=document.createElement("button");y.className="btn btn--success btn--sm",y.textContent="Approve for payment review",y.addEventListener("click",()=>Ds(u,e,t,y,h));let h=document.createElement("button");h.className="btn btn--danger btn--sm",h.textContent="Reject",h.addEventListener("click",()=>Ds(u,e,t,h,y)),b.append(y,h),d.appendChild(b)})}catch(n){r.innerHTML=`<p class="muted">Failed to load submissions: ${T(n.message||"unknown error")}</p>`}}async function Bn(e){let t=window.open("about:blank","_blank","noopener,noreferrer");try{let a=await c.proofAttachment(e),s=URL.createObjectURL(a);t?t.location.href=s:window.location.href=s,setTimeout(()=>URL.revokeObjectURL(s),6e4)}catch(a){t&&t.close(),l(a.message||"Could not open the proof attachment.","error")}}async function Ds(e,t,a,s,r){let n=s.textContent.startsWith("Approve")?"approve":"reject",i=n==="reject"?prompt("Rejection reason:"):prompt("Optional admin note:")||"";if(i!==null){if(n==="reject"&&!i.trim()){l("A rejection reason is required.","error");return}s.disabled=!0,r.disabled=!0;try{await c.adminReviewSubmission(e.id,{decision:n,note:i}),l(n==="approve"?"Submission approved for payment review.":"Submission rejected.","success"),await Os(t,a)}catch(o){s.disabled=!1,r.disabled=!1,l(o.message||"Could not review submission.","error")}}}function ma(e){e&&(e.disabled=!0,e.setAttribute("aria-busy","true"),e.innerHTML='<i class="bi bi-hourglass-split"></i> Activating...')}function Is(e){!e||!e.isConnected||(e.disabled=!1,e.removeAttribute("aria-busy"),e.innerHTML="Activate Job")}async function Dn(e,t){if(be.has(e)){ma(t);return}if(confirm("Approve and activate this job post?")){be.add(e),ma(t);try{await c.adminApproveJob(e),l("Job approved and activated!","success"),be.delete(e),await ie()}catch(a){be.delete(e),Is(t),l(a.message||"Could not approve job.","error")}finally{be.delete(e),Is(t)}}}async function In(e){let t=prompt("Reason for declining this job post:");if(t!==null)try{await c.adminDeclineJob(e,{reason:t}),l("Job declined.","info"),await ie()}catch(a){l(a.message||"Could not decline job.","error")}}async function Un(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await ie()}catch(t){l(t.message||"Could not flag job.","error")}}async function Us(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await ie()}catch(r){l(r.message||"Could not resolve dispute.","error")}}function Js(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Hn,I,be,qe=_(()=>{S();w();Hn=[{value:"pending_approval",label:"Job Post (Pending Approval)"},{value:"open",label:"Active Job"},{value:"all",label:"All Jobs"},{value:"in_review",label:"In Review"},{value:"assigned",label:"Assigned"},{value:"submitted",label:"Submitted"},{value:"revision",label:"Revision"},{value:"disputed",label:"Disputed"},{value:"completed",label:"Completed"},{value:"declined",label:"Declined"},{value:"cancelled",label:"Cancelled"},{value:"expired",label:"Expired"}],I="pending_approval",be=new Set});var Ws={};x(Ws,{AdminTransactionsPage:()=>va});function va(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Type
                    <select class="admin-select" id="admin-transaction-type">
                        ${On.map(t=>`<option value="${t}" ${t===ga?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All transactions"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{ga=t.target.value,await ba()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",ba),await ba()}}}async function ba(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminTransactions({type:ga})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(Jn(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${ee(t.message||"unknown error")}</p>`}}}function Jn(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${ee(e.type)}`,t.innerHTML=`
        ...
        <div class="admin-transaction-row__meta">
            ...
            <span><strong>Date:</strong> ${Wn(e.created_at)}</span>
        </div>
    ...
    `,t}function Wn(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function ee(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var On,ga,fa=_(()=>{S();w();On=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],ga=""});var Vs={};x(Vs,{AdminReportsPage:()=>ha});function ha(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#export-admin-report")?.addEventListener("click",Vn),await zn()}}}async function Vn(){try{let e=await c.adminReportsExport(),t=URL.createObjectURL(e),a=document.createElement("a");a.href=t,a.download="jmjob-report.csv",document.body.appendChild(a),a.click(),a.remove(),URL.revokeObjectURL(t)}catch(e){alert(e.message||"Could not export the report.")}}async function zn(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            <div class="stat-grid admin-report-summary">
                ${nt("Transactions",ge(s.transaction_count))}
                ${nt("Transaction volume",Ne(s.transaction_volume))}
                ${nt("Jobs",ge(s.job_count))}
                ${nt("Job value",Ne(s.job_value))}
            </div>
            <div class="admin-report-grid">
                <div class="card">
                    <h3 class="card__title">Transactions by type</h3>
                    <div class="admin-report-list">${Gn(a.transactions||[])}</div>
                </div>
                <div class="card">
                    <h3 class="card__title">Jobs by status</h3>
                    <div class="admin-report-list">${Xn(a.jobs||[])}</div>
                </div>
                <div class="card">
                    <h3 class="card__title">Assignments by payment state</h3>
                    <div class="admin-report-list">${Yn(a.assignments||[])}</div>
                </div>
                <div class="card">
                    <h3 class="card__title">Submissions by risk</h3>
                    <div class="admin-report-list">${Kn(a.submissions||[])}</div>
                </div>
            </div>
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${te(t.message||"unknown error")}</p>`}}function nt(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${te(e)}</span><strong>${te(t)}</strong></div>`}function Gn(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${te(String(t.type||"").replace("_"," "))}</strong><small>${ge(t.transaction_count)} entries</small></span>
            <strong>${Ne(t.amount)}</strong>
        </div>
    `).join(""):'<p class="muted">No transactions yet.</p>'}function Xn(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${te(String(t.status||"").replace("_"," "))}</strong><small>${ge(t.job_count)} jobs</small></span>
            <strong>${Ne(t.budget)}</strong>
        </div>
    `).join(""):'<p class="muted">No jobs yet.</p>'}function Yn(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
    ...
    `).join(""):'<p class="muted">No assignments yet.</p>'}function Kn(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
    ...
    `).join(""):'<p class="muted">No submissions yet.</p>'}function ge(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Ne(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function te(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ya=_(()=>{S();w()});var zs={};x(zs,{LoginPage:()=>wa});function wa(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
    ...
    `;let t=document.getElementById("forgot-form"),a=document.getElementById("submit-btn");t.addEventListener("submit",async s=>{s.preventDefault();let r=t.email.value.trim();if(!r){l("Please enter your email address.","error");return}a.disabled=!0,a.textContent="Sending...";try{await c.forgotPassword({email:r}),l("If an account exists with this email, you will receive a reset code.","success"),f(`/reset-password?email=${encodeURIComponent(r)}`)}catch(n){l(n.message||"Failed to send reset code.","error"),a.disabled=!1,a.textContent="Send Reset Code"}})}var xa=_(()=>{S();w()});var Ks={};x(Ks,{default:()=>ot});async function ot(){let e=document.querySelector("[data-view]");if(!e)return;let a=(new URLSearchParams(window.location.hash.split("?")[1]).get("email")||"").trim().toLowerCase();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--auth",e.innerHTML=`
        <div class="auth-card">
            ...
            <form class="auth-form" id="reset-form">
                <label class="auth-form__label">
                    Email Address
                    <input type="email" name="email" value="${Qn(a)}" placeholder="you@example.com" required autocomplete="email">
                </label>
    ...
    `;let s=document.getElementById("reset-form"),r=document.getElementById("submit-btn");s.addEventListener("submit",async n=>{n.preventDefault();let i=s.email.value.trim(),o=s.otp.value.trim(),d=s.password.value,p=s.password_confirmation.value;if(!i||!o||!d){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(d!==p){l("Passwords do not match.","error");return}if(d.length<6){l("Password must be at least 6 characters.","error");return}r.disabled=!0,r.textContent="Resetting...";try{await c.resetPassword({email:i,otp:o,password:d,password_confirmation:p}),l("Password reset successfully! You can now log in.","success"),f("/login")}catch(u){l(u.message||"Failed to reset password.","error"),r.disabled=!1,r.textContent="Reset Password"}})}function Qn(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Ta=_(()=>{S();w()});var Tr={};x(Tr,{JobDetailPage:()=>mo});function po(e){return typeof e=="object"?String(e?.type||"text").toLowerCase():String(e||"text").toLowerCase()}function xr(e){return co.has(po(e))}function uo(e){return(typeof e=="object"?e?.title:"")||(xr(e)?"Screenshot / image / PDF / DOC / DOCX":"Written report")}function mo(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=g.get();t.innerHTML=`
        ...
        `;try{let s=await c.job(e),{job:r,bids:n,bid_count:i,my_bid:o,my_submission:d}=s.data;bo(r,n,i,o,d,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${H(s.message||"unknown")}</p>`}}}function bo(e,t,a,s,r,n){let i=document.getElementById("job-detail-content");if(!i)return;let o=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,d=o?Math.max(0,Math.floor((o-Date.now())/1e3)):null,p=d!=null?yo(d):"\u2014",u=["open","in_review"].includes(e.status),b=!!n&&!n.is_admin,y=!!n&&Number(e.poster?.id||0)===Number(n.id),h=b&&(!!e.assignment_id||Number(e.assigned_worker_id||0)===Number(n.id)),k=h&&e.assignment_status?e.assignment_status:e.status;i.innerHTML=`
        <div class="card job-detail__card">
            ...
            <div class="job-detail__body">
                ...
                ${Array.isArray(e.proof_requirements)&&e.proof_requirements.length?`<h3>Proof required</h3><ul>${e.proof_requirements.map(F=>`<li>${H(uo(F))}</li>`).join("")}</ul>`:""}
                <h3>Posted by</h3>
        ...
        ${go(e,r,h)}
        ${h?"":fo(e,t,s,n,u,y)}
    `,ho(e,s,n),vo(e)}function go(e,t,a){if(!a)return"";let s=e.assignment_status||e.status,r=t?.status||s;if(t&&(t.status==="pending_review"||s==="submitted"))return`
            <div class="card">
        ...
        `;if(!["assigned","in_progress","revision"].includes(s))return`<div class="card"><p class="muted">This assignment is ${H(String(s).replace("_"," "))}.</p></div>`;let i=Array.isArray(e.proof_requirements)&&e.proof_requirements.some(xr),o=t?.reviewer_note||t?.rejection_reason;return`
        <div class="card">
                    ...
                    ${t.map(i=>`
                        <div class="bid-row">
                            <div>
                                ...
                                <div class="muted">${H(i.proposal).slice(0,100)}${i.proposal.length>100?"\u2026":""}</div>
                            </div>
    ...
    `:'<div class="card"><p class="muted">Please log in to place a bid.</p></div>':'<div class="card"><p class="muted">Bidding is closed for this job.</p></div>'}function ho(e,t,a){if(t){let r=document.getElementById("withdraw-bid-btn");r&&r.addEventListener("click",async()=>{if(confirm("Withdraw your bid?"))try{await c.withdrawBid(t.id),l("Bid withdrawn.","success"),f(`/jobs/${e.id}`)}catch(n){l(n.message||"Failed to withdraw.","error")}});return}let s=document.getElementById("bid-form");s&&s.addEventListener("submit",async r=>{r.preventDefault();let n=new FormData(s),i=document.getElementById("bid-submit-btn");i.disabled=!0,i.textContent="Submitting\u2026";try{await c.placeBid(e.id,{amount:parseFloat(n.get("amount")),delivery_days:parseInt(n.get("delivery_days"),10),proposal:String(n.get("proposal")||"").trim()}),l("Bid placed!","success"),f(`/jobs/${e.id}`)}catch(o){l(o.message||"Failed to place bid.","error")}finally{i.disabled=!1,i.textContent="Submit Bid"}})}function yo(e){if(e<=0)return"expired";let t=Math.floor(e/86400),a=Math.floor(e%86400/3600);if(t>0)return`${t}d ${a}h`;let s=Math.floor(e%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function H(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var co,Lr=_(()=>{S();w();co=new Set(["screenshot","file","attachment","image","document"])});var Er={};x(Er,{PosterJobDetailPage:()=>wo});function wo(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.innerHTML="",t.className="view view--poster-job-detail",!Eo()){t.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}t.innerHTML='<a href="#/poster/jobs" class="back-link"><i class="bi bi-arrow-left"></i> My jobs</a><div id="poster-job-detail-content"><div class="spinner"></div></div>',await Ar(e)}}}async function Ar(e){let t=document.getElementById("poster-job-detail-content");if(t)try{let s=(await c.posterJobBids(e)).data||{};_o(t,s.job||{},s.bids||[],s.submissions||[])}catch(a){t.innerHTML=`<p class="muted">Failed to load job: ${P(a.message||"unknown error")}</p>`}}function _o(e,t,a,s){e.innerHTML=`
        <div class="card poster-detail-card">
            <div class="poster-detail-card__header"><div><h1 class="page-title">${P(t.title)}</h1><p class="muted">${P(t.description||"")}</p></div><span class="badge badge--status badge--${P(t.status)}">${P(qo(t.status).toUpperCase())}</span></div>
        ...
        <div class="poster-detail-grid">
            <div class="card"><div class="card__header"><div><h2 class="card__title">Bid comparison</h2><p class="muted">Choose one pending proposal to assign the job.</p></div></div><div class="poster-bid-list">${$o(t,a)}</div></div>
            <div class="card"><div class="card__header"><div><h2 class="card__title">Submission review</h2><p class="muted">Approve delivery to release payment or request changes.</p></div></div><div class="poster-submission-list">${So(t,s)}</div></div>
        </div>
    ...
    `,e.querySelectorAll("[data-accept-bid]").forEach(r=>r.addEventListener("click",()=>To(t.id,r.dataset.acceptBid))),e.querySelectorAll("[data-release-submission]").forEach(r=>r.addEventListener("click",()=>Lo(t.id,r.dataset.releaseSubmission))),e.querySelectorAll("[data-revision-submission]").forEach(r=>r.addEventListener("click",()=>Ao(t.id,r.dataset.revisionSubmission))),e.querySelectorAll("[data-proof-attachment]").forEach(r=>r.addEventListener("click",()=>xo(r.dataset.proofAttachment))),e.querySelector("#poster-detail-cancel")?.addEventListener("click",()=>Co(t.id))}function $o(e,t){return t.length?t.map(a=>`
        <div class="poster-bid-row poster-bid-row--${P(a.status)}"><div class="poster-bid-row__main"><strong>${P(a.worker?.name||"Worker")}</strong><span class="muted">${P(a.worker?.email||"")} \xB7 Rating ${Number(a.worker?.rating||0).toFixed(2)}</span><p>${P(a.proposal||"")}</p></div><div class="poster-bid-row__offer"><strong>\u09F3${Number(a.amount||0).toFixed(2)}</strong><span>${Number(a.delivery_days||0)} days</span><span class="badge">${P(String(a.status||"").toUpperCase())}</span>${a.status==="pending"&&["open","in_review"].includes(e.status)?`<button class="btn btn--primary btn--sm" data-accept-bid="${Number(a.id)}">Select worker</button>`:""}</div></div>
    `).join(""):'<p class="muted">No bids yet.</p>'}function So(e,t){return t.length?t.map(a=>`
        <div class="poster-submission-row poster-submission-row--${P(a.status)}"><div><strong>${P(a.worker?.name||"Worker")}</strong><span class="muted">Submitted ${Cr(a.created_at)} \xB7 ${P(String(a.status||"").replace("_"," "))}</span><p>${P(a.description||"")}</p>${a.external_link?`<a href="${P(a.external_link)}" target="_blank" rel="noopener noreferrer">Open delivery link</a>`:""}${ko(a)}${a.reviewer_note?`<p class="muted"><strong>Revision note:</strong> ${P(a.reviewer_note)}</p>`:""}</div>${a.status==="pending_review"&&["submitted","revision"].includes(e.status)?`<div class="poster-submission-row__actions"><button class="btn btn--success btn--sm" data-release-submission="${Number(a.id)}">Release payment</button><button class="btn btn--ghost btn--sm" data-revision-submission="${Number(a.id)}">Request revision</button></div>`:""}</div>
    `).join(""):'<p class="muted">No work submitted yet.</p>'}function ko(e){if(!e.attachment_url)return"";let t=String(e.attachment_path||""),a=/\.(jpg|jpeg|png|gif|webp)$/i.test(t),s=a?"View screenshot":"Open proof attachment";return`<div class="poster-proof-attachment"><i class="bi ${a?"bi-image":"bi-file-earmark-text"}"></i> <button type="button" class="btn btn--ghost btn--sm" data-proof-attachment="${Number(e.id)}">${s}</button></div>`}async function xo(e){let t=window.open("about:blank","_blank","noopener,noreferrer");try{let a=await c.proofAttachment(e),s=URL.createObjectURL(a);t?t.location.href=s:window.location.href=s,setTimeout(()=>URL.revokeObjectURL(s),6e4)}catch(a){t&&t.close(),l(a.message||"Could not open the proof attachment.","error")}}async function To(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await c.posterAcceptBid(e,t),l("Worker selected and escrow held.","success"),await Ra(e)}catch(a){l(a.message||"Could not select worker.","error")}}async function Lo(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await c.posterReleasePayment(e,{submission_id:Number(t)}),l("Payment released.","success"),await Ra(e)}catch(a){l(a.message||"Could not release payment.","error")}}async function Ao(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await c.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),l("Revision requested.","success"),await Ra(e)}catch(s){l(s.message||"Could not request revision.","error")}}async function Co(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await c.posterCancelJob(e,{reason:"Cancelled by poster"}),l("Job cancelled.","success"),f("/poster/jobs")}catch(t){l(t.message||"Could not cancel job.","error")}}async function Ra(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await Ar(e))}function Eo(){return!!g.get()}function qo(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function Cr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function P(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var qr=_(()=>{S();w()});U();w();U();w();var dt=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(At(),as))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Oe(),Ct))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Oe(),Ct))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(qt(),rs))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(jt(),is))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Mt(),os))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ht(),cs))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ve(),Bt))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Dt(),ps))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(It(),us))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ut(),ms))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Vt(),_s))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Gt(),Ss))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ve(),Bt))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Xt(),ks))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Zt(),Ls))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ta(),Es))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(sa(),Ns))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ia(),js))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(la(),Rs))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ua(),Bs))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(qe(),rt))},{path:"/admin/pending-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(qe(),rt))},{path:"/admin/active-jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(qe(),rt))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(fa(),Ws))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(ya(),Vs))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(_a(),zs))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ka(),Xs))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(xa(),Ys))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(Ta(),Ks))}],jl=E(()=>{let e=N.get().split("?")[0]||"/";return dt.find(t=>t.path===e)||dt[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";N.set(e)});U();w();U();var ei=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],ti=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/admin-job-post",label:"Admin Job Post",icon:"bi-plus-square"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/advertisement",label:"Advertisement",icon:"bi-megaphone"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],ai=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function si(){let e=g.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...ti];let t=[...ei];return e&&!e.is_admin&&t.push({separator:!0},...ai),t}var Zs="sidebar_collapsed",ve=B(localStorage.getItem(Zs)==="true");function ri(){let e=!ve.get();ve.set(e),localStorage.setItem(Zs,String(e))}function Qs(){let e=()=>N.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${ve.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[ni(),ii(),oi()]}}function ni(){let e=()=>N.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function ii(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>ri(),title:()=>ve.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${ve.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function oi(){return{tag:"nav",props:{class:"sidebar__nav"},children:si().map(e=>e.header?di(e.header):e.separator?li():ci(e))}}function di(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function li(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function ci({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${N.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>ve.get()?t:"",onclick:r=>{r.preventDefault(),f(e),tr()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function er(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>tr()},children:[]}}function tr(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}w();U();w();var pi=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-briefcase-fill"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/worker/bids",label:"My Submissions",icon:"bi-clipboard-check"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],ui=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/admin-job-post",label:"Admin Job Post",icon:"bi-plus-square"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/advertisement",label:"Advertisement",icon:"bi-megaphone"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],mi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function bi(){let e=g.get();if(e&&e.is_admin)return ui;let t=[...pi];return e&&!e.is_admin&&t.push({separator:!0},...mi),t}function gi({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${N.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:r=>{r.preventDefault(),f(e),La()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function vi(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>La()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function fi(){return{tag:"nav",props:{class:"mobile-nav__list"},children:bi().map(e=>e.separator?hi():gi(e))}}function hi(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function ar(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[vi(),fi()]}}function sr(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>La()},children:[]}}function rr(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function La(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}Wt();S();function nr(){return z(()=>q.get(),()=>xi(),()=>ki())}function ir(){let e=()=>{let t=O.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>gs(),"data-theme":()=>O.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function or(){let e=!!g.get()?.is_admin;return{isAdmin:e,route:e?"/admin/active-jobs":"/worker/active-jobs",load:e?()=>c.adminJobs("open"):()=>c.workerActiveJobs()}}function yi(){let e=document.getElementById("topbar-active-jobs-panel");if(!e)return;let t=e.classList.contains("topbar-active-jobs--open");document.querySelectorAll(".topbar-active-jobs--open").forEach(a=>a.classList.remove("topbar-active-jobs--open")),t||(e.innerHTML.trim()||(e.innerHTML=_i(or()),e.querySelector("[data-active-jobs-close]")?.addEventListener("click",()=>e.classList.remove("topbar-active-jobs--open"))),e.classList.add("topbar-active-jobs--open"),setTimeout($i,0))}function wi(){return{tag:"div",props:{class:"topbar__active-jobs-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__active-jobs","aria-label":"Active Jobs",title:"Active Jobs",onclick:e=>{e.stopPropagation(),yi()}},children:[{tag:"i",props:{class:"bi bi-briefcase-fill"},children:[]},{tag:"span",props:{class:"topbar__active-jobs-badge",id:"topbar-active-jobs-count","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-active-jobs",id:"topbar-active-jobs-panel"},children:[]}]}}function _i(e){return`<div class="topbar-active-jobs__header"><strong>Active Jobs</strong><button type="button" class="topbar-active-jobs__close" data-active-jobs-close aria-label="Close Active Jobs"><i class="bi bi-x-lg"></i></button></div><ul class="topbar-active-jobs__list" id="topbar-active-jobs-list"><li class="topbar-active-job"><i class="bi bi-hourglass-split topbar-active-job__icon"></i><div class="topbar-active-job__body"><div class="topbar-active-job__title">Loading active jobs\u2026</div><div class="topbar-active-job__text">Your active job list will appear here.</div></div></li></ul><div class="topbar-active-jobs__footer"><a href="#${e.route}" class="topbar-active-jobs__link">View all active jobs</a></div>`}async function $i(){let e=document.getElementById("topbar-active-jobs-list"),t=document.getElementById("topbar-active-jobs-count");if(!(!e||!t))try{let a=or(),s=await a.load(),r=Array.isArray(s.data)?s.data:[];t.textContent=r.length>99?"99+":String(r.length),e.innerHTML=r.length?r.slice(0,5).map(n=>Si(n,a)).join(""):'<li class="topbar-active-jobs__empty">No active jobs right now.</li>'}catch{e.innerHTML='<li class="topbar-active-jobs__empty">Active Jobs are unavailable right now.</li>',t.textContent="0"}}function Si(e,t){let a=Aa(e.title||"Untitled job"),s=Aa(String(e.subtitle||e.description||"").trim().slice(0,90)),r=Aa(String(e.worker_state||e.assignment_status||e.status||"active").replace(/_/g," ")),n=t.isAdmin?`#${t.route}`:`#/jobs/${encodeURIComponent(e.id)}`;return`<li class="topbar-active-job"><i class="bi bi-briefcase topbar-active-job__icon"></i><div class="topbar-active-job__body"><div class="topbar-active-job__title">${a}</div><div class="topbar-active-job__text">${s||"Active job"} \xB7 ${r}</div><a class="topbar-active-job__action" href="${n}">Open</a></div></li>`}function Aa(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-active-jobs-panel");t&&t.classList.contains("topbar-active-jobs--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__active-jobs")&&t.classList.remove("topbar-active-jobs--open")});function ki(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[ir(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function xi(){let e=g.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>rr(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[ir(),wi(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await Ie(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}w();U();function dr(){return z(()=>!!_e.get(),()=>{let e=_e.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}S();function lr(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{c.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let r=[];a.facebook&&r.push(`<a href="${lt(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&r.push(`<a href="${lt(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&r.push(`<a href="${lt(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&r.push(`<a href="${lt(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=r.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function lt(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}w();var Ti=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/poster/post-job",label:"Post Job",icon:"bi-plus-square-fill"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],Li=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/pending-jobs",label:"Job Post",icon:"bi-file-earmark-plus"},{path:"/admin/admin-job-post",label:"Admin Job Post",icon:"bi-plus-square"},{path:"/admin/active-jobs",label:"Active Job",icon:"bi-lightning-charge"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/advertisement",label:"Advertisement",icon:"bi-megaphone"}];function Ai(){let e=g.get();return e&&e.is_admin?Li:Ti}function Ci({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${N.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:r=>{r.preventDefault(),f(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function Ei(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function qi(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:Ai().map(e=>e.separator?Ei():Ci(e))}}function Ca(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&Ca()},!0),window.addEventListener("resize",()=>setTimeout(Ca,50)),document.addEventListener("hnav:rendered",()=>setTimeout(Ca,0)));function cr(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[qi()]}}function pr(){let e=()=>!!g.get()?.is_admin,t=()=>N.get().startsWith("/admin"),a=()=>q.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[z(()=>q.get(),()=>Qs(),()=>null),z(()=>q.get(),()=>er(),()=>null),z(()=>q.get(),()=>ar(),()=>null),z(()=>q.get(),()=>sr(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[nr(),z(()=>q.get()&&!e(),()=>cr(),()=>null),{tag:"main",props:{class:"app-main"},children:[Ni()]},lr()]},dr()]}}function Ni(){let t=N.get().split("?")[0]||"/",a=dt.find(r=>r.path===t),s=g.get();return s&&s.is_admin&&!t.startsWith("/admin")?(f("/admin"),Ea()):a?a.requireAuth&&!q.get()?(f("/login"),Ea()):a.requireAdmin&&(!g.get()||!g.get().is_admin)?Mi():!a.requireAuth&&q.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(f("/"),Ea()):ji(a):Pi()}function ji(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function Pi(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function Mi(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>f("/")},children:["Go home"]}]}}function Ea(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}U();w();At();_a();ka();xa();Ta();jt();Oe();qt();Xt();Mt();Ve();la();ua();Ht();Dt();It();Ut();Vt();S();w();var v={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function mr(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
        ...
        `,v.categories.length===0)try{let t=await c.categories();v.categories=Array.isArray(t.data)?t.data:[];let a=document.getElementById("jobs-category");a&&(a.innerHTML=ur())}catch{}document.getElementById("jobs-apply")?.addEventListener("click",()=>{Ri(),v.page=1,ct()}),document.getElementById("jobs-reset")?.addEventListener("click",()=>{v.search="",v.categoryId="",v.minBudget="",v.maxBudget="",v.sort="latest",v.page=1,Hi(),ct()}),document.getElementById("jobs-search")?.addEventListener("keydown",t=>{t.key==="Enter"&&document.getElementById("jobs-apply")?.click()}),await ct()}}}function ur(){return'<option value="">All categories</option>'+v.categories.map(e=>`<option value="${V(e.id)}" ${String(e.id)===String(v.categoryId)?"selected":""}>${V(e.name)}</option>`).join("")}function Ri(){v.search=document.getElementById("jobs-search")?.value.trim()||"",v.categoryId=document.getElementById("jobs-category")?.value||"",v.minBudget=document.getElementById("jobs-min-budget")?.value.trim()||"",v.maxBudget=document.getElementById("jobs-max-budget")?.value.trim()||"",v.sort=document.getElementById("jobs-sort")?.value||"latest"}function Hi(){let e={"jobs-search":v.search,"jobs-category":v.categoryId,"jobs-min-budget":v.minBudget,"jobs-max-budget":v.maxBudget,"jobs-sort":v.sort};Object.entries(e).forEach(([t,a])=>{let s=document.getElementById(t);s&&(s.value=a)})}async function ct(){let e=document.getElementById("jobs-grid");if(!e)return;let t=++v.requestSerial;v.loading=!0,e.innerHTML='<div class="spinner"></div>';try{let a={page:v.page,per_page:v.perPage,sort:v.sort};v.search&&(a.search=v.search),v.categoryId&&(a.category_id=v.categoryId),v.minBudget!==""&&(a.min_budget=v.minBudget),v.maxBudget!==""&&(a.max_budget=v.maxBudget);let s=await c.jobs(a);if(t!==v.requestSerial)return;v.jobs=Array.isArray(s.data)?s.data:[],v.total=Number(s.meta?.total||0),v.lastPage=Math.max(1,Number(s.meta?.last_page||1)),Fi()}catch(a){if(t!==v.requestSerial)return;e.innerHTML=`<p class="muted">Failed to load jobs: ${V(a.message||"unknown error")}</p>`,br(),gr()}finally{t===v.requestSerial&&(v.loading=!1)}}function Fi(){let e=document.getElementById("jobs-grid");if(e){if(br(),gr(),v.jobs.length===0){e.innerHTML='<p class="muted">No jobs match your filters. Try clearing them.</p>';return}e.innerHTML=v.jobs.map(t=>`
        <a class="job-card" href="#/jobs/${encodeURIComponent(t.id)}" data-id="${V(t.id)}">
            <div class="job-card__head">
                ${t.category&&t.category.icon_class?`<i class="bi ${Bi(t.category.icon_class)} job-card__cat-icon"></i>`:""}
            ...
            <p class="job-card__desc">${V(Di(t.description,140))}</p>
    ...
    `).join(""),e.querySelectorAll("a.job-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function br(){let e=document.getElementById("jobs-results-meta");if(!e)return;if(v.total===0){e.textContent="No open jobs found";return}let t=(v.page-1)*v.perPage+1,a=Math.min(v.page*v.perPage,v.total);e.textContent=`Showing ${t}-${a} of ${v.total} open jobs`}function gr(){let e=document.getElementById("jobs-pagination");if(e){if(v.lastPage<=1){e.innerHTML="";return}e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>v.lastPage||a===v.page||(v.page=a,ct())})})}}function Bi(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function Di(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function V(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var qa={bids:[],loading:!1};function vr(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await c.workerBids();qa.bids=t.data||[],Ii()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${fr(t.message||"unknown")}</p>`}}}}function Ii(){let e=document.getElementById("bids-list");if(e){if(qa.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=qa.bids.map(t=>`
        <a class="bid-row-card" href="#/jobs/${t.job_id}" data-id="${t.job_id}">
            <div class="bid-row-card__main">
                <div class="bid-row-card__title">${fr(t.job?.title||"Job")}</div>
                <div class="bid-row-card__meta">
                    ...
                    <span class="muted">${Ui(t.created_at)}</span>
                </div>
            </div>
            <span class="badge badge--status badge--${t.status}">${t.status.toUpperCase()}</span>
        </a>
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),f(`/jobs/${t.getAttribute("data-id")}`)})})}}function Ui(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function fr(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var fe={jobs:[],submissions:[],loading:!1};function Na(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);fe.jobs=t.data||[],fe.submissions=a.data||[],Oi()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${he(t.message||"unknown")}</p>`}}}}function Oi(){let e=document.getElementById("active-jobs-list");if(e){if(fe.jobs.length===0){e.innerHTML='<p class="muted">No activated or assigned jobs are available right now. New jobs appear here after admin activation.</p>';return}e.innerHTML=fe.jobs.map(t=>{let a=t.assignment_id?fe.submissions.find(i=>Number(i.assignment_id)===Number(t.assignment_id)):fe.submissions.find(i=>i.job_id===t.id),s=t.worker_state==="available"?"available":t.assignment_status||t.status,r=String(t.description||"").trim(),n=Number(t.remaining_workers??t.remaining_tasks_count??0);return`
            <div class="active-job-card" data-id="${t.id}">
                <div class="active-job-card__head">
                    <div>
                        <h3>${he(t.title)}</h3>
                       ${t.subtitle?`<div class="muted">${he(t.subtitle)}</div>`:""}
                        ${r?`<p class="muted">${he(r.slice(0,180))}${r.length>180?"\u2026":""}</p>`:""}
                        <div class="muted">Pay: \u09F3${parseFloat(t.cost_per_worker||t.budget||0).toFixed(2)} \xB7 Available slots: ${n} \xB7 Deadline: ${he(t.deadline_at||"None")}</div>
                    </div>
        ...
        `}).join(""),Wi()}}function Ji(e){return`
        <div class="active-job-card__sub">
            <strong>Submitted:</strong> ${Vi(e.created_at)}
            <div class="muted">${he((e.description||"").slice(0,200))}${(e.description||"").length>200?"\u2026":""}</div>
    ...
    `}function Wi(){document.querySelectorAll("[data-cancel-assignment]").forEach(e=>{e.addEventListener("click",async()=>{let t=prompt("Why do you need to cancel this assignment?");if(!(!t||!t.trim())){e.disabled=!0;try{await c.workerCancelAssignment(e.dataset.cancelAssignment,{reason:t.trim()}),l("Assignment cancelled and returned for reassignment.","success"),Na()()}catch(a){l(a.message||"Could not cancel assignment.","error"),e.disabled=!1}}})})}function Vi(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function he(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var j={activeTab:"categories",categories:[],subcategories:[],loading:!1};function hr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="tabs" style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                <button class="btn ${j.activeTab==="categories"?"btn--primary":"btn--ghost"}" id="tab-cats-btn">Main Categories</button>
                <button class="btn ${j.activeTab==="subcategories"?"btn--primary":"btn--ghost"}" id="tab-subcats-btn">Subcategories</button>
            </div>

            <div id="tab-content">
                <div class="card" id="cat-list"><div class="spinner"></div></div>
            </div>
        `,e.querySelector("#tab-cats-btn").addEventListener("click",()=>{j.activeTab="categories",ja(e)}),e.querySelector("#tab-subcats-btn").addEventListener("click",()=>{j.activeTab="subcategories",ja(e)}),await se(e)}}async function se(e){try{let[t,a]=await Promise.all([c.adminCategories(),c.adminSubcategories()]);j.categories=t.data||[],j.subcategories=a.data||[],ja(e)}catch(t){l(t.message||"Failed to load category data.","error")}}function ja(e){let t=e.querySelector("#tab-cats-btn"),a=e.querySelector("#tab-subcats-btn"),s=e.querySelector("#tab-content");s&&(j.activeTab==="categories"?(t&&(t.className="btn btn--primary"),a&&(a.className="btn btn--ghost"),zi(s,e)):(t&&(t.className="btn btn--ghost"),a&&(a.className="btn btn--primary"),Gi(s,e)))}function zi(e,t){e.innerHTML=`
    ...
    `,e.querySelectorAll(".edit-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),n=j.subcategories.find(d=>String(d.id)===String(r));if(!n)return;let i=prompt(`Update Min Cost (\u09F3) for Subcategory "${n.name}":`,String(n.min_cost||1));if(i===null)return;let o=parseFloat(i);if(isNaN(o)||o<0){l("Please enter a valid positive cost amount.","error");return}try{await c.adminUpdateSubcategory(r,{min_cost:o}),l(`Min cost updated for ${n.name}.`,"success"),await se(t)}catch(d){l(d.message,"error")}})}),e.querySelectorAll(".toggle-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id"),n=j.subcategories.find(i=>String(i.id)===String(r));if(n)try{await c.adminUpdateSubcategory(r,{is_active:!n.is_active}),l("Subcategory updated.","success"),await se(t)}catch(i){l(i.message,"error")}})}),e.querySelectorAll(".del-subcat-btn").forEach(s=>{s.addEventListener("click",async()=>{let r=s.getAttribute("data-id");if(confirm("Delete subcategory?"))try{let n=await c.adminDeleteSubcategory(r);l(n.message||"Deleted.","success"),await se(t)}catch(n){l(n.message,"error")}})});let a=e.querySelector("#add-subcat-form");a.addEventListener("submit",async s=>{s.preventDefault();let r=new FormData(a),n={category_id:parseInt(r.get("category_id")||"0",10),name:String(r.get("name")||"").trim(),slug:String(r.get("slug")||"").trim().toLowerCase(),min_cost:parseFloat(r.get("min_cost")||"1.00"),display_order:parseInt(r.get("display_order")||"0",10),is_active:r.get("is_active")==="on"};try{await c.adminCreateSubcategory(n),l("Subcategory created.","success"),await se(t)}catch(i){l(i.message,"error")}})}function ae(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();var re={grouped:{},social:{},noticesData:{interval:4,notices:[]},loading:!1},Xi={advertisement_system_enabled:"Advertisement System",video_ads_enabled:"Video Ads",watch_earn_enabled:"User Watch & Earn",reward_system_enabled:"Reward System",ad_network_enabled:"External Ad Network",website_ads_enabled:"Website Ads",app_ads_enabled:"Android App Ads",ad_frequency_seconds:"Ad Frequency (seconds)",fraud_min_description_chars:"Fraud: Minimum Description Characters",fraud_daily_submission_velocity_limit:"Fraud: Daily Submission Limit",fraud_shared_identity_worker_threshold:"Fraud: Shared Identity Threshold",fraud_review_threshold:"Fraud: Review Score Threshold",fraud_ban_requires_confirmation:"Fraud: Require Explicit Ban Confirmation",registration_otp_enabled:"Registration OTP Verification"};function yr(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=g.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await wr()}}async function wr(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a,s]=await Promise.all([c.adminSettings(),c.socialLinks(),c.notices()]);re.grouped=t.data||{},re.social=a||{},re.noticesData=s||{interval:4,notices:[]},Yi()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${R(t.message||"unknown")}</p>`}}}function Yi(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(re.grouped).map(i=>`
        ...
        <div class="card settings-group" style="margin-top:20px;">
            ...
            <div class="settings-group__rows">
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-facebook" value="${R(n.facebook||"")}" placeholder="https://facebook.com/yourpage" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-instagram" value="${R(n.instagram||"")}" placeholder="https://instagram.com/yourprofile" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-whatsapp" value="${R(n.whatsapp||"")}" placeholder="https://wa.me/1234567890" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-telegram" value="${R(n.telegram||"")}" placeholder="https://t.me/yourchannel" class="settings-row__input">
                    </div>
                </div>
            </div>
        </div>
    ...
    `,e.innerHTML=a,document.getElementById("settings-save-btn").addEventListener("click",Qi),document.getElementById("add-notice-btn").addEventListener("click",Ki),Pa()}function _r(e,t={image:"",text:""}){let a=typeof t=="string"?t.startsWith("/")||t.startsWith("http")?t:"":t?.image||"",s=typeof t=="string"?!t.startsWith("/")&&!t.startsWith("http")?t:"":t?.text||"",r="";return a?r=`<div class="banner-preview"><img src="${R(a)}" alt="Banner preview"></div>`:s?r=`<div class="banner-preview banner-preview--text"><strong>Text Notice:</strong> <span>${R(s)}</span></div>`:r='<div class="banner-preview banner-preview--empty"><i class="bi bi-image muted"></i> No image uploaded</div>',`
    ...
    `}function Ki(){let e=document.getElementById("notice-messages-container");if(!e)return;let t=e.querySelectorAll(".banner-message-row").length+1,a=document.createElement("div");a.innerHTML=_r(t,{image:""});let s=a.firstElementChild;e.appendChild(s),Pa()}function Pa(){let e=document.getElementById("notice-messages-container");if(!e)return;e.querySelectorAll(".banner-message-row").forEach((a,s)=>{let r=a.querySelector(".banner-message-num");r&&(r.textContent=`Banner ${s+1}`);let n=a.querySelector(".banner-file-input"),i=a.querySelector(".notice-msg-image"),o=a.querySelector(".banner-preview"),d=a.querySelector(".banner-upload-status"),p=a.querySelector(".banner-upload-btn");n&&!n.dataset.wired&&(n.dataset.wired="true",n.addEventListener("change",async b=>{let y=b.target.files[0];if(y){d&&(d.textContent="Uploading\u2026");try{let h=new FormData;h.append("image",y);let k=await c.adminUploadBannerImage(h);k&&k.url&&(i.value=k.url,o.className="banner-preview",o.innerHTML=`<img src="${R(k.url)}" alt="Banner preview">`,d&&(d.textContent="Uploaded!"))}catch(h){d&&(d.textContent=h.message||"Upload failed."),l(h.message||"Failed to upload image.","error")}}}));let u=a.querySelector(".remove-notice-btn");u&&(u.onclick=()=>{a.remove(),Pa()})})}function Zi(e,t){let a=`set-${t.key.replace(/[^a-z0-9]/gi,"_")}`,s=Xi[t.key]||t.key,r;switch(t.value_type){case"boolean":r=`<label class="settings-row__check"><input type="checkbox" id="${a}" ${t.value?"checked":""}></label>`;break;case"integer":case"percent":r=`<input type="number" step="1" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"decimal":r=`<input type="number" step="0.0001" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"json":r=`<textarea id="${a}" rows="3" class="settings-row__input">${R(JSON.stringify(t.value,null,2)||"")}</textarea>`;break;default:r=`<input type="text" id="${a}" value="${R(String(t.value))}" class="settings-row__input">`}return`
        <div class="settings-row">
    ...
    `}async function Qi(){let e={};for(let i of Object.keys(re.grouped))for(let o of re.grouped[i]){let d=`set-${o.key.replace(/[^a-z0-9]/gi,"_")}`,p=document.getElementById(d);if(!p)continue;let u;o.value_type==="boolean"?u=p.checked:o.value_type==="integer"||o.value_type==="percent"?u=parseInt(p.value,10):o.value_type==="decimal"?u=parseFloat(p.value):o.value_type==="json"?u=p.value?JSON.parse(p.value):null:u=p.value,e[o.key]=u}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},s=Array.from(document.querySelectorAll(".banner-message-row")).map(i=>({image:i.querySelector(".notice-msg-image")?.value.trim()||""})).filter(i=>i.image!==""),r={interval:document.getElementById("notice-interval")?.value||4,direction:document.getElementById("notice-direction")?.value||"right_to_left",notices:s},n=document.getElementById("settings-save-btn");n.disabled=!0,n.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t),c.adminUpdateNotices(r)]),l("Settings, notices, and social links saved successfully.","success"),await wr()}catch(i){l(i.message||"Failed to save.","error")}finally{n.disabled=!1,n.textContent="Save All Changes"}}function R(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}qe();S();w();function $r(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;if(e.className="view view--admin-job-post",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p></div>';return}let t=new URLSearchParams(window.location.hash.split("?")[1]||""),a=Number(t.get("edit")||0);e.innerHTML='<div class="card"><p class="muted">Loading job form\u2026</p></div>';try{let s=await c.categories(),r=a?(await c.adminJobDetail(a)).data:null;eo(e,s.data||[],r?.job||null,a)}catch(s){e.innerHTML=`<div class="card"><p class="muted">Could not load job form: ${X(s.message||"unknown error")}</p></div>`}}}function eo(e,t,a,s){let r=a?.proof_requirements||[],n=r.some(o=>o.type==="screenshot"),i=r.some(o=>o.type==="text");e.innerHTML=`
        ...
        <form class="card admin-job-form" id="admin-job-form">
            ...
            <label>Deadline <input name="deadline_at" type="datetime-local" value="${to(a?.deadline_at)}"></label>
    ...
    `,e.querySelector("#admin-job-cancel").addEventListener("click",()=>f("/admin/jobs")),e.querySelector("#admin-job-form").addEventListener("submit",async o=>{o.preventDefault();let d=o.currentTarget,p=new FormData(d),u=[];p.get("requires_screenshot")&&u.push({title:"Screenshot proof",type:"screenshot"}),p.get("requires_written")&&u.push({title:"Written report",type:"text"});let b={category_id:Number(p.get("category_id")),title:String(p.get("title")||"").trim(),subtitle:String(p.get("subtitle")||"").trim(),customer_name:String(p.get("customer_name")||"").trim(),customer_phone:String(p.get("customer_phone")||"").trim(),customer_email:String(p.get("customer_email")||"").trim(),description:String(p.get("description")||"").trim(),requirements:String(p.get("requirements")||"").trim(),worker_count:Number(p.get("worker_count")),cost_per_worker:Number(p.get("cost_per_worker")),deadline_at:ao(String(p.get("deadline_at")||"")),proof_requirements:u,admin_notes:String(p.get("admin_notes")||"").trim(),publish:!!p.get("publish")},y=d.querySelector('[type="submit"]');y.disabled=!0;try{let h=s?await c.adminUpdateJob(s,b):await c.adminCreateJob(b);l(h.message||"Job saved.","success"),f(s?`/admin/jobs/${s}`:"/admin/jobs")}catch(h){l(h.message||"Could not save job.","error"),y.disabled=!1}})}function to(e){if(!e)return"";let t=new Date(String(e).replace(" ","T")+"Z");if(Number.isNaN(t.getTime()))return"";let a=s=>String(s).padStart(2,"0");return`${t.getFullYear()}-${a(t.getMonth()+1)}-${a(t.getDate())}T${a(t.getHours())}:${a(t.getMinutes())}`}function ao(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function X(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}S();w();function Sr(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.className="view view--admin-job-detail",!g.get()?.is_admin){t.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p></div>';return}t.innerHTML='<div class="card"><p class="muted">Loading job detail\u2026</p></div>',await Pe(t,e)}}}async function Pe(e,t){try{let a=await c.adminJobDetail(t);so(e,a.data||{},t)}catch(a){e.innerHTML=`<div class="card"><p class="muted">Could not load job: ${$(a.message||"unknown error")}</p></div>`}}function so(e,t,a){let s=t.job||{},r=t.progress||{},n=t.assignments||[],i=t.bids||[],o=t.submissions||[],d=s.currency||"BDT",p=Array.isArray(s.proof_requirements)?s.proof_requirements:[],u=p.length?`<ul>${p.map(b=>`<li>${$(b.title||"Proof")} <span class="muted">(${$(b.type||"text")})</span></li>`).join("")}</ul>`:'<p class="muted">No structured proof requirements configured.</p>';e.innerHTML=`
        <a href="#/admin/jobs" class="back-link"><i class="bi bi-arrow-left"></i> Job management</a>
        <div class="page-heading-row"><div><h1 class="page-title">${$(s.title)}</h1><p class="muted">${$(s.subtitle||"")}</p></div><div class="admin-row__actions"><button class="btn btn--ghost btn--sm" id="edit-job">Edit job</button>${lo(s,n)?'<button class="btn btn--danger btn--sm" id="delete-job">Delete job</button>':""}</div></div>
        <div class="card"><div class="admin-job-row__meta"><span><strong>Customer:</strong> ${$(s.customer_name||"\u2014")}</span><span><strong>Phone:</strong> ${$(s.customer_phone||"\u2014")}</span><span><strong>Email:</strong> ${$(s.customer_email||"\u2014")}</span><span><strong>Status:</strong> ${$(String(s.status||"").replace("_"," ").toUpperCase())}</span><span><strong>Start date:</strong> ${$(Ma(s.created_at))}</span><span><strong>Deadline:</strong> ${$(Ma(s.deadline_at))}</span></div><p>${$(s.description||"").replace(/\n/g,"<br>")}</p>${s.requirements?`<p><strong>Requirements:</strong><br>${$(s.requirements).replace(/\n/g,"<br>")}</p>`:""}<div><strong>Proof requirements:</strong>${u}</div></div>
        <div class="stat-grid"><div class="stat-tile"><span class="muted">Total workers</span><strong>${Number(r.total_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Assigned</span><strong>${Number(r.assigned_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Working</span><strong>${Number(r.in_progress_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Pending review</span><strong>${Number(r.pending_review_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Revision</span><strong>${Number(r.revision_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Completed</span><strong>${Number(r.completed_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Rejected</span><strong>${Number(r.rejected_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Cancelled/refunded</span><strong>${Number(r.cancelled_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Remaining</span><strong>${Number(r.remaining_workers||0)}</strong></div><div class="stat-tile"><span class="muted">Total job amount</span><strong>${je(r.total_amount,d)}</strong></div><div class="stat-tile"><span class="muted">Total payable</span><strong>${je(r.total_payable_amount,d)}</strong></div><div class="stat-tile"><span class="muted">Completed amount</span><strong>${je(r.completed_amount,d)}</strong></div><div class="stat-tile"><span class="muted">Pending amount</span><strong>${je(r.pending_amount,d)}</strong></div><div class="stat-tile"><span class="muted">Remaining amount</span><strong>${je(r.remaining_amount,d)}</strong></div></div>
        <div class="card"><h2 class="card__title">Worker assignments</h2><div class="admin-list">${n.length?n.map(b=>ro(b,i)).join(""):'<p class="muted">No assignments yet.</p>'}</div></div>
        <div class="card"><h2 class="card__title">Pending worker bids</h2><div class="admin-list">${i.filter(b=>b.status==="pending").length?i.filter(b=>b.status==="pending").map(no).join(""):'<p class="muted">No pending bids.</p>'}</div></div>
        <div class="card"><h2 class="card__title">Submissions</h2><div class="admin-list" id="admin-detail-submissions">${o.length?o.map(io).join(""):'<p class="muted">No submissions yet.</p>'}</div></div>
   `,e.querySelector("#edit-job")?.addEventListener("click",()=>f(`/admin/admin-job-post?edit=${a}`)),e.querySelector("#delete-job")?.addEventListener("click",async()=>{if(confirm("Delete this job and its unassigned bids?"))try{await c.adminDeleteJob(a),l("Job deleted.","success"),f("/admin/jobs")}catch(b){l(b.message||"Could not delete job.","error")}}),e.querySelectorAll("[data-review-id]").forEach(b=>b.addEventListener("click",async()=>{let y=b.dataset.reviewDecision,h=y==="reject"?prompt("Rejection reason:"):prompt("Optional admin note:")||"";if(!(h===null||y==="reject"&&!h.trim()))try{await c.adminReviewSubmission(b.dataset.reviewId,{decision:y,note:h}),l("Submission reviewed.","success"),await Pe(e,a)}catch(k){l(k.message||"Could not review submission.","error")}})),e.querySelectorAll("[data-proof-attachment]").forEach(b=>b.addEventListener("click",()=>oo(b.dataset.proofAttachment))),e.querySelectorAll("[data-ban-worker]").forEach(b=>b.addEventListener("click",async()=>{let y=b.dataset.banWorker,h=b.dataset.banState==="1",k=prompt(h?"Reason for unbanning this worker:":"Reason for banning this worker:",h?"Restored by administrator":"");if(!(k===null||!h&&!k.trim())){b.disabled=!0;try{h?await c.adminUnbanUser(y,{reason:k.trim()}):await c.adminBanUser(y,{reason:k.trim()}),l(h?"Worker unbanned.":"Worker banned and active sessions revoked.","success"),await Pe(e,a)}catch(F){b.disabled=!1,l(F.message||"Could not update worker ban state.","error")}}})),e.querySelectorAll("[data-cancel-assignment]").forEach(b=>b.addEventListener("click",async()=>{let y=prompt("Reason for cancelling this assignment:");if(!(!y||!y.trim()))try{await c.adminCancelAssignment(b.dataset.cancelAssignment,{reason:y.trim()}),l("Assignment cancelled and refunded.","success"),await Pe(e,a)}catch(h){l(h.message||"Could not cancel assignment.","error")}})),e.querySelectorAll("[data-reassign-assignment]").forEach(b=>b.addEventListener("click",async()=>{let y=e.querySelector(`[data-reassign-select="${b.dataset.reassignAssignment}"]`),h=Number(y?.value||0);if(!h){l("Select a pending replacement bid first.","error");return}let k=prompt("Reason for reassignment:")||"Reassigned by administrator";try{await c.adminReassignAssignment(b.dataset.reassignAssignment,{bid_id:h,reason:k.trim()}),l("Worker reassigned.","success"),await Pe(e,a)}catch(F){l(F.message||"Could not reassign worker.","error")}}))}function ro(e,t){let a=e.payment_status==="held"&&!["cancelled","completed"].includes(e.status),s=t.filter(n=>n.status==="pending"&&n.worker_id!==e.worker_id),r=a?`<div class="admin-row__actions"><button class="btn btn--danger btn--sm" data-cancel-assignment="${e.id}">Cancel/refund</button>${s.length?`<select data-reassign-select="${e.id}" aria-label="Replacement worker"><option value="">Replace with\u2026</option>${s.map(n=>`<option value="${n.id}">${$(n.worker?.name||`Worker #${n.worker_id}`)} \xB7 \u09F3${Number(n.amount||0).toFixed(2)}</option>`).join("")}</select><button class="btn btn--ghost btn--sm" data-reassign-assignment="${e.id}">Reassign</button>`:""}</div>`:"";return`<div class="admin-row"><div><strong>${$(e.worker?.name||"Unknown worker")}</strong><span class="muted">${$(e.worker?.email||"")} \xB7 ${$(e.worker?.phone||"")}</span></div><div><span class="badge">${$(String(e.status||"").toUpperCase())}</span><span class="muted"> ${$(String(e.payment_status||"").toUpperCase())} \xB7 ${Number(e.payment_amount||0).toFixed(2)}</span>${r}</div></div>`}function no(e){return`<div class="admin-row"><div><strong>${$(e.worker?.name||`Worker #${e.worker_id}`)}</strong><span class="muted">${$(e.worker?.email||"")} \xB7 ${$(e.worker?.phone||"")}</span><p>${$(e.proposal||"")}</p></div><div><span class="badge">PENDING</span><span class="muted"> \u09F3${Number(e.amount||0).toFixed(2)}</span></div></div>`}function io(e){let t=e.worker||{},a=e.status==="pending_review"?`<button class="btn btn--success btn--sm" data-review-id="${e.id}" data-review-decision="approve">Approve</button><button class="btn btn--danger btn--sm" data-review-id="${e.id}" data-review-decision="reject">Reject</button>`:"",s=t.id?`<button class="btn ${t.is_banned?"btn--success":"btn--danger"} btn--sm" data-ban-worker="${t.id}" data-ban-state="${t.is_banned?"1":"0"}">${t.is_banned?"Unban worker":"Ban worker"}</button>`:"",r=a||s?`<div class="admin-row__actions">${a}${s}</div>`:"",n=`User ID #${$(e.worker_id)} \xB7 ${$(t.phone||"Phone unavailable")} \xB7 ${$(t.email||"Email unavailable")}`,i=e.reviewer_note||e.rejection_reason,o=e.risk_status&&e.risk_status!=="clear"?` \xB7 Risk ${$(String(e.risk_status).replace("_"," "))} (${Number(e.risk_score||0).toFixed(0)})`:"",d=e.attachment_url?`${e.external_link?" \xB7 ":""}<button type="button" class="btn btn--ghost btn--sm" data-proof-attachment="${Number(e.id)}"><i class="bi bi-file-earmark-text"></i> Open proof attachment</button>`:"";return`<div class="admin-row"><div><strong>${$(t.name||"Unknown worker")}</strong><span class="muted">${n}</span><span class="muted">Submitted ${$(Ma(e.submitted_at||e.created_at))} \xB7 Attempt ${Number(e.attempt_number||1)} \xB7 ${$(String(e.status||"").replace("_"," "))}${o}</span><p>${$(e.description||"")}</p>${e.external_link?`<a href="${$(e.external_link)}" target="_blank" rel="noopener">Open delivery link</a>`:""}${d}${i?`<p class="muted"><strong>Review note:</strong> ${$(i)}</p>`:""}</div>${r}</div>`}async function oo(e){let t=window.open("about:blank","_blank","noopener,noreferrer");try{let a=await c.proofAttachment(e),s=URL.createObjectURL(a);t?t.location.href=s:window.location.href=s,setTimeout(()=>URL.revokeObjectURL(s),6e4)}catch(a){t&&t.close(),l(a.message||"Could not open the proof attachment.","error")}}function lo(e,t){return!["completed","disputed"].includes(e.status)&&!t.some(a=>!["cancelled"].includes(a.status))}function Ma(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function je(e,t){return`${$(t||"BDT")} ${Number(e||0).toFixed(2)}`}function $(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}fa();ya();w();function kr(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-advertisement",!g.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
                <div>
        ...
        `}}}Zt();ta();sa();ia();Gt();var Nr={"/":Lt,"/refer":Nt,"/webtask":Se,"/tasks":Se,"/earn":ke,"/tg-tasks":Qe,"/withdraw":Je,"/profile":We,"/wallet":We,"/admin":oa,"/admin/payments":pa,"/admin/categories":hr,"/admin/settings":yr,"/admin/jobs":Ee,"/admin/pending-jobs":Ee,"/admin/active-jobs":Ee,"/admin/admin-job-post":$r,"/admin/transactions":va,"/admin/reports":ha,"/admin/advertisement":kr,"/deposit":Rt,"/leaderboard":ze,"/achievements":Ge,"/support":Xe,"/settings":Ke,"/jobs/available":mr,"/worker/bids":vr,"/worker/active-jobs":Na,"/poster":Kt,"/poster/post-job":Qt,"/poster/jobs":aa,"/poster/wallet":na,"/notifications":zt,"/login":wa,"/register":Sa,"/forgot-password":it,"/reset-password":ot};function Pr(){pt(),setTimeout(pt,50),window.addEventListener("hashchange",pt),E(()=>{q.get(),setTimeout(pt,0)})}async function pt(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!Nr[t]){let i=t.match(/^\/admin\/jobs\/(\d+)$/);if(i){if(!q.get()){f("/login");return}let p=g.get();if(!p||!p.is_admin){jr();return}await ut(()=>Sr(i[1]),t);return}let o=t.match(/^\/jobs\/(\d+)$/);if(o){if(!q.get()){f("/login");return}let p=await Promise.resolve().then(()=>(Lr(),Tr));await ut(()=>p.JobDetailPage(o[1]),t);return}let d=t.match(/^\/poster\/jobs\/(\d+)$/);if(d){if(!q.get()){f("/login");return}let p=await Promise.resolve().then(()=>(qr(),Er));await ut(()=>p.PosterJobDetailPage(d[1]),t);return}t="/"}let a=q.get(),s=g.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?f("/admin"):f("/");return}if(!r.includes(t)&&!a){f("/login");return}if(t==="/"&&s&&s.is_admin){f("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){jr();return}let n=Nr[t];await ut(n,t)}async function ut(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function jr(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}w();var Mr=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();Mr.innerHTML="";K(pr(),Mr);G.get()&&M();Pr();
