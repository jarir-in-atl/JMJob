var tr=Object.defineProperty;var f=(e,t)=>()=>(e&&(t=e(e=0)),t);var w=(e,t)=>{for(var a in t)tr(e,a,{get:t[a],enumerable:!0})};function ar(e,t){fa?fa(e,t):console.error("[Ghost] Unhandled effect error:",e)}function A(e){let t=e,a=new Set;return{get(){return C&&(a.add(C),C.dependencies.add(a)),t},set(s){t!==s&&(t=s,va(a))}}}function va(e){Xe(()=>{e.forEach(t=>{t.notify?t.notify():me.add(t)})})}function Xe(e){ze++;try{e()}finally{if(ze--,ze===0){let t=Array.from(me);me.clear(),t.forEach(a=>a.run())}}}function $(e){let t={dependencies:new Set,run(){Ve(t),ue.push(C),C=t;try{e()}catch(a){ar(a,e)}finally{C=ue.pop()}},notify(){me.add(t)}};return t.run(),()=>Ve(t)}function Ye(e){let t,a=!0,s=new Set,r={dependencies:new Set,notify(){a||(a=!0,va(s))}};return{get(){if(C&&(s.add(C),C.dependencies.add(s)),a){Ve(r),ue.push(C),C=r;try{t=e()}finally{C=ue.pop()}a=!1}return t}}}function Ve(e){for(let t of e.dependencies)t.delete(e);e.dependencies.clear()}var C,ue,me,ze,fa,U=f(()=>{C=null,ue=[],me=new Set,ze=0,fa=null});function ae(){Ke.totalUpdates++,Ke.recentUpdates++}var be,Ke,Ze=f(()=>{be=new Set,Ke={totalUpdates:0,startTime:Date.now(),recentUpdates:0}});function B(e,t){if(!e||typeof e!="object")return;if(e.__ghostList){sr(e,t);return}if(e.__ghostWhen){rr(e,t);return}if(e.__ghostLazy){ir(e,t);return}if(e.props=e.props||{},e.effects=e.effects||[],e.children=e.children||[],e.events=e.events||{mount:[],update:[],destroy:[],error:[]},!e.tag)return;be.add(e);let a=document.createElement(e.tag);e.el=a,Object.entries(e.props).forEach(([s,r])=>{if(s==="ghostStyle"&&r?.mount){r.mount(a);return}let i=s.startsWith("on");typeof r=="function"&&!i?e.effects.push($(()=>{a.setAttribute(s,r()),ae(),e.events.update?.forEach(n=>n())})):i?a[s.toLowerCase()]=r:a.setAttribute(s,r)}),e.children.forEach(s=>{if(s!=null)if(s.__ghostList||s.__ghostWhen||s.__ghostLazy)B(s,a);else if(typeof s=="string"||typeof s=="number")a.appendChild(document.createTextNode(String(s)));else if(typeof s=="function"){let r=null;e.effects.push($(()=>{let i=s(),n=document.createTextNode(String(i??""));r?a.replaceChild(n,r):a.appendChild(n),r=n,ae(),e.events.update?.forEach(o=>o())}))}else B(s,a)}),t.appendChild(a),e.events.mount?.forEach(s=>s())}function se(e){if(e){if(e._listCleanup){e._listCleanup();return}if(e._whenCleanup){e._whenCleanup();return}e.effects?.forEach(t=>t()),e.events?.destroy?.forEach(t=>t()),e.el?.parentNode&&e.el.parentNode.removeChild(e.el),be.delete(e)}}function sr(e,t){let{getItems:a,keyFn:s,renderFn:r}=e,i=document.createComment("[ghost-list]"),n=document.createComment("[/ghost-list]");t.appendChild(i),t.appendChild(n);let o=new Map;function d(h){return h.el||null}let g=$(()=>{let h=a(),M=h.map((S,O)=>String(s(S,O))),er=Array.from(o.keys());for(let S of er)if(!M.includes(S)){let O=o.get(S);se(O.ghostNode),o.delete(S)}for(let S=0;S<h.length;S++){let O=M[S];if(!o.has(O)){let te=r(h[S],S),z=document.createElement("ghost-list-slot");for(B(te,z);z.firstChild;)t.insertBefore(z.firstChild,n);o.set(O,{ghostNode:te})}}for(let S=M.length-1;S>=0;S--){let O=M[S],te=o.get(O);if(!te)continue;let z=d(te.ghostNode);if(!z)continue;let ba=M[S+1],ga=(ba?d(o.get(ba)?.ghostNode):null)||n;z.nextSibling!==ga&&t.insertBefore(z,ga)}ae()});e._listCleanup=()=>{g();for(let h of o.values())se(h.ghostNode);o.clear(),i.remove(),n.remove()}}function P(e,t,a=null){return{__ghostWhen:!0,conditionGetter:e,trueFn:t,falseFn:a}}function rr(e,t){let{conditionGetter:a,trueFn:s,falseFn:r}=e,i=document.createComment("[ghost-when]");t.appendChild(i);let n=null,o=$(()=>{let g=a()?s:r;if(n&&(se(n),n=null),g&&(n=g(),n)){let h=document.createElement("ghost-when-slot");for(B(n,h);h.firstChild;)t.insertBefore(h.firstChild,i)}ae()});e._whenCleanup=()=>{o(),n&&se(n),i.remove()}}function ir(e,t){let{importFn:a,fallback:s}=e,r=document.createComment("[ghost-lazy]");t.appendChild(r);let i=null;if(s){let n=document.createElement("ghost-lazy-slot");for(B(s,n);n.firstChild;)t.insertBefore(n.firstChild,r);i=s}a().then(n=>{let o=n.default||n;i&&(se(i),i=null);let d=typeof o=="function"?o():o,g=document.createElement("ghost-lazy-slot");for(B(d,g);g.firstChild;)t.insertBefore(g.firstChild,r);i=d}).catch(n=>{console.error("[Ghost] lazyNode failed to load:",n)})}var Qe=f(()=>{U();Ze()});var ha=f(()=>{U()});var ge=f(()=>{});var ya=f(()=>{Ze()});var wa=f(()=>{U()});var _a=f(()=>{Qe();U();ge();ge()});function or(e){if(typeof window>"u"||!window.DOMParser)return{};let a=new DOMParser().parseFromString(e,"text/xml");function s(r){let i={};if(r.nodeType===3)return r.nodeValue.trim();if(r.attributes?.length){i["@attributes"]={};for(let n of r.attributes)i["@attributes"][n.nodeName]=n.nodeValue}for(let n of r.childNodes){let o=n.nodeName,d=s(n);d!==""&&(i[o]===void 0?i[o]=d:(Array.isArray(i[o])||(i[o]=[i[o]]),i[o].push(d)))}return i}return s(a.documentElement)}function lr(e,t="GET"){return`${t.toUpperCase()}:${e}`}async function tt(e,t={}){let{cache:a=!1,...s}=t,r=(s.method||"GET").toUpperCase(),i={url:e,...s};for(let M of tt.interceptors.request)i=M(i)??i;let n=i.url;delete i.url;let o=lr(n,r);if(a==="memory"&&r==="GET"&&et.has(o))return et.get(o);let d=await fetch(n,i),g=d.headers.get("content-type")||"";if(!d.ok)throw new Error(`Ghost-HTTP Error: ${d.status} ${d.statusText}`);let h;g.includes("application/xml")||g.includes("text/xml")?h=or(await d.text()):g.includes("application/json")?h=await d.json():h=await d.text();for(let M of tt.interceptors.response)h=M(d,h)??h;return a==="memory"&&r==="GET"&&et.set(o,h),h}var et,$a=f(()=>{et=new Map;tt.interceptors={request:[],response:[]}});function at(e,t){let a;try{let r=localStorage.getItem(e);a=r?JSON.parse(r):t}catch{a=t}let s=A(a);return $(()=>{try{localStorage.setItem(e,JSON.stringify(s.get()))}catch(r){console.warn(`Ghost-Bridge: Failed to persist key "${e}"`,r)}}),s}var Sa=f(()=>{U()});function cr(){let e=new Map;return{on(t,a){return e.has(t)||e.set(t,new Set),e.get(t).add(a),()=>e.get(t).delete(a)},emit(t,a){e.has(t)&&e.get(t).forEach(s=>s(a))},clear(t){t?e.delete(t):e.clear()}}}var ao,ka=f(()=>{ao=cr()});var io,dr,Ta=f(()=>{U();io=A("en"),dr=new Map;dr.set("en",{})});var q=f(()=>{U();Qe();ha();ge();ya();wa();_a();$a();Sa();ka();Ta()});function La(e){st=e}function xa(e){rt=e}async function p(e,{method:t="GET",body:a,headers:s={},signal:r}={}){let i=e.startsWith("http")?e:pr.apiBase+e,n={method:t,headers:{"Content-Type":"application/json",Accept:"application/json",...s}};st&&(n.headers.Authorization=`Bearer ${st}`),a!==void 0&&(n.body=JSON.stringify(a)),r&&(n.signal=r);let o=await fetch(i,n);if(o.status===401)throw rt&&rt(),new fe("Unauthorized",401,null);let d=null,g=o.headers.get("content-type")||"";try{if(g.includes("application/json"))d=await o.json();else{let h=await o.text();d=h?{message:h}:null}}catch{}if(!o.ok){let h=d&&d.message||`HTTP ${o.status}`;throw new fe(h,o.status,d)}return d}var pr,st,rt,fe,c,y=f(()=>{pr=window.JMJOB_CONFIG||{apiBase:"/api"},st=null,rt=null;fe=class extends Error{constructor(t,a,s){super(t),this.status=a,this.payload=s}},c={health:()=>p("/health"),register:e=>p("/auth/register",{method:"POST",body:e}),requestRegistrationOtp:e=>p("/auth/register/request-otp",{method:"POST",body:e}),verifyRegistrationOtp:e=>p("/auth/register/verify-otp",{method:"POST",body:e}),login:e=>p("/auth/login",{method:"POST",body:e}),forgotPassword:e=>p("/auth/forgot-password",{method:"POST",body:e}),resetPassword:e=>p("/auth/reset-password",{method:"POST",body:e}),logout:()=>p("/auth/logout",{method:"POST"}),me:()=>p("/auth/me"),notifications:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/notifications${t?"?"+t:""}`)},notificationRead:e=>p(`/notifications/${encodeURIComponent(e)}/read`,{method:"POST"}),notificationsReadAll:()=>p("/notifications/read-all",{method:"POST"}),meUser:()=>p("/user"),reward:e=>p("/user/reward",{method:"POST",body:e}),withdraw:e=>p("/user/withdraw",{method:"POST",body:e}),withdrawals:()=>p("/user/withdrawals"),referrals:()=>p("/user/referrals"),adHistory:()=>p("/user/ads"),adsConfig:()=>p("/ads/config"),adsNext:()=>p("/ads/next"),webTasks:()=>p("/tasks/web"),webTaskStart:e=>p("/tasks/web/start",{method:"POST",body:e}),webTaskClaim:e=>p("/tasks/web/claim",{method:"POST",body:e}),tgTasks:()=>p("/tasks/telegram"),tgTaskVerify:e=>p("/tasks/telegram/verify",{method:"POST",body:e}),adminStats:()=>p("/admin/stats"),adminWithdrawals:(e="pending")=>p(`/admin/withdrawals?status=${e}`),adminApprove:(e,t={})=>p(`/admin/withdrawals/${e}/approve`,{method:"POST",body:t}),adminReject:(e,t={})=>p(`/admin/withdrawals/${e}/reject`,{method:"POST",body:t}),adminPay:(e,t={})=>p(`/admin/withdrawals/${e}/pay`,{method:"POST",body:t}),adminUsers:()=>p("/admin/users"),adminUpdateUserRole:(e,t)=>p(`/admin/users/${e}/role`,{method:"POST",body:{role:t}}),adminProviders:()=>p("/admin/ad-providers"),adminUpdateProvider:(e,t)=>p(`/admin/ad-providers/${e}`,{method:"POST",body:t}),adminResetDailyCounters:()=>p("/admin/reset-daily-counters",{method:"POST"}),paymentGateways:()=>p("/payment/gateways"),paymentSubmit:e=>p("/payment/submit",{method:"POST",body:e}),paymentSubmissions:()=>p("/payment/submissions"),adminPayments:(e="")=>p(`/admin/payments?status=${e}`),adminApprovePayment:(e,t={})=>p(`/admin/payments/${e}/approve`,{method:"POST",body:t}),adminRejectPayment:(e,t={})=>p(`/admin/payments/${e}/reject`,{method:"POST",body:t}),categories:()=>p("/categories"),jobs:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/jobs${t?"?"+t:""}`)},job:e=>p(`/jobs/${e}`),placeBid:(e,t)=>p(`/jobs/${e}/bid`,{method:"POST",body:t}),withdrawBid:e=>p(`/bids/${e}`,{method:"DELETE"}),workerBids:()=>p("/worker/bids"),workerActiveJobs:()=>p("/worker/active-jobs"),submitWork:(e,t)=>p(`/jobs/${e}/submit`,{method:"POST",body:t}),workerSubmissions:()=>p("/worker/submissions"),posterStats:()=>p("/poster/stats"),posterCreateJob:e=>p("/poster/jobs",{method:"POST",body:e}),posterMyJobs:()=>p("/poster/jobs"),posterJobBids:e=>p(`/poster/jobs/${e}/bids`),posterAcceptBid:(e,t,a={})=>p(`/poster/jobs/${e}/accept-bid`,{method:"POST",body:{...a,bid_id:t}}),posterRequestRevision:(e,t={})=>p(`/poster/jobs/${e}/request-revision`,{method:"POST",body:t}),posterReleasePayment:(e,t={})=>p(`/poster/jobs/${e}/release`,{method:"POST",body:t}),posterCancelJob:(e,t={})=>p(`/poster/jobs/${e}/cancel`,{method:"POST",body:t}),adminCategories:()=>p("/admin/categories"),adminCreateCategory:e=>p("/admin/categories",{method:"POST",body:e}),adminUpdateCategory:(e,t)=>p(`/admin/categories/${e}`,{method:"POST",body:t}),adminDeleteCategory:e=>p(`/admin/categories/${e}/delete`,{method:"POST"}),adminSettings:()=>p("/admin/settings"),adminUpdateSettings:e=>p("/admin/settings",{method:"POST",body:e}),socialLinks:()=>p("/social-links"),adminUpdateSocialLinks:e=>p("/admin/social-links",{method:"POST",body:e}),adminJobs:(e="")=>p(`/admin/jobs${e?`?status=${encodeURIComponent(e)}`:""}`),adminFlagJobDispute:e=>p(`/admin/jobs/${e}/dispute`,{method:"POST"}),adminResolveJob:(e,t)=>p(`/admin/jobs/${e}/resolve`,{method:"POST",body:t}),adminTransactions:(e={})=>{let t=new URLSearchParams(e).toString();return p(`/admin/transactions${t?"?"+t:""}`)},adminReports:()=>p("/admin/reports"),adminRevenue:()=>p("/admin/revenue")}});function l(e,t="info",a=3500){re.set({message:e,type:t,id:Date.now()}),it&&clearTimeout(it),it=setTimeout(()=>re.set(null),a)}async function E(){if(!R.get())return null;try{let e=await c.me();return m.set(e.data),e.data}catch{return null}}async function Ea(e,t){let a=await c.login({email:e,password:t});return R.set(a.data.token),m.set(a.data.user),a.data.user}async function Aa(e){return c.requestRegistrationOtp(e)}async function Ca(e){let t=await c.verifyRegistrationOtp(e);return R.set(t.data.token),m.set(t.data.user),t.data.user}async function ve(){try{await c.logout()}catch{}R.set(null),m.set(null),k.set("/login")}function b(e){window.location.hash=e}var ur,mr,R,m,re,it,k,L,v=f(()=>{q();q();y();ur="earnap_token",mr="earnap_user",R=at(ur,null),m=at(mr,null),re=A(null),it=null;k=A(window.location.hash.replace(/^#/,"")||"/"),L=Ye(()=>!!R.get()&&!!m.get());$(()=>{let e=R.get();La(e)});xa(()=>{R.set(null),m.set(null),k.set("/login"),l("Session expired. Please log in.","error")})});var Ma={};w(Ma,{HomePage:()=>he});function he(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--home";let t=m.get(),a=V("div","welcome-popup","");a.innerHTML=`
        ...
        `,a.querySelector("button").addEventListener("click",()=>a.remove()),e.appendChild(a),e.appendChild(br(t)),e.appendChild(gr()),e.appendChild(fr(t))}}function V(e,t,a){let s=document.createElement(e);return t&&(s.className=t),a!==void 0&&(s.textContent=a),s}function br(e){let t=V("div","card card--user-header"),a=V("div","user-header__stats");return a.innerHTML=`
    ...
    `,t.appendChild(a),t}function gr(){let e=V("div","icon-grid");return[{path:"/earn",label:"Earn Ad",icon:"bi-play-circle-fill",tone:"green"},{path:"/tasks",label:"Web Task",icon:"bi-link-45deg",tone:"blue"},{path:"/webtask",label:"Tasks",icon:"bi-telegram",tone:"blue"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2",tone:"amber"},{path:"/refer",label:"Referral",icon:"bi-gift-fill",tone:"pink"},{path:"/profile",label:"Profile",icon:"bi-person-bounding-box",tone:"gray"},{path:"/support",label:"Support",icon:"bi-headset",tone:"red"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin",tone:"green"}].forEach(a=>{let s=V("a",`icon-grid__item icon-grid__item--${a.tone}`);s.href=`#${a.path}`,s.innerHTML=`
            <span class="icon-grid__chip">
                <i class="bi ${a.icon}"></i>
            </span>
            <span class="icon-grid__label">${a.label}</span>
        `,s.addEventListener("click",r=>{r.preventDefault(),b(a.path)}),e.appendChild(s)}),e}function fr(e){let t=V("div","card card--daily-mission"),a=e&&e.today_ads||0,s=e&&e.ads_limit||50,r=Math.min(100,a/Math.max(1,s)*100);t.innerHTML=`
        <div class="card__row">
    ...
    `;let a=t.querySelector("button");return a&&!a.disabled&&a.addEventListener("click",()=>hr(e,a,t)),t}async function hr(e,t,a){t.disabled=!0,t.textContent="Opening\u2026",window.open(e.target_url,"_blank","noopener,noreferrer");let s=0,r=e.duration_seconds;t.textContent=`Wait ${r}s\u2026`;let n=(await c.webTaskStart({task_id:e.id})).data.completion_id,o=setInterval(()=>{s+=1;let d=r-s;t.textContent=d>0?`Wait ${d}s\u2026`:"Claim Reward",s>=r&&(clearInterval(o),yr(t,n,a))},1e3)}function yr(e,t,a){e.textContent="Claim Reward",e.classList.remove("btn--primary"),e.classList.add("btn--success"),e.disabled=!1,e.onclick=async()=>{e.disabled=!0,e.textContent="Claiming\u2026";try{let s=await c.webTaskClaim({completion_id:t});l("+"+parseFloat(s.data.reward).toFixed(2)+" credited!","success"),await E(),ie()()}catch(s){l(s.message||"Claim failed","error"),e.disabled=!1,e.textContent="Claim Reward"}}}function qa(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ye=f(()=>{y();v()});var ja={};w(ja,{EarnPage:()=>we});function we(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--earn";let t=m.get(),a=t?t.ads_remaining:0;e.innerHTML=`
        ...
        `;let s=e.querySelector("#watch-btn");s.disabled||s.addEventListener("click",()=>wr())}}function wr(){let e=document.createElement("div");e.className="modal modal--ad",e.innerHTML=`
    ...
    `,document.body.appendChild(e),e.querySelector(".modal__close").addEventListener("click",()=>e.remove()),e.querySelector(".modal__backdrop").addEventListener("click",()=>e.remove());let t=new Date().toISOString(),a=12,s=e.querySelector("#ad-slot"),r=e.querySelector("#ad-countdown");setTimeout(()=>{s.innerHTML=`
        ...
        `;let r=e.querySelector("#copy-btn"),i=e.querySelector("#refer-link-input");r.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(i.value),l("Link copied to clipboard!","success")}catch{i.select(),document.execCommand("copy"),l("Link copied!","success")}});let n=e.querySelector("#share-tg");n.href="https://t.me/share/url?url="+encodeURIComponent(s);let o=e.querySelector("#refer-list");a&&a.referrals&&a.referrals.forEach(d=>{let g=document.createElement("div");g.className="refer-item",g.innerHTML=`
                ...
                `,o.appendChild(g)})}}function Pa(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var dt=f(()=>{y();v()});var Ha={};w(Ha,{WithdrawPage:()=>_e});function _e(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--withdraw";let t=m.get();e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("button[data-gateway]").forEach(t=>{t.addEventListener("click",()=>{_.selectedGateway=t.getAttribute("data-gateway"),Ba(),kr()})})}}function kr(){let e=_.gateways.find(i=>i.key===_.selectedGateway),t=document.getElementById("deposit-instructions-card"),a=document.getElementById("deposit-form-card");if(!e){t&&(t.style.display="none"),a&&(a.style.display="none");return}t&&(t.style.display=""),a&&(a.style.display="");let s=document.getElementById("payment-instructions");s&&(s.innerHTML=`
        ...
        `,document.getElementById("copy-wallet-btn")?.addEventListener("click",()=>{navigator.clipboard.writeText(e.wallet_number).then(()=>{l("Wallet number copied.","info")}).catch(()=>{l("Could not copy. Please copy manually.","error")})}));let r=document.getElementById("deposit-amount");r&&(r.min=_.minAmount,r.max=_.maxAmount,r.placeholder=`${_.minAmount} \u2013 ${_.maxAmount}`)}function Fa(){let e=document.getElementById("payment-history");if(e){if(_.submissions.length===0){e.innerHTML='<p class="muted">No submissions yet.</p>';return}e.innerHTML=_.submissions.map(t=>{let a=Sr[t.status]||{label:t.status,class:""};return`
            <div class="payment-row ${a.class}">
                ...
                <div class="payment-row__date">${Tr(t.created_at)}</div>
            </div>
        `}).join("")}}function Tr(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function K(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Sr,_,bt=f(()=>{y();v();Sr={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},_={gateways:[],minAmount:1,maxAmount:5e4,selectedGateway:null,submissions:[],loading:!1}});var ft={};w(ft,{ProfilePage:()=>$e});function $e(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--profile";let t=m.get();e.innerHTML=`
        ...
        `;let a=e.querySelector("#ad-history");try{let r=(await c.adHistory()).data||[];if(r.length===0)a.innerHTML='<p class="muted">No ad views yet.</p>';else{a.innerHTML='<div class="ad-history__list"></div>';let i=a.querySelector(".ad-history__list");r.forEach(n=>{let o=document.createElement("div");o.className="ad-history__row",o.innerHTML=`
                    ...
                    `,i.appendChild(o)})}}catch{a.innerHTML='<p class="muted">Failed to load history.</p>'}}}function gt(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Se=f(()=>{y();v()});var Ia={};w(Ia,{default:()=>ke});async function ke(){let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--leaderboard",e.innerHTML=`
    ...
    `,e.querySelectorAll(".faq-question").forEach(t=>{t.addEventListener("click",()=>{t.parentElement.classList.toggle("faq-item--open")})}))}var yt=f(()=>{v()});function Lr(){let e=localStorage.getItem(Ua);return e==="dark"||e==="light"?e:"system"}function xr(e){return e==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":e}function wt(e){let t=xr(e);document.documentElement.setAttribute("data-theme",t)}function Ja(){let e=j.get();j.set(e==="dark"?"light":"dark")}function Wa(e){j.set(e)}function Er(){let e=localStorage.getItem(Ga);return e&&_t.includes(e)?e:"default"}function za(e){e==="default"?document.documentElement.removeAttribute("data-color-theme"):document.documentElement.setAttribute("data-color-theme",e)}function Va(e){_t.includes(e)&&ne.set(e)}function Xa(){return _t}var Ua,j,Ga,_t,ne,$t=f(()=>{q();Ua="jmjob_theme";j=A(Lr());wt(j.get());$(()=>{let e=j.get();wt(e),localStorage.setItem(Ua,e)});window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",()=>{j.get()==="system"&&wt("system")});Ga="jmjob_color_theme",_t=["default","emerald","amber","rose"];ne=A(Er());za(ne.get());$(()=>{let e=ne.get();za(e),localStorage.setItem(Ga,e)})});var Ya={};w(Ya,{default:()=>Ee});async function Ee(){let e=document.querySelector("[data-view]");if(!e)return;let t=m.get();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--settings";let a=j.get(),s=ne.get(),r=Xa();e.innerHTML=`
                    ...
                    <div class="theme-swatches" id="color-theme-group" role="radiogroup" aria-label="Accent color">
                        ${r.map(o=>`
                            <button class="theme-swatch ${o===s?"is-active":""}" data-color="${o}" role="radio" aria-checked="${o===s}" title="${xe[o]||o}">
                                <span class="theme-swatch__chip" style="background: ${Ar[o]};"></span>
    ...
    `;let i=document.getElementById("theme-mode-group");i&&i.querySelectorAll("button[data-mode]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-mode");Wa(d),l(`Theme mode set to ${d}.`,"info")})});let n=document.getElementById("color-theme-group");n&&n.querySelectorAll("button[data-color]").forEach(o=>{o.addEventListener("click",()=>{let d=o.getAttribute("data-color");Va(d),l(`Accent color set to ${xe[d]||d}.`,"info")})}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await ve(),l("Logged out.","info")})}var xe,Ar,St=f(()=>{v();$t();xe={default:"Default (Purple)",emerald:"Emerald (Green)",amber:"Amber (Orange)",rose:"Rose (Pink)"},Ar={default:"linear-gradient(135deg, #7c3aed, #a855f7)",emerald:"linear-gradient(135deg, #059669, #10b981)",amber:"linear-gradient(135deg, #d97706, #f59e0b)",rose:"linear-gradient(135deg, #e11d48, #f43f5e)"}});var Za={};w(Za,{NotificationsPage:()=>kt});function kt(){return async()=>{let e=document.querySelector("[data-view]");e&&(e.innerHTML="",e.className="view view--notifications",e.innerHTML=`
        ...
        `,document.getElementById("notifications-read-all")?.addEventListener("click",async()=>{try{await c.notificationsReadAll(),l("All notifications marked as read.","success"),await Ka()}catch(t){l(t.message||"Could not update notifications.","error")}}),await Ka())}}async function Ka(){let e=document.getElementById("notifications-page-list");if(e)try{let t=await c.notifications({limit:100}),a=Array.isArray(t.data)?t.data:[];e.innerHTML=a.length?a.map(Cr).join(""):'<p class="muted notifications-page__empty">No notifications yet.</p>',e.querySelectorAll("[data-notification-id]").forEach(s=>{s.querySelector("[data-mark-read]")?.addEventListener("click",async()=>{try{await c.notificationRead(s.getAttribute("data-notification-id")),s.classList.remove("notifications-page__item--unread"),s.querySelector("[data-mark-read]").remove()}catch(r){l(r.message||"Could not mark notification as read.","error")}})})}catch(t){e.innerHTML=`<p class="muted">Failed to load notifications: ${oe(t.message||"unknown error")}</p>`}}function Cr(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?`<a class="btn btn--ghost btn--sm" href="#${oe(t.action_url)}">Open</a>`:"",i=e.read?"":'<button class="btn btn--ghost btn--sm" data-mark-read>Mark read</button>';return`<article class="notifications-page__item ${e.read?"":"notifications-page__item--unread"}" data-notification-id="${oe(e.id)}"><i class="bi ${s} notifications-page__icon notifications-page__icon--${a}"></i><div class="notifications-page__body"><h3>${oe(t.title||"Notification")}</h3><p>${oe(t.message||"")}</p><small>${Mr(e.created_at)}</small></div><div class="notifications-page__actions">${r}${i}</div></article>`}function Mr(e){if(!e)return"";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function oe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Tt=f(()=>{y();v()});var Qa={};w(Qa,{TgTasksPage:()=>Ce});function Ce(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--tgtasks",e.innerHTML=`
        ...
        `;let t=e.querySelector("#tg-list");try{let s=(await c.tgTasks()).data||[];if(t.innerHTML="",s.length===0){t.innerHTML='<p class="muted">No tasks available right now.</p>';return}s.forEach(r=>t.appendChild(qr(r)))}catch{t.innerHTML='<p class="muted">Failed to load tasks.</p>'}}}function qr(e){let t=document.createElement("div");if(t.className="card card--task",t.innerHTML=`
    ...
    `,!e.completed){let a=t.querySelector("a.btn");a.addEventListener("click",async s=>{s.preventDefault();let r=a.href;window.open(r,"_blank","noopener,noreferrer"),setTimeout(()=>{confirm(`Did you join ${e.channel_name}? Click OK to claim the reward.`)&&jr(e,t)},3e3)})}return t}async function jr(e,t){let a=t.querySelector(".task-actions");a.innerHTML='<button class="btn btn--ghost" disabled>Claiming\u2026</button>';try{await c.tgTaskVerify({task_id:e.id}),l("+ $"+parseFloat(e.reward).toFixed(3)+" credited!","success"),await E(),Ce()()}catch(s){l(s.message||"Verification failed","error"),a.innerHTML=`<button class="btn btn--primary" data-task-id="${e.id}">Retry</button>`}}function Ae(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Lt=f(()=>{y();v()});var as={};w(as,{PosterDashboardPage:()=>Et});function Et(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-dashboard";let t=m.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML=`
        ...
        `;let a=e.querySelector("#poster-new-job");a&&a.addEventListener("click",s=>{s.preventDefault(),b("/poster/post-job")}),await es()}}async function es(){let e=document.getElementById("poster-dashboard-content");if(e)try{let t=await c.posterStats();Nr(e,t.data||{})}catch(t){e.innerHTML=`
            <div class="card">
        ...
        `,e.querySelector("#poster-retry")?.addEventListener("click",es),l(t.message||"Failed to load poster statistics.","error")}}function Nr(e,t){let a=t.counts||{},s=(a.assigned||0)+(a.submitted||0)+(a.revision||0),r=xt(t.wallet_balance),i=xt(t.frozen_balance),n=xt(t.total_spent);e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-poster-link]").forEach(o=>{o.addEventListener("click",d=>{d.preventDefault(),b(o.getAttribute("href").replace(/^#/,""))})})}function Me(e,t,a,s=""){return`
    ...
    `}function Z(e,t){let a=Number(t||0);return`
        <div class="poster-status-row">
            <span><i class="bi ${Hr(e)}"></i> ${Pr[e]||e}</span>
            <strong>${a}</strong>
        </div>
    `}function Hr(e){return{open:"bi-megaphone",in_review:"bi-search",assigned:"bi-person-check",submitted:"bi-inbox",revision:"bi-arrow-repeat",completed:"bi-check-circle"}[e]||"bi-circle"}function xt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function ts(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Pr,At=f(()=>{y();v();Pr={open:"Open",in_review:"In review",assigned:"Assigned",submitted:"Awaiting review",revision:"Revision requested",completed:"Completed",cancelled:"Cancelled",expired:"Expired",disputed:"Disputed"}});var ss={};w(ss,{PostJobPage:()=>Ct});function Ct(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--post-job",!Ir()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelector("#post-job-cancel").addEventListener("click",()=>b("/poster")),await Fr(e),Br(e)}}}async function Fr(e){let t=e.querySelector("#post-job-category");try{let s=(await c.categories()).data||[];t.innerHTML=s.length?'<option value="">Choose a category\u2026</option>'+s.map(r=>`<option value="${Number(r.id)}">${Dr(r.name)}</option>`).join(""):'<option value="">No active categories</option>'}catch(a){t.innerHTML='<option value="">Unable to load categories</option>',l(a.message||"Could not load categories.","error")}}function Br(e){let t=e.querySelector("#post-job-form");t.addEventListener("submit",async a=>{a.preventDefault();let s=new FormData(t),r=e.querySelector("#post-job-submit");r.disabled=!0,r.textContent="Publishing\u2026";try{await c.posterCreateJob({category_id:Number(s.get("category_id")),title:String(s.get("title")||"").trim(),description:String(s.get("description")||"").trim(),requirements:String(s.get("requirements")||"").trim()||null,budget:Number(s.get("budget")),deadline_at:Rr(s.get("deadline_at")),bidding_window_hours:Number(s.get("bidding_window_hours"))}),l("Job published successfully.","success"),b("/poster/jobs")}catch(i){l(i.message||"Could not publish job.","error")}finally{r.disabled=!1,r.textContent="Publish job"}})}function Rr(e){if(!e)return null;let t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString().slice(0,19).replace("T"," ")}function Ir(){return!!m.get()}function Dr(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Mt=f(()=>{y();v()});var is={};w(is,{PosterJobsPage:()=>qt});function qt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--poster-jobs",!Wr()){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            <div class="page-heading-row">
            ...
            <div class="poster-filter-bar">
                <label>Status
                    <select class="admin-select" id="poster-job-filter">
                        ${Or.map(t=>`<option value="${t}" ${t===je?"selected":""}>${t?rs(t):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        <div class="admin-job-row__meta"><span><strong>Bids:</strong> ${Number(e.bid_count||0)}</span><span><strong>Views:</strong> ${Number(e.view_count||0)}</span><span><strong>Created:</strong> ${Gr(e.created_at)}</span></div>
    ...
    `,t.querySelector("[data-view-job]").addEventListener("click",()=>b(`/poster/jobs/${e.id}`)),t.querySelector("[data-cancel-job]")?.addEventListener("click",()=>Jr(e.id)),t}async function Jr(e){if(!confirm("Cancel this job? Any escrow for this job will be refunded."))return;let t=prompt("Reason (optional):","Cancelled by poster")||"Cancelled by poster";try{await c.posterCancelJob(e,{reason:t}),l("Job cancelled.","success"),await qe()}catch(a){l(a.message||"Could not cancel job.","error")}}function Wr(){return!!m.get()}function rs(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function Gr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Q(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Or,je,jt=f(()=>{y();v();Or=["","open","assigned","submitted","revision","completed","cancelled","disputed"],je=""});var ns={};w(ns,{PosterWalletPage:()=>Nt});function Nt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--poster-wallet";let t=m.get();if(!t||!t.is_admin&&t.role!=="poster"){e.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML='<h1 class="page-title">Poster Wallet</h1><p class="muted">Fund your available wallet, monitor escrow, and review deposits.</p><div id="poster-wallet-content"><div class="spinner"></div></div>';try{let[a,s]=await Promise.all([c.posterStats(),c.paymentSubmissions()]);zr(e.querySelector("#poster-wallet-content"),a.data||{},s.data||[])}catch(a){e.querySelector("#poster-wallet-content").innerHTML=`<p class="muted">Failed to load wallet: ${Pe(a.message||"unknown error")}</p>`}}}function zr(e,t,a){let s=Pt(t.wallet_balance),r=Pt(t.frozen_balance),i=Pt(t.total_spent);e.innerHTML=`
        ...
        <div class="card"><h2 class="card__title">Deposit history</h2><div class="poster-deposit-list">${Vr(a)}</div></div>
    `,e.querySelector("#poster-wallet-deposit").addEventListener("click",()=>b("/deposit"))}function Vr(e){return e.length?e.map(t=>`<div class="poster-deposit-row"><span><strong>${Pe((t.gateway||"").toUpperCase())}</strong><small>${Pe(t.trxid)} \xB7 ${Xr(t.created_at)}</small></span><span><strong>\u09F3${Number(t.amount||0).toFixed(2)}</strong><small>${Pe(t.status||"")}</small></span></div>`).join(""):'<p class="muted">No deposits submitted yet.</p>'}function Pt(e){let t=Number(e||0);return Number.isFinite(t)?t.toFixed(2):"0.00"}function Xr(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function Pe(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ht=f(()=>{y();v()});var cs={};w(cs,{AdminPage:()=>Bt});function Bt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin access required.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `;let a=e.querySelectorAll(".admin-tab"),s=e.querySelector("#admin-content");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(i=>i.classList.remove("admin-tab--active")),r.classList.add("admin-tab--active"),os(r.dataset.tab,s)})}),os("stats",s)}}async function os(e,t){t.innerHTML="Loading\u2026";try{if(e==="stats"){let[a,s]=await Promise.all([c.adminStats(),c.adminRevenue()]),r=a.data||{},i=s.data||{},n=i.currency_symbol||"\u09F3";t.innerHTML=`
                <div class="stat-grid admin-revenue-grid">
                    ${J("bi-graph-up-arrow","Platform revenue",Ft(i.platform_revenue,n))}
                    ...
                    ${J("bi-lock","Held in escrow",Ft(i.escrow_total,n))}
                </div>
                ...
                <div class="card admin-config-card">
                    ...
                    <div><strong>${x(i.currency||"BDT")}</strong> currency \xB7 <strong>${x(i.escrow_mode||"full_bid")}</strong> escrow</div>
                </div>
                <div class="card admin-config-card">
                    <div>
            ...
            `;let r=t.querySelector("#wd-list");s.forEach(i=>r.appendChild(ls(i,r))),t.querySelector("#wd-filter").addEventListener("change",async i=>{let n=await c.adminWithdrawals(i.target.value);r.innerHTML="",(n.data||[]).forEach(o=>r.appendChild(ls(o,r)))})}else if(e==="payments"){window.location.hash="#/admin/payments";return}else if(e==="users"){let s=(await c.adminUsers()).data||[];t.innerHTML='<div class="admin-list"></div>';let r=t.querySelector(".admin-list"),i=Number(m.get()?.id||0);s.forEach(n=>{let o=document.createElement("div");o.className="admin-row",o.innerHTML=`
                    <div>
                        <strong>${x(n.name)}</strong>
                        <span class="muted">${x(n.email)}</span>
                        <span class="badge user-role-badge">${x(n.role||(n.is_admin?"admin":"worker")).toUpperCase()}</span>
                    </div>
    ...
    `,a.querySelector(".provider-save").addEventListener("click",async()=>{let i={block_id:a.querySelector(".provider-block-id").value.trim()||null,weight:parseInt(a.querySelector(".provider-weight").value,10)||0,reward_per_view:parseFloat(a.querySelector(".provider-reward").value)||0,min_duration_seconds:parseInt(a.querySelector(".provider-duration").value,10)||12,enabled:a.querySelector(".provider-enabled").checked};try{await c.adminUpdateProvider(e.id,i),l("Provider saved","success")}catch(n){l(n.message,"error")}}),a}function x(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var Rt=f(()=>{y();v();v()});var us={};w(us,{AdminPaymentsPage:()=>Dt});function Dt(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-payments";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,e.querySelectorAll(".admin-tab").forEach(a=>{a.addEventListener("click",()=>{I.status=a.getAttribute("data-status"),e.querySelectorAll(".admin-tab").forEach(s=>s.classList.remove("admin-tab--active")),a.classList.add("admin-tab--active"),It()})}),await It()}}async function It(){let e=document.getElementById("admin-payments-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminPayments(I.status);I.items=t.data||[],Zr(e)}catch(t){e.innerHTML=`<p class="muted">Error: ${X(t.message||"Failed to load.")}</p>`}}}function Zr(e){if(I.items.length===0){e.innerHTML='<p class="muted">No payment submissions found.</p>';return}e.innerHTML="",I.items.forEach(t=>e.appendChild(Qr(t)))}function Qr(e){let t=Kr[e.status]||{label:e.status,class:""},a=document.createElement("div");return a.className=`admin-row admin-row--payment ${t.class}`,a.innerHTML=`
        <div class="admin-row__main">
    ...
    `,e.status==="pending"&&(a.querySelector('[data-action="approve"]')?.addEventListener("click",()=>ds(e.id,"approve",a)),a.querySelector('[data-action="reject"]')?.addEventListener("click",()=>ds(e.id,"reject",a))),a}async function ds(e,t,a){let s=prompt(t==="approve"?"Optional note for approval:":"Reason for rejection:");if(s!==null)try{let i=await(t==="approve"?c.adminApprovePayment:c.adminRejectPayment)(e,{note:s||null});l(i.message||"Done.","success"),await It()}catch(r){l(r.message||"Action failed.","error")}}function ps(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function X(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Kr,I,Ot=f(()=>{y();v();Kr={pending:{label:"Pending",class:"payment-row--pending"},approved:{label:"Approved",class:"payment-row--approved"},rejected:{label:"Rejected",class:"payment-row--rejected"}},I={status:"pending",items:[],loading:!1}});var bs={};w(bs,{AdminJobsPage:()=>Wt});function Wt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-jobs",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Status
                    <select class="admin-select" id="admin-job-status">
                        ${ei.map(t=>`<option value="${t}" ${t===Jt?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All jobs"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-job-status").addEventListener("change",async t=>{Jt=t.target.value,await le()}),e.querySelector("#admin-job-refresh").addEventListener("click",le),await le()}}}async function le(){let e=document.getElementById("admin-jobs-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminJobs(Jt)).data||[];e.innerHTML=a.length?"":'<p class="muted">No jobs found for this filter.</p>',a.forEach(s=>e.appendChild(ti(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load jobs: ${N(t.message||"unknown error")}</p>`}}}function ti(e){let t=document.createElement("article");t.className=`admin-row admin-job-row admin-job-row--${N(e.status)}`;let a=e.worker?`${N(e.worker.name)} <span class="muted">(${N(e.worker.email||"")})</span>`:'<span class="muted">Unassigned</span>';t.innerHTML=`
        <div class="admin-job-row__header">
            <div>
                <strong>${N(e.title)}</strong>
                <span class="badge">${N(String(e.status||"").replace("_"," ").toUpperCase())}</span>
            </div>
            <strong class="admin-row__amount">${N(e.currency||"BDT")} ${Number(e.budget||0).toFixed(2)}</strong>
        </div>
        <p class="admin-job-row__description muted">${N(e.description||"")}</p>
        <div class="admin-job-row__meta">
            <span><strong>Poster:</strong> ${N(e.poster?.name||"(deleted)")}</span>
            <span><strong>Worker:</strong> ${a}</span>
            <span><strong>Category:</strong> ${N(e.category_name||"Uncategorized")}</span>
        ...
        <div class="admin-job-row__footer">
            <span class="muted">Updated ${si(e.updated_at||e.created_at)}</span>
            <div class="admin-row__actions"></div>
        </div>
    `;let s=t.querySelector(".admin-row__actions");return["completed","cancelled","disputed"].includes(e.status)||s.appendChild(Ut("Mark disputed","btn--danger",()=>ai(e.id))),e.status==="disputed"&&(s.appendChild(Ut("Release payment","btn--success",()=>ms(e.id,"release"))),s.appendChild(Ut("Cancel and refund","btn--danger",()=>ms(e.id,"cancel")))),t}function Ut(e,t,a){let s=document.createElement("button");return s.className=`btn ${t} btn--sm`,s.textContent=e,s.addEventListener("click",a),s}async function ai(e){if(confirm("Flag this job for admin dispute review?"))try{await c.adminFlagJobDispute(e),l("Job flagged for dispute review.","success"),await le()}catch(t){l(t.message||"Could not flag job.","error")}}async function ms(e,t){if(!confirm(t==="release"?"Release the held payment to the worker and close this dispute?":"Cancel this job and refund its escrow to the poster?"))return;let s=t==="cancel"?prompt("Reason for cancellation:","Resolved by admin")||"Resolved by admin":"";try{await c.adminResolveJob(e,{resolution:t,reason:s}),l(t==="release"?"Payment released.":"Job cancelled and escrow refunded.","success"),await le()}catch(r){l(r.message||"Could not resolve dispute.","error")}}function si(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function N(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ei,Jt,Gt=f(()=>{y();v();ei=["","open","in_review","assigned","submitted","revision","disputed","completed","cancelled","expired"],Jt=""});var gs={};w(gs,{AdminTransactionsPage:()=>Xt});function Xt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-transactions",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
            ...
            <div class="admin-toolbar">
                <label>Type
                    <select class="admin-select" id="admin-transaction-type">
                        ${ri.map(t=>`<option value="${t}" ${t===Vt?"selected":""}>${t?t.replace("_"," ").replace(/\b\w/g,a=>a.toUpperCase()):"All transactions"}</option>`).join("")}
                    </select>
                </label>
        ...
        `,e.querySelector("#admin-transaction-type").addEventListener("change",async t=>{Vt=t.target.value,await zt()}),e.querySelector("#admin-transaction-refresh").addEventListener("click",zt),await zt()}}}async function zt(){let e=document.getElementById("admin-transactions-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let a=(await c.adminTransactions({type:Vt})).data||[];e.innerHTML=a.length?"":'<p class="muted">No transactions found for this filter.</p>',a.forEach(s=>e.appendChild(ii(s)))}catch(t){e.innerHTML=`<p class="muted">Failed to load ledger: ${D(t.message||"unknown error")}</p>`}}}function ii(e){let t=document.createElement("article");return t.className=`admin-row admin-transaction-row admin-transaction-row--${D(e.type)}`,t.innerHTML=`
        ...
        <div class="admin-transaction-row__meta">
            ...
            <span><strong>Date:</strong> ${ni(e.created_at)}</span>
        </div>
    ...
    `,t}function ni(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function D(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var ri,Vt,Yt=f(()=>{y();v();ri=["","deposit","withdrawal","escrow_hold","escrow_release","commission","refund","adjustment"],Vt=""});var fs={};w(fs,{AdminReportsPage:()=>Kt});function Kt(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--admin-reports",!m.get()?.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await oi()}}}async function oi(){let e=document.getElementById("admin-reports-content");if(e)try{let a=(await c.adminReports()).data||{},s=a.totals||{};e.innerHTML=`
            ...
            <div class="admin-report-grid">
                <div class="card">
                    ...
                    <div class="admin-report-list">${li(a.transactions||[])}</div>
                </div>
                <div class="card">
                    <h3 class="card__title">Jobs by status</h3>
                    <div class="admin-report-list">${ci(a.jobs||[])}</div>
                </div>
            </div>
        `}catch(t){e.innerHTML=`<p class="muted">Failed to load reports: ${ce(t.message||"unknown error")}</p>`}}function Ne(e,t){return`<div class="stat-tile admin-stat-tile"><span class="muted">${ce(e)}</span><strong>${ce(t)}</strong></div>`}function li(e){return e.length?e.map(t=>`
    ...
    `).join(""):'<p class="muted">No transactions yet.</p>'}function ci(e){return e.length?e.map(t=>`
        <div class="admin-report-row">
            <span><strong>${ce(String(t.status||"").replace("_"," "))}</strong><small>${He(t.job_count)} jobs</small></span>
            <strong>${Fe(t.budget)}</strong>
        </div>
    `).join(""):'<p class="muted">No jobs yet.</p>'}function He(e){let t=Number(e||0);return Number.isFinite(t)?t.toLocaleString():"0"}function Fe(e){let t=Number(e||0);return`\u09F3${Number.isFinite(t)?t.toFixed(2):"0.00"}`}function ce(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Zt=f(()=>{y();v()});var vs={};w(vs,{LoginPage:()=>Qt});function Qt(){let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--auth";let t=window.JMJOB_CONFIG&&window.JMJOB_CONFIG.referralCode||"";e.innerHTML=`
        <div class="auth-card">
            <h1 class="auth-card__title">\u{1F4B0} JMJob</h1>
            <p class="auth-card__sub">Log in to your account</p>
            ${t?`<p class="auth-card__referral">Referred by <strong>${di(t)}</strong></p>`:""}
    ...
    `;let t=document.getElementById("forgot-form"),a=document.getElementById("submit-btn");t.addEventListener("submit",async s=>{s.preventDefault();let r=t.email.value.trim();if(!r){l("Please enter your email address.","error");return}a.disabled=!0,a.textContent="Sending...";try{await c.forgotPassword({email:r}),l("If an account exists with this email, you will receive a reset code.","success"),b(`/reset-password?email=${encodeURIComponent(r)}`)}catch(i){l(i.message||"Failed to send reset code.","error"),a.disabled=!1,a.textContent="Send Reset Code"}})}var ra=f(()=>{y();v()});var _s={};w(_s,{default:()=>Re});async function Re(){let e=document.querySelector("[data-view]");if(!e)return;let a=(new URLSearchParams(window.location.hash.split("?")[1]).get("email")||"").trim().toLowerCase();e.innerHTML="",e.removeAttribute("data-view"),e.className="view view--auth",e.innerHTML=`
        <div class="auth-card">
            ...
            <form class="auth-form" id="reset-form">
                <label class="auth-form__label">
                    Email Address
                    <input type="email" name="email" value="${pi(a)}" placeholder="you@example.com" required autocomplete="email">
                </label>
    ...
    `;let s=document.getElementById("reset-form"),r=document.getElementById("submit-btn");s.addEventListener("submit",async i=>{i.preventDefault();let n=s.email.value.trim(),o=s.otp.value.trim(),d=s.password.value,g=s.password_confirmation.value;if(!n||!o||!d){l("Please fill in all fields.","error");return}if(o.length!==6){l("Please enter a valid 6-digit code.","error");return}if(d!==g){l("Passwords do not match.","error");return}if(d.length<6){l("Password must be at least 6 characters.","error");return}r.disabled=!0,r.textContent="Resetting...";try{await c.resetPassword({email:n,otp:o,password:d,password_confirmation:g}),l("Password reset successfully! You can now log in.","success"),b("/login")}catch(h){l(h.message||"Failed to reset password.","error"),r.disabled=!1,r.textContent="Reset Password"}})}function pi(e){return String(e||"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}var ia=f(()=>{y();v()});var Ws={};w(Ws,{JobDetailPage:()=>gn});function gn(e){return async()=>{let t=document.querySelector("[data-view]");if(!t)return;t.innerHTML="",t.className="view view--job-detail";let a=m.get();t.innerHTML=`
        ...
        `;try{let s=await c.job(e),{job:r,bids:i,bid_count:n,my_bid:o}=s.data;fn(r,i,n,o,a)}catch(s){document.getElementById("job-detail-content").innerHTML=`<p class="muted">Failed to load: ${G(s.message||"unknown")}</p>`}}}function fn(e,t,a,s,r){let i=document.getElementById("job-detail-content");if(!i)return;let n=e.bidding_closes_at?new Date(e.bidding_closes_at.replace(" ","T")+"Z"):null,o=n?Math.max(0,Math.floor((n-Date.now())/1e3)):null,d=o!=null?yn(o):"\u2014",g=["open","in_review"].includes(e.status),h=!!s;i.innerHTML=`
        ...
        ${vn(e,t,s,r,g)}
    `,hn(e,s,r)}function vn(e,t,a,s,r){return a?`
            <div class="card">
    ...
    `:'<div class="card"><p class="muted">Please log in to place a bid.</p></div>':'<div class="card"><p class="muted">Bidding is closed for this job.</p></div>'}function hn(e,t,a){if(t){let r=document.getElementById("withdraw-bid-btn");r&&r.addEventListener("click",async()=>{if(confirm("Withdraw your bid?"))try{await c.withdrawBid(t.id),l("Bid withdrawn.","success"),b(`/jobs/${e.id}`)}catch(i){l(i.message||"Failed to withdraw.","error")}});return}let s=document.getElementById("bid-form");s&&s.addEventListener("submit",async r=>{r.preventDefault();let i=new FormData(s),n=document.getElementById("bid-submit-btn");n.disabled=!0,n.textContent="Submitting\u2026";try{await c.placeBid(e.id,{amount:parseFloat(i.get("amount")),delivery_days:parseInt(i.get("delivery_days"),10),proposal:String(i.get("proposal")||"").trim()}),l("Bid placed!","success"),b(`/jobs/${e.id}`)}catch(o){l(o.message||"Failed to place bid.","error")}finally{n.disabled=!1,n.textContent="Submit Bid"}})}function yn(e){if(e<=0)return"expired";let t=Math.floor(e/86400),a=Math.floor(e%86400/3600);if(t>0)return`${t}d ${a}h`;let s=Math.floor(e%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function G(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Gs=f(()=>{y();v()});var Xs={};w(Xs,{PosterJobDetailPage:()=>wn});function wn(e){return async()=>{let t=document.querySelector("[data-view]");if(t){if(t.innerHTML="",t.className="view view--poster-job-detail",!En()){t.innerHTML='<div class="card"><h2>Poster access required</h2><a class="btn btn--primary" href="#/">Go home</a></div>';return}t.innerHTML='<a href="#/poster/jobs" class="back-link"><i class="bi bi-arrow-left"></i> My jobs</a><div id="poster-job-detail-content"><div class="spinner"></div></div>',await zs(e)}}}async function zs(e){let t=document.getElementById("poster-job-detail-content");if(t)try{let s=(await c.posterJobBids(e)).data||{};_n(t,s.job||{},s.bids||[],s.submissions||[])}catch(a){t.innerHTML=`<p class="muted">Failed to load job: ${T(a.message||"unknown error")}</p>`}}function _n(e,t,a,s){e.innerHTML=`
        <div class="card poster-detail-card">
            <div class="poster-detail-card__header"><div><h1 class="page-title">${T(t.title)}</h1><p class="muted">${T(t.description||"")}</p></div><span class="badge badge--status badge--${T(t.status)}">${T(An(t.status).toUpperCase())}</span></div>
        ...
        <div class="poster-detail-grid">
            <div class="card"><div class="card__header"><div><h2 class="card__title">Bid comparison</h2><p class="muted">Choose one pending proposal to assign the job.</p></div></div><div class="poster-bid-list">${$n(t,a)}</div></div>
            <div class="card"><div class="card__header"><div><h2 class="card__title">Submission review</h2><p class="muted">Approve delivery to release payment or request changes.</p></div></div><div class="poster-submission-list">${Sn(t,s)}</div></div>
        </div>
    ...
    `,e.querySelectorAll("[data-accept-bid]").forEach(r=>r.addEventListener("click",()=>kn(t.id,r.dataset.acceptBid))),e.querySelectorAll("[data-release-submission]").forEach(r=>r.addEventListener("click",()=>Tn(t.id,r.dataset.releaseSubmission))),e.querySelectorAll("[data-revision-submission]").forEach(r=>r.addEventListener("click",()=>Ln(t.id,r.dataset.revisionSubmission))),e.querySelector("#poster-detail-cancel")?.addEventListener("click",()=>xn(t.id))}function $n(e,t){return t.length?t.map(a=>`
    ...
    `).join(""):'<p class="muted">No bids yet.</p>'}function Sn(e,t){return t.length?t.map(a=>`
    ...
    `).join(""):'<p class="muted">No work submitted yet.</p>'}async function kn(e,t){if(confirm("Select this worker? The bid amount will be moved into escrow."))try{await c.posterAcceptBid(e,t),l("Worker selected and escrow held.","success"),await ua(e)}catch(a){l(a.message||"Could not select worker.","error")}}async function Tn(e,t){if(confirm("Approve this submission and release payment to the worker?"))try{await c.posterReleasePayment(e,{submission_id:Number(t)}),l("Payment released.","success"),await ua(e)}catch(a){l(a.message||"Could not release payment.","error")}}async function Ln(e,t){let a=prompt("What should the worker revise?");if(!(!a||!a.trim()))try{await c.posterRequestRevision(e,{submission_id:Number(t),note:a.trim()}),l("Revision requested.","success"),await ua(e)}catch(s){l(s.message||"Could not request revision.","error")}}async function xn(e){if(confirm("Cancel this job? Any escrow for this job will be refunded."))try{await c.posterCancelJob(e,{reason:"Cancelled by poster"}),l("Job cancelled.","success"),b("/poster/jobs")}catch(t){l(t.message||"Could not cancel job.","error")}}async function ua(e){let t=document.getElementById("poster-job-detail-content");t&&(t.innerHTML='<div class="spinner"></div>',await zs(e))}function En(){return!!m.get()}function An(e){return String(e||"").replace("_"," ").replace(/\b\w/g,t=>t.toUpperCase())}function Vs(e){if(!e)return"unknown";let t=new Date(String(e).replace(" ","T")+"Z");return Number.isNaN(t.getTime())?String(e):t.toLocaleString()}function T(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ys=f(()=>{y();v()});q();v();q();v();var Ie=[{path:"/",requireAuth:!0,render:()=>Promise.resolve().then(()=>(nt(),Ma))},{path:"/tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ye(),ot))},{path:"/webtask",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ye(),ot))},{path:"/earn",requireAuth:!0,render:()=>Promise.resolve().then(()=>(lt(),ja))},{path:"/refer",requireAuth:!0,render:()=>Promise.resolve().then(()=>(dt(),Na))},{path:"/withdraw",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ut(),Ha))},{path:"/deposit",requireAuth:!0,render:()=>Promise.resolve().then(()=>(bt(),Ra))},{path:"/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Se(),ft))},{path:"/leaderboard",requireAuth:!0,render:()=>Promise.resolve().then(()=>(vt(),Ia))},{path:"/achievements",requireAuth:!0,render:()=>Promise.resolve().then(()=>(ht(),Da))},{path:"/support",requireAuth:!0,render:()=>Promise.resolve().then(()=>(yt(),Oa))},{path:"/settings",requireAuth:!0,render:()=>Promise.resolve().then(()=>(St(),Ya))},{path:"/notifications",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Tt(),Za))},{path:"/profile",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Se(),ft))},{path:"/tg-tasks",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Lt(),Qa))},{path:"/poster",requireAuth:!0,render:()=>Promise.resolve().then(()=>(At(),as))},{path:"/poster/post-job",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Mt(),ss))},{path:"/poster/jobs",requireAuth:!0,render:()=>Promise.resolve().then(()=>(jt(),is))},{path:"/poster/wallet",requireAuth:!0,render:()=>Promise.resolve().then(()=>(Ht(),ns))},{path:"/admin",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Rt(),cs))},{path:"/admin/payments",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Ot(),us))},{path:"/admin/jobs",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Gt(),bs))},{path:"/admin/transactions",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Yt(),gs))},{path:"/admin/reports",requireAuth:!0,requireAdmin:!0,render:()=>Promise.resolve().then(()=>(Zt(),fs))},{path:"/login",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ea(),vs))},{path:"/register",requireAuth:!1,render:()=>Promise.resolve().then(()=>(sa(),ys))},{path:"/forgot-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ra(),ws))},{path:"/reset-password",requireAuth:!1,render:()=>Promise.resolve().then(()=>(ia(),_s))}],Pl=$(()=>{let e=k.get().split("?")[0]||"/";return Ie.find(t=>t.path===e)||Ie[0]});window.addEventListener("hashchange",()=>{let e=window.location.hash.replace(/^#/,"")||"/";k.set(e)});q();v();q();var ui=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],mi=[{path:"/admin",label:"Overview",icon:"bi-speedometer2"},{path:"/admin/payments",label:"Payments & TRX",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Moderation",icon:"bi-shield-check"},{path:"/admin/transactions",label:"Ledger Audit",icon:"bi-receipt"},{path:"/admin/reports",label:"Analytics & Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Platform Settings",icon:"bi-sliders"}],bi=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function gi(){let e=m.get();if(e&&e.is_admin)return[{header:"ADMIN CONSOLE"},...mi];let t=[...ui];return e&&e.role==="poster"&&t.push({separator:!0},...bi),t}var $s="sidebar_collapsed",ee=A(localStorage.getItem($s)==="true");function fi(){let e=!ee.get();ee.set(e),localStorage.setItem($s,String(e))}function Ss(){let e=()=>k.get().startsWith("/admin");return{tag:"aside",props:{class:()=>`sidebar ${ee.get()?"sidebar--collapsed":""} ${e()?"sidebar--admin":""}`,id:"sidebar"},children:[vi(),hi(),yi()]}}function vi(){let e=()=>k.get().startsWith("/admin");return{tag:"div",props:{class:"sidebar__brand"},children:[{tag:"div",props:{class:"sidebar__brand-text"},children:[{tag:"span",props:{class:"sidebar__brand-prefix"},children:["JM"]},{tag:"span",props:{class:"sidebar__brand-suffix"},children:["JOB"]}]},{tag:"span",props:{class:()=>`sidebar__admin-badge ${e()?"sidebar__admin-badge--active":""}`},children:["ADMIN"]}]}}function hi(){return{tag:"button",props:{class:"sidebar__collapse-btn",onclick:()=>fi(),title:()=>ee.get()?"Expand sidebar":"Collapse sidebar"},children:[{tag:"i",props:{class:()=>`bi ${ee.get()?"bi-chevron-right":"bi-chevron-left"}`},children:[]}]}}function yi(){return{tag:"nav",props:{class:"sidebar__nav"},children:gi().map(e=>e.header?wi(e.header):e.separator?_i():$i(e))}}function wi(e){return{tag:"div",props:{class:"sidebar__header"},children:[e]}}function _i(){return{tag:"div",props:{class:"sidebar__separator"},children:[]}}function $i({path:e,label:t,icon:a}){return{tag:"a",props:{class:`sidebar__item${k.get()===e?" sidebar__item--active":""}`,href:`#${e}`,title:()=>ee.get()?t:"",onclick:r=>{r.preventDefault(),b(e),Ts()}},children:[{tag:"i",props:{class:`bi ${a} sidebar__icon`},children:[]},{tag:"span",props:{class:"sidebar__label"},children:[t]}]}}function ks(){return{tag:"div",props:{class:"sidebar-overlay",id:"sidebar-overlay",onclick:()=>Ts()},children:[]}}function Ts(){let e=document.getElementById("sidebar"),t=document.getElementById("sidebar-overlay");e&&e.classList.remove("sidebar--open"),t&&t.classList.remove("sidebar-overlay--active")}v();q();v();var Si=[{path:"/",label:"Dashboard",icon:"bi-house-door"},{path:"/tasks",label:"Tasks",icon:"bi-list-check"},{path:"/earn",label:"Watch Ads",icon:"bi-play-circle"},{path:"/refer",label:"Refer & Earn",icon:"bi-people"},{path:"/deposit",label:"Deposit",icon:"bi-cash-coin"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/wallet",label:"Wallet",icon:"bi-wallet"},{path:"/notifications",label:"Notifications",icon:"bi-bell"},{path:"/jobs/available",label:"Browse Jobs",icon:"bi-briefcase"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square-fill"},{path:"/worker/bids",label:"My Bids",icon:"bi-clipboard-check"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/leaderboard",label:"Leaderboard",icon:"bi-bar-chart"},{path:"/achievements",label:"Achievements",icon:"bi-trophy"},{path:"/support",label:"Support",icon:"bi-question-circle"},{path:"/settings",label:"Settings",icon:"bi-gear"}],ki=[{path:"/admin",label:"Admin Panel",icon:"bi-shield-lock"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Job Oversight",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Transactions",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"},{path:"/admin/categories",label:"Categories",icon:"bi-tags"},{path:"/admin/settings",label:"Settings",icon:"bi-sliders"}],Ti=[{path:"/poster",label:"Poster Dashboard",icon:"bi-kanban"},{path:"/poster/post-job",label:"Post a Job",icon:"bi-plus-square"},{path:"/poster/jobs",label:"My Jobs",icon:"bi-briefcase"},{path:"/poster/wallet",label:"Poster Wallet",icon:"bi-wallet2"}];function Li(){let e=m.get();if(e&&e.is_admin)return ki;let t=[...Si];return e&&e.role==="poster"&&t.push({separator:!0},...Ti),t}function xi({path:e,label:t,icon:a}){return{tag:"a",props:{class:`mobile-nav__item${k.get()===e?" mobile-nav__item--active":""}`,href:`#${e}`,onclick:r=>{r.preventDefault(),b(e),na()}},children:[{tag:"i",props:{class:`bi ${a} mobile-nav__icon`},children:[]},{tag:"span",props:{class:"mobile-nav__label"},children:[t]}]}}function Ei(){return{tag:"div",props:{class:"mobile-nav__brand"},children:[{tag:"span",props:{class:"mobile-nav__brand-text"},children:["JM JOB"]},{tag:"button",props:{class:"mobile-nav__close","aria-label":"Close menu",onclick:()=>na()},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]}}function Ai(){return{tag:"nav",props:{class:"mobile-nav__list"},children:Li().map(e=>e.separator?Ci():xi(e))}}function Ci(){return{tag:"div",props:{class:"mobile-nav__separator"},children:[]}}function Ls(){return{tag:"aside",props:{class:"mobile-nav",id:"mobile-nav"},children:[Ei(),Ai()]}}function xs(){return{tag:"div",props:{class:"mobile-nav-overlay",id:"mobile-nav-overlay",onclick:()=>na()},children:[]}}function Es(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.add("mobile-nav--open"),t&&t.classList.add("mobile-nav-overlay--active"),document.body.style.overflow="hidden"}function na(){let e=document.getElementById("mobile-nav"),t=document.getElementById("mobile-nav-overlay");e&&e.classList.remove("mobile-nav--open"),t&&t.classList.remove("mobile-nav-overlay--active"),document.body.style.overflow=""}$t();y();function As(){return P(()=>L.get(),()=>Fi(),()=>Hi())}function Cs(){let e=()=>{let t=j.get();return t==="system"?typeof window<"u"&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches:t==="dark"};return{tag:"button",props:{class:"topbar__icon-btn theme-toggle",title:()=>e()?"Switch to light mode":"Switch to dark mode",onclick:()=>Ja(),"data-theme":()=>j.get()},children:[{tag:"i",props:{class:()=>`bi ${e()?"bi-sun":"bi-moon"}`},children:[]}]}}function Mi(){let e=document.getElementById("topbar-notifications-panel");if(!e)return;let t=e.classList.contains("topbar-notifications--open");document.querySelectorAll(".topbar-notifications--open").forEach(a=>a.classList.remove("topbar-notifications--open")),t||e.classList.add("topbar-notifications--open")}function qi(){return setTimeout(ji,0),{tag:"div",props:{class:"topbar__notifications-wrap"},children:[{tag:"button",props:{class:"topbar__icon-btn topbar__notifications","aria-label":"Notifications",onclick:e=>{e.stopPropagation(),Mi()}},children:[{tag:"i",props:{class:"bi bi-bell"},children:[]},{tag:"span",props:{class:"topbar__notification-badge",id:"topbar-notification-badge","aria-live":"polite"},children:["0"]}]},{tag:"div",props:{class:"topbar-notifications",id:"topbar-notifications-panel"},children:[{tag:"div",props:{class:"topbar-notifications__header"},children:[{tag:"strong",props:{},children:["Notifications"]},{tag:"button",props:{class:"topbar-notifications__close","aria-label":"Close",onclick:()=>{let e=document.getElementById("topbar-notifications-panel");e&&e.classList.remove("topbar-notifications--open")}},children:[{tag:"i",props:{class:"bi bi-x-lg"},children:[]}]}]},{tag:"ul",props:{class:"topbar-notifications__list",id:"topbar-notifications-list"},children:[Ni("Loading notifications\u2026","Your latest updates will appear here.","bi-hourglass-split","info")]},{tag:"div",props:{class:"topbar-notifications__footer"},children:[{tag:"a",props:{href:"#/notifications",class:"topbar-notifications__link"},children:["View all notifications"]}]}]}]}}async function ji(){let e=document.getElementById("topbar-notifications-list"),t=document.getElementById("topbar-notification-badge");if(!(!e||!t))try{let a=await c.notifications({limit:5}),s=Array.isArray(a.data)?a.data:[],r=Number(a.meta?.unread_count||s.filter(i=>!i.read).length||0);t.textContent=r>99?"99+":String(r),e.innerHTML=s.length?s.map(Pi).join(""):'<li class="topbar-notifications__empty">No notifications yet.</li>',e.querySelectorAll("[data-notification-id]").forEach(i=>{i.addEventListener("click",async()=>{let n=i.getAttribute("data-notification-id");if(!(!n||i.getAttribute("data-read")==="1"))try{await c.notificationRead(n),i.setAttribute("data-read","1"),i.classList.remove("topbar-notification--unread");let o=Math.max(0,Number(t.textContent.replace("+",""))-1);t.textContent=String(o)}catch{}})})}catch{e.innerHTML='<li class="topbar-notifications__empty">Notifications are unavailable right now.</li>',t.textContent="0"}}function Pi(e){let t=e.data||{},a=["success","warning","primary","info","danger"].includes(t.tone)?t.tone:"info",s=/^bi-[a-z0-9-]+$/.test(String(t.icon||""))?t.icon:"bi-bell",r=typeof t.action_url=="string"&&t.action_url.startsWith("/")?` href="#${De(t.action_url)}"`:"";return`<li class="topbar-notification topbar-notification--${a} ${e.read?"":"topbar-notification--unread"}" data-notification-id="${De(e.id)}" data-read="${e.read?"1":"0"}"><i class="bi ${s} topbar-notification__icon"></i><div class="topbar-notification__body"><div class="topbar-notification__title">${De(t.title||"Notification")}</div><div class="topbar-notification__text">${De(t.message||"")}</div>${r?`<a class="topbar-notification__action"${r}>Open</a>`:""}</div></li>`}function De(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}function Ni(e,t,a,s){return{tag:"li",props:{class:`topbar-notification topbar-notification--${s}`},children:[{tag:"i",props:{class:`bi ${a} topbar-notification__icon`},children:[]},{tag:"div",props:{class:"topbar-notification__body"},children:[{tag:"div",props:{class:"topbar-notification__title"},children:[e]},{tag:"div",props:{class:"topbar-notification__text"},children:[t]}]}]}}typeof document<"u"&&document.addEventListener("click",e=>{let t=document.getElementById("topbar-notifications-panel");t&&t.classList.contains("topbar-notifications--open")&&!t.contains(e.target)&&!e.target.closest(".topbar__notifications")&&t.classList.remove("topbar-notifications--open")});function Hi(){return{tag:"header",props:{class:"topbar topbar--public"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[Cs(),{tag:"a",props:{class:"topbar__link",href:"#/login"},children:["Log in"]},{tag:"a",props:{class:"topbar__link topbar__link--cta",href:"#/register"},children:["Sign up"]}]}]}}function Fi(){let e=m.get(),t=e?parseFloat(e.balance||0).toFixed(2):"0.00",a=e?e.name.charAt(0).toUpperCase():"U";return{tag:"header",props:{class:"topbar topbar--user"},children:[{tag:"div",props:{class:"topbar__left"},children:[{tag:"button",props:{class:"topbar__menu-btn",onclick:()=>Es(),"aria-label":"Open menu"},children:[{tag:"i",props:{class:"bi bi-list"},children:[]}]},{tag:"a",props:{class:"topbar__brand",href:"#/"},children:["JMJOB"]}]},{tag:"div",props:{class:"topbar__right"},children:[Cs(),qi(),{tag:"div",props:{class:"topbar__user"},children:[{tag:"div",props:{class:"topbar__avatar"},children:[a]},{tag:"div",props:{class:"topbar__user-info"},children:[{tag:"div",props:{class:"topbar__user-name"},children:[{tag:"span",props:{},children:[e?e.name:"Loading\u2026"]},{tag:"span",props:{class:"topbar__user-active-dot",title:"Active"},children:[]}]},{tag:"div",props:{class:"topbar__user-balance"},children:[`$${t}`]}]}]},{tag:"button",props:{class:"topbar__icon-btn",title:"Log out",onclick:async()=>{await ve(),l("Logged out.","info")}},children:[{tag:"i",props:{class:"bi bi-box-arrow-right"},children:[]}]}]}]}}v();q();function Ms(){return P(()=>!!re.get(),()=>{let e=re.get();return{tag:"div",props:{class:"toast-container"},children:[{tag:"div",props:{class:"toast toast--"+(e.type||"info"),key:e.id||"toast"},children:[{tag:"span",props:{},children:[e.message]}]}]}},()=>({tag:"div",props:{class:"toast-container"},children:[]}))}y();function qs(){let e=new Date().getFullYear();return{tag:"footer",props:{class:"app-footer",ghostStyle:{mount:t=>{c.socialLinks().then(a=>{let s=t.querySelector("#app-footer-social");if(!s||!a)return;let r=[];a.facebook&&r.push(`<a href="${Oe(a.facebook)}" target="_blank" rel="noopener noreferrer" title="Facebook" class="app-footer__social-link"><i class="bi bi-facebook"></i></a>`),a.instagram&&r.push(`<a href="${Oe(a.instagram)}" target="_blank" rel="noopener noreferrer" title="Instagram" class="app-footer__social-link"><i class="bi bi-instagram"></i></a>`),a.whatsapp&&r.push(`<a href="${Oe(a.whatsapp)}" target="_blank" rel="noopener noreferrer" title="WhatsApp" class="app-footer__social-link"><i class="bi bi-whatsapp"></i></a>`),a.telegram&&r.push(`<a href="${Oe(a.telegram)}" target="_blank" rel="noopener noreferrer" title="Telegram" class="app-footer__social-link"><i class="bi bi-telegram"></i></a>`),s.innerHTML=r.join("")}).catch(()=>{})}}},children:[{tag:"div",props:{class:"app-footer__copy"},children:[`\xA9 ${e} JMJob`]},{tag:"div",props:{class:"app-footer__social",id:"app-footer-social"},children:[]},{tag:"div",props:{class:"app-footer__developed"},children:[{tag:"span",props:{},children:["Developed By: "]},{tag:"a",props:{class:"app-footer__link",href:"https://nextstagesoftware.com/",target:"_blank",rel:"noopener noreferrer"},children:["NextStageSoftware"]}]}]}}function Oe(e){return e?String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]):""}v();var Bi=[{path:"/",label:"Home",icon:"bi-house-door"},{path:"/worker/active-jobs",label:"Active Jobs",icon:"bi-hammer"},{path:"/withdraw",label:"Withdraw",icon:"bi-wallet2"},{path:"/profile",label:"Account",icon:"bi-person-circle"}],Ri=[{path:"/admin",label:"Admin",icon:"bi-shield-lock-fill"},{path:"/admin/payments",label:"Payments",icon:"bi-cash-stack"},{path:"/admin/jobs",label:"Jobs",icon:"bi-briefcase"},{path:"/admin/transactions",label:"Ledger",icon:"bi-receipt"},{path:"/admin/reports",label:"Reports",icon:"bi-bar-chart-line"}];function Ii(){let e=m.get();return e&&e.is_admin?Ri:Bi}function Di({path:e,label:t,icon:a}){return{tag:"a",props:{class:`hnav__item${k.get()===e?" hnav__item--active":""}`,href:`#${e}`,title:t,"aria-label":t,onclick:r=>{r.preventDefault(),b(e)}},children:[{tag:"i",props:{class:`bi ${a} hnav__icon`},children:[]},{tag:"span",props:{class:"hnav__label"},children:[t]}]}}function Oi(){return{tag:"div",props:{class:"hnav__separator"},children:[]}}function Ui(){return{tag:"nav",props:{class:"hnav__list",id:"hnav-list"},children:Ii().map(e=>e.separator?Oi():Di(e))}}function js(e){let t=e==="left";return{tag:"button",props:{class:`hnav__scroll hnav__scroll--${e}`,id:`hnav-scroll-${e}`,type:"button","aria-label":t?"Scroll left":"Scroll right",onclick:a=>{a.preventDefault(),Ji(t?-1:1)}},children:[{tag:"i",props:{class:`bi ${t?"bi-chevron-left":"bi-chevron-right"}`},children:[]}]}}function Ji(e){let t=document.getElementById("hnav-list");if(!t)return;let a=Math.max(120,Math.round(t.clientWidth*.7));t.scrollBy({left:e*a,behavior:"smooth"})}function oa(){let e=document.getElementById("hnav-list"),t=document.getElementById("hnav-scroll-left"),a=document.getElementById("hnav-scroll-right");if(!e||!t||!a)return;let s=e.scrollWidth-e.clientWidth;t.disabled=e.scrollLeft<=1,a.disabled=e.scrollLeft>=s-1,t.classList.toggle("is-disabled",t.disabled),a.classList.toggle("is-disabled",a.disabled)}typeof document<"u"&&(document.addEventListener("scroll",e=>{e.target&&e.target.id==="hnav-list"&&oa()},!0),window.addEventListener("resize",()=>setTimeout(oa,50)),document.addEventListener("hnav:rendered",()=>setTimeout(oa,0)));function Ps(){return{tag:"div",props:{class:"hnav",id:"horizontal-nav"},children:[js("left"),Ui(),js("right")]}}function Ns(){let e=()=>!!m.get()?.is_admin,t=()=>k.get().startsWith("/admin"),a=()=>L.get();return{tag:"div",props:{class:()=>`app-shell ${a()?"app-shell--authed":"app-shell--public"} ${e()||t()?"app-shell--admin":""}`},children:[P(()=>L.get(),()=>Ss(),()=>null),P(()=>L.get(),()=>ks(),()=>null),P(()=>L.get(),()=>Ls(),()=>null),P(()=>L.get(),()=>xs(),()=>null),{tag:"div",props:{class:"main-wrapper"},children:[As(),P(()=>L.get()&&!e(),()=>Ps(),()=>null),{tag:"main",props:{class:"app-main"},children:[Wi()]},qs()]},Ms()]}}function Wi(){let t=k.get().split("?")[0]||"/",a=Ie.find(r=>r.path===t),s=m.get();return s&&s.is_admin&&!t.startsWith("/admin")?(b("/admin"),la()):a?a.requireAuth&&!L.get()?(b("/login"),la()):a.requireAdmin&&(!m.get()||!m.get().is_admin)?Vi():!a.requireAuth&&L.get()&&["/login","/register","/forgot-password","/reset-password"].includes(t)?(b("/"),la()):Gi(a):zi()}function Gi(e){return{tag:"div",props:{class:"view-placeholder","data-view":e.path},children:[{tag:"p",props:{class:"muted"},children:["Loading "+e.path+"\u2026"]}]}}function zi(){return{tag:"div",props:{class:"view-404"},children:[{tag:"h1",props:{},children:["404"]},{tag:"p",props:{},children:["Page not found."]},{tag:"button",props:{class:"btn-primary",onclick:()=>b("/")},children:["Go home"]}]}}function Vi(){return{tag:"div",props:{class:"view-403"},children:[{tag:"h1",props:{},children:["403"]},{tag:"p",props:{},children:["Admin access required."]},{tag:"button",props:{class:"btn-primary",onclick:()=>b("/")},children:["Go home"]}]}}function la(){return{tag:"div",props:{class:"view-loading"},children:[{tag:"div",props:{class:"spinner"},children:[]}]}}q();v();nt();ea();sa();ra();ia();dt();ye();lt();Lt();ut();Se();Rt();Ot();bt();vt();ht();yt();St();y();v();var u={jobs:[],categories:[],loading:!1,search:"",categoryId:"",minBudget:"",maxBudget:"",sort:"latest",page:1,perPage:12,total:0,lastPage:1,requestSerial:0};function Fs(){return async()=>{let e=document.querySelector("[data-view]");if(e){if(e.innerHTML="",e.className="view view--jobs-available",e.innerHTML=`
            ...
            <div class="card jobs-filters">
                <div class="jobs-filters__row">
                    <label class="jobs-filters__field jobs-filters__field--search">
                        <span>Search</span>
                        <input type="search" class="jobs-filters__search" id="jobs-search" maxlength="80" placeholder="Search jobs\u2026" value="${H(u.search)}">
                    </label>
                    ...
                    <label class="jobs-filters__field jobs-filters__field--amount">
                        ...
                        <input type="number" min="0" step="0.01" inputmode="decimal" id="jobs-min-budget" placeholder="\u09F30" value="${H(u.minBudget)}">
                    </label>
                    <label class="jobs-filters__field jobs-filters__field--amount">
                        <span>Max budget</span>
                        <input type="number" min="0" step="0.01" inputmode="decimal" id="jobs-max-budget" placeholder="No limit" value="${H(u.maxBudget)}">
                    </label>
                    <label class="jobs-filters__field">
                        <span>Sort by</span>
        ...
        `,u.categories.length===0)try{let t=await c.categories();u.categories=Array.isArray(t.data)?t.data:[];let a=document.getElementById("jobs-category");a&&(a.innerHTML=Hs())}catch{}document.getElementById("jobs-apply")?.addEventListener("click",()=>{Xi(),u.page=1,Ue()}),document.getElementById("jobs-reset")?.addEventListener("click",()=>{u.search="",u.categoryId="",u.minBudget="",u.maxBudget="",u.sort="latest",u.page=1,Yi(),Ue()}),document.getElementById("jobs-search")?.addEventListener("keydown",t=>{t.key==="Enter"&&document.getElementById("jobs-apply")?.click()}),await Ue()}}}function Hs(){return'<option value="">All categories</option>'+u.categories.map(e=>`<option value="${H(e.id)}" ${String(e.id)===String(u.categoryId)?"selected":""}>${H(e.name)}</option>`).join("")}function Xi(){u.search=document.getElementById("jobs-search")?.value.trim()||"",u.categoryId=document.getElementById("jobs-category")?.value||"",u.minBudget=document.getElementById("jobs-min-budget")?.value.trim()||"",u.maxBudget=document.getElementById("jobs-max-budget")?.value.trim()||"",u.sort=document.getElementById("jobs-sort")?.value||"latest"}function Yi(){let e={"jobs-search":u.search,"jobs-category":u.categoryId,"jobs-min-budget":u.minBudget,"jobs-max-budget":u.maxBudget,"jobs-sort":u.sort};Object.entries(e).forEach(([t,a])=>{let s=document.getElementById(t);s&&(s.value=a)})}async function Ue(){let e=document.getElementById("jobs-grid");if(!e)return;let t=++u.requestSerial;u.loading=!0,e.innerHTML='<div class="spinner"></div>';try{let a={page:u.page,per_page:u.perPage,sort:u.sort};u.search&&(a.search=u.search),u.categoryId&&(a.category_id=u.categoryId),u.minBudget!==""&&(a.min_budget=u.minBudget),u.maxBudget!==""&&(a.max_budget=u.maxBudget);let s=await c.jobs(a);if(t!==u.requestSerial)return;u.jobs=Array.isArray(s.data)?s.data:[],u.total=Number(s.meta?.total||0),u.lastPage=Math.max(1,Number(s.meta?.last_page||1)),Ki()}catch(a){if(t!==u.requestSerial)return;e.innerHTML=`<p class="muted">Failed to load jobs: ${H(a.message||"unknown error")}</p>`,Bs(),Rs()}finally{t===u.requestSerial&&(u.loading=!1)}}function Ki(){let e=document.getElementById("jobs-grid");if(e){if(Bs(),Rs(),u.jobs.length===0){e.innerHTML='<p class="muted">No jobs match your filters. Try clearing them.</p>';return}e.innerHTML=u.jobs.map(t=>`
        <a class="job-card" href="#/jobs/${encodeURIComponent(t.id)}" data-id="${H(t.id)}">
            <div class="job-card__head">
                ${t.category&&t.category.icon_class?`<i class="bi ${Zi(t.category.icon_class)} job-card__cat-icon"></i>`:""}
            ...
            <p class="job-card__desc">${H(Qi(t.description,140))}</p>
    ...
    `,e.querySelectorAll("[data-jobs-page]").forEach(t=>{t.addEventListener("click",()=>{let a=Number(t.getAttribute("data-jobs-page"));a<1||a>u.lastPage||a===u.page||(u.page=a,Ue())})})}}function Zi(e){return/^bi-[a-z0-9-]+$/.test(String(e||""))?e:"bi-briefcase"}function Qi(e,t){let a=(e||"").toString();return a.length>t?a.slice(0,t-1)+"\u2026":a}function H(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var ca={bids:[],loading:!1};function Is(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-bids",e.innerHTML=`
        ...
        `;try{let t=await c.workerBids();ca.bids=t.data||[],en()}catch(t){document.getElementById("bids-list").innerHTML=`<p class="muted">Failed to load: ${Ds(t.message||"unknown")}</p>`}}}}function en(){let e=document.getElementById("bids-list");if(e){if(ca.bids.length===0){e.innerHTML=`<p class="muted">You haven't placed any bids yet. <a href="#/jobs/available">Browse jobs</a> to get started.</p>`;return}e.innerHTML=ca.bids.map(t=>`
        <a class="bid-row-card" href="#/jobs/${t.job_id}" data-id="${t.job_id}">
            <div class="bid-row-card__main">
                ...
                <div class="bid-row-card__meta">
                    ...
                    <span class="muted">${tn(t.created_at)}</span>
                </div>
            </div>
            <span class="badge badge--status badge--${t.status}">${t.status.toUpperCase()}</span>
        </a>
    `).join(""),e.querySelectorAll("a.bid-row-card").forEach(t=>{t.addEventListener("click",a=>{a.preventDefault(),b(`/jobs/${t.getAttribute("data-id")}`)})})}}function tn(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function Ds(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var de={jobs:[],submissions:[],loading:!1};function da(){return async()=>{let e=document.querySelector("[data-view]");if(e){e.innerHTML="",e.className="view view--worker-active",e.innerHTML=`
        ...
        `;try{let[t,a]=await Promise.all([c.workerActiveJobs(),c.workerSubmissions()]);de.jobs=t.data||[],de.submissions=a.data||[],an()}catch(t){document.getElementById("active-jobs-list").innerHTML=`<p class="muted">Failed to load: ${pa(t.message||"unknown")}</p>`}}}}function an(){let e=document.getElementById("active-jobs-list");if(e){if(de.jobs.length===0){e.innerHTML=`<p class="muted">No active jobs. Once a poster accepts your bid, it'll appear here.</p>`;return}e.innerHTML=de.jobs.map(t=>{let a=de.submissions.find(r=>r.job_id===t.id),s=t.status;return`
        ...
        `}).join(""),nn()}}function sn(e,t){return`
        <div class="active-job-card__sub">
            <strong>Submitted:</strong> ${on(t.created_at)}
    ...
    `}function nn(){document.querySelectorAll("form.submit-form").forEach(e=>{e.addEventListener("submit",async t=>{t.preventDefault();let a=parseInt(e.getAttribute("data-job-id"),10),s=new FormData(e),r=e.querySelector("[data-submit-btn]");r.disabled=!0,r.innerHTML='<i class="bi bi-hourglass"></i> Submitting\u2026';try{await c.submitWork(a,{description:String(s.get("description")||"").trim(),external_link:String(s.get("external_link")||"").trim()||null}),l("Work submitted!","success"),da()()}catch(i){l(i.message||"Failed to submit.","error")}finally{r.disabled=!1,r.innerHTML='<i class="bi bi-send"></i> Submit Work'}})})}function on(e){if(!e)return"";try{return new Date(e.replace(" ","T")+"Z").toLocaleString()}catch{return e}}function pa(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var Je={categories:[],loading:!1};function Os(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-categories";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,cn(),await We()}}async function We(){let e=document.getElementById("cat-list");if(e){e.innerHTML='<div class="spinner"></div>';try{let t=await c.adminCategories();Je.categories=t.data||[],ln()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${pe(t.message||"unknown")}</p>`}}}function ln(){let e=document.getElementById("cat-list");if(e){if(Je.categories.length===0){e.innerHTML='<p class="muted">No categories yet. Add one below.</p>';return}e.innerHTML=Je.categories.map(t=>`
    ...
    `).join(""),e.querySelectorAll("[data-toggle]").forEach(t=>t.addEventListener("click",()=>dn(t.getAttribute("data-toggle")))),e.querySelectorAll("[data-delete]").forEach(t=>t.addEventListener("click",()=>pn(t.getAttribute("data-delete"))))}}function cn(){let e=document.getElementById("cat-form");e&&e.addEventListener("submit",async t=>{t.preventDefault();let a=new FormData(e),s={name:String(a.get("name")||"").trim(),slug:String(a.get("slug")||"").trim().toLowerCase(),description:String(a.get("description")||"").trim()||null,icon_class:String(a.get("icon_class")||"").trim()||null,display_order:parseInt(a.get("display_order")||"0",10),is_active:a.get("is_active")==="on"},r=document.getElementById("cat-save-btn");r.disabled=!0,r.textContent="Creating\u2026";try{await c.adminCreateCategory(s),l("Category created.","success"),e.reset(),await We()}catch(i){l(i.message||"Failed.","error")}finally{r.disabled=!1,r.textContent="Create Category"}})}async function dn(e){let t=Je.categories.find(a=>String(a.id)===String(e));if(t)try{await c.adminUpdateCategory(e,{is_active:!t.is_active}),l(t.is_active?"Category disabled.":"Category enabled.","success"),await We()}catch(a){l(a.message||"Failed.","error")}}async function pn(e){if(confirm("Delete this category? It will be deactivated if jobs are attached."))try{let t=await c.adminDeleteCategory(e);l(t.message||"Done.","success"),await We()}catch(t){l(t.message||"Failed.","error")}}function pe(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}y();v();var Y={grouped:{},social:{},loading:!1};function Us(){return async()=>{let e=document.querySelector("[data-view]");if(!e)return;e.innerHTML="",e.className="view view--admin-settings";let t=m.get();if(!t||!t.is_admin){e.innerHTML='<div class="card"><h2>403</h2><p>Admin only.</p><a class="btn btn--primary" href="#/">Go home</a></div>';return}e.innerHTML=`
        ...
        `,await Js()}}async function Js(){let e=document.getElementById("settings-container");if(e){e.innerHTML='<div class="spinner"></div>';try{let[t,a]=await Promise.all([c.adminSettings(),c.socialLinks()]);Y.grouped=t.data||{},Y.social=a||{},un()}catch(t){e.innerHTML=`<p class="muted">Failed to load: ${F(t.message||"unknown")}</p>`}}}function un(){let e=document.getElementById("settings-container");if(!e)return;let a=Object.keys(Y.grouped).map(r=>`
        <div class="card settings-group">
            <h3 class="card__title">${F(r.charAt(0).toUpperCase()+r.slice(1))}</h3>
            <div class="settings-group__rows">
                ${Y.grouped[r].map(i=>mn(r,i)).join("")}
            </div>
        </div>
    `).join(""),s=Y.social;a+=`
            ...
            <div class="settings-group__rows">
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-facebook" value="${F(s.facebook||"")}" placeholder="https://facebook.com/yourpage" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="url" id="social-instagram" value="${F(s.instagram||"")}" placeholder="https://instagram.com/yourprofile" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-whatsapp" value="${F(s.whatsapp||"")}" placeholder="https://wa.me/1234567890" class="settings-row__input">
                    </div>
                </div>
                <div class="settings-row">
                    ...
                    <div class="settings-row__control">
                        <input type="text" id="social-telegram" value="${F(s.telegram||"")}" placeholder="https://t.me/yourchannel" class="settings-row__input">
                    </div>
                </div>
            </div>
        </div>
    ...
    `,e.innerHTML=a,document.getElementById("settings-save-btn").addEventListener("click",bn)}function mn(e,t){let a=`set-${t.key.replace(/[^a-z0-9]/gi,"_")}`,s;switch(t.value_type){case"boolean":s=`<label class="settings-row__check"><input type="checkbox" id="${a}" ${t.value?"checked":""}></label>`;break;case"integer":case"percent":s=`<input type="number" step="1" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"decimal":s=`<input type="number" step="0.0001" id="${a}" value="${t.value}" class="settings-row__input">`;break;case"json":s=`<textarea id="${a}" rows="3" class="settings-row__input">${F(JSON.stringify(t.value,null,2)||"")}</textarea>`;break;default:s=`<input type="text" id="${a}" value="${F(String(t.value))}" class="settings-row__input">`}return`
        <div class="settings-row">
            <label for="${a}" class="settings-row__label">
                <strong>${F(t.key)}</strong>
                <span class="muted">${F(t.description||"")}</span>
            </label>
            <div class="settings-row__control">${s}</div>
        </div>
    `}async function bn(){let e={};for(let s of Object.keys(Y.grouped))for(let r of Y.grouped[s]){let i=`set-${r.key.replace(/[^a-z0-9]/gi,"_")}`,n=document.getElementById(i);if(!n)continue;let o;r.value_type==="boolean"?o=n.checked:r.value_type==="integer"||r.value_type==="percent"?o=parseInt(n.value,10):r.value_type==="decimal"?o=parseFloat(n.value):r.value_type==="json"?o=n.value?JSON.parse(n.value):null:o=n.value,e[r.key]=o}let t={facebook:document.getElementById("social-facebook")?.value||"",instagram:document.getElementById("social-instagram")?.value||"",whatsapp:document.getElementById("social-whatsapp")?.value||"",telegram:document.getElementById("social-telegram")?.value||""},a=document.getElementById("settings-save-btn");a.disabled=!0,a.textContent="Saving\u2026";try{await Promise.all([c.adminUpdateSettings(e),c.adminUpdateSocialLinks(t)]),l("Settings and social links saved successfully.","success"),await Js()}catch(s){l(s.message||"Failed to save.","error")}finally{a.disabled=!1,a.textContent="Save All Changes"}}function F(e){return e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}Gt();Yt();Zt();At();Mt();jt();Ht();Tt();var Ks={"/":he,"/refer":ct,"/webtask":ie,"/tasks":ie,"/earn":we,"/tg-tasks":Ce,"/withdraw":_e,"/profile":$e,"/wallet":$e,"/admin":Bt,"/admin/payments":Dt,"/admin/categories":Os,"/admin/settings":Us,"/admin/jobs":Wt,"/admin/transactions":Xt,"/admin/reports":Kt,"/deposit":mt,"/leaderboard":ke,"/achievements":Te,"/support":Le,"/settings":Ee,"/jobs/available":Fs,"/worker/bids":Is,"/worker/active-jobs":da,"/poster":Et,"/poster/post-job":Ct,"/poster/jobs":qt,"/poster/wallet":Nt,"/notifications":kt,"/login":Qt,"/register":aa,"/forgot-password":Be,"/reset-password":Re};function Zs(){Ge(),setTimeout(Ge,50),window.addEventListener("hashchange",Ge),$(()=>{L.get(),setTimeout(Ge,0)})}async function Ge(){let t=(window.location.hash.replace(/^#/,"")||"/").split("?")[0]||"/";if(!Ks[t]){let n=t.match(/^\/jobs\/(\d+)$/);if(n){let d=await Promise.resolve().then(()=>(Gs(),Ws));await ma(()=>d.JobDetailPage(n[1]),t);return}let o=t.match(/^\/poster\/jobs\/(\d+)$/);if(o){if(!L.get()){b("/login");return}let d=await Promise.resolve().then(()=>(Ys(),Xs));await ma(()=>d.PosterJobDetailPage(o[1]),t);return}t="/"}let a=L.get(),s=m.get(),r=["/login","/register","/forgot-password","/reset-password"];if(r.includes(t)&&a){s&&s.is_admin?b("/admin"):b("/");return}if(!r.includes(t)&&!a){b("/login");return}if(t==="/"&&s&&s.is_admin){b("/admin");return}if(t.startsWith("/admin")&&(!s||!s.is_admin)){Cn();return}let i=Ks[t];await ma(i,t)}async function ma(e,t){let a=document.getElementById("app"),s=a.querySelector(".app-main");if(!s){s=document.createElement("div"),s.className="app-main";let r=a.querySelector(".bottomnav");r?a.insertBefore(s,r):a.appendChild(s)}s.innerHTML=`<div data-view="${t}" class="view-skeleton"><div class="spinner"></div></div>`;try{let r=typeof e=="function"?e():e;typeof r=="function"?await r():r&&typeof r.then=="function"&&await r}catch(r){console.error("View render threw synchronously for",t,r),s.innerHTML=`<div class="card"><h2>Error</h2><p>${r.message}</p></div>`}}function Cn(){let e=document.getElementById("app"),t=e.querySelector(".app-main");t||(t=document.createElement("div"),t.className="app-main",e.appendChild(t)),t.innerHTML=`
        <div class="card" style="max-width: 480px; margin: 40px auto; text-align: center;">
            <h2>403</h2>
            <p>Admin access required.</p>
            <a class="btn btn--primary" href="#/">Go home</a>
        </div>
    `}v();var Qs=document.getElementById("app")||(()=>{let e=document.createElement("div");return e.id="app",document.body.appendChild(e),e})();Qs.innerHTML="";B(Ns(),Qs);R.get()&&E();Zs();
